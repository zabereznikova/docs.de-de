...
---
### <a name="listboxitem-isselected-binding-issue-with-observablecollectiontmove"></a>IsSelected-Bindungsfehler für ListBoxItem mit ObservableCollection\<T>.Move
