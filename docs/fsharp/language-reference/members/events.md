...
Anstatt nur einen Ereignishandler für ein Ereignis mithilfe der [Event.add](https://msdn.microsoft.com/library/10670d3b-8d47-4f6e-b8df-ebc6f64ef4fd) -Funktion können Sie die Funktionen in der `Event` Prozess Ereignisstreams hochgradig angepasstes Möglichkeiten-Modul. Hierzu verwenden Sie den Vorwärtspipeoperator (`|>`) zusammen mit dem Ereignis als ersten Wert in einer Reihe von Funktionsaufrufen und die `Event`-Modulfunktionen als nachfolgende Funktionsaufrufe.
...
[Behandeln und Auslösen von Ereignissen](https://msdn.microsoft.com/library/edzehd2t.aspx)
...
[Control.Event &#60; " -Delegaten "Args &#62; Klasse](https://msdn.microsoft.com/visualfsharpdocs/conceptual/control.event%5b%27delegate%2c%27args%5d-class-%5bfsharp%5d)
