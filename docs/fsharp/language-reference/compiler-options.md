...
|**--checked**[**+**&#124;**-**]|Aktiviert oder deaktiviert die Generierung von Überlaufprüfungen.<br /><br />Diese Compileroption entspricht der C#-Compileroption gleichen Namens. Weitere Informationen finden Sie unter [ &#47;überprüft &#40;C&#35; Compileroptionen&#41;](https://msdn.microsoft.com/library/h25wtyxf.aspx).|
...
|**--platform:&lt;platform-name&gt;**|Gibt an, dass der generierte Code nur auf den angegebenen Plattformen laufen (**X86**, **Itanium**, oder **X64**), oder wenn der Plattformname **"anycpu"**ausgewählt wird, gibt an, dass der generierte Code auf jeder Plattform ausgeführt werden kann.<br /><br />Diese Compileroption entspricht der C#-Compileroption gleichen Namens. Weitere Informationen finden Sie unter [ &#47;Plattform &#40;C&#35; Compileroptionen&#41;](https://msdn.microsoft.com/library/zekwfyz4.aspx).|
...
|**--reference:&lt;assembly-filename&gt;**<br /><br />**R -** &lt; **Assembly-Dateiname&gt;**|Macht Code aus einer F#- oder .NET Framework-Assembly für den Code verfügbar, der kompiliert wird.<br /><br />Diese Compileroption entspricht der C#-Compileroption gleichen Namens. Weitere Informationen finden Sie unter [ &#47;Verweis &#40;C&#35; Compileroptionen&#41;](https://msdn.microsoft.com/library/yabyz3h4.aspx).|
|**--resource:&lt;resource-filename&gt;**|Bettet eine verwaltete Ressourcendatei in die generierte Assembly ein.<br /><br />Diese Compileroption entspricht der C#-Compileroption gleichen Namens. Weitere Informationen finden Sie unter [ &#47;Ressource &#40;C&#35; Compileroptionen&#41;](https://msdn.microsoft.com/library/c0tyye07.aspx).|
