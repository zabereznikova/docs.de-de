...
|[Projekteigenschaftenverweise](https://msdn.microsoft.com/library/16satcwx.aspx)|Beschreibt die Benutzeroberfläche für Projekte, einschließlich Projekteigenschaftenseiten, die Buildoptionen bereitstellen.|
