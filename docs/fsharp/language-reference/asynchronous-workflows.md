...
Zusätzliche asynchrone primitiven stehen in der [f# PowerTools](http://fsprojects.github.io/VisualFSharpPowerTools/). Sie können auch eine eigene asynchronen primitiven schreiben, durch die Definition einer Funktion, deren vollständiger Text in einer Async-Block eingeschlossen ist.
