...
Ein mehrdimensionales Array kann erstellt werden, jedoch gibt es keine Syntax zum Schreiben eines mehrdimensionalen Arrayliterals. Verwenden Sie den [`array2D`](https://msdn.microsoft.com/library/1d52503d-2990-49fc-8fd3-6b0e508aa236) -Operator, um ein Array aus einer Sequenz von Sequenzen von Array Elementen zu erstellen. Die Sequenzen können Array- oder Listenliterale sein. Im folgenden Code wird z. B. ein zweidimensionales Array erstellt.
...
Nur eine Teilmenge der Funktionen für eindimensionale Arrays ist auch für mehrdimensionale Arrays verfügbar. Weitere Informationen finden [`Collections.Array Module`](https://msdn.microsoft.com/visualfsharpdocs/conceptual/collections.array-module-%5bfsharp%5d)Sie [`Collections.Array3D Module`](https://msdn.microsoft.com/visualfsharpdocs/conceptual/collections.array3d-module-%5bfsharp%5d)unter, [`Collections.Array2D Module`](https://msdn.microsoft.com/visualfsharpdocs/conceptual/collections.array2d-module-%5bfsharp%5d), und [`Collections.Array4D Module`](https://msdn.microsoft.com/visualfsharpdocs/conceptual/collections.array4d-module-%5bfsharp%5d).
...
[`Array.find`](https://msdn.microsoft.com/library/db6d920a-de19-4520-85a4-d83de77c1b33)nimmt eine boolesche Funktion an und gibt das erste Element zurück, für das `true`die Funktion zurückgibt <xref:System.Collections.Generic.KeyNotFoundException?displayProperty=nameWithType> , oder löst eine aus, wenn kein Element gefunden wird, das die Bedingung erfüllt. [`Array.findIndex`](https://msdn.microsoft.com/library/5ae3a8f9-7b8f-44ea-a740-d5700f4d899f)ist wie `Array.find`, mit der Ausnahme, dass Sie den Index des-Elements anstelle des-Elements selbst zurückgibt.
...
Verwenden [`Array.max`](https://msdn.microsoft.com/library/f03fbda0-fce6-40e2-a85d-79c9d81f710b) Sie [`Array.min`](https://msdn.microsoft.com/library/d6b3da5f-bac0-4355-9846-4b72d95bc3fd) oder, um das maximale oder minimale Element zu erhalten, wenn der Elementtyp es unterstützt. Ebenso wie [`Array.minBy`](https://msdn.microsoft.com/library/24091583-be78-4cc9-9fab-de6d7506af4f) und ermöglichen, dass eine Funktion zuerst ausgeführt wird, vielleicht zum Transformieren in einen Typ, der den Vergleich unterstützt. [`Array.maxBy`](https://msdn.microsoft.com/library/18dbe7c5-482e-4766-8e01-12a76f847045)
...
Verwenden [`Array.iter`](https://msdn.microsoft.com/library/94eba0f1-ecd7-459f-b89f-ed2a2923e516)Sie, um eine Funktion für jedes Element in einem Array auszuführen, ohne die Rückgabewerte zu speichern. Verwenden [`Array.iter2`](https://msdn.microsoft.com/library/018aa9b9-f186-4142-be8a-a62462794fdc)Sie für eine Funktion mit zwei Arrays gleicher Länge. Wenn Sie auch ein Array der Ergebnisse der Funktion beibehalten müssen, verwenden Sie oder [`Array.map`](https://msdn.microsoft.com/library/38cbe824-0480-47be-85fd-df3afdd97a45) [`Array.map2`](https://msdn.microsoft.com/library/bb7aafe8-4a1f-45b9-92fc-1af9eafbea5c), das jeweils zwei Arrays verwendet.
...
Das- [`Array.Parallel`](https://msdn.microsoft.com/library/60f30b77-5af4-4050-9a5c-bcdb3f5cbb09) Modul enthält Funktionen zum Ausführen paralleler Berechnungen für Arrays. Dieses Modul ist in Anwendungen nicht verfügbar, die auf Versionen vor Version 4 von .NET Framework abzielen.
