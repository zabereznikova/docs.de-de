...
Weitere Informationen finden Sie unter [Paketverwaltungserweiterbarkeit und andere Erweiterungen](https://github.com/dotnet/fsharp/tree/main/src/fsharp/Microsoft.DotNet.DependencyManager).
