...
Die von der Funktion generierte Einschränkung `inline` wird im Code Anführungszeichen beibehalten. Das `negate` Formular der Funktion kann nun ausgewertet werden.
