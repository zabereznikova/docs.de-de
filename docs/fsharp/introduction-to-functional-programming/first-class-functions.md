...
## <a name="give-the-value-a-name"></a><span data-ttu-id="aa12b-115">Zuweisen eines Namens zu einem Wert</span><span class="sxs-lookup"><span data-stu-id="aa12b-115">Give the Value a Name</span></span>
