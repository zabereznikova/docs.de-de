...
---
# <a name="relational-vs-nosql-data"></a>Relationale und nosql-Daten
...
[Azure Database for PostgreSQL](https://azure.microsoft.com/services/postgresql/) ist ein vollständig verwalteter relationaler Datenbankdienst, der auf dem Open-Source-Postgres-Datenbankmodul basiert. Der Dienst unterstützt viele Entwicklungsplattformen, C++einschließlich, Java, Python, Node, C\#und PHP. Sie können PostgreSQL-Datenbanken mit dem [Befehlszeilenschnittstelle](https://datamigration.microsoft.com/scenario/postgresql-to-azurepostgresql?step=1) -Tool oder Azure Data Migration Service zu diesem migrieren.
