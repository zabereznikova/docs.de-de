---
title: Database-per-mikroservice
...
ms.locfileid: "76795062"
---
# <a name="database-per-microservice"></a>Database-per-mikroservice
...
**Abbildung 5–6**. Rollback einer Transaktion
...
### <a name="event-sourcing"></a>Ereignis Beschaffung
...
![Ereignis Beschaffung](./media/event-sourcing.png)

**Abbildung 5-8**. Ereignis Beschaffung
