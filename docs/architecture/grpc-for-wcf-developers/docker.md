...
### <a name="https-in-docker"></a><span data-ttu-id="8a8c4-161">HTTPS in docker</span><span class="sxs-lookup"><span data-stu-id="8a8c4-161">HTTPS in Docker</span></span>
