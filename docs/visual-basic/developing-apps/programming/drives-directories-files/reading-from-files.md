...
## In diesem Abschnitt  
 ...
 Veranschaulicht das Lesen aus einer Textdatei mit Trennzeichen.  
 ...
 Veranschaulicht das Lesen aus einer Textdatei mit mehreren Formaten.  
 ...
 Veranschaulicht die Verwendung eines <xref:System.IO.StreamReader> zum Lesen aus einer Datei.  
...
## Referenz  
 ...
 Beschreibt die `ReadAllText`\-Methode.  
  
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.ReadAllBytes%2A>  
 Beschreibt die `ReadAllBytes`\-Methode.  
  
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.OpenTextFieldParser%2A>  
 Beschreibt die `OpenTextFieldParser`\-Methode.  
...
## Verwandte Abschnitte  
 ...
 Stellt eine Übersicht über das Lesen von Textdateien mit dem `TextFieldParser`\-Objekt bereit.  
