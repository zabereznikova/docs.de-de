...
## <a name="types-of-streams"></a>Arten von Streams  
 In [!INCLUDE[dnprdnshort](~/includes/dnprdnshort-md.md)] wird ein Datenstrom durch die Klasse <xref:System.IO.Stream> dargestellt, die die abstrakte Klasse für alle anderen Datenströme bildet. Sie können eine Instanz der Klasse <xref:System.IO.Stream> nicht direkt erstellen, sondern müssen eine der Klassen verwenden, die diese implementiert.  
