...
Die <xref:Microsoft.VisualBasic.Devices.Network.IsAvailable%2A>-Eigenschaft kann verwendet werden, um zu ermitteln, ob der Computer über eine funktionierende Netzwerk- oder Internetverbindung verfügt.  
