...
|My-Objekt|Windows-Anwendung|Klassenbibliothek|Konsolenanwendung|Windows-Steuerelement Bibliothek|Websteuer Element Bibliothek|Windows-Dienst|Empty|Website|  
|---|---|---|---|---|---|---|---|---|  
