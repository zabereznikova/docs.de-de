...
ms.locfileid: "43539039"
---
# <a name="printing-and-reporting-visual-basic"></a>Drucken und Berichterstellung (Visual Basic)
Visual Basic bietet mehrere Optionen zum Drucken und berichterstellung. Die folgenden Themen enthalten Übersichten und Links zur relevanten Dokumentation mit Bezug auf Drucken und berichterstellung.  
  
## <a name="in-this-section"></a>In diesem Abschnitt  
 [PrintForm-Komponente](../../../visual-basic/developing-apps/printing/printform-component.md)  
 Bietet eine Übersicht über die `PrintForm` Komponente, die es ermöglicht, den Inhalt eines Formulars drucken.  
 ...
 Erläutert, wie der Client und nicht-Bereichen eines Formulars gedruckt werden, indem Sie mit der `PrintForm` Komponente.  
 ...
 Erläutert, wie das den Clientbereich eines Formulars gedruckt werden, indem Sie mit der `PrintForm` Komponente.  
 ...
 Erläutert, wie ein einfaches Formular gedruckt, mit der `PrintForm` Komponente.  
 ...
 Erläutert, wie zum Bereitstellen der `PrintForm` Komponente zusammen mit einer Anwendung.  
