...
## Verwandte Abschnitte  
 ...
 Enthält Links zu Themen, in denen beschrieben wird, wie [!INCLUDE[sql_sync_long](~/includes/sql-sync-long-md.md)] in Anwendungen integriert wird, die die Synchronisierung zwischen lokalen und Remotedaten ermöglichen.  
