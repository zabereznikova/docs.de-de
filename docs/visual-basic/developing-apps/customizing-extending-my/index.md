...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Beschreibt, wie zu bestimmen, welche `My` Objekte werden durch Festlegen des Projekts _MYTYPE-Konstante für bedingte Kompilierung aktiviert.  
