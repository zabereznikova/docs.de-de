...
- **Globale Instanzen.** Der einzige Status, der im `My`-Namespace verwaltet wird, ist für das Projekt Global. @No__t_0 kapselt z. b. den Status, der in der gesamten Anwendung gemeinsam verwendet wird.
