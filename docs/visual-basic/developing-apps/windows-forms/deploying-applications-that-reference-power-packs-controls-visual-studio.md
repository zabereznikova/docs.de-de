...
## Installieren der Power Packs\-Steuerelemente als Voraussetzung  
 ...
 Beim Installieren von [!INCLUDE[vsprvs](~/includes/vsprvs-md.md)] auf dem Entwicklungscomputer wird dem [!INCLUDE[vsprvs](~/includes/vsprvs-md.md)]\-Bootstrapper\-Verzeichnis ein Power Packs\-Bootstrapperpaket hinzugefügt.  Dieses Paket ist dann verfügbar, wenn Sie den Anleitungen zum Hinzufügen erforderlicher Komponenten für die [!INCLUDE[ndptecclick](~/includes/ndptecclick-md.md)]\- oder Windows Installer\-Bereitstellung folgen.  
...
> [!NOTE]
>  Zum Installieren von Bootstrapperkomponenten muss der Benutzer möglicherweise Administrator\- oder ähnliche Benutzerberechtigungen auf dem Computer besitzen.  Bei [!INCLUDE[ndptecclick](~/includes/ndptecclick-md.md)]\-Anwendungen bedeutet dies, dass der Benutzer unabhängig von der für die Anwendung angegebenen Sicherheitsebene zum Installieren der Anwendung Administratorberechtigungen benötigt.  Nach der Installation kann der Benutzer die Anwendung ohne Administratorberechtigungen ausführen.  
