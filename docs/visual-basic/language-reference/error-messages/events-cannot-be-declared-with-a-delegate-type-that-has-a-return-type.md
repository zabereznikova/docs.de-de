---
title: "Ereignisse können nicht mit einem Delegattypen, die einen Rückgabetyp hat deklariert werden | Microsoft-Dokumentation"
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
ms.suite: 
...
Ein Delegat wurde für eine Funktion angegeben.  
  
 **Fehler-ID:** BC31084  
  
## <a name="to-correct-this-error"></a>So beheben Sie diesen Fehler  
  
-   Geben Sie einen Delegaten für ein `Sub` Verfahren.  
