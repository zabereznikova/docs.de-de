...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="0cbc4-102">Member der Visual Basic-Laufzeitbibliothek</span><span class="sxs-lookup"><span data-stu-id="0cbc4-102">Visual Basic Runtime Library Members</span></span>
<span data-ttu-id="0cbc4-103">Die `Microsoft.VisualBasic` -Namespace enthält Klassen, Module, Konstanten und Enumerationen, die Visual Basic-Laufzeitbibliothek bilden.</span><span class="sxs-lookup"><span data-stu-id="0cbc4-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the Visual Basic runtime library.</span></span> <span data-ttu-id="0cbc4-104">Diese Bibliothek Member kann von Prozeduren, Eigenschaften und Konstante Werte, die Sie in Ihrem Code verwenden können.</span><span class="sxs-lookup"><span data-stu-id="0cbc4-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="0cbc4-105">Jedes Modul und die Klasse stellt eine bestimmte Kategorie von Funktionen dar.</span><span class="sxs-lookup"><span data-stu-id="0cbc4-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="0cbc4-106">Microsoft.VisualBasic.Collection-Klasse</span><span class="sxs-lookup"><span data-stu-id="0cbc4-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="0cbc4-107">Microsoft.VisualBasic.ComClassAttribute-Klasse</span><span class="sxs-lookup"><span data-stu-id="0cbc4-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="0cbc4-108">Microsoft.VisualBasic.ControlChars-Klasse</span><span class="sxs-lookup"><span data-stu-id="0cbc4-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="0cbc4-109">Microsoft.VisualBasic.Constants-Klasse</span><span class="sxs-lookup"><span data-stu-id="0cbc4-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="0cbc4-110">Microsoft.VisualBasic.Conversion-Modul</span><span class="sxs-lookup"><span data-stu-id="0cbc4-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="0cbc4-111">Microsoft.VisualBasic.DateAndTime-Modul</span><span class="sxs-lookup"><span data-stu-id="0cbc4-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="0cbc4-112">Microsoft.VisualBasic.ErrObject-Klasse</span><span class="sxs-lookup"><span data-stu-id="0cbc4-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="0cbc4-113">Microsoft.VisualBasic.FileSystem-Modul</span><span class="sxs-lookup"><span data-stu-id="0cbc4-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="0cbc4-114">Microsoft.VisualBasic.Financial-Modul</span><span class="sxs-lookup"><span data-stu-id="0cbc4-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="0cbc4-115">Microsoft.VisualBasic.Globals-Modul</span><span class="sxs-lookup"><span data-stu-id="0cbc4-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="0cbc4-116">Microsoft.VisualBasic.HideModuleNameAttribute-Klasse</span><span class="sxs-lookup"><span data-stu-id="0cbc4-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="0cbc4-117">Microsoft.VisualBasic.Information-Modul</span><span class="sxs-lookup"><span data-stu-id="0cbc4-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="0cbc4-118">Microsoft.VisualBasic.Interaction-Modul</span><span class="sxs-lookup"><span data-stu-id="0cbc4-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="0cbc4-119">Microsoft.VisualBasic.MyGroupCollectionAttribute-Klasse</span><span class="sxs-lookup"><span data-stu-id="0cbc4-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="0cbc4-120">Microsoft.VisualBasic.Strings-Modul</span><span class="sxs-lookup"><span data-stu-id="0cbc4-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="0cbc4-121">Microsoft.VisualBasic.VBFixedArrayAttribute-Klasse</span><span class="sxs-lookup"><span data-stu-id="0cbc4-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="0cbc4-122">Microsoft.VisualBasic.VBFixedStringAttribute-Klasse</span><span class="sxs-lookup"><span data-stu-id="0cbc4-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="0cbc4-123">Microsoft.VisualBasic.VbMath-Modul</span><span class="sxs-lookup"><span data-stu-id="0cbc4-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="0cbc4-124">Microsoft.VisualBasic-Konstanten und Enumerationen</span><span class="sxs-lookup"><span data-stu-id="0cbc4-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  
 <span data-ttu-id="0cbc4-125">Die `Microsoft.VisualBasic` -Namespace stellt Konstanten und Enumerationen als Teil der Visual Basic-Laufzeitbibliothek bereit.</span><span class="sxs-lookup"><span data-stu-id="0cbc4-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="0cbc4-126">Sie können diese Konstante Werte in Ihrem Code verwenden.</span><span class="sxs-lookup"><span data-stu-id="0cbc4-126">You can use these constant values in your code.</span></span> <span data-ttu-id="0cbc4-127">Jeder Enumeration stellt eine bestimmte Kategorie von Funktionen dar.</span><span class="sxs-lookup"><span data-stu-id="0cbc4-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="0cbc4-128">Weitere Informationen finden Sie unter [Konstanten und Enumerationen](../../visual-basic/language-reference/constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="0cbc4-128">For more information, see [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="0cbc4-129">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="0cbc4-129">See Also</span></span>  
 [<span data-ttu-id="0cbc4-130">Konstanten und Enumerationen</span><span class="sxs-lookup"><span data-stu-id="0cbc4-130">Constants and Enumerations</span></span>](../../visual-basic/language-reference/constants-and-enumerations.md)  
 [<span data-ttu-id="0cbc4-131">Schlüsselwörter</span><span class="sxs-lookup"><span data-stu-id="0cbc4-131">Keywords</span></span>](../../visual-basic/language-reference/keywords/index.md)
