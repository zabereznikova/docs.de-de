...
## <a name="remarks"></a>Hinweise  
 Informationen zu den Methoden und Eigenschaften der `My.Computer.Clipboard` Objekt, finden Sie unter <xref:Microsoft.VisualBasic.MyServices.ClipboardProxy>.  
