---
title: My. Computer. File System-Objekt (Visual Basic)
ms.date: 07/20/2015
helpviewer_keywords:
- FileSystem module
- FileClose function
 ...
 **Klasse:** (ermöglicht den Zugriff <xref:Microsoft.VisualBasic.FileIO.FileSystem>auf) <xref:Microsoft.VisualBasic.MyServices.FileSystemProxy>  
