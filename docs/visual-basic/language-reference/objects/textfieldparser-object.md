...
## <a name="remarks"></a>Hinweise  
 Weitere Informationen zu den Methoden und Eigenschaften der `TextFieldParser` Objekt, finden Sie unter <xref:Microsoft.VisualBasic.FileIO.TextFieldParser>.</xref:Microsoft.VisualBasic.FileIO.TextFieldParser>  
 ...
 **Klasse:**<xref:Microsoft.VisualBasic.FileIO.TextFieldParser></xref:Microsoft.VisualBasic.FileIO.TextFieldParser>  
