...
## <a name="remarks"></a>Hinweise  
 ...
 Die `My.Log` Objekt wird für nur für ASP.NET-Anwendungen verfügbar. Verwenden Sie für Clientanwendungen, [My.Application.Log-Objekt](../../../visual-basic/language-reference/objects/my-application-log-object.md).  
