...
Stellt Eigenschaften zum Abrufen von Informationen über die Anwendung, z. B. die Versionsnummer, Beschreibung, geladenen Assemblys und So weiter.  
  
## <a name="remarks"></a>Hinweise  
 Informationen zu den Methoden und Eigenschaften der `My.Application.Info` Objekt, finden Sie unter <xref:Microsoft.VisualBasic.ApplicationServices.AssemblyInfo>.  
