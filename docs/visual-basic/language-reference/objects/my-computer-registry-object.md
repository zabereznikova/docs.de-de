...
## <a name="remarks"></a>Hinweise  
 ...
 Weitere Informationen finden Sie unter [auslesen und Schreiben in die Registrierung](../../../visual-basic/developing-apps/programming/computer-resources/reading-from-and-writing-to-the-registry.md).  
  
> [!NOTE]
>  Können Sie auch die Registrierung mithilfe von Methoden zum Bearbeiten der <xref:Microsoft.Win32.Registry?displayProperty=nameWithType> Klasse.  
