...
## <a name="remarks"></a>Hinweise  
 Informationen zu den Methoden und Eigenschaften der `My.Computer.Mouse` Objekt, finden Sie unter <xref:Microsoft.VisualBasic.Devices.Mouse>.  
