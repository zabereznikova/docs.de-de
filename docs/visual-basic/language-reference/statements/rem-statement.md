...
## <a name="parts"></a>Teile  
 `comment`  
 Dies ist optional. Der Text eines beliebigen Kommentars, den Sie einschließen möchten. Zwischen dem `REM`-Schlüsselwort und dem `comment` ist ein Leerzeichen erforderlich.  
