...
## <a name="example"></a>Beispiel  
 Im folgenden Beispiel wird der `\=`-Operator verwendet, um eine `Integer`-Variable durch eine Sekunde zu dividieren und das ganzzahlige Ergebnis der ersten Variablen zuzuweisen.  
