...
## <a name="attempted-division-by-zero"></a>Versuchte Division durch Null  
 Wenn `expression2` als 0 (null) ausgewertet wird, verhält sich der `/`-Operator für unterschiedliche Operanden-Datentypen anders. In der folgenden Tabelle sind die möglichen Verhalten aufgeführt.  
  
|Operanden Datentypen|Verhalten, wenn `expression2` 0 (null) ist|  
|------------------------|---------------------------------------|  
