...
## <a name="parts"></a>Teile  
 `result` ist erforderlich. Eine beliebige numerische Variable oder Eigenschaft.

 `number1` ist erforderlich. Ein beliebiger numerischer Ausdruck.

 `number2` ist erforderlich. Ein beliebiger numerischer Ausdruck.
