...
> [!NOTE]
>  Sie können auch Funktionen erstellen und aufrufen. Weitere Informationen finden Sie unter [Function-Anweisung](../../../visual-basic/language-reference/statements/function-statement.md) und [Vorgehensweise: Erstellen Sie eine Prozedur, die einen Wert zurückgibt](../../../visual-basic/programming-guide/language-features/procedures/how-to-create-a-procedure-that-returns-a-value.md).  
