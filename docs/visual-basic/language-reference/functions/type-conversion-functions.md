...
|-------------------|----------------------|-------------------------------------|  
|`CBool`|[Datentyp "Boolean"](../../../visual-basic/language-reference/data-types/boolean-data-type.md)|Eine beliebige gültige `Char` oder `String` oder numerischer Ausdruck.|  
