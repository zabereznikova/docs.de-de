---
title: "Konvertierung: Zusammenfassung (Visual Basic) | Microsoft Docs"
ms.date: "2015-07-20"
ms.prod: ".net"
ms.suite: ""
ms.technology: 
...
dev_langs: 
  - "VB"
helpviewer_keywords: 
  - "Datentypkonvertierung [C++], Schlüsselwörter"
  - "Verweis, Typkonvertierungen"
  - "Konvertierungen, Visual Basic"
  - "Typkonvertierung, Schlüsselwörter"
...
|------------|-------------------|  
|Konvertieren eines ANSI\-Werts in eine Zeichenfolge|<xref:Microsoft.VisualBasic.Strings.Chr%2A>, <xref:Microsoft.VisualBasic.Strings.ChrW%2A>|  
|Konvertieren einer Zeichenfolge in Groß\- oder Kleinschreibung|<xref:Microsoft.VisualBasic.Strings.Format%2A>, <xref:Microsoft.VisualBasic.Strings.LCase%2A>,<xref:Microsoft.VisualBasic.Strings.UCase%2A>|  
...
|Konvertieren einer Zeichenfolge in eine Zahl|<xref:Microsoft.VisualBasic.Conversion.Val%2A>|  
