...
`joinClause`  
Dies ist optional. Mindestens eine zusätzliche `Join`-Klausel, um die Abfrage weiter zu verfeinern.

`groupJoinClause`  
Dies ist optional. Mindestens eine zusätzliche `Group Join`-Klausel, um die Abfrage weiter zu verfeinern.
