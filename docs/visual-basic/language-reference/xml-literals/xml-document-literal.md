...
|`piCommentList`|Optional. Die Liste der XML-Verarbeitungsanweisungen und XML-Kommentare. Hat das folgende Format:<br /><br /> `piComment [` `piComment` `... ]`<br /><br /> Dabei kann es sich um `piComment` einen der folgenden handeln:<br /><br /> -   [XML-Verarbeitungs Anweisungs Literale](xml-processing-instruction-literal.md).<br />-   [XML-Kommentarliteral.](xml-comment-literal.md)|  
