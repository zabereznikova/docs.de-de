...
Die Themen in diesem Abschnitt dokumentieren die Syntax von XML-Literalen in [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]. Die XML-Literalsyntax ermöglicht Ihnen, XML direkt in Ihren Code zu integrieren.  
