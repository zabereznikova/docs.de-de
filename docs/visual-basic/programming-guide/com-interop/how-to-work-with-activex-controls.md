...
3.  Wählen Sie das Kontrollkästchen neben dem ActiveX-Steuerelement, das Sie verwenden möchten, und klicken Sie dann auf **OK**.  
    ...
    > [!NOTE]
    >  Das Dienstprogramm Aximp können Sie manuell eine Interop-Assembly für ActiveX-Steuerelemente erstellen. Weitere Informationen finden Sie unter [Aximp.exe (Windows Forms ActiveX Control Importer)](http://msdn.microsoft.com/library/482c0d83-7144-4497-b626-87d2351b78d0).  
