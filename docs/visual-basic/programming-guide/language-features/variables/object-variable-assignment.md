...
- [Vorgehensweise: Einer Objektvariablen verweist nicht auf eine beliebige Instanz](../../../../visual-basic/programming-guide/language-features/variables/how-to-make-an-object-variable-not-refer-to-any-instance.md)
