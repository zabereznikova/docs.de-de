...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Stellt die grundlegenden Konzepte hinter der Verwendung von Zeichenfolgen und Zeichenfolgenvariablen.  
 ...
 Stellt verschiedene Möglichkeiten, analysieren und Bearbeiten von Zeichenfolgen.  
 ...
 Erläutert, wie [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] verwendet kulturinformationen zum zeichenfolgenkonvertierungen und Vergleiche durchführen.  
