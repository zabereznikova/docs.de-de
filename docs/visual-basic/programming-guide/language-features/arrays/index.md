...
##  <a name="BKMK_CreatingAnArray"></a> Erstellen eines Arrays  
 ...
 Weitere Informationen finden Sie unter [ReDim-Anweisung](../../../../visual-basic/language-reference/statements/redim-statement.md).  
...
##  <a name="BKMK_Iterating"></a> Durchlaufen eines Arrays  
 ...
 Im folgenden Beispiel wird ein eindimensionales Array mit [For Each...Next Statement](../../../../visual-basic/language-reference/statements/for-each-next-statement.md) (For Each...Next-Anweisung) durchlaufen.  
