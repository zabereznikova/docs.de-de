...
Zum Starten [ `From` ](../../../../visual-basic/language-reference/queries/from-clause.md) einer Abfrage ist `Aggregate` entweder eine-Klausel oder eine-Klausel erforderlich. Mit einer `From`-Klausel geben Sie für eine Abfrage eine Quellauflistung und eine Iterationsvariable an. Beispiel:

 [!code-vb[VbVbalrIntroToLINQ#7](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#7)]

### <a name="select-clause"></a>Select-Klausel

Optional. Eine-Klausel deklariert einen Satz von Iterations Variablen für eine Abfrage. [ `Select` ](../../../../visual-basic/language-reference/queries/select-clause.md) Beispiel:
...
Optional. Eine-Klausel gibt eine Filterbedingung für eine Abfrage an. [ `Where` ](../../../../visual-basic/language-reference/queries/where-clause.md) Beispiel:

 [!code-vb[VbVbalrIntroToLINQ#9](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#9)]

### <a name="order-by-clause"></a>Order By-Klausel]

| Optionale. Eine-Klausel gibt die Sortierreihenfolge für Spalten in einer Abfrage an. [ `Order By` ](../../../../visual-basic/language-reference/queries/order-by-clause.md) Beispiel:

 [!code-vb[VbVbalrIntroToLINQ#10](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#10)]

### <a name="join-clause"></a>Join-Klausel

Optional. Eine-Klausel kombiniert zwei Auflistungen in einer einzelnen Auflistung. [ `Join` ](../../../../visual-basic/language-reference/queries/join-clause.md) Beispiel:

 [!code-vb[VbVbalrIntroToLINQ#11](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#11)]

### <a name="group-by-clause"></a>Group By-Klausel

Optional. Eine-Klausel gruppiert die Elemente eines Abfrage Ergebnisses. [ `Group By` ](../../../../visual-basic/language-reference/queries/group-by-clause.md) Sie kann verwendet werden, um Aggregatfunktionen auf die einzelnen Gruppen anzuwenden. Beispiel:

 [!code-vb[VbVbalrIntroToLINQ#12](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#12)]

### <a name="group-join-clause"></a>Group Join-Klausel

Optional. Eine-Klausel kombiniert zwei Auflistungen zu einer einzelnen hierarchischen Auflistung. [ `Group Join` ](../../../../visual-basic/language-reference/queries/group-join-clause.md) Beispiel:

 [!code-vb[VbVbalrIntroToLINQ#13](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#13)]

### <a name="aggregate-clause"></a>Aggregate-Klausel

Zum Starten [ `Aggregate` ](../../../../visual-basic/language-reference/queries/aggregate-clause.md) einer Abfrage ist `From` entweder eine-Klausel oder eine-Klausel erforderlich. Mit einer `Aggregate`-Klausel wenden Sie eine oder mehrere Aggregatfunktionen auf eine Auflistung an. Beispielsweise können Sie die `Aggregate` -Klausel verwenden, um eine Summe für alle Elemente zu berechnen, die von einer Abfrage zurückgegeben werden, wie im folgenden Beispiel dargestellt.
...
Optional. Eine-Klausel berechnet einen Wert und weist ihn einer neuen Variablen in der Abfrage zu. [ `Let` ](../../../../visual-basic/language-reference/queries/let-clause.md) Beispiel:
...
Optional. Eine-Klausel umgeht eine angegebene Anzahl von Elementen in einer Auflistung und gibt dann die übrigen Elemente zurück. [ `Skip` ](../../../../visual-basic/language-reference/queries/skip-clause.md) Beispiel:

 [!code-vb[VbVbalrIntroToLINQ#18](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#18)]

### <a name="skip-while-clause"></a>SkipWhile-Klausel

Optional. `true` Eine [ `Skip While` -Klausel](../../../../visual-basic/language-reference/queries/skip-while-clause.md) umgeht Elemente in einer Auflistung, solange eine angegebene Bedingung ist, und gibt dann die übrigen Elemente zurück. Beispiel:

 [!code-vb[VbVbalrIntroToLINQ#19](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#19)]

### <a name="take-clause"></a>Take-Klausel

Optional. Eine-Klausel gibt eine angegebene Anzahl von zusammenhängenden Elementen ab dem Anfang einer Auflistung zurück. [ `Take` ](../../../../visual-basic/language-reference/queries/take-clause.md) Beispiel:

 [!code-vb[VbVbalrIntroToLINQ#20](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#20)]

### <a name="take-while-clause"></a>TakeWhile-Klausel

Optional. `true` Eine [ `Take While` -Klausel](../../../../visual-basic/language-reference/queries/take-while-clause.md) enthält Elemente in einer Auflistung, sofern eine angegebene Bedingung ist, und umgeht die übrigen Elemente. Beispiel:

 [!code-vb[VbVbalrIntroToLINQ#21](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#21)]
  
## <a name="use-additional-linq-query-features"></a>Verwenden zusätzlicher LINQ-Abfragefunktionen  
  
Sie können weitere LINQ-Abfragefeatures verwenden, indem Sie die von LINQ bereitgestellten Member des Enumerable-Typs und des Queryable-Typs aufrufen. Sie können diese zusätzlichen Funktionen verwenden, indem Sie für das Ergebnis eines Abfrageausdrucks einen bestimmten Abfrageoperator aufrufen. Im folgenden Beispiel wird die- <xref:System.Linq.Enumerable.Union%2A?displayProperty=nameWithType> Methode verwendet, um die Ergebnisse von zwei Abfragen zu einem Abfrageergebnis zu kombinieren. Mithilfe der <xref:System.Linq.Enumerable.ToList%2A?displayProperty=nameWithType>-Methode wird das Abfrageergebnis als generische Liste zurückgegeben.
...
## <a name="connect-to-a-database-by-using-linq-to-sql"></a>Herstellen einer Verbindung mit einer Datenbank mithilfe LINQ to SQL  
 ...
 Beispiele mit Schritt-für-Schritt-Anweisungen finden [Sie unter Gewusst wie: Abfragen einer Datenbank](how-to-query-a-database-by-using-linq.md) und [Gewusst wie: Ruft eine gespeicherte Prozedur](how-to-call-a-stored-procedure-by-using-linq.md)auf.  
...
## <a name="how-to-and-walkthrough-topics"></a>Themen zu Vorgehensweisen und exemplarischen Vorgehensweisen
 ...
 [Vorgehensweise: Gespeicherte Prozedur aufzurufen](how-to-call-a-stored-procedure-by-using-linq.md)  
  
 [Vorgehensweise: Ändern von Daten in einer Datenbank](how-to-modify-data-in-a-database-by-using-linq.md)  
  
 [Vorgehensweise: Kombinieren von Daten mit Joins](how-to-combine-data-with-linq-by-using-joins.md)  
  
 [Vorgehensweise: Abfrageergebnisse sortieren](how-to-sort-query-results-by-using-linq.md)  
  
 [Vorgehensweise: Abfrageergebnisse Filtern](how-to-filter-query-results-by-using-linq.md)  
  
 [Vorgehensweise: Anzahl, Summe oder durchschnittliche Daten](how-to-count-sum-or-average-data-by-using-linq.md)  
