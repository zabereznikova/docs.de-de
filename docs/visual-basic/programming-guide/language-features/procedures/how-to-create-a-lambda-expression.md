...
3. Drücken Sie die EINGABETASTE. The `End Function` statement is automatically added.  
...
3. Drücken Sie die EINGABETASTE. The `End Sub` statement is automatically added.  
