...
You can omit the `Get` and `Set` procedure when using an auto-implemented property. Weitere Informationen finden Sie unter [Automatisch implementierte Eigenschaften](./auto-implemented-properties.md).
