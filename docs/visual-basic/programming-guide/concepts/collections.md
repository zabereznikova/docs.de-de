...
> [!NOTE]
> Schließen Sie für die Beispiele in diesem Thema [Imports](../../../visual-basic/language-reference/statements/imports-statement-net-namespace-and-type.md) -Anweisungen für die `System.Collections.Generic`-und `System.Linq`-Namespaces ein.
