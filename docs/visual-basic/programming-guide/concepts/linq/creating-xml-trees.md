...
|[Analysieren von XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/parsing-xml.md)|Zeigt, wie Sie XML aus den verschiedensten Quellen analysieren können. [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)]besteht aus mehreren Ebenen auf der Basis von <xref:System.Xml.XmlReader>, der zum Analysieren der XML verwendet wird.</xref:System.Xml.XmlReader>|  
|[Gewusst wie: Auffüllen einer XML-Struktur mit einem XmlWriter (LINQ to XML) (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-populate-an-xml-tree-with-an-xmlwriter-linq-to-xml.md)|Zeigt, wie eine XML-Struktur mit einem <xref:System.Xml.XmlWriter>.</xref:System.Xml.XmlWriter> aufgefüllt|  
|[Gewusst wie: Überprüfen mit XSD (LINQ to XML) (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-validate-using-xsd-linq-to-xml.md)|Zeigt, wie Sie eine XML-Struktur mit XSD validieren können.|  
