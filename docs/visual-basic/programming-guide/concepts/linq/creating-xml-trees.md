...
|[Einführung in XML-Literalen in Visual Basic](../../../../visual-basic/programming-guide/concepts/linq/introduction-to-xml-literals.md)|Bietet eine kurze Einführung in Strukturen mithilfe von XML-Literalen in Visual Basic erstellen. Dieses Thema enthält Links zu den Visual Basic-Dokumentation von XML-Literalen.|  
|[Klonen oder Das Anfügen (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/cloning-vs-attaching.md)|Zeigt den Unterschied zwischen dem Hinzufügen von Knoten aus einer vorhandenen XML-Struktur (die Knoten werden geklont und dann hinzugefügt) und dem Hinzufügen von Knoten ohne übergeordnetes Element (die Knoten werden einfach angefügt).|  
...
|[Vorgehensweise: Füllen einer XML-Struktur mit einem XmlWriter (LINQ to XML) (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-populate-an-xml-tree-with-an-xmlwriter-linq-to-xml.md)|Zeigt, wie Sie eine XML-Struktur mit einem <xref:System.Xml.XmlWriter> auffüllen können.|  
