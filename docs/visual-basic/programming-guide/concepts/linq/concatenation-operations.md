---
title: "Verkettungsvorgänge (Visual Basic) | Microsoft-Dokumentation"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
Verkettung bezieht sich auf den Betrieb einer Sequenz in einen anderen anfügen.  
  
 Die folgende Abbildung stellt einen Verkettungsvorgang von zwei Sequenzen von Zeichen.  
  
 ![Grafik, die die Verkettung von zwei Sequenzen darstellt. ](../../../../csharp/programming-guide/concepts/linq/media/concat.png "Concat")  
  
 Die Standardabfrageoperator-Methoden, die Verkettung ausführen, werden im folgenden Abschnitt aufgelistet.  
  
## <a name="methods"></a>Methoden  
  
|Methodenname|Beschreibung|Visual Basic-Abfrageausdruckssyntax|Weitere Informationen|  
|-----------------|-----------------|------------------------------------------|----------------------|  
|Concat|Verkettet zwei Sequenzen, um eine Sequenz zu bilden.|Nicht zutreffend.|<xref:System.Linq.Enumerable.Concat%2A?displayProperty=fullName></xref:System.Linq.Enumerable.Concat%2A?displayProperty=fullName><br /><br /> <xref:System.Linq.Queryable.Concat%2A?displayProperty=fullName></xref:System.Linq.Queryable.Concat%2A?displayProperty=fullName>|  
