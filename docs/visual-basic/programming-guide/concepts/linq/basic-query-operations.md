...
## <a name="grouping-data-group-by"></a>Gruppieren von Daten (Gruppieren nach)  
 ...
 Wenn Sie diesen Code mithilfe der Liste der Schüler/Studenten, die im erstellten ausführen [Vorgehensweise: Erstellen Sie eine Liste von Elementen](../../../../visual-basic/programming-guide/concepts/linq/how-to-create-a-list-of-items.md), die Ausgabe der `For Each` -Anweisung ist:  
