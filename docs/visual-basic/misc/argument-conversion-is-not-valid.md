...
## <a name="to-correct-this-error"></a><span data-ttu-id="ac71e-105">So beheben Sie diesen Fehler</span><span class="sxs-lookup"><span data-stu-id="ac71e-105">To correct this error</span></span>  
  
1.  <span data-ttu-id="ac71e-106">Stellen Sie sicher, dass der Wert größer oder gleich null ist.</span><span class="sxs-lookup"><span data-stu-id="ac71e-106">Ensure that the value is greater than or equal to zero.</span></span>