...
---
# <a name="property-ltpropertynamegt-cannot-be-initialized-in-an-object-initializer-expression-because-all-accessible-overloads-require-arguments"></a>Eigenschaft '&lt;Propertyname&gt;' kann nicht in einem Objektinitialisiererausdruck initialisiert werden, da alle Überladungen, die zugegriffen werden kann, Argumente erfordern
