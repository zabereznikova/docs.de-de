---
title: "Option Strict On lässt impliziten Konvertierungen von &#39; &lt;Typ1&gt;&#39; in &#39;&lt; Typ2&gt;&#39;"
ms.date: 07/20/2015
ms.prod: .net
...
---
# <a name="option-strict-on-disallows-implicit-conversions-from-39lttype1gt39-to-39lttype2gt39"></a>Option Strict On lässt impliziten Konvertierungen von &#39; &lt;Typ1&gt;&#39; in &#39;&lt; Typ2&gt;&#39;
...
1.  Ermitteln Sie, ob eine Konvertierung eines beliebigen Typs von `<type1>` in `<type2>`vorhanden ist. Wenn beide Type elementare Typen von [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] oder Instanzen von Klassen sind, können Sie diese Ermittlung in der Regel über die Tabelle in [Widening and Narrowing Conversions](../../visual-basic/programming-guide/language-features/data-types/widening-and-narrowing-conversions.md)festgelegt ist.  
