---
title: Klasse, die nicht auf dem lokalen Computer registriert | Microsoft-Dokumentation
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
Dieser Fehler tritt in der Regel aufgrund einer beschädigten Datei aus. Sie müssen möglicherweise neu installieren [!INCLUDE[vsprvs](../../csharp/includes/vsprvs_md.md)].  
  
## <a name="to-correct-this-error"></a>So beheben Sie diesen Fehler  
  
-   Neuinstallation [!INCLUDE[vsprvs](../../csharp/includes/vsprvs_md.md)].  
