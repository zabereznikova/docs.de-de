...
---
# <a name="property-accessors-cannot-be-declared-ltaccessmodifiergt-in-a-notoverridable-property"></a>Eigenschaftenaccessoren können nicht deklariert werden kann '&lt;Accessmodifier&gt;"in einer NotOverridable-Eigenschaft
