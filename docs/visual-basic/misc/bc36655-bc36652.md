...
Die Datentypen der Typparameter in der Erweiterungsmethode "\<Methodenname >' definiert"\<Typename > "kann nicht von diesen Argumenten abgeleitet werden, da mehrere Typen möglich sind. Sie können diesen Fehler möglicherweise beheben, indem Sie die Datentypen explizit angeben.  
