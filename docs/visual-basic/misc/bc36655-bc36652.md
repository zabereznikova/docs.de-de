...
---
# <a name="data-types-of-the-type-parameters-in-extension-method-ltmethodnamegt-defined-in-lttypenamegt-cannot-be-inferred-from-these-arguments-because-more-than-one-type-is-possible"></a>Die Datentypen der Typparameter in der Erweiterungsmethode "&lt;Methodname&gt;"definiert "&lt;Typename&gt;' können nicht von diesen Argumenten abgeleitet werden, da mehrere Typen möglich sind.
