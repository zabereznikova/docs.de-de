...
Das ALink-Tool bezeichnet, durch die [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] -Compiler meldet einen Fehler beim Erstellen der Assemblys. Eine mögliche Ursache ist eine signierte Assembly, die auf eine unsignierte Assembly verweist.  
