...
Das durch den [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)]\-Compiler aufgerufene ALink\-Tool meldet einen Fehler beim Erstellen der Assembly. Eine mögliche Ursache ist eine signierte Assembly, die auf eine unsignierte Assembly verweist.  
