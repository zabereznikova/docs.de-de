...
## <a name="to-correct-this-error"></a><span data-ttu-id="4fa4d-105">So beheben Sie diesen Fehler</span><span class="sxs-lookup"><span data-stu-id="4fa4d-105">To correct this error</span></span>  
  
-   <span data-ttu-id="4fa4d-106">Stellen Sie erneut eine Verbindung mit dem Netzwerk her, und versuchen Sie es erneut.</span><span class="sxs-lookup"><span data-stu-id="4fa4d-106">Reconnect to the network and try again.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="4fa4d-107">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="4fa4d-107">See Also</span></span>  
 [<span data-ttu-id="4fa4d-108">Fehlertypen</span><span class="sxs-lookup"><span data-stu-id="4fa4d-108">Error Types</span></span>](../../visual-basic/programming-guide/language-features/error-types.md)
