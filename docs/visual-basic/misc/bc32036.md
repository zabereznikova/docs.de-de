...
Eine abgeleitete Klasse deklariert keinen Konstruktor, und [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] kann keinen Konstruktor generieren, da der aufzurufende Basisklassenkonstruktor nicht ermittelt werden kann.  
