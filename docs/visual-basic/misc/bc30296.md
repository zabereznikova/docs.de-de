...
---
# <a name="interface-ltinterfacenamegt-cannot-inherit-from-itself-ltmessagegt"></a>Schnittstelle "&lt;Schnittstellenname&gt;' kann nicht von sich selbst erben: &lt;Nachricht&gt;
