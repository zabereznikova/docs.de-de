...
---
# <a name="ltmethodnamegt-is-not-accessible-in-this-context-because-the-return-type-is-not-accessible"></a>"&lt;Methodname&gt;' kann nicht in diesem Kontext zugegriffen werden, da der Rückgabetyp nicht zugegriffen werden.
