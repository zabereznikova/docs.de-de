...
---
# <a name="anonymous-type-property-ltpropertynamegt-cannot-be-used-in-the-definition-of-a-lambda-expression-within-the-same-initialization-list"></a>Die anonyme Typeigenschaft "&lt;Propertyname&gt;' kann nicht in der Definition eines Lambdaausdrucks innerhalb derselben Initialisierungsliste verwendet werden
