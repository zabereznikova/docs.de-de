...
## <a name="to-correct-this-error"></a><span data-ttu-id="9bea8-104">So beheben Sie diesen Fehler</span><span class="sxs-lookup"><span data-stu-id="9bea8-104">To correct this error</span></span>  
  
1.  <span data-ttu-id="9bea8-105">Ändern Sie den angegebenen Wert in einen gültigen Wert.</span><span class="sxs-lookup"><span data-stu-id="9bea8-105">Change the supplied value to a valid one.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="9bea8-106">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="9bea8-106">See Also</span></span>  
 [<span data-ttu-id="9bea8-107">Sammlungsänderungen für Steuerelemente in Visual Basic .NET</span><span class="sxs-lookup"><span data-stu-id="9bea8-107">Controls Collection Changes in Visual Basic .NET</span></span>](http://msdn.microsoft.com/library/8eb5b458-8b39-4d79-9c97-2b29c527afa5)
