...
---
# <a name="mustoverride-cannot-be-specified-on-ltprocedurenamegt-because-it-is-in-a-partial-type-that-is-declared-notinheritable-in-another-partial-definition"></a>"MustOverride" kann nicht angegeben werden, auf "&lt;Prozedurname&gt;' da es sich in einem partiellen Typ handelt, die in einer anderen partiellen Definition"NotInheritable"deklariert ist
