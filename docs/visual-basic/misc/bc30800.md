...
Die Regeln, die Prozeduraufrufe sind einfacher in neueren Versionen von [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]. Alle Argumente müssen in Klammern stehen.  
...
## <a name="see-also"></a>Siehe auch  
 [Prozedur aufruft, ändert sich die Sequenz in Visual Basic](http://msdn.microsoft.com/en-us/4ef1eea6-36cb-4b97-a31b-9ba65e46a9fd)   
