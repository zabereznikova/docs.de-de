...
---
# <a name="operands-of-type-object-used-for-operator-ltoperatorsymbolgt-use-the-is-operator-to-test-object-identity"></a>Operanden vom Typ Objekt verwendet wird, für den Operator "&lt;Operatorsymbol&gt;'; verwenden Sie den Is-Operator, um die Objektidentität zu testen
