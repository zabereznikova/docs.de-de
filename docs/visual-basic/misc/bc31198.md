...
Die Deklaration eines XML\-Literals wird in einem Ausdruck an einer Stelle verwendet, die mehrdeutig für den [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]\-Compiler ist. Der [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]\-Compiler kann also nicht feststellen, ob das Kleiner\-als\-Zeichen \(\<\) als Vergleichsoperator oder Startzeichen eines XML\-Literals vorgesehen ist. Der folgende Code veranschaulicht dies:  
