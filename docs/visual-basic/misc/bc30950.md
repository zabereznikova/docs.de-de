...
---
# <a name="no-accessible-method-ltprocedurenamegt-has-a--signature-compatible-with-delegate-ltdelegatenamegtltsuberrorlistgt"></a>Keine Methode zugegriffen werden kann '&lt;Prozedurname&gt;"hat eine Signatur, die mit dem Delegaten kompatibel"&lt;Delegatname&gt;':&lt;teilfehlerliste&gt;
