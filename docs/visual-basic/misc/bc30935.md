...
---
# <a name="member-classnameprocedurename-that-matches-this-signature-cannot-be-overridden-because-the-class-classname-contains-multiple-members-with-this-same-name-and-signature-signaturelist"></a>Der ClassName-Member des Members >.\< \< die Prozedur Name > ", die dieser Signatur entspricht, kann nicht überschrieben werden,\<weil die Klasse" ClassName > "mehrere Member mit demselben Namen und \<derselben Signatur enthält: signaturelist >
