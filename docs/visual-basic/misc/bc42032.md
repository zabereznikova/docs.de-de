...
---
# <a name="operands-of-type-object-used-for-operator-ltoperatorsymbolgt-use-the-isnot-operator-to-test-object-identity"></a>Operanden vom Typ Objekt verwendet wird, für den Operator "&lt;Operatorsymbol&gt;'; verwenden Sie den Operator"IsNot", um die Objektidentität zu testen
