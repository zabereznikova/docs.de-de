...
---
# <a name="cannot-convert-start-value-of-type-type1-limit-value-of-type2-and-step-value-of-type3-to-a-common-type"></a>Der Start-Wert des Typs "\<type1>", der Limit-Wert "\<type2>" und der Step-Wert "\<type3>" können nicht in einen allgemeinen Typ konvertiert werden
