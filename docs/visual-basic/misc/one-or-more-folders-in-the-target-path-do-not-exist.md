...
## <a name="to-correct-this-error"></a><span data-ttu-id="d547e-105">So beheben Sie diesen Fehler</span><span class="sxs-lookup"><span data-stu-id="d547e-105">To correct this error</span></span>  
  
-   <span data-ttu-id="d547e-106">Vergewissern Sie sich, dass Sie den richtigen Zielpfad angeben.</span><span class="sxs-lookup"><span data-stu-id="d547e-106">Check to make sure you are supplying the correct target path.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="d547e-107">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="d547e-107">See Also</span></span>  
 [<span data-ttu-id="d547e-108">Gewusst wie: Analysieren von Dateipfaden</span><span class="sxs-lookup"><span data-stu-id="d547e-108">How to: Parse File Paths</span></span>](../../visual-basic/developing-apps/programming/drives-directories-files/how-to-parse-file-paths.md)
