...
---
# <a name="conversion-from-lttype1gt-to-lttype2gt-cannot-occur-in-a-constant-expression-used-as-an-argument-to-an-attribute"></a>Konvertierung von '&lt;type1&gt;'to'&lt;Typ2&gt;' kann nicht in einem konstanten Ausdruck als Argument für ein Attribut verwendet auftreten
