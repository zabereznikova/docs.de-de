...
---
# <a name="data-types-of-the-type-parameters-in-extension-method-ltmethodnamegt-defined-in-typename-cannot-be-inferred-from-these-arguments-because-they-do-not-convert-to-the-same-type"></a>Die Datentypen der Typparameter in der Erweiterungsmethode "&lt;Methodname&gt;' definiert in"Typname"kann nicht von diesen Argumenten abgeleitet werden, da sie nicht in denselben Typ konvertiert werden
