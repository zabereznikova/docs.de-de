...
`Option Strict On` lässt keine impliziten Konvertierungen von "`<type1>`" in "`<type2>`" zu. Der Visual Basic 6.0\-Auflistungstyp ist mit dem [!INCLUDE[dnprdnshort](../../csharp/getting-started/includes/dnprdnshort-md.md)]\-Auflistungstyp nicht kompatibel.  
  
 Das Auflistungsobjekt, das in Visual Basic 6.0 verwendet wird, unterscheidet sich von dem Auflistungsobjekt, das in [!INCLUDE[vs_current_long](../../csharp/misc/includes/vs-current-long-md.md)] verwendet wird.  
