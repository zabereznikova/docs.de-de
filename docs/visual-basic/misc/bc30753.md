...
---
# <a name="option-strict-on-disallows-implicit-conversions-from-lttype1gt-to-lttype2gt-the-visual-basic-60-collection-type-is-not-compatible-with-the-net-framework-collection-type"></a>Option Strict On lässt implizite Konvertierungen von "&lt;type1&gt;'to'&lt;Typ2&gt;"; der Visual Basic 6.0-Auflistungstyp ist nicht kompatibel mit dem .NET Framework-Auflistungstyp
