...
`Option Strict On` lässt keine implizite Konvertierungen von "`<type1>`'to'`<type2>`"; der Visual Basic 6.0-Auflistungstyp ist nicht kompatibel mit dem .NET Framework-Auflistungstyp.
