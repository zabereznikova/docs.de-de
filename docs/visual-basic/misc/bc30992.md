...
---
# <a name="property-ltpropertynamegt-cannot-be-initialized-in-an-object-initializer-expression-because-it-requires-arguments"></a>Eigenschaft '&lt;Propertyname&gt;' kann nicht in einem Objektinitialisiererausdruck initialisiert werden, da sie Argumente erfordert
