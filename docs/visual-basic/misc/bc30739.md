...
---
# <a name="39raiseevent39-statements-are-not-valid-in-the-immediate-window"></a>"RaiseEvent"-Anweisungen sind im Direktfenster ungültig
`RaiseEvent`Anweisungen können nicht verwendet werden, der **sofort** Fenster.  
