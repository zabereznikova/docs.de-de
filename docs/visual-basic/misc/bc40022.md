...
ms.locfileid: "64624431"
---
# <a name="member-membername1-implicitly-declares-implicitmembername-which-conflicts-with-a-member-in-the-base-class-baseclassname"></a>Member '\<membername1 >' deklariert implizit '\<Name des impliziten Members > ', was einen Konflikt mit einem Member in der Basisklasse'\<Basisklassenname >'
