...
ms.locfileid: "50199421"
---
# <a name="visual-basic-command-line-compiler"></a>Visual Basic-Befehlszeilencompiler

Die Visual Basic-Befehlszeilencompiler bietet eine Alternative zum Kompilieren von Programmen in der integrierten Entwicklungsumgebung (IDE) von Visual Studio. Dieser Abschnitt enthält Beschreibungen für die Visual Basic-Compiler-Optionen.
