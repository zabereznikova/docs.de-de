...
- [App-Konfiguration](../architecture/blazor-for-web-forms-developers/config.md) -blazor-e-Book-Konfiguration
...
- [Der Verlauf der Beschreibungen\# ](../csharp/whats-new/csharp-version-history.md) der Version C-Add Recent Language Version
