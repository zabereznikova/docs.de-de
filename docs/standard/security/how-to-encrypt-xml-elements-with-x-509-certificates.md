...
1.  Verwenden Sie [Makecert.exe \(Certificate Creation Tool\)](../Topic/Makecert.exe%20\(Certificate%20Creation%20Tool\).md), um ein X.509\-Testzertifikat zu generieren und dieses Zertifikat im lokalen Benutzerspeicher abzulegen.  Sie müssen einen exportierbaren Austauschschlüssel generieren.  Führen Sie den folgenden Befehl aus:  
