---
title: Sicherheit in .NET Framework | Microsoft-Dokumentation
ms.custom: 
ms.date: 03/30/2017
ms.prod: .net
ms.reviewer: 
...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Beschreibt einige bewährte Methoden für das Erstellen von zuverlässigen .NET Framework-Anwendungen. Dieser Abschnitt ist für Entwickler relevant.  
