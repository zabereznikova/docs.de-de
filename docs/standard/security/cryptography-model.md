...
## <a name="choosing-an-algorithm"></a><span data-ttu-id="0329c-143">Wählen eines Algorithmus</span><span class="sxs-lookup"><span data-stu-id="0329c-143">Choosing an Algorithm</span></span>
