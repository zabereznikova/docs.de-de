...
### <a name="signing-xml-files"></a>Signieren von XML-Dateien  
 ...
 Die Klassen in diesem Namespace entsprechen den [XML Signature Syntax and Processing-Empfehlungen](http://www.w3.org/TR/xmldsig-core/) des World Wide Web Consortium.  
