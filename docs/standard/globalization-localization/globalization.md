...
## <a name="handling-strings"></a>Arbeiten mit Zeichenfolgen  
...
### <a name="use-unicode-internally"></a>Unicode intern verwenden  
...
### <a name="use-resource-files"></a>Ressourcendateien verwenden  
...
### <a name="testing-strings-for-equality"></a>Testen von Zeichenfolgen auf Gleichheit  
 Bestimmen Sie zum Testen von zwei Zeichenfolgen auf Gleichheit nicht deren Übereinstimmung in der Sortierreihenfolge, sondern verwenden Sie die <xref:System.String.Equals%2A?displayProperty=nameWithType>-Methode anstelle einer Zeichenfolgenvergleichsmethode wie <xref:System.String.Compare%2A?displayProperty=nameWithType> oder <xref:System.Globalization.CompareInfo.Compare%2A?displayProperty=nameWithType>.  
...
### <a name="ordering-and-sorting-strings"></a>Ordnen und Sortieren von Zeichenfolgen  
...
### <a name="avoid-string-concatenation"></a>Zeichenfolgenverkettung vermeiden  
...
## <a name="handling-dates-and-times"></a>Arbeiten mit Datumsangaben und Zeiten  
...
### <a name="displaying-dates-and-times"></a>Anzeigen von Datums- und Zeitangaben  
...
### <a name="persisting-dates-and-times"></a>Beibehalten von Datums- und Zeitangaben  
...
<a name="Numbers"></a>   
## <a name="handling-numeric-values"></a>Arbeiten mit numerischen Werte  
...
### <a name="displaying-numeric-values"></a>Anzeigen von numerischen Werten  
...
### <a name="persisting-numeric-values"></a>Beibehalten von numerischen Werten  
...
<a name="Cultures"></a>   
## <a name="working-with-culture-specific-settings"></a>Arbeiten mit kulturspezifischen Einstellungen  
