...
## <a name="see-also"></a>Siehe auch
 ...
 [Wählen zwischen ASP.NET und ASP.NET Core](/aspnet/core/choose-aspnet-framework) [Zielframeworks](frameworks.md) [Leitfaden für .NET Core](../core/index.md)  
