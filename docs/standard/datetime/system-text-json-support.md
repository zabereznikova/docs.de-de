...
## <a name="custom-support-for-xrefsystemdatetime-and-xrefsystemdatetimeoffset-in-xrefsystemtextjsonjsonserializer"></a>Benutzerdefinierte unter <xref:System.DateTime> Stützung <xref:System.DateTimeOffset> für und in<xref:System.Text.Json.JsonSerializer>
