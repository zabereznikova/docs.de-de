...
helpviewer_keywords: 
  ...
  - "Code, Ausführung"
  - "Code, Laufzeitfunktionen"
  - "Common Language Runtime"
  - "Kompilieren von Quellcode, Laufzeitfunktionen"
  - "Sprachcompiler"
  - "Verwalteter Code"
  - "Verwaltete Daten"
  - "Metadaten, Laufzeitfunktionen"
  - "Laufzeit"
  - "Quellcodeausführung"
...
-   Verwendung von Delegaten anstelle von Funktionszeigern zur Verbesserung der Typsicherheit.  Allgemeines TypsystemWeitere Informationen zu Delegaten finden Sie unter [Allgemeines Typsystem](../../docs/standard/base-types/common-type-system.md).  
  
## Versionen der Common Language Runtime  
...
|[NIB: Overview of the .NET Framework](http://msdn.microsoft.com/de-de/ea38ac1e-92af-4d1b-8db1-e8a5ea10ed85)|Beschreibt die wichtigsten Konzepte von .NET Framework, z. B. das allgemeine Typsystem, sprachübergreifende Interoperabilität, verwaltete Ausführung, Anwendungsdomänen und Assemblys.|  
