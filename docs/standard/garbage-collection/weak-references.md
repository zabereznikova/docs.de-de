...
-   Long  
     ...
     Wenn der Objekttyp keine <xref:System.Object.Finalize%2A>\-Methode besitzt, werden die Funktionen des kurzen schwachen Verweises angewendet, und der schwache Verweis ist nur so lange gültig, bis das Ziel gesammelt wurde, was nach der Ausführung des Finalizers jederzeit möglich ist.  
...
## Richtlinien zum Verwenden von schwachen Verweisen  
