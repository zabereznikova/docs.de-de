...
- [Vorgehensweise: Steuerung der Serialisierung abgeleiteter Klassen](../../../docs/standard/serialization/how-to-control-serialization-of-derived-classes.md)  
