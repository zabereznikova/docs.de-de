...
2. Geben `http://localhost/[virtual directory]/Service.asmx`Sie ein `[virtual directory]` , wobei das virtuelle Verzeichnis darstellt, das Sie beim Erstellen des Beispiels erstellt haben.  
