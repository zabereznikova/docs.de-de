...
| `System.ArgIterator` | <span data-ttu-id="3b4bd-159">`va_list` (nur auf Windows x86/x64/arm64)</span><span class="sxs-lookup"><span data-stu-id="3b4bd-159">`va_list` (on Windows x86/x64/arm64 only)</span></span> |
