...
## <a name="default-rules-for-marshalling-common-types"></a>Standardregeln für das Marshallen von häufig verwendeten Typen
...
Manchmal führt das standardmäßige Marshalling für Ihre Struktur nicht zum gewünschten Ergebnis. Im Artikel [Anpassen des Marshallens für Strukturen](./customize-struct-marshalling.md) erfahren Sie, wie Sie das Marshalling für Ihre Struktur anpassen.
