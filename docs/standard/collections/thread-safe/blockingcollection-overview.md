...
## <a name="cancelling-add-and-take-operations"></a>Abbrechen von Hinzufüge- und Entnahmevorgängen  
 ...
 Ein Beispiel für das Hinzufügen von Unterstützung für den Abbruch finden Sie im zweiten Beispiel unter [Vorgehensweise: Hinzufügen und Entfernen von einzelnen Elementen zu bzw. aus einer BlockingCollection](how-to-add-and-take-items.md).  
