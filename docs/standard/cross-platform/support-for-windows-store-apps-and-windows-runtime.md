...
-   Entwickeln von [!INCLUDE[win8_appname_long](../../../includes/win8-appname-long-md.md)] -apps mit Verwendung von XAML-Steuerelemente, wie in beschrieben [Roadmap für Windows Store-apps mit c# oder Visual Basic](http://go.microsoft.com/fwlink/p/?LinkID=242212), [Entwickeln von Windows Store-apps (VB / C#-/ C++ und XAML)](http://go.microsoft.com/fwlink/p/?LinkId=238311), und [.NET für Windows Store-apps – Übersicht](http://go.microsoft.com/fwlink/p/?LinkId=238312) im Windows Developer Center.  
...
-   [.NET für Windows Store-apps](http://go.microsoft.com/fwlink/p/?LinkId=247912) bietet eine komprimierte Übersicht über den .NET Framework-Klassenbibliotheken und nur die Typen und Member Sie erstellen können [!INCLUDE[win8_appname_long](../../../includes/win8-appname-long-md.md)] apps und [!INCLUDE[wrt](../../../includes/wrt-md.md)] Komponenten.  
    ...
    -   Funktionen, die lediglich die Betriebssystem-API umschließen, wurden ebenfalls entfernt, da [!INCLUDE[wrt](../../../includes/wrt-md.md)] auf einfache Weise von verwaltetem Code aus aufgerufen werden kann.  
     ...
     Um weitere Informationen zu den [!INCLUDE[net_win8_profile](../../../includes/net-win8-profile-md.md)], finden Sie unter der [.NET für Windows Store-apps – Übersicht](http://go.microsoft.com/fwlink/p/?LinkId=238312) in das Windows Dev Center.To erfahren Sie über die API Auswahlprozesses verwendet werden, finden Sie unter der [.NET für Windows Store-apps](http://go.microsoft.com/fwlink/p/?LinkId=251061) Eintrag in .NET Blog.  
...
### <a name="other-differences"></a>Weitere Unterschiede  
 In einigen wenigen Fällen erfordert die Tatsache, dass im Code .NET Framework-Typen statt [!INCLUDE[wrt](../../../includes/wrt-md.md)]-Typen dargestellt werden, eine Aktion Ihrerseits. Z. B. die [Windows.Foundation.Uri](http://go.microsoft.com/fwlink/p/?LinkId=238376) Klasse wird als <xref:System.Uri?displayProperty=nameWithType> in .NET Framework-Code. <xref:System.Uri?displayProperty=nameWithType>einen relativen URI, ermöglicht jedoch [Windows.Foundation.Uri](http://go.microsoft.com/fwlink/p/?LinkId=238376) muss einen absoluten URI. Wenn Sie einen URI an eine [!INCLUDE[wrt](../../../includes/wrt-md.md)]-Methode übergeben, müssen Sie daher sicherstellen, dass es sich um einen absoluten URI handelt. (Siehe [übergeben eines URI an Windows-Runtime](../../../docs/standard/cross-platform/passing-a-uri-to-the-windows-runtime.md).)  
...
-   Sie können Releaseversionen der wiederverwendbare Komponenten mithilfe der [!INCLUDE[wrt](../../../includes/wrt-md.md)] [VersionAttribute](http://go.microsoft.com/fwlink/p/?LinkId=238563) Attribut identifiziert die Typen (und welche Member in einem Typ) in verschiedenen Versionen hinzugefügt wurden.  
  
-   Die Typen in der Komponente können von [!INCLUDE[wrt](../../../includes/wrt-md.md)]-Typen abgeleitet werden. Steuerelemente können Ableitung von primitiven Steuerelementtypen in der [Windows.UI.Xaml.Controls.Primitives](http://go.microsoft.com/fwlink/p/?LinkId=238564) Namespace oder aus mehreren beendeten Steuerelemente wie z. B. [Schaltfläche](http://go.microsoft.com/fwlink/p/?LinkId=238565).  
