...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Beschreibt das Implementieren einer benutzerdefinierten <xref:System.Xml.Xsl.XsltContext>-Klasse mit den Schnittstellen <xref:System.Xml.Xsl.IXsltContextFunction> und <xref:System.Xml.Xsl.IXsltContextVariable>, die Erweiterungsfunktionen und -variablen unterstützen.  
