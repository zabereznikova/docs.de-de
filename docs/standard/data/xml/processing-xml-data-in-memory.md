---
title: "Verarbeiten von XML-Daten im Arbeitsspeicher | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
Das Microsoft .NET Framework enthält drei Modelle für die Verarbeitung von XML\-Daten: die <xref:System.Xml.XmlDocument>\-Klasse, die <xref:System.Xml.XPath.XPathDocument>\-Klasse und [LINQ to XML](../../../../ocs/visual-basic/programming-guide/concepts/linq/linq-to-xml.md).  
 ...
 [LINQ to XML](../../../../ocs/visual-basic/programming-guide/concepts/linq/linq-to-xml.md) ist das neue Modell in .NET Framework 3.5 zum Verarbeiten von XML\-Daten.  Dabei handelt es sich um ein im Arbeitsspeicher arbeitendes Modell \(In\-Memory\-Modell\), das die [LINQ \(Language\-Integrated Query\)](../Topic/LINQ%20\(Language-Integrated%20Query\).md)\-Technologie nutzt.  LINQ erweitert die Sprachsyntax von C\# und Visual Basic um neue Abfragefunktionen.  
