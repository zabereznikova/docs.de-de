...
>  Attribute können nur einfache Typen haben.  
 ...
 Weitere Informationen zu Schema-Validierung und die <xref:System.Xml.XPath.XPathNavigator> Klasse, finden Sie unter [Schema-Validierung mit "XPathNavigator"](../../../../docs/standard/data/xml/schema-validation-using-xpathnavigator.md).  
