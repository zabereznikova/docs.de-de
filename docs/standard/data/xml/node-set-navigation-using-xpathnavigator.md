---
title: "Navigieren in Knotengruppen mit &quot;XPathNavigator&quot; | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
Sie können mit den Navigationsmethoden für Knotengruppen der <xref:System.Xml.XPath.XPathNavigator>\-Klasse durch Knoten in einem <xref:System.Xml.XPath.XPathDocument> oder <xref:System.Xml.XmlDocument> navigieren.  Sie können durch alle Knoten oder durch eine von den Auswahlmethoden der <xref:System.Xml.XPath.XPathNavigator>\-Klasse zurückgegebene Gruppe von Knoten navigieren.  
  
## Navigation durch Gruppen von Elementknoten  
...
## Navigation durch Kommentare und Knoten mit Verarbeitungsanweisungen  
