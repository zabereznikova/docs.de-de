---
title: "Regeln f&#252;r R&#252;ckschlussschemaknotentypen und Struktur | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
|Kommentar|Ignoriert.|  
|Entitätsverweis|Die <xref:System.Xml.Schema.XmlSchemaInference>\-Klasse behandelt keine Entitätsverweise.  Wenn ein XML\-Dokument Entitätsverweise enthält, müssen Sie einen Reader verwenden, der die Entitäten erweitert.  Sie können beispielsweise eine <xref:System.Xml.XmlTextReader>\-Klasse mit der <xref:System.Xml.XmlTextReader.EntityHandling%2A>\-Eigenschaft übergeben, die auf den <xref:System.Xml.EntityHandling>\-Member als Parameter festgelegt ist.  Wenn Entitätsverweise auftreten und der Reader Entitäten nicht erweitert, wird eine Ausnahme ausgelöst.|  
