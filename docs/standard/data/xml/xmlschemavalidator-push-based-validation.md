...
## <a name="validating-xml-data-using-xmlschemavalidator"></a><span data-ttu-id="17d4b-111">Validieren von XML-Daten mithilfe von "XmlSchemaValidator"</span><span class="sxs-lookup"><span data-stu-id="17d4b-111">Validating XML Data using XmlSchemaValidator</span></span>  
...
|<xref:System.Xml.Schema.XmlSchemaValidator.ValidateWhitespace%2A>|<span data-ttu-id="17d4b-150">Validiert, ob Leerraum im aktuellen Elementkontext zulässig ist, und sammelt den Leerraum zum Validieren, ob das aktuelle Element einfachen Inhalt aufweist.</span><span class="sxs-lookup"><span data-stu-id="17d4b-150">Validates whether white-space is allowed in the current element context, and accumulates the white-space for validation whether the current element has simple content.</span></span>|  
...
#### <a name="retrieving-expected-attributes"></a><span data-ttu-id="17d4b-195">Abrufen von erwarteten Attributen</span><span class="sxs-lookup"><span data-stu-id="17d4b-195">Retrieving Expected Attributes</span></span>  
...
#### <a name="retrieving-unspecified-default-attributes"></a><span data-ttu-id="17d4b-204">Abrufen von nicht angegebenen Standardattributen</span><span class="sxs-lookup"><span data-stu-id="17d4b-204">Retrieving Unspecified Default Attributes</span></span>  
...
|<xref:System.Xml.Schema.XmlSchemaValidator.SkipToEndElement%2A>|<span data-ttu-id="17d4b-289">Wie in <xref:System.Xml.Schema.XmlSchemaValidator.ValidateEndElement%2A>.</span><span class="sxs-lookup"><span data-stu-id="17d4b-289">Same as <xref:System.Xml.Schema.XmlSchemaValidator.ValidateEndElement%2A>.</span></span>|<span data-ttu-id="17d4b-290">Wie in <xref:System.Xml.Schema.XmlSchemaValidator.ValidateEndElement%2A>.</span><span class="sxs-lookup"><span data-stu-id="17d4b-290">Same as <xref:System.Xml.Schema.XmlSchemaValidator.ValidateEndElement%2A>.</span></span>|<span data-ttu-id="17d4b-291">Siehe oben.</span><span class="sxs-lookup"><span data-stu-id="17d4b-291">Same as above.</span></span>|  
|<xref:System.Xml.Schema.XmlSchemaValidator.EndValidation%2A>|<span data-ttu-id="17d4b-292">Gibt ein leeres Array zurück.</span><span class="sxs-lookup"><span data-stu-id="17d4b-292">Returns an empty array.</span></span>|<span data-ttu-id="17d4b-293">Gibt ein leeres Array zurück.</span><span class="sxs-lookup"><span data-stu-id="17d4b-293">Returns an empty array.</span></span>|<span data-ttu-id="17d4b-294">Siehe oben.</span><span class="sxs-lookup"><span data-stu-id="17d4b-294">Same as above.</span></span>|  
  
> [!NOTE]
>  <span data-ttu-id="17d4b-295">Die von den verschiedenen Eigenschaften der <xref:System.Xml.Schema.XmlSchemaValidator>-Klasse zurückgegebenen Werte werden nicht durch das Aufrufen einer der Methoden in der oben stehenden Tabelle verändert.</span><span class="sxs-lookup"><span data-stu-id="17d4b-295">The values returned by the various properties of the <xref:System.Xml.Schema.XmlSchemaValidator> class are not altered by calling any of the methods in the above table.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="17d4b-296">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="17d4b-296">See also</span></span>
