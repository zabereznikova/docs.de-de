---
title: "XML-Dokumentobjektmodell (DOM) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
```  
 ...
 ![Struktur von XML&#45;Dokumenten](../../../../docs/standard/data/xml/media/xml-to-domtree.gif "XML\_To\_DOMTree")  
...
-   Abfragen ganzer Knoten zusätzlich zu den im Knoten enthaltenen Informationen, z. B. dem Text in einem Elementknoten.  
    ...
    > [!NOTE]
    >  Wenn eine Anwendung die vom DOM bereitgestellte Struktur oder die Bearbeitungsfunktionen nicht erfordert, bieten die **XmlReader**\-Klasse und die **XmlWriter**\-Klasse nicht zwischengespeicherten Vorwärtsstreamzugriff auf XML.  Weitere Informationen finden Sie unter <xref:System.Xml.XmlReader> und <xref:System.Xml.XmlWriter>.  
