...
## <a name="see-also"></a>Siehe auch  
 ...
 [XSLT-Stylesheet Scripting mithilfe \<msxsl: SCRIPT >](../../../../docs/standard/data/xml/xslt-stylesheet-scripting-using-msxsl-script.md)  
