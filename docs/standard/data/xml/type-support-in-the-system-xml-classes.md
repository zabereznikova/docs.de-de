...
-   Die <xref:System.Xml.XmlReader> und <xref:System.Xml.XPath.XPathNavigator> -Klasse enthalten jeweils eine **SchemaInfo** -Eigenschaft, die die Schemainformationen eines Knotens zurückgibt.  
  
-   Die **ReadContentAs** und **ReadElementContentAs** und Methoden für die <xref:System.Xml.XmlReader> -Klasse lesen einen Textwert und konvertieren Sie ihn in einen CLR-Wert in einen einzigen Methodenaufruf.  
...
-   Die **ValueAs** und <xref:System.Xml.XPath.XPathNavigator.TypedValue%2A> Eigenschaften für die <xref:System.Xml.XPath.XPathNavigator> -Klasse geben einen Knotenwert zurück und konvertieren Sie ihn in einen CLR-Wert in einen einzigen Methodenaufruf.  
...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 [Hinweise zur Implementierung der XML-Datentyp-Unterstützung](../../../../docs/standard/data/xml/xml-type-support-implementation-notes.md)  
