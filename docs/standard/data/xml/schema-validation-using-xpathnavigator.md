---
title: "Schema-Validierung mithilfe von &quot;XPathNavigator&quot; | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
```  
 ...
 Im Beispiel oben wird eine <xref:System.Xml.Schema.XmlSchemaValidationException> ausgelöst, wenn <xref:System.Xml.XmlDocument.Load%2A> aufgerufen wird, falls ein Attribut oder Elementtyp nicht mit dem im Validierungsschema angegebenen zugehörigen Typ übereinstimmt.  Wenn für den validierenden <xref:System.Xml.XmlReader> ein <xref:System.Xml.XmlReaderSettings.ValidationEventHandler> festgelegt wurde, wird der <xref:System.Xml.XmlReaderSettings.ValidationEventHandler> aufgerufen, sobald ein ungültiger Typ gefunden wird.  
  
 Greift der <xref:System.Xml.XPath.XPathNavigator> auf ein Attribut oder Element zu, bei dem für <xref:System.Xml.XPath.XPathNavigator.TypedValue%2A> `invalid` angegeben ist, wird eine <xref:System.Xml.Schema.XmlSchemaException> ausgelöst .  
  
 Um beim Zugriff auf Attribute oder Elemente mit dem <xref:System.Xml.XPath.XPathNavigator> zu bestimmen, ob das jeweilige Attribut oder Element gültig ist, kann die <xref:System.Xml.Schema.XmlSchemaInfo.Validity%2A>\-Eigenschaft verwendet werden.  
...
### Validieren eines Dokuments mithilfe der Validate\-Methode  
 Die <xref:System.Xml.XmlDocument.Validate%2A>\-Methode der <xref:System.Xml.XmlDocument>\-Klasse validiert das in einem <xref:System.Xml.XmlDocument>\-Objekt enthaltene XML\-Dokument anhand des in der <xref:System.Xml.XmlDocument.Schemas%2A>\-Eigenschaft des <xref:System.Xml.XmlDocument>\-Objekts angegebenen Schemas und führt den Zuwachs des Infosets durch.  Dadurch wird ein zuvor nicht typisiertes XML\-Dokument im <xref:System.Xml.XmlDocument>\-Objekt durch ein typisiertes Dokument ersetzt.  
 ...
 Im folgenden Beispiel wird die im <xref:System.Xml.XmlDocument>\-Objekt enthaltene `contosoBooks.xml`\-Datei anhand des `contosoBooks.xsd`\-Schemas validiert, das in der <xref:System.Xml.XmlDocument.Schemas%2A>\-Eigenschaft des <xref:System.Xml.XmlDocument>\-Objekts enthalten ist.  
...
```  
 ...
 Weitere Informationen zum Ändern von Werten mithilfe der <xref:System.Xml.XPath.XPathNavigator.SetTypedValue%2A>\-Methode finden Sie unter dem Thema [Ändern von XML\-Daten mit "XPathNavigator"](../../../../docs/standard/data/xml/modify-xml-data-using-xpathnavigator.md).  
  
### Schreibgeschützte Validierung  
 Die <xref:System.Xml.XPath.XPathDocument>\-Klasse ist eine schreibgeschützte Darstellung eines XML\-Dokuments im Speicher.  Sowohl die <xref:System.Xml.XPath.XPathDocument>\-Klasse als auch die <xref:System.Xml.XmlDocument>\-Klasse erstellen <xref:System.Xml.XPath.XPathNavigator>\-Objekte zum Navigieren und zum Bearbeiten von XML\-Dokumenten.  Da die <xref:System.Xml.XPath.XPathDocument>\-Klasse schreibgeschützt ist, können von <xref:System.Xml.XPath.XPathDocument>\-Objekten zurückgegebene <xref:System.Xml.XPath.XPathNavigator>\-Objekte das im <xref:System.Xml.XPath.XPathDocument>\-Objekt enthaltene XML\-Dokument nicht bearbeiten.  
 ...
 Weitere Informationen zu schreibgeschützten <xref:System.Xml.XPath.XPathNavigator>\-Objekten, die bearbeitet werden können, finden Sie unter dem Thema [Lesen von XML\-Daten mithilfe von "XPathDocument" und "XmlDocument"](../../../../docs/standard/data/xml/reading-xml-data-using-xpathdocument-and-xmldocument.md).  
