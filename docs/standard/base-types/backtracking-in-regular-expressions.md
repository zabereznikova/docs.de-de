---
title: "Backtracking in regul&#228;ren Ausdr&#252;cken | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
ms.topic: "article"
helpviewer_keywords: 
  - "Reguläre Ausdrücke von .NET Framework, Backtracking"
  - "Alternative Suchmuster"
  - "Optionale Suchmuster"
  - "Suchen mit regulären Ausdrücken, Backtracking"
  - "Mustervergleich mit regulären Ausdrücken, Backtracking"
  - "Backtracking"
  - "Reguläre Ausdrücke [.NET Framework], Backtracking"
  - "Zeichenfolgen [.NET Framework], Reguläre Ausdrücke"
  - "Analysieren von Text mit regulären Ausdrücken, Backtracking"
...
---
# Backtracking in regul&#228;ren Ausdr&#252;cken
...
### Lookbehindassertionen  
 ...
 Im folgenden Beispiel werden zwei äquivalente reguläre Ausdrucksmuster verwendet, die den Benutzernamen in einer E\-Mail\-Adresse überprüfen. Aufgrund übermäßiger Rückverfolgung tritt beim ersten Muster eine schlechte Leistung auf. Das zweite Muster ist eine Änderung des ersten regulären Ausdrucks, indem ein geschachtelter Quantifizierer durch eine positive Lookbehindassertion ersetzt wird. In der Beispielausgabe wird die Ausführungszeit der <xref:System.Text.RegularExpressions.Regex.IsMatch%2A?displayProperty=fullName>\-Methode angezeigt.  
...
|`[0-9A-Z]`|Übereinstimmung mit einem alphanumerischen Zeichen. Bei diesem Vergleich wird die Groß\-\/Kleinschreibung nicht beachtet, da die <xref:System.Text.RegularExpressions.Regex.IsMatch%2A?displayProperty=fullName>\-Methode mit der <xref:System.Text.RegularExpressions.RegexOptions?displayProperty=fullName>\-Option aufgerufen wird.|  
...
### Lookaheadassertionen  
 ...
 Im folgenden Beispiel werden zwei äquivalente Muster für reguläre Ausdrücke verwendet, die einen vollqualifizierten Typnamen überprüfen. Aufgrund übermäßiger Rückverfolgung tritt beim ersten Muster eine schlechte Leistung auf. Das zweite Muster ist eine Änderung des ersten regulären Ausdrucks, indem ein geschachtelter Quantifizierer durch eine positive Lookaheadassertion ersetzt wird. In der Beispielausgabe wird die Ausführungszeit der <xref:System.Text.RegularExpressions.Regex.IsMatch%2A?displayProperty=fullName>\-Methode angezeigt.  
