...
Im folgenden Beispiel werden [NumberFormatInfo](xref:System.Globalization.NumberFormatInfo)-Objekte verwendet, die die Kulturen „Englisch (USA)“ und „Englisch (Vereinigtes Königreich)“ sowie die neutralen Kulturen „Französisch“ und „Russisch“ darstellen, um eine Gleitkommazahl zu formatieren.
...
Im folgenden Beispiel werden [DateTimeFormatInfo](xref:System.Globalization.DateTimeFormatInfo)-Objekte verwendet, die die Kulturen „Englisch (USA)“ und „Englisch (Vereinigtes Königreich)“ sowie die neutralen Kulturen „Französisch“ und „Russisch“ darstellen, um ein Datum zu formatieren. 
