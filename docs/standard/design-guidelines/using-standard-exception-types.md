 ...
 **X DO NOT** explizit auslösen <xref:System.OutOfMemoryException>. Diese Ausnahme wird nur von der CLR-Infrastruktur ausgelöst werden.  
  
## <a name="comexception-sehexception-and-executionengineexception"></a>ComException und SEHException ExecutionEngineException  
 **X DO NOT** explizit auslösen <xref:System.Runtime.InteropServices.COMException>, <xref:System.ExecutionEngineException>, und <xref:System.Runtime.InteropServices.SEHException>. Diese Ausnahmen werden nur von der CLR-Infrastruktur ausgelöst werden.  
