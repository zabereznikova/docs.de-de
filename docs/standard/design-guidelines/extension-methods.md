 ...
 **X DO NOT** Erweiterungsmethoden implementieren eine Funktion in Namespaces, die üblicherweise mit anderen Funktionen definieren. Stattdessen definieren sie im Namespace verknüpft sind, mit der Funktion, der sie angehören.  
