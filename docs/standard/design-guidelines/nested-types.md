 ...
 **X AVOID** öffentlich verfügbar gemacht werden geschachtelte Typen. Die einzige Ausnahme hierbei ist, wenn Variablen des geschachtelten Typs müssen nur in seltenen Szenarien wie z. B. Erstellen von Unterklassen oder andere erweiterte Anpassungsszenarien deklariert werden.  
 ...
 **X DO NOT** geschachtelte Typen verwenden, wenn sie vom Clientcode instanziiert werden müssen.  Wenn ein Typ einen öffentlichen Konstruktor verfügt, sollte es wahrscheinlich nicht geschachtelt werden.  
 ...
 **X DO NOT** einen geschachtelten Typ als Member einer Schnittstelle definieren. Dieses Konstrukt wird von zahlreichen Sprachen nicht unterstützt.  
