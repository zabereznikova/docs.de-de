 ...
 **✓ CONSIDER** Verweis Tests für konkrete Implementierungen von Abstraktionen bereitstellen. Diese Tests sollten es Benutzern ermöglichen, zu testen, ob Ihre Implementierungen den Vertrag ordnungsgemäß implementieren.  
