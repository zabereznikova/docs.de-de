...
Möglicherweise wird .NET Framework 3.5 zum Ausführen einer Anwendung auf Windows 10, Windows 8.1 und Windows 8 benötigt. Sie können diese Schritte auch für frühere Versionen von Windows verwenden.
