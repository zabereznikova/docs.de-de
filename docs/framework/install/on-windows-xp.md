...
Diese Anleitung soll Sie bei der Installation der benötigten .NET Framework-Versionen unterstützen. [.NET Framework 4.7.1](https://www.microsoft.com/en-us/download/details.aspx?id=56115&desc=dotnet47) ist die aktuelle Version. Sie wird unter Windows XP und Windows Server 2003 nicht unterstützt. Die Version ist in [Windows 10 Fall Creators Update](https://www.microsoft.com/software-download/windows10) und [Windows Server 2016 Version 1709](https://docs.microsoft.com/windows-server/get-started/get-started-with-1709) enthalten.

## <a name="net-framework-403"></a>.NET Framework 4.0.3

[.NET Framework 4.0.3](http://go.microsoft.com/fwlink/?LinkID=213834) ist die aktuellste unterstützte .NET Framework-Version unter Windows XP und Windows Server 2003. .NET Framework 4.0.3 erfordert ein bereits installiertes [.NET Framework 4](http://go.microsoft.com/fwlink/?LinkID=213834). Für diese beiden .NET Framework-Versionen wird von Microsoft kein Support mehr geleistet.

## <a name="net-framework-4"></a>.NET Framework 4

Sie können [.NET Framework 4](http://go.microsoft.com/fwlink/?LinkID=213834&dotnetdocs) unter Windows XP installieren. Allerdings wird hierfür von Microsoft kein Support mehr geleistet.

## <a name="net-framework-35"></a>.NET Framework 3.5

Sie können [.NET Framework 3.5](http://go.microsoft.com/fwlink/?LinkID=213834&dotnetdocs) unter Windows XP installieren.
