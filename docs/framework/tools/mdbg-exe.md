---
title: MDbg.exe (.NET Framework-Befehlszeilendebugger) | Microsoft-Dokumentation
ms.custom: 
ms.date: 03/30/2017
...
|**Opendump** *pfadDerDumpdatei*|Öffnet die angegebene Dumpdatei zum Debuggen.|  
