...
## <a name="remarks"></a>Hinweise  
 ...
 Zum Verwenden der SOS-Debugerweiterung in Visual Studio installieren Sie das [Windows-Treiberkit (WDK)](https://msdn.microsoft.com/windows/hardware/hh852362). Informationen zur integrierten Debugumgebung von Visual Studio finden Sie unter [Debugging Environments](https://msdn.microsoft.com/library/windows/hardware/hh406268.aspx) im Windows Developer Center.  
  
 Sie können die SOS-Debugerweiterung auch in den WinDbg.exe-Debugger laden (verfügbar auf der [WDK und Entwicklertool-Website](https://go.microsoft.com/fwlink/?LinkId=103787)), und in WinDbg.exe Befehle ausführen.  
