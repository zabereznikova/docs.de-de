---
title: Certmgr.exe (Certificate Manager-Tool) | Microsoft-Dokumentation
ms.custom: 
ms.date: 03/30/2017
...
-   Speichert ein X.509-Zertifikat, eine CTL oder eine CRL aus einem Zertifikatspeicher in einer Datei.  
 ...
 Weitere Informationen zu Zertifikaten finden Sie unter [Arbeiten mit Zertifikaten](../../../docs/framework/wcf/feature-details/working-with-certificates.md).  
