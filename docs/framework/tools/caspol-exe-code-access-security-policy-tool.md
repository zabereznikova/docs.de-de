...
## <a name="remarks"></a>Hinweise  
 ...
 Weitere Informationen zu Sicherheitsrichtlinien und die Bestimmung der Berechtigungszuteilung an Codes durch die Laufzeit finden Sie unter [Sicherheitsrichtlinienverwaltung](/previous-versions/dotnet/netframework-4.0/c1k0eed6(v=vs.100)).  
