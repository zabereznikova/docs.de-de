...
|`-ExeConfig` \<*filename*>|Gibt die Konfigurationsdatei an, die in Ihrem Szenario verwendet wird, um Versions- und Loaderinformationen bereitzustellen.|
...
- [Übersicht: Leistungsverbesserungen in .NET Framework 4.5](/archive/msdn-magazine/2012/april/clr-an-overview-of-performance-improvements-in-net-4-5)
