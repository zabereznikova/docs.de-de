...
> [!IMPORTANT]
>  Die Sicherheitsrichtlinie war ein Schlüsselelement in früheren Versionen von .NET Framework. Ab [!INCLUDE[net_v40_long](../../../includes/net-v40-long-md.md)] ist die Sicherheitsrichtlinie veraltet. Die Beseitigung der Sicherheitsrichtlinie geschieht getrennt von der Sicherheitstransparenz. Informationen zu den Auswirkungen dieser Änderung finden Sie unter [Code Access Security Policy Compatibility and Migration](../../../docs/framework/misc/code-access-security-policy-compatibility-and-migration.md).  
...
-   Ebene 2 \(<xref:System.Security.SecurityRuleSet>\) – die [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)]\-Transparenzregeln.  
  
-   Ebene 1 \(<xref:System.Security.SecurityRuleSet>\) – die .NET Framework 2.0\-Transparenzregeln.  
