---
title: "Kompositionsanalysetool (Mefx) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Kompositionsanalysetool [MEF]"
  - "MEF, Kompositionsanalysetool"
  - "Mefx [MEF], Kompositionsanalysetool"
...
## Abrufen von MEFX  
 MEFX steht auf Codeplex unter [Managed Extensibility Framework](http://go.microsoft.com/fwlink/?LinkID=187078) zur Verfügung. Nach dem Herunterladen müssen Sie das Tool nur noch entpacken.  
...
## Auflisten von Importen und Exporten  
