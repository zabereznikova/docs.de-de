---
title: "&#220;bersicht &#252;ber das Modell der attributierten Programmierung (MEF) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Modell der attributierten Programmierung [MEF]"
  - "MEF, Modell der attributierten Programmierung"
...
---
# &#220;bersicht &#252;ber das Modell der attributierten Programmierung (MEF)
...
## Importieren und Exportieren – Grundlagen  
...
### Optionale Importe  
 ...
 Sie können mit der `AllowDefault`\-Eigenschaft angeben, dass ein Import *optional* ist. In diesem Fall ist die Komposition erfolgreich, auch wenn der Import mit keinen verfügbaren Exporten übereinstimmt, und die importierende Eigenschaft wird auf die Standardeinstellung für den Eigenschaftentyp festgelegt \(`null` für Objekteigenschaften, `false` für boolesche Werte oder 0 \(null\) für numerische Eigenschaften\). Die folgende Klasse verwendet einen optionalen Import.  
...
### Importieren von mehreren Objekten  
...
## Verhindern der Erkennung von Teilen  
...
## Importieren und Exportieren von Vererbung  
