---
title: "Serialisierungsrichtlinien | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  ...
  - "jsharp"
helpviewer_keywords: 
  - "Binäre Serialisierung, Richtlinien"
  - "Serialisierung, Richtlinien"
...
-   Erwägen Sie eine Unterstützung der *XML\-Serialisierung* anstelle oder zusätzlich zur Datenvertragsserialisierung, wenn eine größere Kontrolle über das bei der Serialisierung des Typs erstellte XML\-Format benötigt wird.  
...
#### Unterstützen der Datenvertragsserialisierung  
 Um die Datenvertragsserialisierung für einen Typ zu unterstützen, wenden Sie das **DataContractAttribute** auf den Typ und das **DataMemberAttribute** auf die Member \(Felder und Eigenschaften\) des Typs an.  
