---
title: "Beispiele f&#252;r die XML-Serialisierung | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
Die XML\-Serialisierung kann verschiedenste Formen annehmen, von einfach bis zu komplex.Sie können beispielsweise eine Klasse serialisieren, die nur aus öffentlichen Feldern und Eigenschaften besteht, wie unter [Einführung in die XML\-Serialisierung](../../../docs/framework/serialization/introducing-xml-serialization.md) beschrieben.Die folgenden Codebeispiele beziehen sich auf verschiedene komplexe Szenarios, einschließlich der Verwendung der XML\-Serialisierung zur Generierung eines XML\-Streams, der einem bestimmten XSD\-Dokument \(XML Schema\) entspricht.  
