---
title: "Schreiben gro&#223;er, reaktionsf&#228;higer .NET Framework-Apps | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Warum die neue Compilerleistung für Ihre App angewendet werden kann  
 ...
 Weitere Informationen zu den neuen Compilern finden Sie im [.NET Compiler Platform \(„Roslyn“\)\-Open\-Source\-Projekt](http://roslyn.codeplex.com/).  
...
### Tatsache 1: Vermeiden Sie eine vorzeitige Optimierung.  
...
```  
 ...
 Eine andere übliche Quelle für das Boxing bei Enumerationstypen ist die <xref:System.Enum.HasFlag%28System.Enum%29?displayProperty=fullName>\-Methode.  Das an <xref:System.Enum.HasFlag%28System.Enum%29> übergebene Argument muss geschachtelt werden.  In den meisten Fällen ist es einfacher und zuordnungsfrei, Aufrufe an <xref:System.Enum.HasFlag%28System.Enum%29?displayProperty=fullName> durch einen bitweisen Test zu ersetzen.  
 ...
 **Beispiel 5: Lambdas, List\<T\> und IEnumerable\<T\>**  
 ...
 In diesem Beispiel werden [LINQ und Funktionsformatcode](http://blogs.msdn.com/b/charlie/archive/2007/01/26/anders-hejlsberg-on-linq-and-functional-programming.aspx) verwendet, um ein Symbol im Modell des Compilers mit einer Namenszeichenfolge zu finden:  
...
```  
 ...
 In der ersten Zeile erfolgt der [Abschluss](http://blogs.msdn.com/b/ericlippert/archive/2003/09/17/53028.aspx) des [Lambda\-Ausdrucks](../Topic/Lambda%20Expressions%20\(C%23%20Programming%20Guide\).md) `s => s.Name == name` mit der lokalen Variable `name`.  Das bedeutet, dass zusätzlich zum Zuordnen eines Objekts für den [Delegaten](../Topic/delegate%20\(C%23%20Reference\).md), den `predicate` speichert, der Code eine statische Klasse zuordnet, um die Umgebung zu speichern, die den Wert von `name` erfasst.  Der Compiler generiert Code wie den folgenden:  
...
### Zwischenspeichern der Async\-Methode  
 Das nächste Beispiel zeigt ein typisches Problem, wenn Sie versuchen, zwischengespeicherte Ergebnisse in einer [Async](../Topic/Asynchronous%20Programming%20with%20Async%20and%20Await%20\(C%23%20and%20Visual%20Basic\).md)\-Methode zu verwenden.  
 ...
 **Korrektur für Beispiel 6**  
 ...
 Zum Entfernen der abgeschlossenen <xref:System.Threading.Tasks.Task>\-Zuordnung können Sie das Task\-Objekt mit dem abgeschlossenen Ergebnis zwischenspeichern:  
...
## Siehe auch  
 ...
 [Einführung in die Leistungsprofilerstellung](../Topic/Beginners%20Guide%20to%20Performance%20Profiling.md)   
 [Performance](../../../docs/framework/performance/index.md)   
 [.NET\-Leistungstipps](http://msdn.microsoft.com/library/ms973839.aspx)   
 [Windows Phone Tool zur Leistungsanalyse](http://msdn.microsoft.com/magazine/hh781024.aspx)   
 [Suchen von Anwendungsengpässen mit Visual Studio\-Profiler](http://msdn.microsoft.com/magazine/cc337887.aspx)   
 [PerfView\-Lernprogramme auf Channel 9](http://channel9.msdn.com/Series/PerfView-Tutorial)   
 [Allgemeine Leistungstipps](http://curah.microsoft.com/4604/improving-your-net-apps-startup-performance)   
 [.NET Compiler Platform \("Roslyn"\)\-Open\-Source\-Projekt](http://roslyn.codeplex.com/)