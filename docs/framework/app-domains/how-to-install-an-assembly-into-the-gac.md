---
title: "Gewusst wie: Installieren einer Assembly in den globalen Assemblycache | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "Globaler Assemblycache, Installieren von Assemblys"
...
> [!IMPORTANT]
>  Nur Assemblys mit starkem Namen können im GAC installiert werden.  Informationen zum Erstellen von Assemblys mit starkem Namen finden Sie unter [Gewusst wie: Signieren einer Assembly mit einem starken Namen](../../../docs/framework/app-domains/how-to-sign-an-assembly-with-a-strong-name.md).  
  
-   [Windows Installer](http://msdn.microsoft.com/library/windows/desktop/cc185688.aspx).  
...
### So verwenden Sie das Global Assembly Cache\-Tool \(Gacutil.exe\)  
...
### So verwenden Sie ein InstallShield Limited Edition\-Projekt  
...
6.  Führen Sie folgende Schritte für jedes Projekt in der Projektmappe aus, das eine Assembly enthält, die Sie im globalen Assemblycache installieren möchten:  
    ...
    3.  Wählen Sie im Bereich **Dateien des Quellcomputers** den Eintrag **Primäre Ausgabe von** *\<project\_name\>* aus.  
...
## Siehe auch  
 ...
 [Windows Installer Deployment](http://msdn.microsoft.com/de-de/121be21b-b916-43e2-8f10-8b080516d2a0)