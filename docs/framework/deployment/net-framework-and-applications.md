---
title: "Bereitstellen von .NET Framework und Anwendungen | Microsoft Docs"
ms.custom: ""
ms.date: "12/14/2016"
...
dev_langs: 
  ...
  - "jsharp"
helpviewer_keywords: 
  - ".NET Framework-Anwendungsbereitstellung"
  - ".NET Framework, Bereitstellen"
  - "Bereitstellen von Anwendungen [.NET Framework]"
  - "Bereitstellen von Anwendungen [.NET Framework], Verteilung"
  - "Bereitstellen von Anwendungen [.NET Framework], Funktionen"
  - "Bereitstellen von Anwendungen [.NET Framework], Packen"
...
Dieser Artikel hilft Ihnen dabei, mit der Bereitstellung des .NET Framework mit Ihrer Anwendung zu beginnen.  Die meisten der Informationen sind für Entwickler, OEM\- und Organisationsadministratoren vorgesehen.  Benutzer, die .NET Framework auf ihren Computern installieren möchten, sollten [Installieren von .NET Framework 4.5](../../../docs/framework/install/guide-for-developers.md) lesen.  
...
-   Allgemeine Informationen zum Installer und der Bereitstellung:  
    ...
    -   Installeroptionen:  
        ...
        -   [Webinstaller](../../../docs/framework/install/guide-for-developers.md#choices)  
  
        -   [Offlineinstaller](../../../docs/framework/install/guide-for-developers.md#choices)  
    ...
    -   [Problembehandlung von blockierten .NET Framework\-Installationen](../../../docs/framework/install/troubleshoot-blocked-installations-and-uninstallations.md)  
  
-   Bereitstellen von .NET Framework mit einer Clientanwendung \(für Entwickler\):  
  
    -   [Verwenden von InstallShield](../../../docs/framework/deployment/deployment-guide-for-developers.md#installshield) in einem Setup\- und in einem Bereitstellungsprojekt  
    ...
    -   Weitere Informationen für Entwickler finden Sie unter [Zusätzliche Informationen](../../../docs/framework/deployment/deployment-guide-for-developers.md)  
...
-   Bereitstellen von .NET Framework \(für OEMs und Administratoren\):  
    ...
    -   [Das Administratorhandbuch](../../../docs/framework/deployment/guide-for-administrators.md)  
...
|[Handbuch für die Bereitstellung für Administratoren](../../../docs/framework/deployment/guide-for-administrators.md)|Hierin wird erläutert, wie ein Systemadministrator mit System Center Configuration Manager \(SCCM\) .NET Framework und dessen Systemabhängigkeiten in einem Netzwerk bereitstellen kann.|  
|[Handbuch für die Bereitstellung für Entwickler](../../../docs/framework/deployment/deployment-guide-for-developers.md)|Es wird erklärt, wie Entwickler .NET Framework auf den Computern der Benutzer mit ihren Anwendungen installieren können.|  
|[Bereitstellen von Anwendungen, Diensten und Komponenten](../Topic/Deploying%20Applications,%20Services,%20and%20Components.md)|Erläutert Bereitstellungsoptionen in Visual Studio, einschließlich Anweisungen zum Veröffentlichen einer Anwendung mit ClickOnce\- und Windows Installer\-Technologie.|  
|[Publishing ClickOnce Applications](../Topic/Publishing%20ClickOnce%20Applications.md)|Beschreibt, wie eine Windows\-Forms\-Anwendung verpackt und mit ClickOnce auf Clientcomputern in einem Netzwerk bereitgestellt wird.|  
