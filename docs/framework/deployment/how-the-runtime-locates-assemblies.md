---
title: "So sucht Common Language Runtime nach Assemblys | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  ...
  - "jsharp"
helpviewer_keywords: 
  - ".NET Framework-Anwendungsbereitstellung, Suchen von Assemblys"
  - "app.config-Dateien, Assemblyspeicherorte"
  - "Anwendungskonfigurationsdateien, Suchen von Assemblys"
  - "Assemblys [.NET Framework], Speicherort"
  - "Bereitstellen von Anwendungen [.NET Framework], Assemblyspeicherorte"
...
```  
 ...
 Zum Erstellen einer Assembly können Sie das [Al.exe \(Assembly Linker\-Tool\)](../../../docs/framework/tools/al-exe-assembly-linker.md)\-Tool mit einem Befehl wie dem Folgenden verwenden:  
...
<a name="step4"></a>   
## Schritt 4: Suchen der Assembly mit CodeBases oder durch Überprüfung  
