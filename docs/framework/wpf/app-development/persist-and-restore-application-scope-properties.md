...
---
# <a name="how-to-persist-and-restore-application-scope-properties-across-application-sessions"></a><span data-ttu-id="07378-102">Gewusst wie: Beibehalten und Wiederherstellen von Eigenschaften für den Anwendungsbereich über mehrere Anwendungssitzungen</span><span class="sxs-lookup"><span data-stu-id="07378-102">How to: Persist and Restore Application-Scope Properties Across Application Sessions</span></span>
<span data-ttu-id="07378-103">Dieses Beispiel zeigt, wie Sie anwendungsspezifische Eigenschaften persistent zu speichern, wenn eine Anwendung heruntergefahren und zum Wiederherstellen starten Sie anwendungsspezifische Eigenschaften, wenn eine Anwendung weiter.</span><span class="sxs-lookup"><span data-stu-id="07378-103">This example shows how to persist application-scope properties when an application shuts down, and how to restore application-scope properties when an application is next launch.</span></span>  
  
## <a name="example"></a><span data-ttu-id="07378-104">Beispiel</span><span class="sxs-lookup"><span data-stu-id="07378-104">Example</span></span>  
 <span data-ttu-id="07378-105">Die Anwendung anwendungsspezifische Eigenschaften zum beibehalten und Wiederherstellen von isolierten Speicher.</span><span class="sxs-lookup"><span data-stu-id="07378-105">The application persists application-scope properties to, and restores them from, isolated storage.</span></span> <span data-ttu-id="07378-106">Isolierte Speicherung ist eine geschützte Speicherbereich, der von Anwendungen ohne Zugriffsberechtigung für die Datei sicher verwendet werden kann.</span><span class="sxs-lookup"><span data-stu-id="07378-106">Isolated storage is a protected storage area that can safely be used by applications without file access permission.</span></span>  
