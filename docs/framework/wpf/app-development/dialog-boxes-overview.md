...
> [!NOTE]
>  Sie müssen einen Besitzer unterstützen bereitstellen [!INCLUDE[TLA#tla_ui](../../../../includes/tlasharptla-ui-md.md)] -Automatisierung für Dialogfelder (finden Sie unter [UI Automation Overview](../../ui-automation/ui-automation-overview.md)).  
