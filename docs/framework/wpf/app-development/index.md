...
## <a name="windows-and-dialog-boxes"></a>Fenster und Dialogfelder  
 Benutzer interagieren über Windows mit eigenständigen WPF-Anwendungen. Fenster dienen dazu, Anwendungsinhalte zu hosten und Anwendungsfunktionen, über die Benutzer mit diesen Inhalten interagieren können, verfügbar zu machen. In WPF werden Fenster durch die <xref:System.Windows.Window>-Klasse gekapselt, die Folgendes unterstützt:  
