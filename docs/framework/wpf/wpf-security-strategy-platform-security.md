...
#### <a name="gs-compilation"></a>/GS-Kompilierung  
 ...
 [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] kompiliert wird, mit dem/GS-Flag, um eine weitere Schutzebene der Verteidigung, mit [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] Anwendungen.  
  
#### <a name="microsoft-windows-update-enhancements"></a>Verbesserungen von Microsoft Windows Update  
 [!INCLUDE[TLA#tla_win_update](../../../includes/tlasharptla-win-update-md.md)] wurde ebenfalls verbessert die Leistung in [!INCLUDE[TLA2#tla_winxpsp2](../../../includes/tla2sharptla-winxpsp2-md.md)] zur Vereinfachung des Prozesses für das Herunterladen und Installieren von Updates. Durch diese Änderungen wird die Sicherheit für [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)]-Kunden erheblich erhöht, da sie dafür sorgen, dass die Systeme der Kunden (besonders in Hinblick auf die Sicherheitsupdates) auf dem neuesten Stand sind.  
  
<a name="Windows_Vista"></a>   
### <a name="windows-vista"></a>Windows Vista  
 [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] Benutzer [!INCLUDE[TLA#tla_longhorn](../../../includes/tlasharptla-longhorn-md.md)] profitieren von zusätzlichen sicherheitsverbesserungen des Betriebssystems, wie u. a. "Least-Priviledged User Access", integritätsprüfungen für Code und rechteisolierung.  
...
#### <a name="code-integrity-checks"></a>Integritätsprüfungen für Code  
 [!INCLUDE[TLA#tla_longhorn](../../../includes/tlasharptla-longhorn-md.md)] umfasst umfangreichere integritätsprüfungen für Code um zu verhindern, dass bösartigen Code in Systemdateien oder den Kernel auf Lade-/Laufzeit eingefügt wird. Dies geht über den Schutz der Systemdateien hinaus.  
...
### <a name="limited-rights-process-for-browser-hosted-applications"></a>Prozess mit eingeschränkten Rechten für im Browser gehostete Anwendungen  
 Im Browser gehostete [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)]-Anwendungen werden im Sicherheitssandkasten der Internetzone ausgeführt. [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] Integration mit [!INCLUDE[TLA#tla_ie](../../../includes/tlasharptla-ie-md.md)] erweitert diesen Schutz und zusätzliche Unterstützung.  
...
### <a name="validation-and-verification"></a>Validierung und Prüfung  
 Assemblyisolation und Integrität wird von der [!INCLUDE[TLA2#tla_clr](../../../includes/tla2sharptla-clr-md.md)] über einen Validierungsprozess bereitgestellt. [!INCLUDE[TLA2#tla_clr](../../../includes/tla2sharptla-clr-md.md)] Validierung wird sichergestellt, dass Assemblys isoliert werden, indem Sie deren PE (Portable Executable)-Dateiformat für Adressen, die außerhalb der Assembly verweisen zu überprüfen. [!INCLUDE[TLA2#tla_clr](../../../includes/tla2sharptla-clr-md.md)] Überprüfung überprüft auch die Integrität der Metadaten, die in einer Assembly eingebettet ist.  
