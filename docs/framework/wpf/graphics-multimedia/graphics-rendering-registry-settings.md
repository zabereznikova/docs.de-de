...
|`HKEY_CURRENT_USER\SOFTWARE\Microsoft\Avalon.Graphics\MaxMultisampleType`|DWORD|  
 ...
 Der **maximale Wert für Multisampling** ist ein DWORD-Wert, der zwischen 0 und 16 liegt. Der Wert 0 gibt an, dass das Multisampling-Antialiasing von 3D-Inhalt deaktiviert werden soll, und der Wert 16 versucht, bis zu 16X Multisampling-Antialiasing zu verwenden, wenn dies von der Grafikkarte unterstützt wird. Beachten Sie, dass die Einstellung dieses Registrierungsschlüssel Werts auf Computern, die XPDM-Treiber verwenden, dazu führt, dass Anwendungen einen großen Teil des zusätzlichen Grafik Speichers verwenden, die Leistung des 3D-Rendering verringern und die Möglichkeit bietet, Renderingfehler und Stabilitätsprobleme einzuführen.  
