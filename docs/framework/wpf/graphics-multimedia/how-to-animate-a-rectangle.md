...
## <a name="example"></a>Beispiel  
 Im folgenden Beispiel wird eine Instanz von der <xref:System.Windows.Media.Animation.RectAnimation> Klasse zum Animieren der <xref:System.Windows.Media.RectangleGeometry.Rect%2A> Eigenschaft eine <xref:System.Windows.Media.RectangleGeometry>, die Änderungen auf die Größe und Position des Rechtecks animiert.  
