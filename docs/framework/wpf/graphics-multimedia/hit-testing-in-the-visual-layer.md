...
## <a name="hit-testing-support"></a>Unterstützung für den Treffertest  
 ...
 ![Diagramm eines gültigen treffertestbereich](./media/wcpsdk-mmgraphics-visuals-hittest-1.png "wcpsdk_mmgraphics_visuals_hittest_1")  
...
### <a name="how-the-visual-tree-affects-hit-testing"></a>Beeinflussung des Treffertests durch die visuelle Struktur  
 ...
 ![Diagramm der Hierarchie einer visuellen Struktur](./media/wcpsdk-mmgraphics-visuals-overview-01.gif "wcpsdk_mmgraphics_visuals_overview_01")  
...
## <a name="using-a-hit-test-filter-callback"></a>Verwenden eines Treffertestfilter-Rückrufs  
 ...
 ![Verzweigen einer visuellen Struktur mit einem Treffertestfilter](./media/filteredvisualtree-01.png "FilteredVisualTree_01")  
