...
## <a name="example"></a>Beispiel  
 ...
 In diesem Beispiel wurde Code ausgelassen. Den vollständigen Code finden Sie unter den [Animation Timing Verhalten Sample](https://go.microsoft.com/fwlink/?LinkID=159970).
