---
title: 'Vorgehensweise: Konvertieren einer BitmapSource in ein indiziertes Pixelformat'
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "57360718"
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="da4aa-102">Vorgehensweise: Konvertieren einer BitmapSource in ein indiziertes Pixelformat</span><span class="sxs-lookup"><span data-stu-id="da4aa-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="da4aa-103">Dieses Beispiel zeigt, wie Sie konvertieren ein <xref:System.Windows.Media.Imaging.BitmapSource> in ein indiziertes Pixelformat.</span><span class="sxs-lookup"><span data-stu-id="da4aa-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="da4aa-104">Beispiel</span><span class="sxs-lookup"><span data-stu-id="da4aa-104">Example</span></span>  
