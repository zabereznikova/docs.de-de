---
title: "Frame-Stile und -Vorlagen | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "Frame [WPF], Stile und Vorlagen"
  - "Bestandteile [WPF], Frame"
  - "Zustände [WPF], Frame"
  - "Formate [WPF], Frame"
  - "Vorlagen [WPF], Frame"
...
---
# Frame-Stile und -Vorlagen
In diesem Thema werden die Stile und Vorlagen für das <xref:System.Windows.Controls.Frame>\-Steuerelement beschrieben.  Sie können die standardmäßige <xref:System.Windows.Controls.ControlTemplate> ändern, um dem Steuerelement ein individuelles Aussehen zu verleihen.  Weitere Informationen finden Sie unter [Anpassen der Darstellung eines vorhandenen Steuerelements durch Erstellen einer ControlTemplate](../../../../docs/framework/wpf/controls/customizing-the-appearance-of-an-existing-control.md).  
...
|PART\_FrameCP|<xref:System.Windows.Controls.ContentPresenter>|Der Inhaltsbereich.|  
  
## Frame\-Zustände  
 In der folgenden Tabelle sind die visuellen Zustände für das <xref:System.Windows.Controls.Frame>\-Steuerelement aufgelistet.  
...
## Beispiel für ein Frame\-ControlTemplate  
 Im folgenden Beispiel wird veranschaulicht, wie eine <xref:System.Windows.Controls.ControlTemplate> für das <xref:System.Windows.Controls.Frame>\-Steuerelement definiert wird.  
