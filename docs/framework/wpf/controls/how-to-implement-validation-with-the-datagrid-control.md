...
-   Geben Sie einen oder mehrere Validierungsregeln für die Bindung mit einer Spalte verwendet. Dies ist vergleichbar mit Validieren von Daten in einfachen Steuerelementen, wie in beschrieben [Übersicht über die Datenbindung](../../../../docs/framework/wpf/data/data-binding-overview.md).  
