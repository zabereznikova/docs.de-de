...
## <a name="example"></a>Beispiel  
 So aktivieren Sie die Annahme von Tabstopps als Eingabe in einem <xref:System.Windows.Controls.TextBox> steuern, legen Sie die <xref:System.Windows.Controls.Primitives.TextBoxBase.AcceptsTab%2A> -Attribut **"true"**.  
