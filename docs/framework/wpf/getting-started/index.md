...
|Neu bei .NET?|[Übersicht über .NET Framework](https://msdn.microsoft.com/library/zw4w595w\(v=vs.140\).aspx)<br /><br /> [Grundlagen der .NET Framework-Anwendung](../../../../docs/standard/application-essentials.md)<br /><br /> [Erste Schritte mit Visual C# und Visual Basic](https://msdn.microsoft.com/library/dd492171\(v=vs.140\).aspx)|  
