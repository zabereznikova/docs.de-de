...
<a name="introduction"></a>Dieses Thema enthält Informationen zu neuen [!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] und erweiterten Funktionen in Version 4.5.  
...
- `public static event EventHandler<PropertyChangedEventArgs> StaticPropertyChanged;`  
 ...
 Beachten Sie, dass die Klasse im ersten Fall ein <xref:System.EventArgs> statisches Ereignis namens *PropertyName* `Changed` verfügbar macht, das an den Ereignishandler übergibt.  Im zweiten Fall macht die Klasse ein statisches Ereignis namens `StaticPropertyChanged` verfügbar, das den <xref:System.ComponentModel.PropertyChangedEventArgs>-Ereignishandler übergibt. Eine Klasse, die die statische Eigenschaft implementiert, kann Benachrichtigungen über Eigenschaftsänderungen nach Wahl mit einer der beiden Methode auslösen.  
...
- [Neuerungen in .NET Framework](../../whats-new/index.md)
