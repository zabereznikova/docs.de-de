...
### <a name="collection-syntax"></a>Auflistungssyntax  
 ...
 Das folgende Beispiel zeigt die Auflistungssyntax zum Festlegen der Werte von der <xref:System.Windows.Media.GradientBrush.GradientStops%2A> Eigenschaft:  
