---
title: "Ereignisse (WPF) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - "Ereignisse, Fenster"
  - "Windows Presentation Foundation, Ereignisse"
  - "WPF, Ereignisse"
...
---
# Ereignisse (WPF)
In [!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] wurden [Routingereignisse](GTMT) eingeführt, die Handler aufrufen können, die auf verschiedenen Listenern in der Elementstruktur einer Anwendung vorhanden sein können.  
