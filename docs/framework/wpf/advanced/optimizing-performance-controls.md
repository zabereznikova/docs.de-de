...
-   Festlegen von <!--zz <xref:System.Windows.Controls.VirtualizingStackPanel.IsVirtualizing%2A>--> `IsVirtualizing` zu `false`.    
...
> [!NOTE]
>  Ein Beispiel für das Aktivieren von Virtualisierung und wiederverwendens von Containern auf einem <xref:System.Windows.Controls.TreeView>, finden Sie unter [Verbessern der Leistung von TreeView](../../../../docs/framework/wpf/controls/how-to-improve-the-performance-of-a-treeview.md).  
