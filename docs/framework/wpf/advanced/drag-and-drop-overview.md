---
title: "&#220;bersicht &#252;ber Drag&#160;&amp;&#160;Drop | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "Quellen von Ziehvorgängen [WPF], Drag & Drop"
  - "Drag & Drop [WPF], Info"
  - "Drag & Drop [WPF], Ereignisse"
  - "Drag & Drop [WPF], Implementieren"
  - "Ablageziele [WPF], Drag & Drop"
...
|<xref:System.Windows.DragDrop.PreviewGiveFeedback>|[Tunnel](GTMT)\-Version von <xref:System.Windows.DragDrop.GiveFeedback>.|  
...
-   `allowedEffects` – Einer der <xref:System.Windows.DragDropEffects>\-Enumerationswerte, der die zulässigen Auswirkungen des Drag & Drop\-Vorgangs angibt.  
 ...
 Der `allowedEffects`\-Parameter wird verwendet, um anzugeben, welche Aktionen die Ziehquelle dem Ablageziel mit den übertragenen Daten erlaubt.  Die üblichen Werte für eine Ziehquelle sind <xref:System.Windows.DragDropEffects>, <xref:System.Windows.DragDropEffects> und <xref:System.Windows.DragDropEffects>.  
  
> [!NOTE]
>  Das Ablageziel kann außerdem angeben, welche Auswirkungen es als Reaktion auf die Ablage der Daten beabsichtigt.  Wenn das Ablageziel den Typ der abzulegenden Daten beispielsweise nicht erkennt, kann es die Daten zurückweisen, indem es die zulässigen Auswirkungen auf <xref:System.Windows.DragDropEffects> festlegt.  Dies erfolgt normalerweise im <xref:System.Windows.DragDrop.DragOver>\-Ereignishandler des Ablageziels.  
