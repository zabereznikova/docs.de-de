...
- Wird von <xref:System.Array> abgeleitet (Weitere Informationen zu Arrays in XAML finden Sie unter [x:Array-Markup Erweiterung](../../../desktop-wpf/xaml-services/xarray-markup-extension.md).)  
