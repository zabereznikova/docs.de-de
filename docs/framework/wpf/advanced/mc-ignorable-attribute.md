...
## <a name="remarks"></a>Hinweise  
 Das `mc` [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] `http://schemas.openxmlformats.org/markup-compatibility/2006`Namespace Präfix ist die empfohlene Präfix Konvention, die beim Mapping des Kompatibilitäts Namespace verwendet werden soll. [!INCLUDE[TLA2#tla_xml](../../../../includes/tla2sharptla-xml-md.md)]  
