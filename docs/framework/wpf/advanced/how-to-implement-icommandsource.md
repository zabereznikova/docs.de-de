...
## <a name="example"></a>Beispiel  
 ...
 Der nächste Schritt besteht zum Implementieren der <xref:System.Windows.Input.ICommandSource> Member.  In diesem Beispiel werden die Eigenschaften als implementiert <xref:System.Windows.DependencyProperty> Objekte.  Dadurch können die Eigenschaften, die Datenbindung verwendet.  Weitere Informationen zu den <xref:System.Windows.DependencyProperty> Klasse, finden Sie unter den [Übersicht über Abhängigkeitseigenschaften](../../../../docs/framework/wpf/advanced/dependency-properties-overview.md).  Weitere Informationen zur Datenbindung finden Sie unter den [Übersicht über die Datenbindung](../../../../docs/framework/wpf/data/data-binding-overview.md).  
