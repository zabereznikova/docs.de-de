...
- <xref:System.Windows.Media.NumberSubstitutionMethod.Context>: Wenn die Kultur eine Kultur Arabisch oder Persian ist, gibt an, aus, dass die Ziffern vom Kontext abhängen.  
