...
1. Doppelklicken Sie in **Projektmappen-Explorer**auf **SimpleControl. XAML** , um es im [!INCLUDE[wpfdesigner_current_short](../../../../includes/wpfdesigner-current-short-md.md)]zu öffnen.
