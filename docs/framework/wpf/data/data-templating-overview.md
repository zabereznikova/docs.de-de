...
## <a name="prerequisites"></a>Vorraussetzungen  
 ...
 Darüber hinaus ist es wichtig zu verstehen, `Resources`, die sind im Wesentlichen das, was Objekte ermöglichen, z.B. <xref:System.Windows.Style> und <xref:System.Windows.DataTemplate> wiederverwendbarkeit. Weitere Informationen zu Ressourcen finden Sie unter [XAML-Ressourcen](../../../../docs/framework/wpf/advanced/xaml-resources.md).  
