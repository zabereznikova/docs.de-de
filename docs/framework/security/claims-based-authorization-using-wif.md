...
### <a name="iprincipalisinrole-method"></a>IPrincipal.IsInRole-Methode  
 Um den RBAC-Ansatz in Ansprüche unterstützende Anwendungen zu implementieren, verwenden Sie die **IsInRole ()** -Methode in der **IPrincipal** -Schnittstelle, genauso wie bei Anwendungen, die keine Ansprüche unterstützen. Es gibt mehrere Möglichkeiten für den Einsatz der **IsInRole()** -Methode:  
