---
title: "Anspruchsbasierte Autorisierung mit WIF | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.reviewer: ""
ms.suite: ""
...
## Übersicht  
 ...
 Ansprüche können auch verwendet werden, um komplexere Autorisierungsentscheidungen über Rollen hinaus zu ermöglichen.  Ansprüche können praktisch auf beliebigen Informationen über den Benutzer basiert werden: Alter, Postleitzahl, Schuhgröße usw. Ein Mechanismus zur Zugriffssteuerung, der auf beliebigen Ansprüchen basiert, wird als anspruchsbasierte Autorisierung bezeichnet.  Weitere Informationen finden Sie unter [Anspruchsbasierte Autorisierung](../../../docs/framework/security/claims-based-authorization-using-wif.md#BKMK_2).  
...
-   Verwenden der URL\-Autorisierung mithilfe des **\<authorization\>**\-Abschnitts der Datei **web.config**.  Dieser Ansatz ist geeignet, wenn Sie die Autorisierung auf URL\-Ebene verwalten.  Dies ist von allen bisher erwähnten Ebenen die gröbste Ebene.  Der Vorteil dieser Methode ist, dass Änderungen in der Konfigurationsdatei vorgenommen werden, d. h., dass der Code nicht kompiliert werden sollte, um von der Änderung zu profitieren.  
