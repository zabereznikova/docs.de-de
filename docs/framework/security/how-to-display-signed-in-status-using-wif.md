---
title: "Gewusst wie: Anzeigen des Anmeldestatus mit WIF | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.reviewer: ""
ms.suite: ""
...
---
# Gewusst wie: Anzeigen des Anmeldestatus mit WIF
## Gilt für  
...
#### So richten Sie die Identitäts\- und Zugriffserweiterung ein  
...
#### So aktivieren Sie den lokalen Entwicklungs\-STS in der ASP.NET\-Anwendung  
...
2.  Das Fenster **Identität und Zugriff** wird geöffnet.  Wählen Sie unter **Anbieter** die Option **Anwendung mit dem lokalen Entwicklungs\-STS testen** aus, und klicken Sie auf **Übernehmen**.  
...
#### So zeigen Sie den Anmeldestatus an  
  
1.  Öffnen Sie in Visual Studio die Datei **Default.aspx** unter dem Projekt **TestApp**.  
  
2.  Ersetzten Sie das vorhandene Markup in der Datei **Default.aspx** durch das folgende Markup:  
...
#### So testen Sie die Integration zwischen WIF und ASP.NET  
