...
- [Einführung in die anspruchsbasierte Identität](claims-based-identity-model.md#BKMK_1)  
  
- [Grundlegendes Szenario für ein anspruchsbasiertes Identitätsmodell](claims-based-identity-model.md#BKMK_2)  
...
## <a name="basic-scenario-for-a-claims-based-identity-model"></a>Grundlegendes Szenario für ein anspruchsbasiertes Identitätsmodell  
 ...
 ![Authentifizierungsfluss des abhängigen Partners](./media/conc-relying-partner-processc.png "Conc_relying_partner_processc")  
...
1. Wenn ein nicht authentifizierter Benutzer eine Seite anfordert, wird der Browser an die Seiten des Identitäts Anbieters (IDP) umgeleitet.  
  
2. Der IDP erfordert, dass der Benutzer seine Anmelde Informationen (z. b. Benutzername/Kennwort oder Kerberos-Authentifizierung) präsentiert.  
  
3. Der IDP gibt ein Token zurück, das an den Browser zurückgegeben wird.  
