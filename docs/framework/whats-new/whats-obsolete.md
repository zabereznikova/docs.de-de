---
title: "Veraltete Elemente in der .NET Framework-Klassenbibliothek | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Veraltet [.NET Framework]"
  - "Veraltet [.NET Framework]"
  - "Veraltete Elemente [.NET Framework]"
...
---
# Veraltete Elemente in der .NET Framework-Klassenbibliothek
...
|4.5 \(einschließlich 4.5.1 und andere Punktversionen\)|v4.0|  
|4|v4.0|  
|3.5|v2.0.50727|  
|2.0|v2.0.50727|  
|1.1|v1.1.4322|  
...
## Listen mit veralteten Komponenten für .NET Framework 4.5  
 [Veraltete Typen](../../../docs/framework/whats-new/obsolete-types.md)  
  
 [Veraltete Member](../../../docs/framework/whats-new/obsolete-members.md)  
  
## Listen mit veralteten Komponenten für frühere Versionen  
 [Veraltete Typen in .NET Framework 4](http://go.microsoft.com/fwlink/?LinkId=224224)  
  
 [Veraltete Members in .NET Framework 4](http://go.microsoft.com/fwlink/?LinkId=224227)  
  
 [.NET Framework 3.5 – Liste veralteter Komponenten](http://go.microsoft.com/fwlink/?LinkId=163710)  
  
 [.NET Framework 2.0 – Liste veralteter Komponenten](http://go.microsoft.com/fwlink/?LinkId=125264)  
