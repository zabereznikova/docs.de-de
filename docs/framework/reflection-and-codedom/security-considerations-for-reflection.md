---
title: "Sicherheits&#252;berlegungen f&#252;r die Reflektion | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "Teilweise vertrauenswürdig, Reflektion"
  - "Berechtigungen [.NET Framework], Reflektion"
  - "Reflektion, Sicherheit"
  - "Reflektion, Teilweise vertrauenswürdig"
...
-   Code, der mit teilweiser Vertrauenswürdigkeit ausgeführt wird, wird als transparent behandelt.  
 ...
 Weitere Informationen zum Sicherheitsmodell in [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)] finden Sie unter [Sicherheitsänderungen](../../../docs/framework/security/security-changes.md).  
...
## Zugreifen auf Member, auf die normalerweise nicht zugegriffen werden kann  
...
-   Damit Code einen beliebigen nicht öffentlichen Member aufrufen kann: Dem Code muss <xref:System.Security.Permissions.ReflectionPermission> mit dem <xref:System.Security.Permissions.ReflectionPermissionFlag?displayProperty=fullName>\-Flag gewährt werden.  
...
-   Assembly A kann Reflektion nicht verwenden, um auf private Member von [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)]\-Assemblys wie "mscorlib.dll" zuzugreifen, denn "mscorlib.dll" ist voll vertrauenswürdig und hat daher Berechtigungen, die Assembly A nicht gewährt wurden  Es wird eine <xref:System.MemberAccessException> ausgelöst, wenn Codezugriffssicherheit zur Laufzeit den Stapel durchläuft.  
  
## Serialisierung  
 Für Serialisierung bietet <xref:System.Security.Permissions.SecurityPermission> mit dem <xref:System.Security.Permissions.SecurityPermissionAttribute.SerializationFormatter%2A?displayProperty=fullName>\-Flag die Möglichkeit, Member von serialisierbaren Typen unabhängig davon, ob grundsätzlich auf sie zugegriffen werden kann, abzurufen und festzulegen.  Mit dieser Berechtigung kann Code den privaten Status einer Instanz erkennen und ändern.  \(Zusätzlich dazu, dass dem Typ die entsprechenden Berechtigungen gewährt werden, muss er in den Metadaten als serialisierbar [markiert](../../../docs/standard/attributes/applying-attributes.md) sein.\)  
  
## Parameter des MethodInfo\-Typs  
...
-   Das <xref:System.Security.Permissions.ReflectionPermissionFlag?displayProperty=fullName>\-Flag wurde in [!INCLUDE[net_v20SP1_long](../../../includes/net-v20sp1-long-md.md)] eingeführt.  Frühere Versionen von [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] erfordern das <xref:System.Security.Permissions.ReflectionPermissionFlag?displayProperty=fullName>\-Flag für Code, der Reflektion verwendet, um auf nicht öffentliche Member zuzugreifen.  Diese Berechtigung sollte in keinem Fall teilweise vertrauenswürdigem Code erteilt werden.  
