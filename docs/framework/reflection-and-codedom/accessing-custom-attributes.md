---
title: Zugreifen auf benutzerdefinierte Attribute | Microsoft-Dokumentation
ms.custom: 
ms.date: 03/30/2017
...
## <a name="the-execution-context"></a>Der Ausführungskontext  
 ...
 Methoden wie <xref:System.Reflection.Assembly.GetCustomAttributes%28System.Boolean%29?displayProperty=fullName> überprüfen die Sichtbarkeit und die Erreichbarkeit des Typarguments. Nur Code in der Assembly, der den benutzerdefinierten Typ enthält, kann ein benutzerdefiniertes Attribut dieses Typs mithilfe von **GetCustomAttributes** abrufen.  
