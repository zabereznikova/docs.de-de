...
- [Vorgehensweise: Anfügen einer vorhandenen Entität an den DataServiceContext](../../../../docs/framework/data/wcf/attach-an-existing-entity-to-dc-wcf-data.md)
