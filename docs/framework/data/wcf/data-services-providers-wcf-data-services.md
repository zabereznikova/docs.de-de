...
[!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)]unterstützt mehrere Anbieter Modelle zum verfügbar machen von [!INCLUDE[ssODataFull](../../../../includes/ssodatafull-md.md)] Daten als-Feed. Dieses Thema enthält Informationen, um Ihnen die Auswahl des besten [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)]-Anbieters für eine Datenquelle zu erleichtern.  
