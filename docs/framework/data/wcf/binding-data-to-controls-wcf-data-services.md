...
## <a name="binding-data-to-windows-presentation-foundation-elements"></a>Binden von Daten an Windows Presentation Foundation-Elemente  
 ...
 Weitere Informationen finden Sie unter [Vorgehensweise: Binden Sie Daten an Windows Presentation Foundation](bind-data-to-wpf-elements-wcf-data-services.md)Elemente.  
...
## <a name="binding-paged-data"></a>Binden von ausgelagerten Daten  
 ...
 Verknüpfte Objekte werden auf ähnliche Weise geladen. Weitere Informationen finden Sie unter [Vorgehensweise: Binden Sie Daten an Windows Presentation Foundation](bind-data-to-wpf-elements-wcf-data-services.md)Elemente.  
...
> [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] überprüft die benutzerdefinierten Verhalten nicht, die Sie in diesen Delegaten implementieren.  
 ...
 Weitere Informationen finden Sie unter [Vorgehensweise: Anpassen des Daten Bindungs](how-to-customize-data-binding-behaviors-wcf-data-services.md)Verhaltens.  
...
- [Vorgehensweise: Manuelles Generieren von Client Datendienst Klassen](how-to-manually-generate-client-data-service-classes-wcf-data-services.md)
