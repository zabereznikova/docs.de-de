...
---
# <a name="how-to-create-a-data-service-using-a-linq-to-sql-data-source-wcf-data-services"></a>Vorgehensweise: Erstellen eines Datendiensts mit einer LINQ to SQL-Datenquelle (WCF Data Services)
