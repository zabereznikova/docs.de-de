...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Beschreibt das Arbeiten mit einem [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] feed in einer .NET Framework-Clientanwendung.  
  
 [Schnellstart](../../../../docs/framework/data/wcf/quickstart-wcf-data-services.md)  
 Veranschaulicht das Erstellen und Zugriff auf eine einfache [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)]-basierten Dienst, der einen auf der Northwind-Beispieldatenbank basierenden Feed verfügbar macht.  
