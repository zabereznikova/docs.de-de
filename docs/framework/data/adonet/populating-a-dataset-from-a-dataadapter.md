...
## <a name="sql-server-decimal-type"></a>SQL Server-Typ "decimal"  
 ...
 ADO.NET 2,0 hat eine verbesserte unter <xref:System.Data.SqlTypes> Stützung für `DataSet`in eingeführt. Weitere Informationen finden Sie unter [SqlTypes and the DataSet](./sql/sqltypes-and-the-dataset.md).  
