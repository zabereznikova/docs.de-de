---
title: "&#196;ndern von Daten mit gespeicherten Prozeduren | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Beispiel  
 In diesem Beispiel wird die folgende gespeicherte Prozedur verwendet, um in die **Categories**\-Tabelle der **Northwind**\-Beispieldatenbank eine neue Kategorie einzufügen.  Die gespeicherte Prozedur nimmt den Wert in der **CategoryName**\-Spalte als Eingabeparameter, verwendet die SCOPE\_IDENTITY\(\)\-Funktion, um den neuen Wert des Identitätsfelds **CategoryID** abzurufen, und gibt ihn als Ausgabeparameter zurück.  Die RETURN\-Anweisung gibt über die @@ROWCOUNT\-Funktion die Anzahl der eingefügten Zeilen zurück.  
...
> [!NOTE]
>  Für das <xref:System.Data.OleDb.OleDbDataAdapter>\-Objekt müssen Parameter mit einer <xref:System.Data.ParameterDirection> von **ReturnValue** vor den anderen Parametern angegeben werden.  
