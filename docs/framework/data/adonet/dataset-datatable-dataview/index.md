...
## <a name="in-this-section"></a>In diesem Abschnitt  
 [Erstellen eines "DataSets"](../../../../../docs/framework/data/adonet/dataset-datatable-dataview/creating-a-dataset.md)  
 ...
 [Verwenden eines "DataSet" von einem XML-Webdienst aus](../../../../../docs/framework/data/adonet/dataset-datatable-dataview/consuming-a-dataset-from-an-xml-web-service.md)  
...
## <a name="related-sections"></a>Verwandte Abschnitte  
 ...
 [Hinzufügen von vorhandenen Einschränkungen zu einem "DataSet"](../../../../../docs/framework/data/adonet/adding-existing-constraints-to-a-dataset.md)  
