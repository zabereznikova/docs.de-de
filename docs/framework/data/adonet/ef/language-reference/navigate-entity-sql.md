...
## <a name="arguments"></a>Argumente  
 ...
 `relationship-type`  
 Der Typname der Beziehung aus der CSDL-Datei (Conceptual Schema Definition Language, konzeptionelle Schemadefinitionssprache). Die `relationship-type` ist qualifiziert, als \<Namespace >.\< Beziehungstypname >.  
