...
---
# BETWEEN (Entity SQL)
Ermittelt, ob der Ergebniswert eines Ausdrucks in einem angegebenen Bereich liegt. Der BETWEEN\-Ausdruck von [!INCLUDE[esql](../../../../../../includes/esql-md.md)] hat die gleiche Funktionalität wie der BETWEEN\-Ausdruck von Transact\-SQL.  
