...
## <a name="datetime"></a>DateTime  
 ...
 Der Datums Teil muss folgendes Format aufweisen: `YYYY` @ no__t-1 @ no__t-2 @ no__t-3 @ no__t-4, wobei `YYYY` ein vierstelliger Jahreswert zwischen 0001 und 9999 ist, `MM` den Monat zwischen 1 und 12 und `DD` den tagewert, der für den angegebenen Monat gültig ist `MM`.  
...
## <a name="guid"></a>GUID  
 Ein `GUID`-Literal stellt einen global eindeutigen Bezeichner dar. Dabei handelt es sich um eine Sequenz, die durch das-Schlüsselwort `GUID` gefolgt von hexadezimalen Ziffern in *dem Format,* das in einfachen Anführungszeichen eingeschlossen ist, dargestellt wird: 8-4-4-4-12. Bei den Hexadezimalzeichen wird die Groß/- Kleinschreibung nicht berücksichtigt.  
