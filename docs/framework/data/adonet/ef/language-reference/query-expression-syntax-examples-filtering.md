...
In den Beispielen in diesem Thema wird gezeigt, wie mithilfe der `Where` und `Where…Contains` Methoden zum Abfragen der [AdventureWorks Sales-Modell](http://msdn.microsoft.com/en-us/f16cd988-673f-4376-b034-129ca93c7832) mithilfe der Abfrageausdruckssyntax Abfragen. Beachten Sie, wo...`Contains` kann nicht verwendet werden, als Teil einer [kompilierte Abfrage](../../../../../../docs/framework/data/adonet/ef/language-reference/compiled-queries-linq-to-entities.md).  
