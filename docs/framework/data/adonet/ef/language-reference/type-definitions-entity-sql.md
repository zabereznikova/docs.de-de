---
title: "Typdefinitionen (Entity SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Hinweise  
 Die Deklarationsanweisung für eine Inlinefunktion besteht aus dem [FUNCTION](../../../../../../docs/framework/data/adonet/ef/language-reference/function-entity-sql.md)\-Schlüsselwort, dem Bezeichner, der den Funktionsnamen \(z. B. "MyAvg"\) darstellt und der Parameterdefinitionsliste in Klammern \(z. B. "Gebührenauflistung \(Decimal\)"\).  
