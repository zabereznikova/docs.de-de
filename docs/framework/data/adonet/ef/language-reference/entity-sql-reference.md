...
|[THEN](then-entity-sql.md)|Das Ergebnis einer [beim](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/bb387119(v=vs.100)) -Klausel, wenn er auf "true" ausgewertet wird.|
