...
## <a name="example"></a>Beispiel  
 In diesem Beispiel wird eine Abfrage ausgeführt, die <xref:System.Data.Metadata.Edm.RefType>-Ergebnisse zurückgibt. Wenn Sie die folgende Abfrage an die `ExecuteRefTypeQuery`-Funktion als Argument übergeben, gibt die Funktion einen Verweis auf die Entität zurück:  
