---
title: "Generieren von SQL aus Befehlsstrukturen – Best Practices | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Gruppieren von "DbExpression"\-Knoten in einer SQL SELECT\-Anweisung  
...
## Vereinfachen von Joins in einer SQL SELECT\-Anweisung  
...
## Spaltennamen\- und Blockaliasumbenennung  
...
## Vermeiden von SELECT \*  
 Verwenden Sie zum Auswählen aus Basistabellen nicht `SELECT *`.  Das Speichermodell einer [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)]\-Anwendung beinhaltet möglicherweise nur eine Teilmenge der Spalten der Datenbanktabelle.  In diesem Fall führt `SELECT *` möglicherweise zu einem falschen Ergebnis.  Stattdessen sollten Sie alle beteiligten Spalten mithilfe des Spaltennamens des Ergebnistyps der teilnehmenden Ausdrücke angeben.  
  
## Wiederverwendung von Ausdrücken  
 Ausdrücke können in der Abfragebefehlsstruktur wiederverwendet werden, die von [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] übergeben wird. Gehen Sie nicht davon aus, dass jeder Ausdruck in der Abfragebefehlsstruktur nur einmal auftritt.  
  
## Zuordnen von primitiven Typen  
