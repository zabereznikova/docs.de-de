...
#### <a name="consider-opening-the-database-connection-manually"></a>Manuelles Öffnen der Datenbankverbindung  
 Wenn Ihre Anwendung eine Reihe von Objekt Abfragen ausführt oder häufig aufruft <xref:System.Data.Objects.ObjectContext.SaveChanges%2A> , um Erstellungs-, Aktualisierungs-und Löschvorgänge in der Datenquelle beizubehalten, muss der Entity Framework die Verbindung mit der Datenquelle fortlaufend öffnen und schließen. Erwägen Sie in diesem Fall, die Verbindung am Start dieser Operationen manuell zu öffnen und die Verbindung zu schließen bzw. freizugeben, wenn die Vorgänge abgeschlossen sind. Weitere Informationen finden Sie unter [Verwalten von Verbindungen und Transaktionen](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/bb896325(v=vs.100)).  
