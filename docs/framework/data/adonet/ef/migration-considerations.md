...
> [!NOTE]
> Alle diese Aufgaben werden automatisch ausgeführt, wenn Sie die Entity Data Model Tools verwenden, die mit Visual Studio 2008 beginnen. Weitere Informationen finden Sie unter Gewusst [wie: Verwenden des Entity Data Model-Assistenten](/previous-versions/dotnet/netframework-4.0/bb738677(v=vs.100)).  
...
- Binden von Daten an Steuerelemente.  
  ...
  Weitere Informationen finden Sie unter [Binden von Objekten an Steuerelemente](/previous-versions/dotnet/netframework-4.0/bb738469(v=vs.100)).  
