...
---
# <a name="query-expression-syntax-examples-aggregate-operators-linq-to-dataset"></a>Beispiele für die Abfrageausdruckssyntax: Aggregat Operatoren (LINQ to DataSet)
