...
2. Binden Sie im <xref:System.Windows.Forms.Form.Load>-Ereignishandler Ihres Formulars das <xref:System.Windows.Forms.DataGridView>-Steuerelement an die <xref:System.Windows.Forms.BindingSource>-Komponente, und verwenden Sie die `GetData`-Methode, um Daten aus der Datenbank abzurufen. Die <xref:System.Data.DataView> wird aus einer LINQ to DataSet-Abfrage erstellt, über den Kontakt <xref:System.Data.DataTable> und klicken Sie dann an gebunden ist die <xref:System.Windows.Forms.BindingSource> Komponente.  
