...
## <a name="adonet-components"></a>ADO.NET-Komponenten  
 Die zwei Hauptkomponenten von ADO.net für den Zugriff auf und die <xref:System.Data.DataSet>Bearbeitung von Daten sind die .NET Framework-Datenanbieter und.  
...
### <a name="the-dataset"></a>Das "DataSet"  
 ...
 Das folgende Diagramm veranschaulicht die Beziehung zwischen einem .NET Framework-Datenanbieter und `DataSet`einem.  
