...
> [!IMPORTANT]
>  Das Codebeispiel bezieht sich auf eine Access-Datenbankdatei namens MySchool.mdb. Sie können MySchool.mdb (als Teil der vollständigen Beispielprojekt für c# oder Visual Basic) entweder die [Visual Studio 2012-Beispiel](https://code.msdn.microsoft.com/How-to-retrieve-the-95b4ee43) oder [Visual Studio 2013-Beispiel](https://code.msdn.microsoft.com/How-to-Retrieve-the-511acece).  
