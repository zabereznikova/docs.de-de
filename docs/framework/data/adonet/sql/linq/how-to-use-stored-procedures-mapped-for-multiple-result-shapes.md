---
title: "Vorgehensweise: Verwenden gespeicherter Prozeduren f&#252;r mehrere Ergebnisformen | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Vorgehensweise: Verwenden gespeicherter Prozeduren f&#252;r mehrere Ergebnisformen
Wenn eine gespeicherte Prozedur mehrere Ergebnisformen zurückgeben kann, lässt sich der Rückgabetyp nicht auf eine einzige Projektionsform festlegen.  Obwohl [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] alle möglichen Projektionstypen erzeugen kann, ist die Rückgabereihenfolge nicht bekannt.  
  
 Vergleichen Sie dieses Szenario mit gespeicherten Prozeduren, die sequenziell mehrere Ergebnisformen erzeugen.  Weitere Informationen finden Sie unter [Vorgehensweise: Verwenden von gespeicherten Prozeduren, die sequenziellen Ergebnisformen zugeordnet sind](../../../../../../docs/framework/data/adonet/sql/linq/how-to-use-stored-procedures-mapped-for-sequential-result-shapes.md).  
