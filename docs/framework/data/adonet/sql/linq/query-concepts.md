...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 [Beziehungsübergreifendes Abfragen](../../../../../../docs/framework/data/adonet/sql/linq/querying-across-relationships.md)  
 Erläutert die Verwendung von Assoziationen im [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]-Objektmodell.  
  
 [Remoteausführung von Abfragen im Vergleich zur lokalen Ausführung](../../../../../../docs/framework/data/adonet/sql/linq/remote-vs-local-execution.md)  
