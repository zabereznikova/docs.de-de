...
## <a name="supported-systemtimespan-method-support"></a>Unterstützung der System.TimeSpan-Methode  
...
### <a name="addition-and-subtraction"></a>Addition und Subtraktion  
 Vom CLR-<xref:System.TimeSpan?displayProperty=nameWithType>-Typ werden Additionen und Subtraktionen unterstützt, vom SQL-`TIME`-Typ jedoch nicht. Ihre LINQ to SQL-Abfragen werden bei Additionen und Subtraktionen daher Fehler verursachen, wenn sie dem SQL-`TIME`-Typ zugeordnet sind. Finden Sie weitere Überlegungen für die Arbeit mit SQL Datums- und Uhrzeittypen in [SQL-CLR-Typzuordnung](../../../../../../docs/framework/data/adonet/sql/linq/sql-clr-type-mapping.md).  
