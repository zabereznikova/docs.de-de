...
-   In der [!INCLUDE[vs_ordesigner_long](../../../../../../includes/vs-ordesigner-long-md.md)], ändern Sie die **Serialisierungsmodus** Eigenschaft **Unidirectional**.  
