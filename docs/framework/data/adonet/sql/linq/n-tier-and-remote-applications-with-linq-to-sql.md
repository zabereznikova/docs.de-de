...
Sie können N-Tier-Anwendungen bzw. Anwendungen mit mehreren Ebenen erstellen, die [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] verwenden. In der [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] Regel befinden sich der Datenkontext, Entitätsklassen und abfragekonstruktionslogik auf der mittleren Ebene als Datenzugriffsschicht (Data Access Layer, DAL). Geschäftslogik und nicht dauerhafte Daten können vollständig in partiellen Klassen und Methoden von Entitäten und Datenkontext implementiert werden, oder sie können in separaten Klassen implementiert werden.
 ...
 In ASP.NET-Anwendungen wird diese Komplexität größtenteils von <xref:System.Web.UI.WebControls.LinqDataSource> verwaltet. Weitere Informationen finden Sie unter [LinqDataSource Web Server Control Overview](https://docs.microsoft.com/previous-versions/aspnet/bb547113(v=vs.100)).
...
- [Datenabruf und CUD-Operationen in n-schichtigen Anwendungen (LINQ to SQL)](data-retrieval-and-cud-operations-in-n-tier-applications.md)
 ...
 Weitere Informationen zu n-tier-Anwendungen, die ADO.NET DataSets verwenden, finden Sie unter [Arbeiten mit Datasets in anwendungen mit n-Tier.](/visualstudio/data-tools/work-with-datasets-in-n-tier-applications)
