...
## <a name="downloading-management-studio-express"></a>Herunterladen von Management Studio Express  
 Wenn Sie möchten eine Datenbank zu ändern, die Sie heruntergeladen haben, können Sie die Datenbank zugreifen **Server-Explorer** in Visual Studio integrierte Entwicklungsumgebung (IDE) oder Microsoft SQL Server Management Studio Express (SSMSE) verwenden .  
