...
|<xref:System.Data.Linq.Mapping.AssociationAttribute.DeleteRule%2A>|Zeichenfolge|None|Fügt einer Zuordnung ein Löschverhalten hinzu.|  
...
|Eigenschaft|Typ|Default|Beschreibung|  
|--------------|----------|-------------|-----------------|  
|<xref:System.Data.Linq.Mapping.ParameterAttribute.DbType%2A>|Zeichenfolge|None|Gibt den Datenbanktyp an.|  
