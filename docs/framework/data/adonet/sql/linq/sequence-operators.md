...
---
# <a name="sequence-operators"></a><span data-ttu-id="d8ce1-102">Sequenzoperatoren</span><span class="sxs-lookup"><span data-stu-id="d8ce1-102">Sequence Operators</span></span>
<span data-ttu-id="d8ce1-103">Im Allgemeinen unterstützt [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] keine Sequenzoperatoren, die über eine oder mehrere der folgenden Qualitäten verfügen:</span><span class="sxs-lookup"><span data-stu-id="d8ce1-103">Generally speaking, [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] does not support sequence operators that have one or more of the following qualities:</span></span>  
  
-   <span data-ttu-id="d8ce1-104">Annehmen eines Lambda mit einem Indexparameter.</span><span class="sxs-lookup"><span data-stu-id="d8ce1-104">Take a lambda with an index parameter.</span></span>  
  
-   <span data-ttu-id="d8ce1-105">Verwenden der Eigenschaften sequenzieller Zeilen, wie <xref:System.Linq.Queryable.TakeWhile%2A>.</span><span class="sxs-lookup"><span data-stu-id="d8ce1-105">Rely on the properties of sequential rows, such as <xref:System.Linq.Queryable.TakeWhile%2A>.</span></span>  
  
-   <span data-ttu-id="d8ce1-106">Verwenden einer beliebigen CLR-Implementierung, z. B. <xref:System.Collections.Generic.IComparer%601>.</span><span class="sxs-lookup"><span data-stu-id="d8ce1-106">Rely on an arbitrary CLR implementation, such as <xref:System.Collections.Generic.IComparer%601>.</span></span>  
  
|<span data-ttu-id="d8ce1-107">Beispiele für nicht unterstützte Elemente</span><span class="sxs-lookup"><span data-stu-id="d8ce1-107">Examples of Unsupported</span></span>|  
|-----------------------------|  
...
## <a name="differences-from-net"></a><span data-ttu-id="d8ce1-108">Unterschiede zu .NET</span><span class="sxs-lookup"><span data-stu-id="d8ce1-108">Differences from .NET</span></span>  
 <span data-ttu-id="d8ce1-109">Alle unterstützten Sequenzoperatoren funktionieren in der Common Language Runtime (CLR) wie erwartet, außer `Average`.</span><span class="sxs-lookup"><span data-stu-id="d8ce1-109">All supported sequence operators work as expected in the common language runtime (CLR) except for `Average`.</span></span> `Average` <span data-ttu-id="d8ce1-110">Gibt einen Wert des gleichen Typs wie der Typ, dessen Durchschnitt ermittelt wird, zurück, wohingegen in der CLR `Average` gibt immer einen <xref:System.Double> oder <xref:System.Decimal>.</span><span class="sxs-lookup"><span data-stu-id="d8ce1-110">returns a value of the same type as the type being averaged, whereas in the CLR `Average` always returns either a <xref:System.Double> or a <xref:System.Decimal>.</span></span> <span data-ttu-id="d8ce1-111">Wird das Quellargument explizit in double/decimal oder wird der Selector in double/decimal umgewandelt, weist auch die resultierende SQL diese Umwandlung auf, und das Ergebnis entspricht den Erwartungen.</span><span class="sxs-lookup"><span data-stu-id="d8ce1-111">If the source argument is explicitly cast to double / decimal or the selector casts to double / decimal, the resulting SQL will also have such a conversion and the result will be as expected.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="d8ce1-112">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="d8ce1-112">See also</span></span>

- [<span data-ttu-id="d8ce1-113">Datentypen und Funktionen</span><span class="sxs-lookup"><span data-stu-id="d8ce1-113">Data Types and Functions</span></span>](../../../../../../docs/framework/data/adonet/sql/linq/data-types-and-functions.md)
