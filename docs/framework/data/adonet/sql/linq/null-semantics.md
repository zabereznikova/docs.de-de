...
Die folgende Tabelle enthält Links zu verschiedenen Bestandteile der [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] Dokumentation, in denen `null` (`Nothing` in Visual Basic) werden Probleme erläutert.  
  
|Thema|Beschreibung|  
|-----------|-----------------|  
|[SQL-CLR-Typenkonflikte](../../../../../../docs/framework/data/adonet/sql/linq/sql-clr-type-mismatches.md)|Der Abschnitt "Null-Semantik" dieses Themas umfasst Informationen zum dreistufigen SQL-Boolean und die common Language Runtime (CLR) von zwei Status <xref:System.Boolean>, das Literal `Nothing` (Visual Basic) und `null` (c#), sowie zu ähnliche Aspekten.|  
