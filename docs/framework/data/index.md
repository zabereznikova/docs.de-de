---
title: "Daten und Modellierung in .NET&#160;Framework | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - ".NET Framework, Datenzugriff"
  - "Daten [.NET Framework], Aufrufen"
  - "Datenzugriff [.NET Framework], Informationen über den .NET Framework-Datenzugriff"
...
## In diesem Abschnitt  
 ...
 [LINQ Portal](http://msdn.microsoft.com/de-de/6eb15c76-4ee6-4146-981e-b3429a945e6f)  
 Enthält Links zu relevanter Dokumentation für sprachintegrierte Abfrage \(Language\-Integrated Query, LINQ\).  
  
 [Transaktionsverarbeitung ](../../../docs/framework/data/transactions/index.md)  
...
## Verwandte Abschnitte  
 [Microsoft SQL Server\-Modellierungstechnologien](http://go.microsoft.com/fwlink/?LinkId=193039)  
