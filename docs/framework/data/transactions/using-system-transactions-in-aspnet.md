...
```  
 ...
 [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] [add-Element für zu kompilierende Assemblys (ASP.NET-Einstellungsschema)](http://msdn.microsoft.com/en-us/602197e8-108d-4249-b752-ba2a318f75e4)erteilt wird.  
