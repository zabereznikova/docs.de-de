---
title: "Optimierung mit Einphasencommit und heraufstufbarer Einphasenbenachrichtigung  | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
>  Die **TransactionCommitted**\-Ablaufverfolgungen \(die generiert werden, wenn ein Commit für die eskalierte Transaktion aufgerufen wird\) enthalten die Aktivitäts\-ID der DTC\-Transaktion.  
 ...
 Weitere Informationen zur Verwaltungseskalation finden Sie unter [Eskalation der Transaktionsverwaltung ](../../../../docs/framework/data/transactions/transaction-management-escalation.md).  
