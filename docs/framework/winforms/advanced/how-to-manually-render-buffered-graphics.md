---
title: "Gewusst wie: Manuelles Rendern von gepufferten Grafiken | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "Flimmern, Reduzieren durch manuelles Wiedergeben von Grafiken"
  - "Grafiken [Windows Forms], Rendern"
...
1.  Rufen Sie einen Verweis auf eine Instanz der <xref:System.Drawing.BufferedGraphicsContext>\-Klasse ab.  Weitere Informationen finden Sie unter [Gewusst wie: Manuelles Verwalten von gepufferten Grafiken](../../../../docs/framework/winforms/advanced/how-to-manually-manage-buffered-graphics.md).  
