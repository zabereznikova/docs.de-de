...
|<xref:System.Windows.Forms.OpenFileDialog>|Bei Betriebssystemen mit der Größe von rechts nach links legen Sie die <xref:System.Windows.Forms.Control.RightToLeft>-Eigenschaft des enthaltenden Formulars auf fest, um <xref:System.Windows.Forms.RightToLeft.Yes?displayProperty=nameWithType> das Dialogfeld zu lokalisieren |Keine Auswirkung|Nein|
