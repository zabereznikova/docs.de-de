...
ms.locfileid: "67505008"
---
# <a name="using-transformations-in-managed-gdi"></a>Verwenden von Transformationen in Managed GDI+
Affine Transformationen enthalten, drehen, skalieren, spiegeln, Verzerrens, und verschieben. In GDI + die <xref:System.Drawing.Drawing2D.Matrix> -Klasse bildet die Grundlage für die Ausführung von affine Transformations auf Vektor-Zeichnungen, Bilder und Text.  
