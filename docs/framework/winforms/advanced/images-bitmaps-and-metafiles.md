...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Erläutert die verschiedenen Bildformate.  
  
 [Metadateien in GDI+](../../../../docs/framework/winforms/advanced/metafiles-in-gdi.md)  
 Erläutert die [!INCLUDE[ndptecgdiplus](../../../../includes/ndptecgdiplus-md.md)]-Unterstützung für Metadateien.  
  
 [Zeichnen, Positionieren und Klonen von Bildern in GDI+](../../../../docs/framework/winforms/advanced/drawing-positioning-and-cloning-images-in-gdi.md)  
 Erläutert Methoden für das Zeichnen von Vektor- und Rasterbildern mit verwaltetem Code.  
...
## <a name="related-sections"></a>Verwandte Abschnitte  
 ...
 Enthält Links zu Themen, die veranschaulichen, wie Bilder in Ihrer Anwendung verwendet werden.
