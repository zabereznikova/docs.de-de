...
## <a name="specify-whether-a-component-is-a-member-of-the-form"></a>Gibt an, ob eine Komponente des Formulars angehört

1. Öffnen Sie in Visual Studio im Windows Forms-Designer das Formular ein.
