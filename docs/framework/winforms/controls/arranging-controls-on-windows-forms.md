...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Beschreibt, wie Sie mithilfe von Steuerelementen in Formularen platzieren können die <xref:System.Windows.Forms.Control.Margin%2A>, <xref:System.Windows.Forms.Control.Padding%2A>, und <xref:System.Windows.Forms.Control.AutoSize%2A> Eigenschaften innerhalb der **Formulardesigner**.  
