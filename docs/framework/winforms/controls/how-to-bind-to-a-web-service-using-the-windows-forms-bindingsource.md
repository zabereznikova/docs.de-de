...
---
# <a name="how-to-bind-to-a-web-service-using-the-windows-forms-bindingsource"></a>Vorgehensweise: Binden Sie an einen Webdienst mithilfe der BindingSource in Windows Forms
