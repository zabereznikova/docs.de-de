...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Führt die allgemeinen Konzepte der `NotifyIcon`-Komponente ein, die es Benutzern ermöglicht, Symbole für Prozesse anzuzeigen, die im Hintergrund ausgeführt werden und keine Benutzeroberfläche haben.  
 ...
 Enthält Schritte zum Festlegen des Symbols, das von der `NotifyIcon` Komponente angezeigt wird.  
