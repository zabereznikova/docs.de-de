...
### <a name="to-change-the-column-order-using-the-designer"></a>So ändern Sie die Spaltenreihenfolge, die mithilfe des Designers  
...
3.  Klicken Sie auf den nach-oben oder nach unten zeigenden Pfeil rechts neben der **ausgewählten Spalten** auflisten, bis die ausgewählte Spalte an der Position werden soll.  
