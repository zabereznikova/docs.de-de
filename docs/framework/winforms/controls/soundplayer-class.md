...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 [Vorgehensweise: Wiedergeben eines in eine Ressource aus Windows Form eingebetteten Sounds](how-to-play-a-sound-embedded-in-a-resource-from-a-windows-form.md)  
