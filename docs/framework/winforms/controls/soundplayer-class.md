...
## <a name="related-sections"></a>Verwandte Abschnitte  
 ...
 Siehe auch [HYPERLINK "http://msdn.microsoft.com/library/11bxex12 (110)" My.Computer-Objekt](http://msdn.microsoft.com/library/11bxex12\(v=vs.110\)) oder [My.Computer-Objekt](http://msdn.microsoft.com/library/11bxex12\(v=vs.120\)).
