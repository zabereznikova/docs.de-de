...
1.  Hinzufügen eines neuen Formulars mit dem Namen `ChildForm` zum Projekt.  
     ...
     Weitere Informationen finden Sie unter [Vorgehensweise: Hinzufügen von Windows Forms zu einem Projekt](http://msdn.microsoft.com/library/3d7bb25f-fd90-47cf-9378-fa0d764686c1).  
...
4.  Klicken Sie auf **neu** mehrmals.  
     ...
     Die untergeordneten Formulare werden automatisch aufgelistet, unter der W**inzufügen** Menüelement, da die <xref:System.Windows.Forms.MenuStrip> des Steuerelements <xref:System.Windows.Forms.MenuStrip.MdiWindowListItem%2A> -Eigenschaft zugewiesen wird.  
