...
---
# <a name="how-to-set-the-text-displayed-by-a-windows-forms-control-using-the-designer"></a>Vorgehensweise: Legen Sie den Text von einer Windows Forms-Steuerelement mithilfe des Designers
