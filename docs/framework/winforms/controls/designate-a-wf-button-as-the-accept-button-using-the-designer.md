...
- [Vorgehensweise: Festlegen einer Windows Forms Schaltfläche als Schaltfläche "Abbrechen" mithilfe des Designers](designate-a-wf-button-as-the-cancel-button-using-the-designer.md)
