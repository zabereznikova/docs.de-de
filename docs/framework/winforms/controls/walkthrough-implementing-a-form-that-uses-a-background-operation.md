...
## <a name="create-a-form-that-uses-a-background-operation"></a>Erstellen eines Formulars, das eine Hintergrundoperation verwendet

1. Erstellen Sie in Visual Studio ein Windows-basierten Anwendung mit dem Namen `BackgroundWorkerExample` (**Datei** > **neu** > **Projekt**  >  **Visual C#**  oder **Visual Basic** > **Klassischer Desktop** > **Windows Forms Anwendung**).
...
## <a name="create-a-backgroundworker-with-the-designer"></a>Erstellen Sie einen Workerprozess im Hintergrund mit dem Designer
...
### <a name="implement-progress-reporting"></a>Implementieren Sie statusberichterstellung
...
### <a name="implement-support-for-cancellation"></a>Implementieren der Unterstützung für Abbrüche
...
Drücken Sie **F5** zum Kompilieren und Ausführen der Anwendung.
