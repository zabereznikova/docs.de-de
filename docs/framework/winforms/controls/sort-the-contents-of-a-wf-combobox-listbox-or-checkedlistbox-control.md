---
title: 'Gewusst wie: Sortieren des Inhalts eines ComboBox-, ListBox- oder CheckedListBox-Steuerelements in Windows Forms'
ms.date: 03/30/2017
helpviewer_keywords:
...
Werden von datengebundenen Windows Forms-Steuerelemente nicht sortieren. Um sortierte Daten anzuzeigen, verwenden Sie eine Datenquelle, die das Sortieren unterstützt, und lassen Sie dann auf die Datenquelle, die es zu sortieren. Datenquellen, die das Sortieren unterstützt werden, Datenansichten, Manager anzeigen und Arrays sortiert.  
  
 Wenn das Steuerelement nicht datengebunden ist, können Sie ihn sortieren.  
  
### <a name="to-sort-the-list"></a>Um die Liste zu sortieren.  
  
1.  Legen Sie die `Sorted`-Eigenschaft auf `true` fest.  
  
     Mit dieser Einstellung werden alle vorhandenen Listenelemente in sortierter Reihenfolge neu angeordnet.  
