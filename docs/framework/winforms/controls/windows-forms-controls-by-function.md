...
|Die Datenbindung und navigation|<xref:System.Windows.Forms.BindingSource> component|Vereinfacht Binden von Steuerelementen in einem Formular an Daten durch währungsverwaltung, änderungsbenachrichtigung und andere Dienste.|  
...
|Benutzerhilfe|<xref:System.Windows.Forms.HelpProvider> component|Stellt Popup-oder Onlinehilfe für Steuerelemente bereit.|  
||<xref:System.Windows.Forms.ToolTip> component|Stellt ein Popupfenster, das eine kurze Beschreibung des Zwecks eines Steuerelements anzeigt, wenn der Benutzer den Zeiger auf das Steuerelement gezeigt.|  
