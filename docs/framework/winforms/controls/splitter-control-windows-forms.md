...
> [!NOTE]
>  Obwohl <xref:System.Windows.Forms.SplitContainer> ersetzt und funktionell erweitert, um die `Splitter` -Steuerelement früherer Versionen `Splitter` wird für Abwärtskompatibilität und für zukünftige Verwendung beibehalten, falls gewünscht.  
