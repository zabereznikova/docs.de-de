---
title: "DataGridView-Steuerelement (Windows Forms) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "Datasets [Windows Forms], Anzeigen im DataGridView-Steuerelement"
  - "Datasets [Windows Forms], Benutzeroberfläche"
  - "Grid-Steuerelemente [Windows Forms]"
  - "Tabellen [Windows Forms]"
  - "Tabellarische Daten, Anzeigen in Windows Forms"
...
## In diesem Abschnitt  
 ...
 Siehe auch [Verwenden des Designers mit dem DataGridView\-Steuerelement in Windows Forms](http://msdn.microsoft.com/library/ms171593\(v=vs.110\)).  
