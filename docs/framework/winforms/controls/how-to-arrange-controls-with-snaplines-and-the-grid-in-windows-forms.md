...
-   Wählen Sie die **SnapToGrid** Layoutmodus in Windows Forms-Designer **Optionen** (Dialogfeld).  
     ...
     Weitere Informationen finden Sie unter [Allgemein, Windows Forms-Designer, Optionen (Dialogfeld)](http://msdn.microsoft.com/en-us/8dd170af-72f0-4212-b04b-034ceee92834). Alle Steuerelemente auszurichten selbst jetzt entlang der Punkte im Raster.  
