...
1.  Legen Sie die <xref:System.Windows.Forms.RichTextBox.Text%2A> -Eigenschaft in eine Zeichenfolge, die eine gültige URL enthält (z. B. "http://www.microsoft.com/").  
