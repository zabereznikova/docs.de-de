...
Beschreibt die Eigenschaften von <xref:System.Windows.Forms.Control.Margin%2A> und <xref:System.Windows.Forms.Control.Padding%2A> sowie deren Rollen im Layout.
...
Veranschaulicht, wie Sie die <xref:System.Windows.Forms.Control.Dock%2A>-Eigenschaft verwenden, um das Steuerelement an der Kante des Formulars auszurichten, das es einnimmt.
...
Veranschaulicht, wie die <xref:System.Windows.Forms.Control.Padding%2A>-Eigenschaft verwendet wird, um ein Steuerelement zu gliedern.
