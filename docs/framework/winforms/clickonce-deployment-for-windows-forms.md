...
In den folgenden Themen wird ClickOnce beschrieben, eine Technologie, die für die einfache Bereitstellung von Windows Forms Anwendungen auf Client Computern verwendet wird.  
...
## <a name="related-sections"></a>Verwandte Abschnitte  
 ...
 Bietet mehrere Optionen für die Bereitstellung von ClickOnce-Anwendungen.  
  
 [Auswählen einer Strategie für die ClickOnce-Aktualisierung](/visualstudio/deployment/choosing-a-clickonce-update-strategy)  
 Bietet mehrere Optionen zum Aktualisieren von ClickOnce-Anwendungen.  
 ...
 Beschreibt verschiedene Probleme, die beim Bereitstellen von ClickOnce-Anwendungen auftreten können, und dokumentiert die Fehlermeldungen der obersten Ebene, die von ClickOnce generiert werden könnten.  
  
 [ClickOnce und Anwendungseinstellungen](/visualstudio/deployment/clickonce-and-application-settings)  
 Beschreibt, wie die ClickOnce-Bereitstellung mit Anwendungseinstellungen funktioniert, in denen Anwendungs-und Benutzereinstellungen für den zukünftigen Abruf gespeichert werden.  
 ...
 Beschreibt ein ClickOnce-Feature, mit dem vertrauenswürdige Anwendungen auf Client Computern mit einer höheren Berechtigungsstufe ausgeführt werden können.  
 ...
 Veranschaulicht die Verwendung von Befehlszeilen-und SDK-Tools zum Bereitstellen einer ClickOnce-Anwendung ohne Verwendung von Visual Studio.  
 ...
 Beschreibt, wie Sie über eine ClickOnce-Anwendung auf lokale Datendateien und Remote Datenquellen zugreifen.  
 ...
 Veranschaulicht, wie Sie eine Datei so markieren, dass Sie im ClickOnce-Datenverzeichnis verfügbar ist.  
