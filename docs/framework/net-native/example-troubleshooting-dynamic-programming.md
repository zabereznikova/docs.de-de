...
```  
 ...
 In diesem Fall wurde das Problem durch Hinzufügen einer Laufzeitdirektive für `App.Core.ViewModels` behoben. Die Grundursache war ein API-Aufruf an die <xref:System.Type.GetType%28System.String%29?displayProperty=fullName>-Methode, die **NULL** zurückgegeben hat. Die App hat das Problem ignoriert, bis ein Absturz aufgetreten ist.  
