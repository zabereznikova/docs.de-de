---
title: "Beispiel: Problembehandlung bei dynamischer Programmierung | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 In diesem Fall wurde das Problem durch Hinzufügen einer Laufzeitdirektive für `App.Core.ViewModels` behoben.  Die Ursache war ein API\-Aufruf an die <xref:System.Type.GetType%28System.String%29?displayProperty=fullName>\-Methode, die **null** zurückgegeben hat. Die App hat das Problem ignoriert, bis ein Absturz aufgetreten ist.  
  
 In der dynamischen Programmierung empfiehlt sich bei Verwendung von Reflektions\-APIs unter [!INCLUDE[net_native](../../../includes/net-native-md.md)] die Verwendung der <xref:System.Type.GetType%2A?displayProperty=fullName>\-Überladungen, die bei einem Fehler eine Ausnahme ausgelösen.  
