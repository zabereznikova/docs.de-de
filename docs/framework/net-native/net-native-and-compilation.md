---
title: ".NET Native und Kompilierung | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## .NET Native: Generieren von systemeigenen Binärdateien  
...
## .NET Native\- und JIT\-Kompilierung \(Just\-In\-Time\)  
...
-   "mrt100\_app.dll": Eine umgestaltete Common Language Runtime, die Laufzeitdienste wie die Garbage Collection bereitstellt.  
  
 Alle Abhängigkeiten werden vom APPX\-Manifest der App erfasst.  Zusätzlich zur EXE\- und DLL\-Datei der Anwendung sowie zur Datei "mrt100\_app.dll", die direkt im AppX\-Paket gebündelt werden, sind zwei weitere Dateien enthalten:  
  
-   „msvcr140\_app.dll“: Die von der Datei „mrt100\_app.dll“ verwendete C\-Laufzeitbibliothek \(CRT\).  Sie ist über einen Frameworkverweis in das Paket einbezogen.  
  
-   "mrt100.dll":  Diese Bibliothek enthält Funktionen, die die Leistung der Datei "mrt100\_app.dll" verbessern können, obwohl die Funktionalität der Datei "mrt100\_app.dll" nicht verhindert wird, wenn diese Bibliothek nicht vorhanden ist.  Wenn die Bibliothek verfügbar ist, wird sie auf dem lokalen Computer aus dem Verzeichnis "system32" geladen.  
...
## .NET Native und NGEN  
 Der [Native Image Generator](../../../docs/framework/tools/ngen-exe-native-image-generator.md) \(NGEN\) kompiliert Assemblys in systemeigenen Code und installiert sie auf dem lokalen Computer im Cache für systemeigene Images.  Obwohl NGEN wie .NET Native systemeigenen Code erzeugt, unterscheidet sich NGEN jedoch in einigen entscheidenden Punkten von .NET Native:  
...
## Siehe auch  
 ...
 [Allgemeine Problembehandlung für .NET Native](../../../docs/framework/net-native/net-native-general-troubleshooting.md)