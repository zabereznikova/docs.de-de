---
title: "Laufzeitdirektiven-Konfigurationsdatei (rd.xml) Referenz | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Laufzeitdirektiven-Konfigurationsdatei (rd.xml) Referenz
Eine Laufzeitdirektivendatei \(.rd.xml\) ist eine XML\-Konfigurationsdatei, die angibt, ob bestimmte Programmelemente für die Reflektion verfügbar sind.  Im Folgenden ist ein Beispiel einer Laufzeitdirektivendatei angegeben:  
...
## Die Struktur einer Laufzeitdirektivendatei  
 Die Laufzeitdirektivendatei verwendet den Namespace `http://schemas.microsoft.com/netfx/2013/01/metadata`.  
  
 Das Stammelement ist das [Directives](../../../docs/framework/net-native/directives-element-net-native.md)\-Element.  Es kann null oder mehr [Library](../../../docs/framework/net-native/library-element-net-native.md)\-Elemente enthalten und null oder ein [Application](../../../docs/framework/net-native/application-element-net-native.md)\-Element, wie in der folgenden Struktur dargestellt.  Die Attribute des [Application](http://msdn.microsoft.com/de-de/2a038172-1ad5-47b7-a8db-79b2f1212f0a)\-Elements können eine anwendungsweite Laufzeitreflektionsrichtlinie definieren oder als Container für untergeordnete Elemente dienen.  Das [Library](../../../docs/framework/net-native/library-element-net-native.md)\-Element ist lediglich ein Container.  Die untergeordneten Elemente der Elemente [Application](../../../docs/framework/net-native/application-element-net-native.md) und [Library](../../../docs/framework/net-native/library-element-net-native.md) definieren die Typen, Methoden, Felder, Eigenschaften und Ereignisse, die für die Reflektion verfügbar sind.  
  
 Um Referenzinformationen anzuzeigen, wählen Sie Elemente aus der folgenden Struktur, oder lesen Sie unter [Elemente der Laufzeitrichtlinie](../../../docs/framework/net-native/runtime-directive-elements.md) nach.  In der folgenden Hierarchie kennzeichnet die Ellipse eine rekursive Struktur.  Die Informationen in Klammern zeigen an, ob dieses Element optional oder erforderlich ist, und wenn es verwendet wird, wie viele Instanzen \(eine oder viele\) zulässig sind.  
...
.  .  .    
 ...
 Das [Application](../../../docs/framework/net-native/application-element-net-native.md)\-Element kann entweder keine Attribute oder die im [Abschnitt zu Laufzeitdirektiven und \-richtlinien](#Directives) beschriebenen Richtlinienattribute besitzen.  
  
 Ein [Library](../../../docs/framework/net-native/library-element-net-native.md)\-Element verfügt über ein einzelnes Attribut, `Name`, das den Namen einer Bibliothek oder Assembly ohne Dateierweiterung angibt.  Das folgende [Library](../../../docs/framework/net-native/library-element-net-native.md)\-Element gilt z. B. für eine Assembly namens Extensions.dll.  
...
<a name="Directives"></a>   
## Laufzeitdirektiven und \-richtlinien  
...
### Festlegen von Richtlinien für Assemblys, Namespaces und Typen  
...
### Festlegen von Richtlinien für Member  
...
### Wenn zwei Direktiven Richtlinien auf das gleiche Programmelement anwenden  
...
### Wenn die untergeordneten und übergeordneten Elemente denselben Richtlinientyp anwenden  
...
### Wenn offene generische Typen und instanziierte Elemente denselben Richtlinientyp anwenden  
...
### Wie die Richtlinie abgeleitet wird  
...
#### Auswirkungen der Browse\-Richtlinie  
...
#### Auswirkungen der Dynamic\-Richtlinie  
...
#### Auswirkungen der Activation\-Richtlinie  
...
#### Auswirkungen der Serialize\-Richtlinie  
...
#### Auswirkungen der Richtlinien XmlSerializer, DataContractSerializer und DataContractJsonSerializer  
 ...
 Weitere Informationen finden Sie im Abschnitt "Unterschiede der Serialisierungsprogramme" in [Migrieren der Windows Store\-App auf .NET Native](../../../docs/framework/net-native/migrating-your-windows-store-app-to-net-native.md).  
