...
```  
 ...
 Der Quellcode für das Beispiel lautet wie folgt. Die `outputBlock`-Variable stellt ein [TextBlock](http://msdn.microsoft.com/library/windows.ui.xaml.controls.textblock.aspx)-Steuerelement dar.  
