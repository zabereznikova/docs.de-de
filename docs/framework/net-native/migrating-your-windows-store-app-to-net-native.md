...
Der .net Native-Compiler kann auch häufig verwendete generische Typen verarbeiten <xref:System.Collections.Generic.List%601> , z <xref:System.Collections.Generic.Dictionary%602> . b. und, die ohne Hinweise oder Anweisungen funktionieren. Das [dynamic](../../csharp/language-reference/builtin-types/reference-types.md#the-dynamic-type) -Schlüsselwort wird ebenfalls innerhalb bestimmter Grenzen unterstützt.
...
- Wenn die Anzahl der Argumente falsch ist und der Typ eines der Argumente falsch ist, löst .net Native eine anstelle eines aus <xref:System.ArgumentException> <xref:System.Reflection.TargetParameterCountException> .
...
- Werttypen größer als 1 Megabyte werden nicht unterstützt.

- Werttypen dürfen in .net Native keinen Parameter losen Konstruktor aufweisen. (In c# und Visual Basic werden Parameter lose Konstruktoren für Werttypen untersagt. Allerdings können diese in IL erstellt werden.)
 ...
 **Nicht mehr unterstützte APIs**
 ...
 Als veraltet markierte APIs für das Marshalling `VARIANT` gehören:
...
Als veraltet markierte APIs in der- <xref:System.Runtime.InteropServices.ICustomQueryInterface?displayProperty=nameWithType> Schnittstelle, die in .net Native nicht unterstützt werden, umfassen Folgendes:
...
In diesem Abschnitt werden die verbleibenden APIs aufgelistet, die in .net Native nicht unterstützt werden. Die größte Gruppe von nicht unterstützten APIs sind die Windows Communication Foundation (WCF)-APIs.
...
Die Typen in den [System. Service Model. *-Namespaces](xref:System.ServiceModel) werden in .net Native nicht unterstützt. Hierzu gehören die folgenden Typen:
