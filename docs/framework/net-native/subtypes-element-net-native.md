---
title: "&lt;Untertypen&gt; Element (.NET Native) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 Aufgrund der der `<Subtypes>` -Direktive, die den folgenden Code hinzu, eine `Derived1` -Instanz dynamisch durch Aufrufen der <xref:System.Activator.CreateInstance%28System.Type%29?displayProperty=fullName> -Methode erfolgreich ausgeführt wird.  Die Blockvariable ist hier ein <xref:System.Windows.Controls.TextBlock> Objekt in eine leere Windows Store-app.  
