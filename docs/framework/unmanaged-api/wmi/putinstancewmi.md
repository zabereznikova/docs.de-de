...
`pInst`\
[in] Ein Zeiger auf die Instanz geschrieben werden.
...
|---------|---------|---------|
| `WBEM_FLAG_USE_AMENDED_QUALIFIERS` | 0x20000 | Wenn festgelegt, WMI keine keine Qualifizierer mit speichert die **Amended** Flavor. <br> Wenn dies nicht festgelegt ist, wird davon ausgegangen, dass dieses Objekt ist nicht lokalisiert werden soll, und alle Qualifizierer werden mit dieser Instanz gespeichert. |
