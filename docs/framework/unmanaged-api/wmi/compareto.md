...
`pCompareTo`\
in Das Objekt für den Vergleich. `pCompareTo` muss eine gültige [IWbemClassObject](/windows/desktop/api/wbemcli/nn-wbemcli-iwbemclassobject) -Instanz sein. Es kann nicht `null`werden.
