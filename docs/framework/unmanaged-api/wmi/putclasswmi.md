...
|Konstante  |Wert  |Beschreibung  |
|---------|---------|---------|
| `WBEM_E_ACCESS_DENIED` | 0x80041003 | Der Benutzer besitzt keine Berechtigung zum Erstellen oder Ändern von Klassen. |
| `WBEM_E_FAILED` | 0x80041001 | Ein Unbekannter Fehler aufgetreten. |
| `WBEM_E_INVALID_CLASS` | 0x80041010 | Die angegebene Klasse ist ungültig. In der Regel gibt dies an, dass `pObject` ein Instanzobjekt angibt. |
