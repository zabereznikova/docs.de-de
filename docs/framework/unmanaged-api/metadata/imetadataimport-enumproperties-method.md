...
## <a name="parameters"></a>Parameter  
 ...
 `td`  
 [in] Eine TypeDef-Token, das den Typ mit Eigenschaften auflisten darstellt.  
...
|`S_FALSE`|Es gibt keine Token aufgelistet werden. In diesem Fall `pcProperties` ist 0 (null).|  
