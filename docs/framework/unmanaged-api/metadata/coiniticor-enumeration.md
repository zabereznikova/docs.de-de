...
Gibt Konstanten an, die von [CoInitializeCor](../../../../docs/framework/unmanaged-api/hosting/coinitializecor-function.md) verwendet werden, wenn die Common Language Runtime initialisiert wird.  
