...
|MetaDataNotificationForTokenMovement|Steuert, welche tokenumwandlung während einer Metadatenzusammenführung die Rückrufe generieren. Verwenden Sie die [IMetaDataEmit:: Setter](imetadataemit-sethandler-method.md) -Methode, um die [IMapToken](imaptoken-interface.md) -Schnittstelle einzurichten.|Muss eine Variante vom Typ UI4 sein und muss eine Kombination der Werte der [CorNotificationForTokenMovement](cornotificationfortokenmovement-enumeration.md) -Enumeration enthalten.|  
