...
Wird aufgerufen, wenn ein `catch` Block für eine Ausnahme in der Common Language Runtime (CLR) selbst gefunden wird. Diese Methode ist in der .NET Framework Version 2,0 veraltet.  
