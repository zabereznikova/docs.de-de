...
> [!NOTE]
>  Verwenden von .NET Framework-Versionen 2.0, 3.0 und 3.5 Profiler in den [!INCLUDE[net_v40_short](../../../../includes/net-v40-short-md.md)] und höheren Versionen muss die COMPLUS_ProfAPI_ProfilerCompatibilitySetting-Umgebungsvariable festgelegt.  
...
-   Wenn Sie die Variablen, in festgelegt eine [ICorDebug:: CreateProcess](../../../../docs/framework/unmanaged-api/debugging/icordebug-createprocess-method.md) Aufruf, sie gelten nur für die Anwendung, die Sie zu dem Zeitpunkt ausgeführt werden. (Sie gelten auch für andere Anwendungen, die von dieser Anwendung gestartet werden und die die Umgebung erben.)  
