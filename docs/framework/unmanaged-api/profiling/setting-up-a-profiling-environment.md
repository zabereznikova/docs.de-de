...
- COR_ENABLE_PROFILING: Die CLR stellt nur dann eine Verbindung mit einem Profiler her, wenn diese Umgebungsvariable vorhanden und auf 1 festgelegt ist.  
  
- COR_PROFILER: Wenn die COR_ENABLE_PROFILING-Überprüfung abgeschlossen ist, stellt die CLR eine Verbindung mit dem Profiler her, der über diese CLSID oder ProgID verfügt, die zuvor in der Registrierung gespeichert werden muss. Die COR_PROFILER-Umgebungsvariable ist als Zeichenfolge definiert, wie in den beiden folgenden Beispielen gezeigt.  
...
> [!NOTE]
> Wenn Sie die .NET Framework-Versionen 2,0, 3,0 und 3,5 in den .NET Framework 4 und höheren Versionen verwenden möchten, müssen Sie die Umgebungsvariable COMPLUS_ProfAPI_ProfilerCompatibilitySetting festlegen.  
