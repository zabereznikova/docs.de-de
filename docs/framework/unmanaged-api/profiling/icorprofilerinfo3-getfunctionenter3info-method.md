...
## <a name="parameters"></a>Parameters  
 ...
 `eltInfo`  
 [in] Ein nicht transparentes Handle, das Informationen über einen bestimmten Stapelrahmen entspricht. Der Profiler sollte denselben `eltInfo` bereitstellen, der von der [FunctionEnter3WithInfo](functionenter3withinfo-function.md) -Funktion angegeben wurde.  
