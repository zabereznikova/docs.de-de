...
## <a name="parameters"></a>Parameter  
 ...
 `pReJitId`  
 [in] Die Identität der erneut JIT-kompilierten Funktion. The identity must be zero in the .NET Framework 4.5.  
