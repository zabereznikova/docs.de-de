...
- `pbHookFunction`
  ...
  \[out] ein Zeiger auf einen Wert, den der Profiler auf `true` festlegt, wenn er `FunctionEnter2`, `FunctionLeave2`und `FunctionTailcall2` Rückrufe empfangen möchte. Andernfalls wird dieser Wert auf `false`festgelegt.
