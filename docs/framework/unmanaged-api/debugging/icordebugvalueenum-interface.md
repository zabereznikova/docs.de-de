...
|------------|-----------------|  
|[Next-Methode](icordebugvalueenum-next-method.md)|Ruft die angegebene Anzahl von `ICorDebugValue` Instanzen aus der-Enumeration ab der aktuellen Position ab.|  
