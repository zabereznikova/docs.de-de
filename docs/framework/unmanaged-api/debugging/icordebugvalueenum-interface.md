...
|------------|-----------------|  
|[Next-Methode](../../../../docs/framework/unmanaged-api/debugging/icordebugvalueenum-next-method.md)|Ruft die angegebene Anzahl von `ICorDebugValue` -Instanzen ab der aktuellen Position aus der-Enumeration ab.|  
