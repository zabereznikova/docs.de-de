...
---
# <a name="icordebugobjectvaluegetvirtualmethod-method"></a>ICorDebugObjectValue::GetVirtualMethod-Methode
`GetVirtualMethod` in dieser Version von .NET Framework ist nicht implementiert werden.  
