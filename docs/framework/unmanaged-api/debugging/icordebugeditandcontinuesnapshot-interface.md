...
ms.locfileid: "61989100"
---
# <a name="icordebugeditandcontinuesnapshot-interface"></a>ICorDebugEditAndContinueSnapshot-Schnittstelle

`ICorDebugEditAndContinueSnapshot` ist veraltet. Verwenden Sie diese Schnittstelle nicht.  
