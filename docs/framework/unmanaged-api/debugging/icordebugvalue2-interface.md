...
|------------|-----------------|  
|[GetExactType-Methode](../../../../docs/framework/unmanaged-api/debugging/icordebugvalue2-getexacttype-method.md)|Ruft einen Schnittstellen Zeiger auf ein `ICorDebugType` Objekt ab, das die <xref:System.Type> dieses Werts darstellt.|  
