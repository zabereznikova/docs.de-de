...
ICorDebugEnum-Methoden implementiert, und listet Objektarrays nach ihrer relativen virtuellen Adresse (RVA).  
  
## <a name="methods"></a>Methoden  
  
|Methode|Beschreibung|  
|------------|-----------------|  
|[Next-Methode](../../../../docs/framework/unmanaged-api/debugging/icordebugobjectenum-next-method.md)|Ruft die RVA, der die angegebene Anzahl von Objekten aus der Enumeration, beginnend mit der aktuellen Position ab.|  
