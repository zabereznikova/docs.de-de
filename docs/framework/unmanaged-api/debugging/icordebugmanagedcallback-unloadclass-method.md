...
## <a name="parameters"></a>Parameter  
 `pAppDomain`  
 [in] Ein Zeiger auf ein ICorDebugAppDomain-Objekt, das die Anwendungsdomäne, die mit der Klasse darstellt.  
  
 `c`  
 [in] Ein Zeiger auf ein ICorDebugClass-Objekt, das die Klasse darstellt.  
  
## <a name="remarks"></a>Hinweise  
 Die Klasse darf nicht nach dem Aufruf verwiesen werden.  
