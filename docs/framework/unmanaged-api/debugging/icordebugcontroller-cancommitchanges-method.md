...
ms.locfileid: "73125460"
---
# <a name="icordebugcontrollercancommitchanges-method"></a>ICorDebugController::CanCommitChanges-Methode

`CanCommitChanges` ist veraltet. Diese Methode nicht aufzurufen.
