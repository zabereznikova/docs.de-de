...
---
# <a name="icordebugeditandcontinueerrorinfogettoken-method"></a>ICorDebugEditAndContinueErrorInfo::GetToken-Methode
`GetToken` ist veraltet. Diese Methode nicht aufzurufen.  
