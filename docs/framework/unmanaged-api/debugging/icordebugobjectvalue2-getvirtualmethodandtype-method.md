...
## <a name="remarks"></a>Hinweise  
 Ruft Schnittstellenzeiger auf die "ICorDebugFunction" und "ICorDebugType"-Instanzen, die am stärksten abgeleitete Methode und Typ für den angegebenen Parameterverweis darstellen.  
