...
|[MANAGED_EXCEPTION_CATCH_HANDLER_FOUND](cordebugrecordformat-enumeration.md)|Die Code Adresse, an der `catch` handlerausführung in dem Frame gestartet wird, der von der [getstackpointer](icordebugexceptiondebugevent-getstackpointer-method.md) -Methode angegeben wird.|  
