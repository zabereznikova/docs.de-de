...
---
# <a name="icordebugsymbolprovidergettypeprops-method"></a>Icordebugsymbolprovider:: gettypeer-Eigenschaften Methode
...
## <a name="remarks"></a>Hinweise  
 Um die erforderliche Größe des-Arrays des Typs `signature` zu erhalten, legen `cbSignature` Sie das-Argument `signature` auf 0 und auf **null**fest. Wenn die Methode zurückgegeben wird, enthält `pcbSignature` die Anzahl der für das `signature`-Array erforderlichen Bytes.  
