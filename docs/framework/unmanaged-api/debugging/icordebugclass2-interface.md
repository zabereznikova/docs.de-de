...
|------------|-----------------|  
|[<span data-ttu-id="fd16d-108">GetParameterizedType-Methode</span><span class="sxs-lookup"><span data-stu-id="fd16d-108">GetParameterizedType Method</span></span>](../../../../docs/framework/unmanaged-api/debugging/icordebugclass2-getparameterizedtype-method.md)|<span data-ttu-id="fd16d-109">Ruft die Typdeklaration für diese Klasse ab.</span><span class="sxs-lookup"><span data-stu-id="fd16d-109">Gets the type declaration for this class.</span></span>|  
|[<span data-ttu-id="fd16d-110">SetJMCStatus-Methode</span><span class="sxs-lookup"><span data-stu-id="fd16d-110">SetJMCStatus Method</span></span>](../../../../docs/framework/unmanaged-api/debugging/icordebugclass2-setjmcstatus-method.md)|<span data-ttu-id="fd16d-111">Für jede Methode dieser Klasse legt einen Wert, der angibt, ob die Methode den benutzerdefinierten Code ist.</span><span class="sxs-lookup"><span data-stu-id="fd16d-111">For each method of this class, sets a value that indicates whether the method is user-defined code.</span></span>|  
...
> [!NOTE]
>  <span data-ttu-id="fd16d-113">Diese Schnittstelle kann weder computerübergreifend noch prozessübergreifend remote aufgerufen werden.</span><span class="sxs-lookup"><span data-stu-id="fd16d-113">This interface does not support being called remotely, either cross-machine or cross-process.</span></span>  
