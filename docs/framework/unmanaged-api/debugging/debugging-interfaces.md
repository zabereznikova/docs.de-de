...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 [Iclrbinbugginglibraryprovider-Schnittstelle](iclrdebugginglibraryprovider-interface.md)\
 ...
 [ICorDebug-Schnittstelle](icordebugassembly-interface.md)\
 ...
 Erweitert die [ICorDebugAssembly](icordebugassembly-interface.md) -Schnittstelle logisch, um die Unterstützung für containerassemblys und ihre enthaltenen Assemblys **Nur auf .net Native verfügbar.**  
 ...
 [Icordebubugbreakpoint-Schnittstelle](icordebugbreakpoint-interface.md)\
 Stellt einen Haltepunkt in einer Funktion oder einen Beobachtungspunkt für einen Wert dar.  
  
 [Icordebubugbreakpointenum-Schnittstelle](icordebugbreakpointenum-interface.md)\
 ...
 [Icorentbugdatatarget-Schnittstelle](icordebugdatatarget-interface.md)\
 ...
 Erweitert logisch die [ICorDebug DataTarget](icordebugdatatarget-interface.md) -Schnittstelle. **Nur auf .net Native verfügbar.**  
  
 [ICorDebugDataTarget3-Schnittstelle](icordebugdatatarget3-interface.md)\
 Erweitert logisch die [ICorDebugDataTarget](icordebugdatatarget-interface.md) -Schnittstelle, um Informationen über geladene Module bereitzustellen. **Nur auf .net Native verfügbar.**  
  
 [Icordebugdebugevent-Schnittstelle](icordebugdebugevent-interface.md)\
 Definiert die Basisschnittstelle, von der alle `ICorDebug` Debug-Ereignisse abgeleitet werden. **Nur auf .net Native verfügbar.**  
 ...
 Erweitert die [icordebugdebugevent](icordebugdebugevent-interface.md) -Schnittstelle zur Unterstützung von Ausnahme Ereignissen. **Nur auf .net Native verfügbar.**  
 ...
 [ICorDebug-Schnittstelle](icordebugframeenum-interface.md)\
 ...
 [ICorDebug-Schnittstelle](icordebuggcreferenceenum-interface.md)\
 ...
 Stellt die Debugsymbolinformationen für ein Instanzfeld dar. **Nur auf .net Native verfügbar.**  
 ...
 Stellt Informationen zu einem geladenen Modul bereit. **Nur auf .net Native verfügbar.**  
 ...
 Stellt einen In-Memory-Puffer dar. **Nur auf .net Native verfügbar.**  
  
 [Icorentbugmergedassemblyrecord-Schnittstelle](icordebugmergedassemblyrecord-interface.md)\
 Enthält Informationen zu einer zusammengeführten Assembly. **Nur auf .net Native verfügbar.**  
 ...
 [Icordebutbugmodulebreakpoint-Schnittstelle](icordebugmodulebreakpoint-interface.md)\
 ...
 Erweitert die [icordebugdebugevent](icordebugdebugevent-interface.md) -Schnittstelle, um Ereignisse auf Modulebene zu unterstützen. **Nur auf .net Native verfügbar.**  
  
 [Icorentbugmoduleerumum-Schnittstelle](icordebugmoduleenum-interface.md)\
 ...
 Erweitert logisch die [ICorDebugProcess](icordebugprocess-interface.md) -Schnittstelle, um Funktionen wie das Decodieren verwalteter Debugereignisse zu ermöglichen, die in nativen Ausnahme-Debugereignissen und der Aufteilung virtueller Module **Nur auf .net Native verfügbar.**  
 ...
 Stellt die Debugsymbolinformationen für ein statisches Feld dar. **Nur auf .net Native verfügbar.**  
 ...
 [ICorDebug-Schnittstelle](icordebugstepperenum-interface.md)\
 ...
 Stellt Methoden bereit, die zum Abrufen von Debugsymbolinformationen verwendet werden können. **Nur auf .net Native verfügbar.**  
  
 [ICorDebugSymbolProvider2-Schnittstelle](icordebugsymbolprovider2-interface.md)\
 Erweitert logisch die [icordebugsymbolprovider](icordebugsymbolprovider-interface.md) -Schnittstelle, um zusätzliche Debugsymbolinformationen abzurufen. **Nur auf .net Native verfügbar.**  
 ...
 [Icorentbugthreaderum-Schnittstelle](icordebugthreadenum-interface1.md)\
 ...
 [Icorentbugtypeerum-Schnittstelle](icordebugtypeenum-interface.md)\
 ...
 [ICorDebug Value](icordebugvalue-interface.md) -\
 ...
 [Icordebutbugvaluebreakpoint](icordebugvaluebreakpoint-interface.md) -\
 Erweitert `ICorDebugBreakpoint`, um Zugriff auf bestimmte Werte zu ermöglichen.  
  
 [ICorDebug](icordebugvalueenum-interface.md) -\
 Implementiert `ICorDebugEnum`-Methoden und listet `ICorDebugValue`-Arrays auf.  
  
 [Icorentbugvariablehome-Schnittstelle](icordebugvariablehome-interface.md)\
 ...
 Ruft Debugsymbolinformationen für eine Variable ab. **Nur auf .net Native verfügbar.**  
  
 [Icorentbugvirtualunwinder-Schnittstelle](icordebugvirtualunwinder-interface.md)\
 Stellt Methoden bereit, um die Stapelentladung zu unterstützen. **Nur auf .net Native verfügbar.**  
