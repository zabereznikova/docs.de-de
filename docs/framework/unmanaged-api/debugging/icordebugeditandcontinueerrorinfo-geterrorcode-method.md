...
---
# <a name="icordebugeditandcontinueerrorinfogeterrorcode-method"></a>ICorDebugEditAndContinueErrorInfo::GetErrorCode-Methode
`GetErrorCode` ist veraltet. Rufen Sie diese Methode nicht.  
