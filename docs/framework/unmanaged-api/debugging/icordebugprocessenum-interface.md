...
|------------|-----------------|  
|[Next-Methode](../../../../docs/framework/unmanaged-api/debugging/icordebugprocessenum-next-method.md)|Ruft die angegebene Anzahl von `ICorDebugProcess` Instanzen aus der-Enumeration ab der aktuellen Position ab.|  
