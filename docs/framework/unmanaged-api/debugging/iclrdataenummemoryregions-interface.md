...
ms.locfileid: "33404887"
---
# <a name="iclrdataenummemoryregions-interface"></a>ICLRDataEnumMemoryRegions-Schnittstelle
...
|------------|-----------------|  
|[EnumMemoryRegions-Methode](../../../../docs/framework/unmanaged-api/debugging/iclrdataenummemoryregions-enummemoryregions-method.md)|Listet die angegebenen Bereiche des Arbeitsspeichers.|  
