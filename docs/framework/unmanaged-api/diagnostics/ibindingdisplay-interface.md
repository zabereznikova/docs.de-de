...
|------------|-----------------|  
|[GetCurrentDisplay-Methode](../../../../docs/framework/unmanaged-api/diagnostics/ibindingdisplay-getcurrentdisplay-method.md)|Returns the current binding display information.|  
