...
|[SetSource-Methode](../../../../docs/framework/unmanaged-api/diagnostics/isymunmanageddocumentwriter-setsource-method.md)|Legt die eingebettete Quelle für ein Dokument, das geschrieben wird.|  
