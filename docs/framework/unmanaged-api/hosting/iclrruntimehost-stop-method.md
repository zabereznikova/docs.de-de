...
> [!IMPORTANT]
>  Diese Methode nicht zum Freigeben von Ressourcen auf dem Host, Anwendungsdomänen zu entladen oder Zerstören von Threads. Sie müssen den Vorgang, um diese Ressourcen freizugeben beenden.  
