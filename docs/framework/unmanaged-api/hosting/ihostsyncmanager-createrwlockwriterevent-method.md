...
## <a name="remarks"></a>Hinweise  
 ...
 Die CLR ruft die- `CreateRWLockWriterEvent` Methode auf, um einen Verweis auf eine- `IHostAutoEvent` Instanz zu erhalten, die bei der Implementierung einer Writer-Sperre verwendet werden soll. Der Host kann das angegebene Cookie verwenden, um zu bestimmen, welche Tasks auf die Sperre warten, indem die Iterations Methoden der [ICLRSyncManager](iclrsyncmanager-interface.md) -Schnittstelle aufgerufen werden.  
