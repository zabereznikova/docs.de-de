...
> [!IMPORTANT]
> Planen Sie diese Aufgabe nicht neu. Der Host muss einen Task neu planen, wenn [ThreadIsBlockingForSuspension](ihostgcmanager-threadisblockingforsuspension-method.md) aufgerufen wird.  
