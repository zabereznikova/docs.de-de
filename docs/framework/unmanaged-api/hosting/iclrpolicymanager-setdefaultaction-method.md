...
#### <a name="parameters"></a>Parameter  
 ...
 `action`  
 [in] Eines der [EPolicyAction](../../../../docs/framework/unmanaged-api/hosting/epolicyaction-enumeration.md) Werte, der die Richtlinienaktion CLR abwartet, wenn `operation` auftritt.  
