...
## <a name="remarks"></a>Hinweise  
 Die `ReleasedVirtualAddressSpace` Methode ist eine Rückrufmethode und muss vom Writer der Hostinganwendung implementiert werden. Sie wird von der CLR aufgerufen.  
