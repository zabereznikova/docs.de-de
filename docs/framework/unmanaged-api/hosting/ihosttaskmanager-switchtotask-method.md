...
#### <a name="parameters"></a>Parameter  
 `option`  
 [in] Eines der [WAIT_OPTION](../../../../docs/framework/unmanaged-api/hosting/wait-option-enumeration.md) -Enumerationswerte, der angibt, der Aktion, die den Host ausführen soll, wenn der angeforderte Vorgang blockiert.  
