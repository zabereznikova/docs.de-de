...
|-------------|-----------------|  
|S_OK|`SetGCStartupLimitsEx` erfolgreich zurückgegeben.|  
...
## <a name="remarks"></a>Hinweise  
 Die Werte, die `SetGCStartupLimitsEx` festgelegt haben, können nur angegeben werden, bevor der Host gestartet wird. Spätere Aufrufe von `SetGCStartupLimitsEx` werden ignoriert.  
