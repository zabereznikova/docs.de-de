...
Ruft die Prioritätsebene der Aufgabe, die vom aktuellen [IHostTask](../../../../docs/framework/unmanaged-api/hosting/ihosttask-interface.md) Instanz.  
...
#### <a name="parameters"></a>Parameter  
 `pPriority`  
 [out] Ein Zeiger auf eine ganze Zahl, die die Prioritätsebene der Aufgabe, die vom aktuellen `IHostTask` Instanz.  
