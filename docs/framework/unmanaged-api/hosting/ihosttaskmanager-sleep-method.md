...
## <a name="parameters"></a>Parameter  
 ...
 `option`  
 in Einer der [WAIT_OPTION](wait-option-enumeration.md) Enumerationswerte, der angibt, welche Aktion der Host durchführen soll, wenn diese Aktion blockiert wird.  
