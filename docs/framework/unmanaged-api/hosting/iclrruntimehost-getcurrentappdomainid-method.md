...
Ruft den numerischen Bezeichner von die <xref:System.AppDomain> , die gerade ausgeführt.  
...
#### <a name="parameters"></a>Parameter  
 `pdwAppDomainId`  
 [out] Den numerischen Bezeichner von die <xref:System.AppDomain> , die gerade ausgeführt.  
...
## <a name="remarks"></a>Hinweise  
 Die `pdwAppDomainId` Parameter festgelegt ist, auf den Wert des der <xref:System.AppDomain.Id%2A> Eigenschaft von der <xref:System.AppDomain> in die der aktuelle Thread ausgeführt wird.  
