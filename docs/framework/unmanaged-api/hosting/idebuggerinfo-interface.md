...
|------------|-----------------|  
|[IsDebuggerAttached-Methode](../../../../docs/framework/unmanaged-api/hosting/idebuggerinfo-isdebuggerattached-method.md)|Ruft einen Wert, der angibt, ob dieses Prozesses ein verwalteter Debugger angefügt wird.|  
