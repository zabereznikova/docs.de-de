...
|------------|-----------------|  
|[IsDebuggerAttached-Methode](../../../../docs/framework/unmanaged-api/hosting/idebuggerinfo-isdebuggerattached-method.md)|Ruft einen Wert, der angibt, ob dieser Prozess ein verwalteter Debugger angefügt ist.|  
