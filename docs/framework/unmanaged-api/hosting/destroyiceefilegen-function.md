...
## <a name="remarks"></a>Hinweise  
 `DestroyICeeFileGen`zerstört die `ICeeFileGen` Objekt erstellt, indem die [CreateICeeFileGen](../../../../docs/framework/unmanaged-api/hosting/createiceefilegen-function.md) Funktion.  
