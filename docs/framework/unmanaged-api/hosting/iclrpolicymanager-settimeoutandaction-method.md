...
## <a name="parameters"></a>Parameter  
 `operation`  
 in Einer der [eclroperations](../../../../docs/framework/unmanaged-api/hosting/eclroperation-enumeration.md) -Werte, der den Vorgang angibt, für den das Timeout und die Richtlinie `action`festgelegt werden sollen. Die folgenden Werte werden unterstützt:  
...
- OPR_ThreadRudeAbortInNonCriticalRegion  
 ...
 `dwMilliseconds`  
 in Der neue Timeout Wert in Millisekunden. Der Wert unendlich bewirkt, dass `operation` nie ein Timeout auftritt.  
...
|-------------|-----------------|  
|S_OK|`SetTimeoutAndAction` erfolgreich zurückgegeben.|  
