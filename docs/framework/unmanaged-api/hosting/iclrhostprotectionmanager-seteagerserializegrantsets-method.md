...
---
# <a name="iclrhostprotectionmanagerseteagerserializegrantsets-method"></a>ICLRHostProtectionManager::SetEagerSerializeGrantSets-Methode
...
|-------------|-----------------|  
|S_OK|`SetEagerSerializeGrantSets` wurde erfolgreich zurückgegeben.|  
