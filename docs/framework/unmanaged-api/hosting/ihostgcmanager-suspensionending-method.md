...
|-------------|-----------------|  
|S_OK|`SuspensionEnding` erfolgreich zurückgegeben.|  
...
## <a name="remarks"></a>Hinweise  
 Die CLR ruft nach dem Ausführen einer Garbage Collection `SuspensionEnding` auf, um den Host darüber zu informieren, dass die Ausführung des Threads fortgesetzt wird.  
