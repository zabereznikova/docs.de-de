...
|-------------|-----------------|  
|S_OK|`Start` erfolgreich zurückgegeben.|  
...
## <a name="remarks"></a>Hinweise  
 In vielen Szenarien ist es nicht notwendig, `Start`aufzurufen, da die Laufzeit bei der ersten Anforderung zum Ausführen von verwaltetem Code automatisch initialisiert wird. Sie können jedoch `Start` verwenden, um genau anzugeben, wann die Laufzeit initialisiert werden soll.  
