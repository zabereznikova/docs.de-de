...
Fordert an, dass der Host einen Port schließt, der durch einen früheren Aufrufen von " [feateiocompletionport](../../../../docs/framework/unmanaged-api/hosting/ihostiocompletionmanager-createiocompletionport-method.md)" geöffnet wurde.  
...
|-------------|-----------------|  
|S_OK|`CloseIoCompletionPort` erfolgreich zurückgegeben.|  
...
## <a name="remarks"></a>Hinweise  
 `hPort` muss ein Handle für einen Port sein, der von einem früheren `CreateIoCompletionPort`-Auflistungstyp erstellt wurde.  
