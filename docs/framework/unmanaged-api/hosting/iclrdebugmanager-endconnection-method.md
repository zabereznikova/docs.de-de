...
|-------------|-----------------|  
|S_OK|`EndConnection` erfolgreich zurückgegeben.|  
...
## <a name="remarks"></a>Hinweise  
 [ICLRDebugManager](../../../../docs/framework/unmanaged-api/hosting/iclrdebugmanager-interface.md) bietet drei Methoden, `BeginConnection`, [SetConnectionTasks](../../../../docs/framework/unmanaged-api/hosting/iclrdebugmanager-setconnectiontasks-method.md)und `EndConnection`zum Zuordnen von Aufgabenlisten zu Bezeichnernamen und anzeigen Amen.  
