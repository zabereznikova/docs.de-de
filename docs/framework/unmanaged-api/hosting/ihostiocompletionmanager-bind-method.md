...
## <a name="parameters"></a>Parameter  
 `hPort`  
 in Der e/a-Abschlussport, an den `hHandle`gebunden werden soll. Wenn der Wert von `hPort` NULL ist, wird `hHandle` an den Standard-e/a-Abschlussport gebunden.  
  
 `hHandle`  
 in Das Betriebssystem handle, das an `hPort`gebunden werden soll.  
  
## <a name="return-value"></a>Rückgabewert  
  
|HRESULT|Beschreibung|  
|-------------|-----------------|  
|S_OK|`Bind` erfolgreich zurückgegeben.|  
...
## <a name="remarks"></a>Hinweise  
 Ein e/a-Abschlussport wird erstellt, indem ein-`CreateIoCompletionPort`aufgerufen wird. Die CLR ruft `Bind` auf, um ein Handle an diesen Port zu binden.  
