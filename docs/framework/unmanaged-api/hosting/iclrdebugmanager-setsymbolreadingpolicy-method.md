...
## <a name="parameters"></a>Parameter  
 `policy`  
 in Ein Member der [esymbolleseringpolicy](../../../../docs/framework/unmanaged-api/hosting/esymbolreadingpolicy-enumeration.md) -Enumeration.  
  
## <a name="return-value"></a>Rückgabewert  
  
|HRESULT|Beschreibung|  
|-------------|-----------------|  
|S_OK|`SetSymbolReadingPolicy` erfolgreich zurückgegeben.|  
