...
Windows Communication Foundation (WCF)-Testclient (WcfTestClient.exe) ist ein GUI-Tool, das ermöglicht Benutzern die Eingabe Testparameter, die Eingabe an den Dienst senden, und zeigen die Antwort, die der Dienst zurücksendet. Zusammen mit dem [!INCLUDE[indigo2](../../../includes/indigo2-md.md)]-Diensthost ermöglicht er einen problemlosen Diensttest.  
  
 Finden Sie in der Regel die [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] -Testclient (WcfTestClient.exe) an folgendem Speicherort: C:\Program Files (x86) \Microsoft Visual Studio\2017\Community\Common7\IDE - Community möglicherweise "Enterprise", "Professional" oder "Community" Je nachdem, welche Stufe von Visual Studio installiert ist.
