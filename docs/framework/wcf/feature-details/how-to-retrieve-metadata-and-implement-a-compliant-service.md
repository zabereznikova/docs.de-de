...
5. Ändern Sie in der Client Konfigurationsdatei, die vom [Service Model Metadata Utility Tool (Svcutil. exe)](../servicemodel-metadata-utility-tool-svcutil-exe.md) generiert wird, den [\<client>](../../configure-apps/file-schema/wcf/client.md) Konfigurations Abschnitt in einen [\<services>](../../configure-apps/file-schema/wcf/services.md) Konfigurations Abschnitt. (Ein Beispiel für eine generierte Clientanwendungs-Konfigurationsdatei finden Sie im folgenden "Beispiel"-Abschnitt.)  
