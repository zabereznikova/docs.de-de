...
- [Microsoft Patterns and Practices "," Kapitel 3: Implementieren von Transport- und Nachrichtensicherheit-Ebene](https://go.microsoft.com/fwlink/?LinkId=88897)
