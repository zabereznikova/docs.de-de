---
title: "Routingszenarien | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
### Dienstversionsverwaltung  
 ...
 Die Schritte zum Erstellen einer Dienstversionskonfiguration finden Sie unter [Vorgehensweise: Dienstversionskontrolle](../../../../docs/framework/wcf/feature-details/how-to-service-versioning.md).  Ein Beispiel für die Verwendung von XPathMessageFilter zum Weiterleiten von Nachrichten anhand eines benutzerdefinierten Headers finden Sie unter [Erweiterte Filter](../../../../docs/framework/wcf/samples/advanced-filters.md).  
  
### Dienstdatenpartitionierung  
 Beim Entwerfen einer verteilten Umgebung ist es häufig ratsam, die Verarbeitungslast auf mehrere Computer zu verteilen, um eine hohe Verfügbarkeit sicherzustellen, die Verarbeitungslast für einzelne Computer zu verringern oder für eine bestimmte Teilmenge von Nachrichten dedizierte Ressourcen bereitzustellen.  Der Routingdienst ist zwar kein Ersatz für eine dedizierte Lösung für den Lastenausgleich, aber Sie können die Funktion für das inhaltsbasierte Routing verwenden, um Nachrichten, die einander ansonsten ähnlich sind, an bestimmte Ziele weiterzuleiten.  Es kann z. B. sein, dass Sie Nachrichten eines bestimmten Clients gesondert von den Nachrichten verarbeiten müssen, die Sie von anderen Clients empfangen.  
  
 Die Schritte zum Erstellen einer Dienstdatenpartitionierung finden Sie unter [Vorgehensweise: Dienstdatenpartitionierung](../../../../docs/framework/wcf/feature-details/how-to-service-data-partitioning.md).  Ein Beispiel für die Verwendung von Filtern zum Partitionieren von Daten basierend auf der URL und auf benutzerdefinierten Headern finden Sie unter [Erweiterte Filter](../../../../docs/framework/wcf/samples/advanced-filters.md).  
...
### Dynamisches Routing  
 ...
 Die Schritte zum Implementieren des dynamischen Routings finden Sie unter [Vorgehensweise: Dynamisches Update](../../../../docs/framework/wcf/feature-details/how-to-dynamic-update.md).  Ein Beispiel für die Verwendung des dynamischen Routings finden Sie unter [Dynamische Neukonfiguration](../../../../docs/framework/wcf/samples/dynamic-reconfiguration.md).  
...
### Protokollüberbrückung  
 ...
 .  Ein Beispiel für die Verwendung des Routingdiensts zum Übersetzen von Nachrichten zwischen Protokollen finden Sie unter [Überbrückung und Fehlerbehandlung](../../../../docs/framework/wcf/samples/bridging-and-error-handling.md).  
...
### Fehlerbehandlung  
 ...
 Die Schritte zum Konfigurieren der Fehlerbehandlung finden Sie unter [Vorgehensweise: Fehlerbehandlung](../../../../docs/framework/wcf/feature-details/how-to-error-handling.md).  Ein Beispiel für die Implementierung der Fehlerbehandlung finden Sie unter [Überbrückung und Fehlerbehandlung](../../../../docs/framework/wcf/samples/bridging-and-error-handling.md) und [Erweiterte Fehlerbehandlung](../../../../docs/framework/wcf/samples/advanced-error-handling.md).  
