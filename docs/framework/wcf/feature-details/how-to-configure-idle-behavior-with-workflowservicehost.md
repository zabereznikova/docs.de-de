...
1. Fügen Sie `workflowIdle` dem <`behavior`>-Element innerhalb `serviceBehaviors` des <>-Elements ein <> Element hinzu, wie im folgenden Beispiel gezeigt.  
