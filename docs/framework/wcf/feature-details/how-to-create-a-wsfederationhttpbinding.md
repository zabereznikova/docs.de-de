...
12. [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][-Identität und Authentifizierung](../../../../docs/framework/wcf/feature-details/service-identity-and-authentication.md).  
