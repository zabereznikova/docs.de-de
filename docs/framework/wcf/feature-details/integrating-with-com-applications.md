...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Um den WCF-Dienstmoniker innerhalb COM-Anwendung verwenden zu können, die erforderlichen attributierten Typen bei COM registriert, und die COM-Anwendung sowie der Moniker mit der erforderlichen Bindungskonfiguration konfiguriert.  
 ...
 Beschreibt, wie ein WCF-Beispiel, die Verwendung eines WCF WSDL-Monikers aufgerufen.  
 ...
 Beschreibt das Aufrufen einer WCF-Beispiel mit einem WCF-Moniker, der einen Mex-Endpunkt angibt.  
 ...
 Der WCF-Dienstmoniker unterstützt die `IChannelCredentials` Schnittstelle, die einen Bereich von alternative Methoden zur Angabe von kanalanmeldeinformationen ermöglicht.  
