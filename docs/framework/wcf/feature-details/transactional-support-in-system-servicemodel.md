...
Die Themen in diesem Abschnitt beschreiben die Transaktionsfunktionen, die Windows Communication Foundation (WCF) enthält.  
  
## <a name="in-this-section"></a>In diesem Abschnitt  
 [ServiceModel-Transaktionsattribute](../../../../docs/framework/wcf/feature-details/servicemodel-transaction-attributes.md)  
 Beschreibt die beiden <xref:System.ServiceModel> Attribute, die Sie so konfigurieren Sie das Verhalten von Transaktionen für einen WCF-Dienst zu ermöglichen.  
 ...
 Veranschaulicht das Erstellen eines transaktionsdiensts in WCF.  
  
 [Diagnose von Transaktionsanwendungen](../../../../docs/framework/wcf/feature-details/diagnosing-transactional-applications.md)  
 Beschreibt, wie die Verwaltungs- und Diagnosefunktion in WCF zu verwenden, um Ihre transaktionsanwendung.  
 ...
 Beschreibt, wie Ihre WCF-Dienste, die Unternehmensdienst verwendeten Code integriert.
