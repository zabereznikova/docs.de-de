...
ms.locfileid: "33498214"
---
# <a name="transport-security"></a>Transportsicherheit
Transportsicherheit in Windows Communication Foundation (WCF) abhängig von der ausgewählten Bindung ab. Der Transport, den die Bindung implementiert, bestimmt das tatsächliche Sicherheitsverfahren. In den Themen in diesem Abschnitt werden die implementierten Mechanismen und deren Optionen erläutert.  
...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Beschreibt HTTP-Authentifizierungsschemas, z. B. Basic, Hashwert, NT-LAN-Manager (NTLM) und andere.  
