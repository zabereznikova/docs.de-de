...
|Keine Transaktion|Obligatorisch.|N/V|Abgelehnt, da eine Transaktion erforderlich ist.|  
|Keine Transaktion|Zulässig|N/V|Prozess|  
|Keine Transaktion|Nicht zulässig|N/V|Prozess|  
