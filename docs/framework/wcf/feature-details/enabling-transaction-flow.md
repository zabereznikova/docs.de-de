...
|Allowed|true|OleTransactions|Die Transaktionsfluss kann in der WCF-OleTransactions-Format.|  
...
## <a name="enabling-transaction-flow-at-the-endpoint-level"></a>Aktivieren des Transaktionsflusses auf der Endpunktebene  
 ...
 Die meisten der ständigen Bindungen WCF bietet enthalten die `transactionFlow` und `transactionProtocol` Attribute, um die spezielle Bindung für eingehender Transaktionen konfigurieren können. Weitere Informationen zum Festlegen von Konfigurationselementen finden Sie unter [ \<Bindung >](../../../../docs/framework/misc/binding.md).  
...
## <a name="security"></a>Sicherheit  
 ...
 Beim Generieren von WCF-Clients für unbekannte oder nicht vertrauenswürdige Webdienste durch die Verwendung von Metadatenaustausch sollten Aufrufe Vorgänge zu diesen Webdiensten möglichst die aktuelle Transaktion unterdrücken. Im folgenden Beispiel wird die dafür erforderliche Vorgehensweise veranschaulicht.  
