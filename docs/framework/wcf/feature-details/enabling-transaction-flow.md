---
title: "Aktivieren des Transaktionsflusses | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Transaktionen [WCF], Aktivieren des Flusses"
...
|-----------------------------------|------------------------------------------|------------------------------------------------|---------------------------------|  
|Mandatory|true|WS\-AT|Der Transaktionsfluss muss im interoperablen WS\-AT\-Format erfolgen.|  
|Mandatory|true|OleTransactions|Der Transaktionsfluss muss im OleTransactions\-Format von [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] erfolgen.|  
|Mandatory|false|Nicht zutreffend|Nicht zutreffend, da es sich um eine ungültige Konfiguration handelt.|  
...
|Die Transaktion stimmt nicht mit dem erwarteten Protokollformat überein.|Mandatory|`MustUnderstand`  ist gleich `false`.|Abgelehnt, da eine Transaktion erforderlich ist.|  
...
|Keine Transaktion|Mandatory|Nicht zutreffend|Abgelehnt, da eine Transaktion erforderlich ist.|  
...
## Aktivieren des Transaktionsflusses auf der Endpunktebene  
 ...
 Die meisten der von [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] bereitgestellten Bindungen enthalten die Attribute `transactionFlow` and `transactionProtocol`, sodass Sie die spezielle Bindung für die Annahme eingehender Transaktionen konfigurieren können.[!INCLUDE[crabout](../../../../includes/crabout-md.md)] zum Festlegen der Konfigurationselemente finden Sie unter [\<Bindung\>](../../../../docs/framework/misc/binding.md).  
...
## Sicherheit  
 ...
 Wenn Sie unter Verwendung eines Metadatenaustausches [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]\-Clients für unbekannte oder nicht vertrauenswürdige Webdienste generieren, sollten Vorgänge zu diesen Webdiensten möglichst die aktuelle Transaktion unterdrücken.Das folgende Beispiel veranschaulicht die Vorgehensweise.  
