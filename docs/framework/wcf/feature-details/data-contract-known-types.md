...
-   Der gesendete Datenvertrag wird vom erwarteten Datenvertrag abgeleitet. [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] im Abschnitt zur Vererbung unter [Data Contract Equivalence](../../../../docs/framework/wcf/feature-details/data-contract-equivalence.md)). In diesem Fall gilt für die übertragenen Daten nicht der Datenvertrag, der vom empfangenden Endpunkt erwartet wird.  
