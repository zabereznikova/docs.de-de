...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Bietet eine Übersicht über WS-Discovery-Unterstützung, die von WCF bereitgestellt.  
 ...
 Zeigt, wie einen Windows Communication Foundation (WCF)-Dienst erkennbar zu machen.  
 ...
 Zeigt, wie eine Discovery-Clientchannel zu verwenden, wenn eine WCF-Clientanwendung schreiben.
