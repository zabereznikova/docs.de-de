...
-   <xref:System.ServiceModel.Activities.Description.WorkflowUnhandledExceptionAction.Abandon> – Bricht die Workflowdienstinstanz.  
  
-   <xref:System.ServiceModel.Activities.Description.WorkflowUnhandledExceptionAction.AbandonAndSuspend> – Ein Rollback auf den letzten beibehaltenen Zustand und hält die Workflowdienstinstanz an. Dies ist nur der Fall, wenn der Workflow bereits mindestens einmal beibehalten wurde. Falls nicht, wird die Workflowinstanz abgebrochen.  
  
-   <xref:System.ServiceModel.Activities.Description.WorkflowUnhandledExceptionAction.Cancel> – Bricht die Instanz ab.  
  
-   <xref:System.ServiceModel.Activities.Description.WorkflowUnhandledExceptionAction.Terminate> – Die Instanz beendet.  
