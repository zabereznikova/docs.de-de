...
|Identifizieren (Identify)|Die Serveranwendung kennt die Identität des Clients und kann mit den Anmeldeinformationen des Clients Zugriffsvalidierungen durchführen, sie kann jedoch nicht die Identität des Clients annehmen. Identifizieren Sie die Standard-Identitätswechselebene, die bei SSPI-Anmeldeinformationen in WCF verwendet werden, es sei denn, der Tokenanbieter stellt eine andere Identitätswechselebene bereit ist.|  
