...
3.  Kompilieren Sie den verwalteten [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]-Client als Assembly mit starkem Namen. Dies erfordert die Signierung mit einem kryptografischen Schlüsselpaar. [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][Signieren einer Assembly mit einem starken Namen](http://go.microsoft.com/fwlink/?LinkId=94874) in .NET Developer's Guide.  
