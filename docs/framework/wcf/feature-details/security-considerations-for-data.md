...
#### <a name="maxdepth"></a>MaxDepth  
 Diese Kontingent schränkt die maximale Schachtelungstiefe von XML-Elementen ein. Angenommen, das Dokument "\<ein >\<B >\<C / >\</b > \< /a >" hat eine Schachtelungstiefe von drei Elementen. <xref:System.Xml.XmlDictionaryReaderQuotas.MaxDepth%2A> ist aus den folgenden Gründen wichtig:  
