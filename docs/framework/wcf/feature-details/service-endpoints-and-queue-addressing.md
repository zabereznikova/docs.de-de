---
title: "Dienstendpunkte und Adressieren von Warteschlangen | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## MSMQ\-Adressierung  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] zu MSMQ\-Pfad und \-Formatnamen finden Sie unter [Informationen über Message Queuing](http://go.microsoft.com/fwlink/?LinkId=94837) \(möglicherweise in englischer Sprache\).  
...
-   \<*host\-name*\> ist der Name des Computers, der die Zielwarteschlange hostet.  
...
-   \<*queue\-name*\> ist der Name der Warteschlange.Der Warteschlangenname kann auch auf eine Unterwarteschlange verweisen.Demnach ist \<*queue\-name*\> \= \<*name\-of\-queue*\>\[;*sub\-queue\-name*\].  
 ...
 Ein Endpunkt, der aus einer Warteschlange liest, muss die Adresse der Warteschlange nach demselben Schema angeben, das zuvor beim Öffnen des ServiceHost angegeben worden war.Beispiele finden Sie unter [Net MSMQ\-Bindung](../../../../docs/framework/wcf/samples/net-msmq-binding.md) und [Message Queuing Integration Binding Samples](http://msdn.microsoft.com/de-de/997d11cb-f2c5-4ba0-9209-92843d4d0e1a).  
...
|---------------------------------------------|-----------------------------------------------------|--------------------------------------------------------|-------------------------------------|  
|Net.msmq:\/\/\<Computername\>\/privat\/abc|False \(Standardwert\)|Systemeigen \(Standardwert\)|DIRECT\=OS:Computername\\privat$\\abc|  
|Net.msmq:\/\/\<Computername\>\/privat\/abc|False|SRMP|DIRECT\=http:\/\/Computer\/msmq\/privat$\/abc|  
|Net.msmq:\/\/\<Computername\>\/privat\/abc|True|Systemeigen|PUBLIC\=some\-guid \(die GUID der Warteschlange\)|  
  
### Lesen von Nachrichten aus der Warteschlange für unzustellbare Nachrichten oder der Warteschlange für potenziell schädliche Nachrichten  
...
## NetMsmqBinding und Dienstadressierung  
 ...
 Der MSMQ\-Formatname hat das durch MSMQ in [Informationen über Message Queuing](http://go.microsoft.com/fwlink/?LinkId=94837) \(möglicherweise in englischer Sprache\) festgelegte Format.  
