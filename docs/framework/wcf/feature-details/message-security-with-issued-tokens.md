...
Client für ausgestellte token ermöglicht das Verbundsicherheitsszenario in Windows Communication Foundation (WCF).  
 ...
 Eine ausführliche Erklärung der verbundenen Szenario legen, finden Sie unter [Verbund und ausgestellte Token](../../../../docs/framework/wcf/feature-details/federation-and-issued-tokens.md).  
