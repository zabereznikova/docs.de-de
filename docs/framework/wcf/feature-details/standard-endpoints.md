---
title: "Standardendpunkte | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 Um einen Standardendpunkt in der Konfiguration hinzuzufügen, fügen Sie dem \<`service`\>\-Element ein \<`endpoint`\>\-Element sowie alle erforderlichen Konfigurationseinstellungen im \<`standardEndpoints`\>\-Element hinzu.Im folgenden Beispiel wird gezeigt, wie Sie ein <xref:System.ServiceModel.Discovery.UdpDiscoveryEndpoint>\-Objekt hinzufügen. Dabei handelt es sich um einen der Standardendpunkte, die im Lieferumfang von [!INCLUDE[netfx_current_long](../../../../includes/netfx-current-long-md.md)] enthalten sind.  
