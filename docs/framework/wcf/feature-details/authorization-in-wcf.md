...
Autorisierung ist der Prozess, Zugriff und Rechte für Ressourcen zu steuern, z. B. Dienste oder Dateien. Die Themen in diesem Abschnitt zeigen Sie Durchführung dieser grundlegenden Aufgaben in Windows Communication Foundation (WCF) in einer Vielzahl von Möglichkeiten.  
  
## <a name="in-this-section"></a>In diesem Abschnitt  
 [Zugriffssteuerungsmechanismen](../../../../docs/framework/wcf/feature-details/access-control-mechanisms.md)  
 Bietet eine kurze Gliederung der Autorisierungsmechanismen in WCF und vorgeschlagenen verwendet.  
 ...
 [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] kann den Autorisierungs-Manager zum Verwalten der Autorisierung für eine Website verwenden. WCF kann auf ähnliche Weise nutzen, die [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)]/Authorization Manager Kombination für die Autorisierung von Clients.  
