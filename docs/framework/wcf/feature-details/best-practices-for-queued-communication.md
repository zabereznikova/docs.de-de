...
### <a name="use-of-dead-letter-queues"></a>Verwendung von Warteschlangen für unzustellbare Nachrichten  
 ...
 [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] [Behandeln von Nachrichtenübertragungsfehlern mithilfe von unzustellbare Warteschlangen](../../../../docs/framework/wcf/feature-details/using-dead-letter-queues-to-handle-message-transfer-failures.md).  
