...
```  
 ...
 Sie können zusätzlich Verweisparameter verwenden, um einen Parameter sowohl zu einem Teil der Anforderungs- als auch der Antwortnachricht zu machen. Die Parameter müssen Typen angehören, die serialisiert (zu XML konvertiert) werden können. WCF verwendet standardmäßig eine Komponente mit dem Namen der <xref:System.Runtime.Serialization.DataContractSerializer> Klasse, um diese Konvertierung auszuführen. Die meisten primitiven Typen (z. B. `int`, `string`, `float` und `DateTime`) werden unterstützt. Benutzerdefinierte Typen müssen normalerweise einen Datenvertrag aufweisen. Weitere Informationen finden Sie unter [Using Data Contracts](../../../../docs/framework/wcf/feature-details/using-data-contracts.md).  
...
```  
 ...
 Weitere Informationen finden Sie unter [Using Message Contracts](../../../../docs/framework/wcf/feature-details/using-message-contracts.md).  
...
## <a name="describing-messages-by-using-streams"></a>Beschreiben von Nachrichten mithilfe von Streams  
 ...
 Statt das Serialisierungsprogramm aufzurufen, WCF Ruft Daten aus einem Stream ab und setzt sie direkt in eine ausgehende Nachricht, oder ruft Daten aus einer eingehenden Nachricht ab und setzt sie direkt in einen Stream. Im folgenden Beispiel wird die Verwendung von Streams veranschaulicht.  
...
```  
 ...
 Weitere Informationen finden Sie unter [umfangreiche Daten und Streaming](../../../../docs/framework/wcf/feature-details/large-data-and-streaming.md).  
...
```  
 ...
 Dies ist ein erweitertes Szenario, das ausführlich beschrieben wird [Using the Message Class](../../../../docs/framework/wcf/feature-details/using-the-message-class.md).  
