...
11. Erstellen Sie innerhalb der `InvokeCalculatorService`-Methode eine Instanz der `CalculatorServiceClient`-Klasse. Diese Klasse wird durch das [Self-Host-](../samples/self-host.md) Beispiel definiert. Sie wurde mithilfe von "Svcutil.exe" generiert.  
