...
- Wenn Sie Nachrichten allgemein und unabhängig vom Nachrichteninhalt bearbeiten müssen (z. B. zum Routen oder Weiterleiten von Nachrichten beim Erstellen eines Routers, Lastenausgleichsmoduls oder Veröffentlichen-Abonnieren-Systems).  
 ...
 Machen Sie sich <xref:System.ServiceModel.Channels.Message> vor der Verwendung der-Klasse mit der WCF-Datenübertragungs Architektur in [Datenübertragung Übersicht über die Architektur](../../../../docs/framework/wcf/feature-details/data-transfer-architectural-overview.md)vertraut.  
