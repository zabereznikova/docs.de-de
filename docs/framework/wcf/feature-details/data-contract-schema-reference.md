...
-   <span data-ttu-id="ef6df-123">Alle Anmerkungen (außer den in diesem Dokument beschriebenen) werden ignoriert.</span><span class="sxs-lookup"><span data-stu-id="ef6df-123">Any annotations (except for those described in this document) are ignored.</span></span>  
...
|<span data-ttu-id="ef6df-172">Attribut</span><span class="sxs-lookup"><span data-stu-id="ef6df-172">Attribute</span></span>|<span data-ttu-id="ef6df-173">Schema</span><span class="sxs-lookup"><span data-stu-id="ef6df-173">Schema</span></span>|  
|---------------|------------|  
...
|`attributeGroup`|<span data-ttu-id="ef6df-199">Unzulässig.</span><span class="sxs-lookup"><span data-stu-id="ef6df-199">Forbidden.</span></span> <span data-ttu-id="ef6df-200">In der WCF-v1-Version `DataContractSerializer` ignoriert das Vorhandensein von `attributeGroup` in `xs:complexType`.</span><span class="sxs-lookup"><span data-stu-id="ef6df-200">In the WCF v1 release, `DataContractSerializer` ignores the presence of `attributeGroup` inside `xs:complexType`.</span></span>|  
...
-   <span data-ttu-id="ef6df-248">Wird einem <xref:System.Runtime.Serialization.CollectionDataContractAttribute>zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="ef6df-248">Maps to a <xref:System.Runtime.Serialization.CollectionDataContractAttribute>.</span></span>  
...
|<span data-ttu-id="ef6df-308">Inhalt</span><span class="sxs-lookup"><span data-stu-id="ef6df-308">Contents</span></span>|<span data-ttu-id="ef6df-309">Schema</span><span class="sxs-lookup"><span data-stu-id="ef6df-309">Schema</span></span>|  
|--------------|------------|  
...
|`fractionDigits`|<span data-ttu-id="ef6df-338">Ignoriert.</span><span class="sxs-lookup"><span data-stu-id="ef6df-338">Ignored.</span></span>|  
...
|<span data-ttu-id="ef6df-370">(leer)</span><span class="sxs-lookup"><span data-stu-id="ef6df-370">(empty)</span></span>|<span data-ttu-id="ef6df-371">Unterstützt, wird leerem Enumerationstyp zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="ef6df-371">Supported, maps to empty enumeration type.</span></span>|  
 ...
 <span data-ttu-id="ef6df-372">Der folgende Code zeigt eine C#-Enumerationsklasse.</span><span class="sxs-lookup"><span data-stu-id="ef6df-372">The following code shows a C# enumeration class.</span></span>  
...
### <a name="xslist-attributes"></a><span data-ttu-id="ef6df-378">\<xs:list>: attributes</span><span class="sxs-lookup"><span data-stu-id="ef6df-378">\<xs:list>: attributes</span></span>  
...
|`gMonth`|<span data-ttu-id="ef6df-441"><xref:System.String>.</span><span class="sxs-lookup"><span data-stu-id="ef6df-441"><xref:System.String>.</span></span>|  
...
## <a name="iserializable-types-mapping"></a><span data-ttu-id="ef6df-475">Zuordnung von ISerializable-Typen</span><span class="sxs-lookup"><span data-stu-id="ef6df-475">ISerializable types mapping</span></span>  
...
```  
 ...
 <span data-ttu-id="ef6df-487">Auf Folgendes sollte geachtet werden:</span><span class="sxs-lookup"><span data-stu-id="ef6df-487">The following should be noted:</span></span>  
  
-   <span data-ttu-id="ef6df-488">`ser:char` wurde eingeführt, um Unicode-Zeichen des Typs <xref:System.Char>darzustellen.</span><span class="sxs-lookup"><span data-stu-id="ef6df-488">`ser:char` is introduced to represent Unicode characters of type <xref:System.Char>.</span></span>  
  
-   <span data-ttu-id="ef6df-489">Der `valuespace` von `xs:duration` wurde zu einer geordneten Menge reduziert, damit diese einem <xref:System.TimeSpan>zugeordnet werden kann.</span><span class="sxs-lookup"><span data-stu-id="ef6df-489">The `valuespace` of `xs:duration` is reduced to an ordered set so that it can be mapped to a <xref:System.TimeSpan>.</span></span>  
  
-   <span data-ttu-id="ef6df-490">`FactoryType` wird in Schemas verwendet, die von Typen exportiert werden, die von <xref:System.Runtime.Serialization.ISerializable>abgeleitet wurden.</span><span class="sxs-lookup"><span data-stu-id="ef6df-490">`FactoryType` is used in schemas exported from types that are derived from <xref:System.Runtime.Serialization.ISerializable>.</span></span>  
  
## <a name="importing-non-datacontract-schemas"></a><span data-ttu-id="ef6df-491">Importieren von Nicht-DataContract-Schemas</span><span class="sxs-lookup"><span data-stu-id="ef6df-491">Importing non-DataContract schemas</span></span>  
 <span data-ttu-id="ef6df-492">`DataContractSerializer` verfügt über die `ImportXmlTypes` -Option, die den Import von Schemas erlaubt, die dem `DataContractSerializer` -XSD-Profil nicht entsprechen (siehe die <xref:System.Runtime.Serialization.XsdDataContractImporter.Options%2A> -Eigenschaft).</span><span class="sxs-lookup"><span data-stu-id="ef6df-492">`DataContractSerializer` has the `ImportXmlTypes` option to allow import of schemas that do not conform to the `DataContractSerializer` XSD profile (see the <xref:System.Runtime.Serialization.XsdDataContractImporter.Options%2A> property).</span></span> <span data-ttu-id="ef6df-493">Die Festlegung dieser Option auf `true` aktiviert die Akzeptanz nicht-konformer Schematypen und ihre Zuordnung zu der folgenden Implementierung, wobei <xref:System.Xml.Serialization.IXmlSerializable> ein Array von <xref:System.Xml.XmlNode> einschließt (nur der Klassenname unterscheidet sich).</span><span class="sxs-lookup"><span data-stu-id="ef6df-493">Setting this option to `true` enables acceptance of non-conforming schema types and mapping them to the following implementation, <xref:System.Xml.Serialization.IXmlSerializable> wrapping an array of <xref:System.Xml.XmlNode> (only the class name differs).</span></span>  
...
## <a name="datetimeoffset-serialization"></a><span data-ttu-id="ef6df-494">DateTimeOffset-Serialisierung</span><span class="sxs-lookup"><span data-stu-id="ef6df-494">DateTimeOffset Serialization</span></span>  
 <span data-ttu-id="ef6df-495"><xref:System.DateTimeOffset> wird nicht als primitiver Typ behandelt.</span><span class="sxs-lookup"><span data-stu-id="ef6df-495">The <xref:System.DateTimeOffset> is not treated as a primitive type.</span></span> <span data-ttu-id="ef6df-496">Stattdessen wird dieser Typ als komplexes Element mit zwei Teilen serialisiert.</span><span class="sxs-lookup"><span data-stu-id="ef6df-496">Instead, it is serialized as a complex element with two parts.</span></span> <span data-ttu-id="ef6df-497">Der erste Teil stellt die Datums- und Uhrzeitangabe dar und der zweite Teil den Offset dieser Datums- und Uhrzeitangabe.</span><span class="sxs-lookup"><span data-stu-id="ef6df-497">The first part represents the date time, and the second part represents the offset from the date time.</span></span> <span data-ttu-id="ef6df-498">Ein Beispiel für einen serialisierten DateTimeOffset-Wert wird im folgenden Code gezeigt.</span><span class="sxs-lookup"><span data-stu-id="ef6df-498">An example of a serialized DateTimeOffset value is shown in the following code.</span></span>  
...
```  
 ...
 <span data-ttu-id="ef6df-499">Das Schema lautet folgendermaßen:</span><span class="sxs-lookup"><span data-stu-id="ef6df-499">The schema is as follows.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="ef6df-500">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="ef6df-500">See also</span></span>
- <xref:System.Runtime.Serialization.DataContractSerializer>
- <xref:System.Runtime.Serialization.DataContractAttribute>
- <xref:System.Runtime.Serialization.DataMemberAttribute>
- <xref:System.Runtime.Serialization.XsdDataContractImporter>
- [<span data-ttu-id="ef6df-501">Verwenden von Datenverträgen</span><span class="sxs-lookup"><span data-stu-id="ef6df-501">Using Data Contracts</span></span>](../../../../docs/framework/wcf/feature-details/using-data-contracts.md)
