---
title: "Interoperabilit&#228;t mit ASP.NET-Webdiensten | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 Die XML, in die <xref:System.Xml.Serialization.XmlSerializer> standardmäßig einen Typ serialisiert, ist semantisch identisch mit der XML, in die <xref:System.Runtime.Serialization.DataContractSerializer> einen Typ serialisiert, vorausgesetzt, der Namespace ist für die XML explizit definiert.Gehen Sie wie folgt vor, wenn ein Datentyp für die Verwendung mit [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)]\-Webdiensten als Vorbereitung für eine zukünftige Arbeit mit [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] definiert wird:  
