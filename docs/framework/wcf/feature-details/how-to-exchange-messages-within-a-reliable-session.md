...
1. *Svcutil.exe* generiert auch die Konfiguration für den Client, verwendet die <xref:System.ServiceModel.WSHttpBinding> Klasse. Benennen Sie die Konfigurationsdatei *"App.config"* Verwendung [!INCLUDE[vsprvs](../../../../includes/vsprvs-md.md)].
