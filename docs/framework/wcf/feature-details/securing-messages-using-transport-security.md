---
title: "Sichern von Nachrichten mit Transportsicherheit | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
### MSMQ\-Schutzebene  
 Die Schutzebene bestimmt, wie die MSMQ\-Nachricht geschützt werden soll, um sicherzustellen, dass sie nicht manipuliert wird.Sie wird in der <xref:System.ServiceModel.MsmqTransportSecurity.MsmqProtectionLevel%2A>\-Eigenschaft angegeben.Der Standardwert ist <xref:System.Net.Security.ProtectionLevel>.  
...
> [!NOTE]
>  Zum Verschlüsseln der Nachricht ist ein Active Directory\-Zugriff erforderlich \(`UseActiveDirectory`\-Eigenschaft von <xref:System.ServiceModel.NetMsmqBinding> muss auf `true` festgelegt werden\), der wiederum mit <xref:System.ServiceModel.MsmqAuthenticationMode> und <xref:System.ServiceModel.MsmqAuthenticationMode> verwendet werden kann.  
  
#### Ohne Schutzebene  
 Dies wird impliziert, wenn <xref:System.ServiceModel.MsmqTransportSecurity.MsmqProtectionLevel%2A> auf <xref:System.Net.Security.ProtectionLevel> festgelegt wurde.Dies ist kein gültiger Wert für andere Authentifizierungsmodi.  
