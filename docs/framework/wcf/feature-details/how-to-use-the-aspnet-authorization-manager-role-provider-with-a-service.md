---
title: "Vorgehensweise: Verwenden des Rollenanbieters f&#252;r den ASP.NET-Autorisierungs-Manager bei einem Dienst | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] zum Integrieren eines [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)]\-Rollenanbieters mit einer [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]\-Anwendung finden Sie unter [Vorgehensweise: Verwenden des Rollenanbieters für den ASP.NET bei einem Dienst](../../../../docs/framework/wcf/feature-details/how-to-use-the-aspnet-role-provider-with-a-service.md).  [!INCLUDE[crabout](../../../../includes/crabout-md.md)] zum Verwenden des Autorisierungs\-Managers in [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] finden Sie unter [Gewusst wie: Verwenden des Autorisierungs\-Managers \(AzMan\) mit ASP.NET 2.0](http://go.microsoft.com/fwlink/?LinkId=71303).  
