...
## <a name="chain-trust-and-certificate-authorities"></a>Vertrauensketten und Zertifizierungsstellen  
 ...
 Digitale Zertifikate werden verwendet, um eine Entität zu authentifizieren, durch die Verwendung dieser Hierarchie, die so genannte eine *Vertrauenskette*. Sie können die Kette eines beliebigen Zertifikats, die über das MMC-Snap-in, indem auf das Zertifikat doppelklicken und anschließend auf Anzeigen der **Zertifikatpfad** Registerkarte. Weitere Informationen zum Importieren von Zertifikatketten für eine Zertifizierungsstelle finden Sie unter [Vorgehensweise: Geben Sie das Zertifikat Autorität Zertifikatkette zum Überprüfen von Signaturen](../../../../docs/framework/wcf/feature-details/specify-the-certificate-authority-chain-verify-signatures-wcf.md).  
