...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Eine Übersicht über die Transaktionsfunktion, die von [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] bereitgestellt wird.  
 ...
 Beschreibt WS-AtomicTransaction (WS-AT), ein interoperables Transaktionsweitergabeprotokoll, das in [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] implementiert wird.  
 ...
 Beschreibt die Transaktionsfunktionen, die von [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] bereitgestellt werden  
