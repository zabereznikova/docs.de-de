...
ms.locfileid: "33498169"
---
# <a name="transactions-in-wcf"></a>Transaktionen in WCF
Der Windows Communication Foundation (WCF)--Transaktionsfunktion ermöglicht es, mehrere Komponenten, gleichzeitig an einem Datenvorgang teilzunehmen. In den Themen in diesem Abschnitt wird diese Funktion ausführlich behandelt.  
...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Beschreibt WS-AtomicTransaction (WS-AT), ein interoperables transaktionsweitergabeprotokoll, die in WCF implementiert wird.  
 ...
 Beschreibt die Transaktionsfunktionen, die von WCF bereitgestellt.  
