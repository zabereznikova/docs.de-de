...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 [Generieren eines WCF-Clients aus Dienstmetadaten](../../../../docs/framework/wcf/feature-details/generating-a-wcf-client-from-service-metadata.md)  
 Veranschaulicht, wie Metadaten mit Svcutil.exe abgerufen werden und wie ein [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)]-Client generiert wird.  
