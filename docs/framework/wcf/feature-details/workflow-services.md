...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 [Gewusst wie: Zugreifen auf einen Dienst aus einer Workflowanwendung](../../../../docs/framework/wcf/feature-details/how-to-access-a-service-from-a-workflow-application.md)  
 ...
 [Verarbeitung von Nachrichten außerhalb der normalen Reihenfolge](../../../../docs/framework/wcf/feature-details/out-of-order-message-processing.md)  
