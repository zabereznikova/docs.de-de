...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Eine Übersicht darüber, wie WCF Security in verteilten anwendungstopografie bereitstellt.  
  
 [Sicherheitsterminologie](../../../../docs/framework/wcf/feature-details/wcf-security-terminology.md)  
 Ein Glossar mit Begriffen, die bei der Erörterung von WCF-Sicherheit verwendet werden soll.  
