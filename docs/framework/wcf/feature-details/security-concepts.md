...
In diesem Abschnitt wird kurz erläutert, die Verwaltungskonzepte im Zusammenhang mit Windows Communication Foundation (WCF)-Sicherheit.  
...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Einen Überblick darüber, wie WCF Sicherheit in verteilten anwendungstopografie bereitstellt.  
  
 [Sicherheitsterminologie](../../../../docs/framework/wcf/feature-details/wcf-security-terminology.md)  
 Ein Glossar von Begriffen zum Thema der WCF-Sicherheit.  
