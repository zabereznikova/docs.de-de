...
## <a name="mode-1-channel-context-management"></a>Modus 1: Kanal Kontext Verwaltung  
...
## <a name="mode-2-application-context-management"></a>Modus 2: Anwendungskontext Verwaltung  
