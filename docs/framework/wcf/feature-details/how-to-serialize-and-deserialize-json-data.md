...
2. Serialisieren Sie das `Person`-Objekt mithilfe des <xref:System.Runtime.Serialization.Json.DataContractJsonSerializer>in einen Speicherdaten Strom.
