...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 [Vorgehensweise: Hosten einer nicht-dienstworkflows in IIS](../../../../docs/framework/wcf/feature-details/how-to-host-a-non-service-workflow-in-iis.md)  
 Veranschaulicht das Hosten eines Workflows, der kein Workflowdienst in IIS ist.  
  
 [Vorgehensweise: Hosten ein Workflowdiensts mit Windows Server AppFabric](../../../../docs/framework/wcf/feature-details/how-to-host-a-workflow-service-with-windows-server-app-fabric.md)  
