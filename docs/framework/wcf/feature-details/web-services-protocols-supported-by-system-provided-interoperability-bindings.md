...
|Metadaten|WS-Richtlinie|[WS-Policy](https://go.microsoft.com/fwlink/?LinkId=94864)<br /><br /> WCF verwendet die WS-richtlinienspezifikation zusammen mit domänenspezifischen Assertionen zur Beschreibung von dienstanforderungen und-Funktionen an.|  
|Metadaten|WS-Richtlinie 1.5|[WS-Policy 1.5](https://go.microsoft.com/fwlink/?LinkId=95327)<br /><br /> WCF verwendet die WS-richtlinienspezifikation zusammen mit domänenspezifischen Assertionen zur Beschreibung von dienstanforderungen und-Funktionen an.|  
