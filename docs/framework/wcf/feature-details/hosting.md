...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Beschreibt, wie ein Windows Communication Foundation (WCF)-Dienst in Internetinformationsdiensten gehostet wird oder [Windows Server AppFabric](https://go.microsoft.com/fwlink/?LinkId=196496).  
