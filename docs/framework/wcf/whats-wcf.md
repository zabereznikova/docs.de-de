---
title: "Was ist die Windows Communication Foundation? | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Windows Communication Foundation (WCF), Technologie – Übersicht"
  - "Technologieübersicht [WCF]"
  - "WCF [WCF], Technologie – Übersicht"
...
## Funktionen von WCF  
 [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] enthält die folgenden Funktionen.[!INCLUDE[crdefault](../../../includes/crdefault-md.md)] [Details zur WCF\-Funktion](../../../docs/framework/wcf/feature-details/index.md).  
