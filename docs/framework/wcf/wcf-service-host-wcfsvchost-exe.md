...
[!INCLUDE[indigo1](../../../includes/indigo1-md.md)] -Diensthost (WcfSvcHost.exe) können Sie zum Starten von Visual Studio-Debugger (F5), um automatisch hosten, und Testen Sie einen Dienst implementiert wurden. Anschließend können Sie den Dienst mit dem [!INCLUDE[indigo2](../../../includes/indigo2-md.md)]-Testclient (WcfTestClient.exe) oder Ihrem eigenen Client testen, um potenzielle Fehler zu identifizieren und zu beheben.  
  
## <a name="wcf-service-host"></a>WCF-Diensthost  
 Der [!INCLUDE[indigo2](../../../includes/indigo2-md.md)]-Diensthost listet die Dienste in einem [!INCLUDE[indigo2](../../../includes/indigo2-md.md)]-Dienstprojekt auf, lädt die Projektkonfiguration und instanziiert einen Host für jeden gefundenen Dienst. Das Tool ist in Visual Studio über integriert die [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] -Dienstvorlage und wird beim Starten des Debuggen des Projekts aufgerufen.  
...
> [!NOTE]
>  Der [!INCLUDE[indigo2](../../../includes/indigo2-md.md)]-Diensthost unterstützt teilweise Vertrauenswürdigkeit nicht. Wenn Sie verwenden möchten eine [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] Dienst in einer teilweise vertrauenswürdigen, verwenden Sie nicht die [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] -dienstbibliotheksprojektvorlage in Visual Studio zur Erstellung des Diensts. Erstellen Sie stattdessen eine neue WebSite in Visual Studio durch Auswählen der [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] -dienstwebsitevorlage, die den Dienst in einem WebServer hosten kann [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] teilweise Vertrauenswürdigkeit unterstützt.  
...
#### <a name="using-wcf-test-client"></a>Verwenden des WCF-Testclients  
 ...
 Um sicherzustellen, dass [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] Testclient dient der rechten Maustaste auf das Projekt in **Projektmappen-Explorer** wählen Sie in Visual Studio **Eigenschaften**, und wählen Sie dann die **Debuggen**Registerkarte. Klicken Sie auf **Startprojekt** und stellen Sie sicher, dass der Folgendes angezeigt wird der **Befehlszeilenargumente** (Dialogfeld).  
...
#### <a name="specifying-no-client"></a>Keine Angabe des Clients  
 Um anzugeben, dass kein Client nach verwendet werden soll [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] service hosting der rechten Maustaste auf das Projekt in **Projektmappen-Explorer** wählen Sie in Visual Studio **Eigenschaften**, und wählen Sie dann die  **Debuggen** Registerkarte. Klicken Sie auf **Startprojekt** und lassen Sie die **Befehlszeilenargumente** Dialogfeld leer.  
