...
ms.locfileid: "43487444"
---
# <a name="set-up-instructions"></a>Setupanweisungen
Diese Reihe von Themen wird beschrieben, wie Dienste einrichten, die erforderlich sind, um ein Windows Communication Foundation (WCF)-Dienst ausgeführt wird.  
...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Beschreibt die Schritte zum Einrichten der WCF-Beispiele.  
  
 [Firewall-Anweisungen](../../../../docs/framework/wcf/samples/firewall-instructions.md)  
 Beschreibt die Schritte zum Einrichten der Windows-Firewall zum Zulassen von WCF-Dienste funktionieren erforderlich sind.  
 ...
 Beschreibt die Schritte zum Erstellen von WCF-Beispiele.  
  
 [Durchführen der Windows Communication Foundation-Beispiele](../../../../docs/framework/wcf/samples/running-the-samples.md)  
 Beschreibt die Schritte für die WCF-Beispiele ausführen, auf dem gleichen Computer und computerübergreifend.  
  
 [Aktivieren von Peer-zu-Peer-Diensten](https://msdn.microsoft.com/library/e7a0fcf4-b0e5-4b26-a7e3-f0f37b60a1f9)  
