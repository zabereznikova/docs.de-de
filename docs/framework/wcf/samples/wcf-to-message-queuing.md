...
> [!NOTE]
> Dieses Beispiel erfordert die Installation von Message Queuing. Weitere Informationen finden Sie in den Installationsanweisungen in [Message Queuing](https://go.microsoft.com/fwlink/?LinkId=94968).  
