...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 [Erweiterte Fehlerbehandlung](../../../../docs/framework/wcf/samples/advanced-error-handling.md)  
 Veranschaulicht, wie der Routingdienst eine intelligente Fehlerwiederherstellung mit Transaktionen und anderen komplexen Messagingkonzepten (z. B. Multicasting) ausführt.
