...
1. Klicken Sie auf das **Startmenü** und wählen Sie **Ausführen...**.  
  
2. Geben Sie `eventvwr` ein und klicken Sie dann auf **OK**.  
  
3. Klicken Sie im Fenster Ereignisanzeige auf **Anwendung**.  
  
4. Doppelklicken Sie im **Anwendungsfenster** auf das kürzlich hinzugefügte Ereignis "System.ServiceModel 4.0.0.0" unter der Kategorie "WebHost", um unsichere Endpunktmeldungen anzuzeigen.  
