...
> [!NOTE]
>  Stellen Sie sicher Sie ausgeführt haben, erstellen oder einen WCF-Beispiele ausführen können, die [Setupprozedur für die Windows Communication Foundation-Beispiele zum einmaligen](../../../../docs/framework/wcf/samples/one-time-setup-procedure-for-the-wcf-samples.md).  
