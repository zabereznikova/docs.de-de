...
```  
 ...
 Um diesen Konfigurationshandler zu verwenden, er muss registriert werden innerhalb der [ \<system.serviceModel >](../../../../docs/framework/configure-apps/file-schema/wcf/system-servicemodel.md) Element, wie in der folgenden Beispielkonfiguration dargestellt.  
