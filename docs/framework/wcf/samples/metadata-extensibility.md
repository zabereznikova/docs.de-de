...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Veranschaulicht, wie einen Dienst mit einem sicheren Metadatenendpunkt implementiert, die eines der nicht-standardmetadatenaustausch-Bindungen verwendet und zum Konfigurieren [ServiceModel Metadata Utility Tool (Svcutil.exe)](../../../../docs/framework/wcf/servicemodel-metadata-utility-tool-svcutil-exe.md) oder Clients, Metadaten abzurufen. eines metadatenendpunkts.  
