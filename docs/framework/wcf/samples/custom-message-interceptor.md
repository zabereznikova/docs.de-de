---
title: "Benutzerdefinierter Nachrichteninterceptor | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Hinzufügen eines Bindungselements  
 Das Beispiel definiert ein benutzerdefiniertes Bindungselement: `InterceptingBindingElement`.`InterceptingBindingElement` nimmt einen `ChannelMessageInterceptor` als Eingabe und verwendet diesen `ChannelMessageInterceptor`, um durchkommende Nachrichten zu bearbeiten.Dies ist die einzige Klasse, die öffentlich sein muss.Die Factory, der Listener und die Kanäle können alle interne Implementierungen der öffentlichen Laufzeitschnittstellen sein.  
...
4.  Wenn Sie das Beispiel in einer Konfiguration mit einem Computer oder computerübergreifend ausführen möchten, folgen Sie den unter [Durchführen der Windows Communication Foundation\-Beispiele](../../../../docs/framework/wcf/samples/running-the-samples.md) aufgeführten Anweisungen.  
