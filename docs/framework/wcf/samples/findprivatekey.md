...
1. Open [!INCLUDE[fileExplorer](../../../../includes/fileexplorer-md.md)] und navigieren Sie zu der *WF_WCF_Samples\WCF\Setup\FindPrivateKey\CS* Ordner, in dem Verzeichnis, in dem Sie das Beispiel installiert haben.
