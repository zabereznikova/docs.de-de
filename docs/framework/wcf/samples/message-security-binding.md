...
ms.locfileid: "50047721"
---
# <a name="message-security-binding"></a>Nachrichtensicherheitsbindung
Dieser Abschnitt enthält Beispiele, in denen nachrichtensicherheitsbindung in Windows-Diensten in WCF.  
  
## <a name="in-this-section"></a>In diesem Abschnitt  
 [Nachrichtensicherheit – anonym](../../../../docs/framework/wcf/samples/message-security-anonymous.md)  
 Dieses Beispiel veranschaulicht, wie eine Windows Communication Foundation (WCF)-Anwendung implementiert wird, die Sicherheit auf Nachrichtenebene ohne Clientauthentifizierung verwendet, aber erfordert Server-Authentifizierung mithilfe von x. 509-Zertifikat des Servers.  
  
 [Nachrichtensicherheitszertifikat](../../../../docs/framework/wcf/samples/message-security-certificate.md)  
 ...
 [Nachrichtensicherheit – Windows](../../../../docs/framework/wcf/samples/message-security-windows.md)  
