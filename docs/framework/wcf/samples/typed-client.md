...
---
# <a name="typed-client"></a>Typisierter Client
Das Beispiel veranschaulicht, wie Informationen von einem typisierten Client abgerufen werden, der vom [ServiceModel Metadata Utility Tool (Svcutil.exe)](../../../../docs/framework/wcf/servicemodel-metadata-utility-tool-svcutil-exe.md)generiert wird. Dieses Beispiel basiert auf dem [Ersten Schritte,](../../../../docs/framework/wcf/samples/getting-started-sample.md) der einen Rechnerdienst implementiert. In diesem Beispiel ist der Client eine Konsolenanwendung (.exe), und der Dienst wird von IIS (Internet Information Services, Internetinformationsdienste) gehostet.  
  
> [!NOTE]
> Die Setupprozedur und die Buildanweisungen für dieses Beispiel befinden sich am Ende dieses Themas.  
  
 Die `Endpoint`-Eigenschaften des Clients erlauben den Zugriff auf Informationen über den Dienstendpunkt, mit dem der Client kommuniziert, einschließlich Adress-, Bindungs- und Vertragsinformationen. Die `InnerChannel`-Eigenschaft des Clients ist eine Instanz von <xref:System.ServiceModel.IClientChannel>, die den Zugriff auf Informationen über den zugrunde liegenden Kanal erlaubt, wie z.&#160;B. zu seinem Zustand und seiner Sitzungs-ID.  
