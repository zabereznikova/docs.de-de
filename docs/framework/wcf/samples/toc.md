...
#### [Internet-Internetinformationsdiensts](internet-information-service-hosting-instructions.md)
#### [Internetinformation Services (IIS)-Server-Zertifikat-Installationsanweisungen](iis-server-certificate-installation-instructions.md)
#### [Virtuelles Verzeichnis Setupanweisungen](virtual-directory-setup-instructions.md)
...
### [Ausführen der Windows Communication Foundation-Beispiele](running-the-samples.md)
## [Standard](basic.md)
...
### [Bindung](binding.md)
#### [Dem ByteStream-Encoder](bytestream-encoder.md)
...
##### [Standardbindung](basicbinding.md)
#### [Benutzerdefinierte Bindung](custom-binding.md)
##### [Imperativ für benutzerdefinierte Bindungen](custom-binding-imperative.md)
##### [Binden von Transport und Codierung für benutzerdefinierte](custom-binding-transport-and-encoding.md)
...
###### [Volatile-Warteschlangenkommunikation](volatile-queued-communication.md)
###### [Warteschlangen für unzustellbare](dead-letter-queues.md)
###### [Beschädigten Sie in MSMQ 4.0 Handhabung von Nachrichten](poison-message-handling-in-msmq-4-0.md)
...
##### [Interoperation mit ASMX-Webdienste](interoperating-with-asmx-web-services.md)
...
#### [Abrufen von Metadaten](retrieve-metadata.md)
...
##### [Die Verwendung und die Stileigenschaften festlegen](setting-the-use-and-style-properties.md)
##### [XmlReader-Beispiel](xmlreader-sample.md)
#### [Dienstverträge](service-contracts.md)
##### [Duplex](duplex.md)
##### [Fehlervertrag](fault-contract.md)
##### [Unidirektionale](one-way.md)
##### [Sitzung](session.md)
##### [Stream](stream.md)
...
#### [Verwenden zum Bereitstellen der Funktionen für NetDataContractSerializer DataContractSerializer und DataContractResolver](datacontractserializer-datacontractresolver-netdatacontractserializer.md)
...
#### [Ermittlungsbindungselement](discovery-binding-element-sample.md)
...
#### [Für Workflowsuche](workflow-discovery-sample.md)
...
#### [PII Sicherheitssperre](pii-security-lockdown.md)
...
### [Dienste](services.md)
#### [Hosting](hosting.md)
##### [Windows-Prozessaktivierungsdienst](windows-process-activation.md)
...
##### [Selbsthosting](self-host.md)
#### [Dienst-Interoperabilität](service-interoperability.md)
##### [Mithilfe des WCF-Monikers mit COM-Clients](using-the-wcf-moniker-with-com-clients.md)
##### [ASMX-Client mit einem WCF-Dienst](asmx-client-with-a-wcf-service.md)
#### [Verhalten](behaviors.md)
##### [Parallelität](concurrency.md)
##### [Standardverhalten von Diensten](default-service-behavior.md)
...
###### [Identität des Clients angenommen](impersonating-the-client.md)
...
#### [Grundlegende HTTP-Dienst](basic-http-service.md)
...
#### [URI-Vorlage](uritemplate-sample.md)
...
#### [Zuverlässige, sichere Profil](reliable-secure-profile.md)
...
#### [Benutzer und Kennwort-Validierungssteuerelement](user-name-password-validator.md)
...
#### [Benutzerdefinierte Token](custom-token.md)
...
### [Nachrichten-Inspektoren](message-inspectors.md)
### [WebContentTypeMapper](webcontenttypemapper-sample.md)
## [Szenario](scenario.md)
### [Datenbindungsszenarien](data-binding-scenarios.md)
#### [Datenbindung in einer Windows Forms-Client](data-binding-in-a-windows-forms-client.md)
...
### [Für Ermittlungssicherheit](discovery-security-sample.md)
