...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Veranschaulicht, wie WCF zum Erstellen eines einfachen (ASP.NET Asynchronous JavaScript and XML (AJAX)-Diensts.  
  
 [AJAX-Dienst mit HTTP POST](../../../../docs/framework/wcf/samples/ajax-service-using-http-post.md)  
 Veranschaulicht, wie WCF zum Erstellen einer [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] Asynchronous JavaScript and XML (AJAX)-Dienst, der HTTP POST verwendet.  
 ...
 Veranschaulicht, wie WCF verwenden, um einen Dienst (ASP.NET Asynchronous JavaScript and XML (AJAX) zu erstellen, der Instanzen komplexer Typen erstellt.  
  
 [AJAX-Dienst mit JSON und XML](../../../../docs/framework/wcf/samples/ajax-service-with-json-and-xml-sample.md)  
 Veranschaulicht, wie WCF verwenden, um ein Dienst Asynchronous JavaScript and XML (AJAX) zu erstellen, der JavaScript Objekt Notation (JSON) oder XML-Daten zurückgibt.
