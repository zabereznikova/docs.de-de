...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Zeigt den lokalen Kanal, einen WCF-Transportkanal, der für die Kommunikation innerhalb derselben Anwendungsdomäne verwendet wird.  
  
 [Reliable Secure Profile](../../../../docs/framework/wcf/samples/reliable-secure-profile.md)  
 Veranschaulicht, wie WCF und Reliable Secure Profile (RSP) verfasst.  
 ...
 Veranschaulicht, wie die Menge an Arbeitsspeicher verwendet, um große Nachrichten über WCF Puffern beschränken.
