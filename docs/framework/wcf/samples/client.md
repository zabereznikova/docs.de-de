...
## In diesem Abschnitt  
 ...
 Veranschaulicht, wie Informationen von einem typisierten Client abgerufen werden, der vom [ServiceModel Metadata Utility\-Tool \(Svcutil.exe\)](../../../../docs/framework/wcf/servicemodel-metadata-utility-tool-svcutil-exe.md) generiert wurde.