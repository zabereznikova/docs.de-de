...
Dieser Abschnitt enthält Beispiele für die Veröffentlichung von Windows Communication Foundation (WCF).  
  
## <a name="in-this-section"></a>In diesem Abschnitt  
 [Eigenständiger Diagnosefeed](../../../../docs/framework/wcf/samples/stand-alone-diagnostics-feed-sample.md)  
 Erstellen Sie einen RSS-/Atom-feed für die Syndizierung mit WCF veranschaulicht.  
