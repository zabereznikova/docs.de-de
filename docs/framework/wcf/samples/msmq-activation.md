...
2.  Stellen Sie sicher, dass Sie ausgeführt haben die [Setupprozedur für die Windows Communication Foundation-Beispiele zum einmaligen](../../../../docs/framework/wcf/samples/one-time-setup-procedure-for-the-wcf-samples.md). Außerdem müssen Sie die [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]-Aktivierungskomponenten für andere Protokolle als HTTP installieren:  
