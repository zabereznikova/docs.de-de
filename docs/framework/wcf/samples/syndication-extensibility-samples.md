...
Dieser Abschnitt enthält Beispiele, in denen benutzerdefinierte Syndication in Windows Communication Foundation (WCF) veranschaulicht.  
  
## <a name="in-this-section"></a>In diesem Abschnitt  
 [Stark typisierte Erweiterungen](../../../../docs/framework/wcf/samples/strongly-typed-extensions-sample.md)  
 Erläutert, wie ein im vorgeschlagenen RFC zu Atom-Threading-Erweiterungen definiertes Erweiterungselement implementiert wird.  
