...
## <a name="in-this-section"></a>In diesem Abschnitt  
 [Net MSMQ-Bindung](../../../../docs/framework/wcf/samples/net-msmq-binding.md)  
 ...
 Veranschaulicht die Integration zwischen Message Queuing und [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)].  
  
 [NetTCPBinding](../../../../docs/framework/wcf/samples/nettcpbinding.md)  
 Veranschaulicht die Verwendung der TCP-Bindung in [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)].  
