...
- <span data-ttu-id="9609c-170">Erstellen des Serverzertifikats.</span><span class="sxs-lookup"><span data-stu-id="9609c-170">Creating the server certificate.</span></span>  
