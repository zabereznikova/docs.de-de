...
-   <span data-ttu-id="f4657-170">Erstellen des Serverzertifikats.</span><span class="sxs-lookup"><span data-stu-id="f4657-170">Creating the server certificate.</span></span>  
