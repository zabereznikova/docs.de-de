...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Veranschaulicht, wie Daten, die von einem typischen [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]-Dienst zurückgegeben wurden, in einer Web Forms-Anwendung gebunden werden.  
  
 [Datenbindung in einem Windows Presentation Foundation-Client](../../../../docs/framework/wcf/samples/data-binding-in-a-wpf-client.md)  
 Veranschaulicht die Verwendung der Datenbindung in einem [!INCLUDE[avalon1](../../../../includes/avalon1-md.md)]-Client.
