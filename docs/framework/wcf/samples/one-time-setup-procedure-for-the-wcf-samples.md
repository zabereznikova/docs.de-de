...
3.  Wenn [!INCLUDE[vs_current_long](../../../../includes/vs-current-long-md.md)] nicht installiert ist, und das Betriebssystem ist nicht Windows Server 2008 SP2 oder höher installieren [Hotfix 251798](https://go.microsoft.com/fwlink/?LinkId=184693).  
  
4.  Führen Sie die folgenden Befehle durch. Weitere Informationen dazu, warum diese Befehle ausgeführt werden müssen, finden Sie unter [IIS gehosteten Dienst nicht](https://msdn.microsoft.com/library/ee5499fc-1b10-4cda-a9b1-13dba70f05f8).  
...
6.  Überprüfen Sie im folgenden Standardverzeichnis: \<InstallDrive >:**\WF_WCF_Samples**. Wenn die Beispiele bereits installiert wurden, ist dies das Standardverzeichnis.  
...
8.  Nach dem Installieren der Beispiele finden Sie unter: \<InstallDrive >:**\WF_WCF_Samples\WCF\Setup\\**  
