...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Veranschaulicht, wie [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]-Entwicklern die Arbeit mit deserialisierten, beliebigen JSON-Objekten ermöglicht wird, ohne benutzerdefinierte Typen zu erstellen.  
