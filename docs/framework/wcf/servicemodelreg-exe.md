...
> [!NOTE]
> Wenn das Service Model-Registrierungs Tool auf [!INCLUDE[wv](../../../includes/wv-md.md)]ausgeführt wird, zeigt das Dialogfeld **Windows-Funktionen** möglicherweise nicht an, dass die **Windows Communication Foundation http-Aktivierungs** Option unter **Microsoft .NET Framework 3,0** aktiviert ist. Sie können auf das Dialogfeld " **Windows-Features** " zugreifen, indem Sie auf **Start**und dann auf **Ausführen** klicken und dann **OptionalFeatures**eingeben.  
