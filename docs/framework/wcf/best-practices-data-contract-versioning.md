---
title: "Empfohlene Vorgehensweisen: Versionsverwaltung von Datenvertr&#228;gen | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Bewährte Methoden [WCF], Datenvertragsversionsverwaltung"
  - "Datenverträge"
  - "Dienstverträge"
  - "Windows Communication Foundation, Datenverträge"
...
## Versionsverwaltung, wenn eine Schemavalidierung erforderlich ist  
 ...
 [!INCLUDE[crdefault](../../../includes/crdefault-md.md)] empfohlene Vorgehensweisen: [Dienstversionsverwaltung](../../../docs/framework/wcf/service-versioning.md).  
...
-   Wenden Sie ein <xref:System.ServiceModel.ServiceBehaviorAttribute>\-Attribut auf Ihren Dienstvertrag an, und legen Sie die <xref:System.ServiceModel.ServiceBehaviorAttribute.IgnoreExtensionDataObject%2A>\-Eigenschaft dabei auf `true` fest.  
 ...
 [!INCLUDE[crabout](../../../includes/crabout-md.md)] zu Roundtrips finden Sie unter [Aufwärtskompatible Datenverträge](../../../docs/framework/wcf/feature-details/forward-compatible-data-contracts.md).  
  
## Versionsverwaltung, wenn eine Schemavalidierung nicht erforderlich ist  
 Die genaue Schemakompatibilität ist nur selten erforderlich.  Viele Plattformen tolerieren zusätzliche Elemente, die von einem Schema nicht beschrieben werden.  Solange dies toleriert wird, können Sie alle Funktionen verwenden, die unter [Datenvertragsversionsverwaltung](../../../docs/framework/wcf/feature-details/data-contract-versioning.md) und [Aufwärtskompatible Datenverträge](../../../docs/framework/wcf/feature-details/forward-compatible-data-contracts.md) beschrieben sind.  Die folgenden Richtlinien sind zu empfehlen.  
...
11. Ändern Sie die `EmitDefaultValue`\-Eigenschaft für erforderliche Datenmember \(wobei `IsRequired` den Wert `true` hat\) nicht von Version zu Version.  
