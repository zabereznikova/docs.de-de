...
-   Wenn Sie möchten, erweitern oder anpassen [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] entsprechend Ihren Anforderungen finden Sie unter [Erweitern von WCF](../../../docs/framework/wcf/extending/index.md).  
