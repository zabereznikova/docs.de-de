...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis gibt an, dass der WS-Atomic Transaction-Protokolldienst angehalten wurde. Das Ereignis führt die Protokoll-ID, den Protokollnamen, den Prozessnamen und die Prozess-ID auf. sein.  
