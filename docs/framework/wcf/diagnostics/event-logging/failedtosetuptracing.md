...
manager: wpickett
ms.workload: dotnet
ms.openlocfilehash: 5359fbfe4292d7b9e553aed37a2bcff49f1f4c98
...
## <a name="description"></a>Beschreibung  
 Ein Versuch, die Ablaufverfolgung einzurichten, ist fehlgeschlagen. Die Ablaufverfolgung ist deaktiviert.  
  
 Das Ereignis führt die Ausnahme, den Prozessnamen und die Prozess-ID auf.  
