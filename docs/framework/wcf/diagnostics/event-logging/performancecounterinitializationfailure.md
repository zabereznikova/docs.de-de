...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis gibt an, dass ein Leistungsindikator nicht initialisiert werden konnte. Das Ereignis listet den Zählernamen, die Ausnahme, den Prozessnamen und die Prozess-ID auf.  
