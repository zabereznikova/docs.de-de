...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis gibt an, dass beim Behandeln einer Windows Process Activation Service (WAS)-Benachrichtigung ein unerwarteter Fehler im Listener-Adapter aufgetreten ist. Der Prozess wird beendet. Das Ereignis führt das Protokoll, die Ausnahme, den Prozessnamen sowie die Prozess-ID auf.  
