...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis gibt an, dass ein ungültiger Nachrichtenprotokollierungsfilter, der auf den Nachrichtentext zugriff, entfernt wurde. Das Ereignis listet den XPath, den Prozessnamen und die Prozess-ID auf.  
