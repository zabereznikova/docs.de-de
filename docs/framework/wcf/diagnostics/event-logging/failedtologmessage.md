...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis gibt an, dass eine Nachricht nicht protokolliert wurde. Das Ereignis führt die Ausnahme, den Prozessnamen und die Prozess-ID auf.  
