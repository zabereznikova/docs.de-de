...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis gibt an, dass die PII-Protokollierung aktiviert wurde. Vertrauliche Informationen werden protokolliert. Das Ereignis führt den Prozessnamen und die Prozess-ID auf.  
