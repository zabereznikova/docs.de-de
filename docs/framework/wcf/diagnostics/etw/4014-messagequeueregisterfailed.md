...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird ausgegeben, wenn die Registrierung der Nachrichtenwarteschlange fehlgeschlagen ist.  
  
## <a name="message"></a>Meldung  
 Fehler bei der Registrierung der Nachrichtenwarteschlange für URI "%1", Status: "%2".  
