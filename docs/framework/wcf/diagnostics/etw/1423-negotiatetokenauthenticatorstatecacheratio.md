...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird ausgegeben, um das Verhältnis von Aushandlungen für den Tokenauthentifizierungs-Zustandscache bereitzustellen.  
  
## <a name="message"></a>Meldung  
 Verhältnis von Aushandlungen für Tokenauthentifizierungs-Zustandscache: %1%2  
