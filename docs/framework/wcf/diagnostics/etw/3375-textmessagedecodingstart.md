...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird ausgegeben, wenn das Decodieren der Nachricht von TextMessageEncoder gestartet wurde.  
  
## <a name="message"></a>Meldung  
 Das Decodieren der Nachricht wurde von TextMessageEncoder gestartet.  
