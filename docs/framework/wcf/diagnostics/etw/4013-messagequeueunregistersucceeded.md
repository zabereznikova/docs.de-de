...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird ausgegeben, wenn das Aufheben der Registrierung der Nachrichtenwarteschlange erfolgreich war.  
  
## <a name="message"></a>Meldung  
 Die Aufhebung der Registrierung der Nachrichtenwarteschlange für URI "%1" war erfolgreich.  
