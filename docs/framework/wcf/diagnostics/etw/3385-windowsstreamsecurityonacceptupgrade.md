...
## <a name="description"></a>Beschreibung  
 Das Ereignis wird ausgegeben, wenn die Windows-Streamsicherheit das Sicherheitsupgrade akzeptiert.  
  
## <a name="message"></a>Meldung  
 Windows-Streamingsicherheit akzeptiert Upgrade.  
