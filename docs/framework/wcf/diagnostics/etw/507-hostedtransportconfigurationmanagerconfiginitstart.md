...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird ausgegeben, wenn die HostedTransportConfigurationManager-Initialisierung gestartet wurde.  
  
## <a name="message"></a>Meldung  
 HostedTransportConfigurationManager-Konfigurationsinitialisierung starten.  
