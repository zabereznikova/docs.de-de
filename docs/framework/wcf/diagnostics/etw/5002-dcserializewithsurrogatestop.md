...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird ausgegeben, wenn die DataContract-Serialisierung mit Surrogates beendet wird.  
  
## <a name="message"></a>Meldung  
 DataContract-Serialisierung mit Surrogates anhalten.  
