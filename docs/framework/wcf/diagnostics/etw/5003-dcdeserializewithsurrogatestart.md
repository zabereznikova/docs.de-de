...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird ausgegeben, wenn die DataContract-Deserialisierung mit Surrogates startet.  
  
## <a name="message"></a>Meldung  
 DataContract-Deserialisierung von "%1" mit Surrogates starten.  
