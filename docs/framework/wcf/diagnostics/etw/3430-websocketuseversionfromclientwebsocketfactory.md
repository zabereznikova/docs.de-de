...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird ausgegeben, wenn die WebSocketVersion aus einer Client-WebSocket-Factory verwendet wird.  
  
## <a name="message"></a>Meldung  
 Es wird die WebSocketVersion aus einer Client-WebSocket-Factory vom Typ '%1' verwendet.  
