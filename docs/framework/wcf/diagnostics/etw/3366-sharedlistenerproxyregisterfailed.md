...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird ausgegeben, wenn die SharedListenerProxy-Registrierung fehlgeschlagen ist.  
  
## <a name="message"></a>Meldung  
 Fehler beim Registrieren von SharedListenerProxy mit Status "%1".  
