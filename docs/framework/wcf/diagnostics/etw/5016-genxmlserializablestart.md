...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird beim Starten der Generierung von serialisierbarem XML-Elementen ausgegeben.  
  
## <a name="message"></a>Meldung  
 Generierung von serialisierbarem XML-Element für "%1" starten.  
