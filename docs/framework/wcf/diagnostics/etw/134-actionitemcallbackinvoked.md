...
|-|-|  
|ID|134|  
|Stichwörter|Threading|  
|Ebene|Ausführlich|  
|Kanal|Microsoft-Windows-Application Server-Applications/Debug|  
  
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird ausgegeben, wenn der e/a-Thread threadplanungsrückruf aufgerufen endet.  
  
## <a name="message"></a>Meldung  
 E/a-Thread-threadplanungsrückruf aufgerufen.  
