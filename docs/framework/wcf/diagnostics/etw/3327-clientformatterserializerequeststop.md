...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird ausgegeben, wenn die Serialisierung der Anforderungsnachricht vom Client abgeschlossen wurde.  
  
## <a name="message"></a>Meldung  
 Die Serialisierung der Anforderungsnachricht wurde vom Client abgeschlossen.  
