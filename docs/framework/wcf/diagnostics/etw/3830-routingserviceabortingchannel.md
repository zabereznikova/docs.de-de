...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird ausgegeben, wenn der Routingdienst einen Abbruch für einen bestimmten Kanal aufruft.  
  
## <a name="message"></a>Meldung  
 Der Routingdienst ruft einen Abbruch auf folgendem Kanal auf: '%1'  
