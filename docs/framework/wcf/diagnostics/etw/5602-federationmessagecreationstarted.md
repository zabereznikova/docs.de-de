...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird ausgegeben, wenn die Erstellung der Verbundnachricht aus der Formularbereitstellung gestartet wurde.  
  
## <a name="message"></a>Meldung  
 Erstellung der Verbundnachricht aus der Formularbereitstellung gestartet.  
