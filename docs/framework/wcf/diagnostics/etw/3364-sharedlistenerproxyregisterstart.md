...
## <a name="description"></a>Beschreibung  
 Dieses Ereignis wird ausgegeben, wenn die SharedListenerProxy-Registrierung gestartet wurde.  
  
## <a name="message"></a>Meldung  
 Die SharedListenerProxy-Registrierung für URI "%1" wurde gestartet.  
