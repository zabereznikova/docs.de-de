...
In diesem Abschnitt werden alle Ausnahmen in den folgenden Bereichen generiert von Windows Communication Foundation (WCF) aufgelistet:  
 ...
 [Sicherheitsausnahmen](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/security-exceptions.md)  
  
 [Dienstframework](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/service-framework.md)  
  
 [Dienstframeworkdaten](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/service-framework-data.md)  
