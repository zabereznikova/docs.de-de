---
title: "IdentityModel-Ausnahmen | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|SAMLUnableToLoadAdvice|Konnte das Element \<saml:advice\-\> nicht laden.|  
...
|ValueMustBeZero|Der Wert dieses Arguments muss 0 \(null\) sein.|  
...
|SspiWrapperEncryptDecryptAssert1|SSPIWrapper::EncryptDecryptHelper &#124; "Offset" liegt außerhalb des Bereichs.|  
|SspiWrapperEncryptDecryptAssert2|SSPIWrapper::EncryptDecryptHelper &#124; "Size" liegt außerhalb des Bereichs.SecurityTokenManagerCannotCreateAuthenticatorForRequirement\=Der Sicherheitstoken\-Manager kann keinen Tokenauthentifizierer für diese bestimmte Anforderung erstellen.|  
...
|SAMLUnableToLoadAssertion|Das Element \<saml:assertion\-\> konnte nicht geladen werden.|  
...
|SAMLUnableToLoadConditions|Das Element \<saml:conditions\-\> konnte nicht geladen werden.|  
...
|SAMLUnableToLoadCondition|Das Element \<saml:conditions\-\> konnte nicht geladen werden.|  
...
|TraceCodeSecuritySessionRequestorOperationFailure|Der Clientsicherheitssitzungsvorgang ist fehlgeschlagen.|  
...
|SigningTokenHasNoKeys|Das angegebene Signiertoken verfügt über keine Schlüssel.|  
...
|TraceCodeStreamSecurityUpgradeAccepted|Das Datenstrom\-Sicherheitsupgrade wurde erfolgreich akzeptiert.|  
...
|TraceCodeIssuanceTokenProviderRemovedCachedToken|Der IssuanceTokenProvider hat das abgelaufene Diensttoken gelöscht.|  
|IncorrectUserNameFormat|Der Benutzername hat ein ungültiges Format.Das Benutzernamenformat muss die Form "Benutzername" oder "domain\\\\username" haben.|  
...
|TraceCodeNegotiationTokenProviderAttached|NegotiationTokenProvider wurde angehängt.|  
...
|TraceCodeSslClientCertMissing|Der Remote\-SSL\-Client hat kein erforderliches Zertifikat geliefert.|  
...
|FoundMultipleCerts|Es wurden mehrere X.509\-Zertifikate gefunden, die das angegebene Suchkriterium verwenden: StoreName, StoreLocation, FindType, FindValue.Geben Sie einen spezifischeren Fundwert an.|  
...
|TraceCodeSecurityServerSessionRenewalFaultSent|Die Serversicherheitssitzung hat einen "Schlüsselerneuerungs"\-Fehler an den Client gesendet.|  
...
|TraceCodeSecurityImpersonationSuccess|Sicherheitsidentitätswechsel fand erfolgreich am Server statt.|  
