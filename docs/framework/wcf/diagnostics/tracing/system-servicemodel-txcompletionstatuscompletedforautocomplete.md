...
Die angegebene Transaktion für den angegebenen Vorgang wurde abgeschlossen, da der  `OperationBehaviorAttribute.TransactionAutoComplete`-Member auf `true` festgelegt wird.  
  
## <a name="description"></a>Beschreibung  
 Wird nachverfolgt, wenn die Transaktion automatisch von der Infrastruktur im Namen des Benutzers abgeschlossen wird.  
