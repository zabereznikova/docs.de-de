...
Der WS-WS-Atomic-Transaktionsprotokolldienst wurde initialisiert.  
  
## <a name="description"></a>Beschreibung  
 Aufgezeichnet während des Starts des Transaktions-Managers, um anzugeben, welches Protokoll erfolgreich initialisiert wurde.  
