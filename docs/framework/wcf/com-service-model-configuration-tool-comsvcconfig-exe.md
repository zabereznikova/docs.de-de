---
title: "COM+ Service Model Configuration-Tool (ComSvcConfig.exe) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
>  Sie müssen Administrator auf dem lokalen Computer sein, um ComSvcConfig.exe zu verwenden.  
 ...
 Weitere Informationen über ComSvcConfig.exe finden Sie unter [Vorgehensweise: Verwenden des COM\+\-Dienstmodell\-Konfigurationstools](../../../docs/framework/wcf/feature-details/how-to-use-the-com-service-model-configuration-tool.md).  
...
|`/contract:<` *ClassID*  `&#124;`  *ProgID*  `&#124; *,` *InterfaceID*  `&#124;`  *InterfaceName*  `&#124; *` `>`|Gibt die COM\+\-Komponente und \-Schnittstelle an, die als Vertrag für den Dienst konfiguriert werden sollen.<br /><br /> Kurzform: `/c`.<br /><br /> Das Platzhalterzeichen \(\*\) kann zwar grundsätzlich zum Angeben der Komponenten\- und Schnittstellennamen verwendet werden, die Verwendung wird jedoch nicht empfohlen, da dabei unter Umständen unerwünschte Schnittstellen verfügbar gemacht werden.|  
