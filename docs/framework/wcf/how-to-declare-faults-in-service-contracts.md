...
1. Erstellen Sie einen Dienstvertrag, der mindestens einen Vorgang enthält. Ein Beispiel finden Sie unter [Gewusst wie: Definieren Sie einen Dienst](how-to-define-a-wcf-service-contract.md)Vertrag.
