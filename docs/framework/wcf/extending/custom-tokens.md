...
Obwohl [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] eine systemeigene Unterstützung für X.509-Zertifikate, Sicherheitskontexttoken, Kerberos-Tickets und Benutzernamentoken als Anmeldeinformationen unterstützt, ist es so flexibel, dass Sie auch benutzerdefinierte Anmeldeinformationen verwenden können.  
