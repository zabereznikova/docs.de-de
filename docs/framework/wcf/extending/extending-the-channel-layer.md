...
---
# <a name="extending-the-channel-layer"></a>Erweitern der Kanalschicht
...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 [Benutzerdefinierte Streamupgrades](../../../../docs/framework/wcf/extending/custom-stream-upgrades.md)  
