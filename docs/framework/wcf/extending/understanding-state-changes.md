...
|State|Wurde Abort aufgerufen?|Ausnahme|  
|-----------|----------------------------|---------------|  
|Erstellt|N/V|<xref:System.InvalidOperationException?displayProperty=nameWithType>|  
|Öffnen|N/V|<xref:System.InvalidOperationException?displayProperty=nameWithType>|  
|Geöffnet|N/V|<xref:System.InvalidOperationException?displayProperty=nameWithType>|  
|Schließen|Ja|<xref:System.ServiceModel.CommunicationObjectAbortedException?displayProperty=nameWithType>|  
|Schließen|Nein |<xref:System.ObjectDisposedException?displayProperty=nameWithType>|  
...
|Fehlerhaft|N/V|<xref:System.ServiceModel.CommunicationObjectFaultedException?displayProperty=nameWithType>|  
