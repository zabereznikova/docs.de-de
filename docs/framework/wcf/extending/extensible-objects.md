---
title: "Erweiterbare Objekte | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 <xref:System.ServiceModel.IExtension%601> impliziert keine Interaktionen mit anderen standardmäßigen verwalteten Schnittstellen.  Die <xref:System.IDisposable.Dispose%2A?displayProperty=fullName>\-Methode des Besitzerobjekts trennt ihre Erweiterungen in der Regel nicht ab.  
 ...
 Wenn keine Erweiterung in der Auflistung eine <xref:System.ServiceModel.IExtension%601> ist, gibt <xref:System.ServiceModel.IExtensionCollection%601.Find%2A> NULL zurück, und <xref:System.ServiceModel.IExtensionCollection%601.FindAll%2A> gibt eine leere Auflistung zurück. Wenn mehrere Erweiterungen <xref:System.ServiceModel.IExtension%601> implementieren, gibt <xref:System.ServiceModel.IExtensionCollection%601.Find%2A> eine davon zurück.  Der von <xref:System.ServiceModel.IExtensionCollection%601.FindAll%2A> zurückgegebene Wert ist eine Momentaufnahme.  
 ...
 Die <xref:System.ServiceModel.IExtensionCollection%601>\-Schnittstelle ist eine Auflistung von <xref:System.ServiceModel.IExtension%601>\-Objekten, für die der Abruf von <xref:System.ServiceModel.IExtension%601> anhand des Typs zulässig ist.  <xref:System.ServiceModel.IExtensionCollection%601.Find%2A?displayProperty=fullName> gibt das zuletzt hinzugefügte Objekt zurück, das eine <xref:System.ServiceModel.IExtension%601> dieses Typs ist.  
