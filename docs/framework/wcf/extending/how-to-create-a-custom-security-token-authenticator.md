...
## <a name="see-also"></a>Siehe auch  
 ...
 [So wird es gemacht: Erstellen Sie einen benutzerdefinierten Sicherheitstoken-Anbieter](../../../../docs/framework/wcf/extending/how-to-create-a-custom-security-token-provider.md)  
