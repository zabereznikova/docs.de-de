---
title: "WCF-Vereinfachungsfunktionen | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Geänderter Standard für den ASP.NET\-Kompatibilitätsmodus  
 WCF bietet einen ASP.NET\-Kompatibilitätsmodus, der Entwicklern beim Schreiben von WCF\-Diensten vollständigen Zugriff auf die Funktionen in der ASP.NET\-HTTP\-Pipeline gewährt.Um den Modus zu verwenden, müssen Sie das `aspNetCompatibilityEnabled`\-Attribut im [\<serviceHostingEnvironment\>](../../../docs/framework/configure-apps/file-schema/wcf/servicehostingenvironment.md)\-Abschnitt von **web.config** auf **True** festlegen.Außerdem muss die `RequirementsMode`\-Eigenschaft für jeden Dienst in dieser appDomain für <xref:System.ServiceModel.Activation.AspNetCompatibilityRequirementsAttribute> auf <xref:System.ServiceModel.Activation.AspNetCompatibilityRequirementsMode> oder <xref:System.ServiceModel.Activation.AspNetCompatibilityRequirementsMode> festgelegt sein.Standardmäßig wird <xref:System.ServiceModel.Activation.AspNetCompatibilityRequirementsAttribute> jetzt auf <xref:System.ServiceModel.Activation.AspNetCompatibilityRequirementsMode> festgelegt, und in der Standardvorlage für die WCF\-Dienstanwendung ist das `aspNetCompatibilityEnabled`\-Attribut auf `true` festgelegt.[!INCLUDE[crdefault](../../../includes/crdefault-md.md)][Neues in Windows Communication Foundation 4.5](../../../docs/framework/wcf/whats-new.md) und [WCF\-Dienste und ASP.NET](../../../docs/framework/wcf/feature-details/wcf-services-and-aspnet.md).  
...
> [!IMPORTANT]
>  Weitere Informationen zum Schützen Ihrer Daten finden Sie unter "Sicheres Verwenden von XML" in [Sicherheitsüberlegungen zu Daten](../../../docs/framework/wcf/feature-details/security-considerations-for-data.md).  
