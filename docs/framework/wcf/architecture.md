---
title: "Windows Communication Foundation-Architektur | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - "Architektur [WCF]"
  - "WCF [WCF], Architektur"
  - "Windows Communication Foundation [WCF], Architektur"
...
## WCF\-Architektur  
 ![Die WCF&#45;Architektur](../../../docs/framework/wcf/media/wcf-architecture.gif "WCF\_Architecture")  
...
### Messaging  
 Die Messagingebene besteht aus *Kanälen*.Ein Kanal ist eine Komponete, die eine Nachricht in bestimmter Weise verarbeitet, z. B. durch Authentifizierung.Ein Reihe von Kanälen wird auch *Kanalstapel* genannt.Kanäle arbeiten mit Nachrichten und Nachrichtenheadern.Die Dienstlaufzeitebene hingegen verarbeitet hauptsächlich den Inhalt des Nachrichtentexts.  
