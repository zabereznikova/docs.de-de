...
4. `rss` `rssChannelItemGuid` Klassen, ,`rssChannel`,und,werden mit den erforderlichen Membern erstellt, um auf die Elemente im RSS-Feed zuzugreifen. `rssChannelItem` `link` `rssChannelImage`  
