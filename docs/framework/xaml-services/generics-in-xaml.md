...
## <a name="generics-and-xaml-2009-features"></a>Generika und XAML 2009-Funktionen  
 Wenn Sie XAML 2009 verwenden anstelle von mapping des CLR-Basistypen zum Abrufen von XAML-Typen für häufige Sprachprimitive, können Sie [integrierte Typen für XAML 2009](../../../docs/framework/xaml-services/built-in-types-for-common-xaml-language-primitives.md) als Informationselemente in `x:TypeArguments`. Sie können z. B. die folgenden deklarieren (Präfix-Zuordnungen, die nicht angezeigt, aber `x` ist der XAML-Sprachnamespace XAML für XAML 2009):  
