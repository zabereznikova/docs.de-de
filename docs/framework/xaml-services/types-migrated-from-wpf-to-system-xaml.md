...
## Dienstklassen, die MarkupExtension unterstützen  
 In [!INCLUDE[net_v35_short](../../../includes/net-v35-short-md.md)] und [!INCLUDE[net_v30_short](../../../includes/net-v30-short-md.md)] für WPF wurden mehrere Dienste bereitgestellt, die <xref:System.Windows.Markup.MarkupExtension>\-Implementierern und <xref:System.ComponentModel.TypeConverter>\-Implementierungen die Verwendung von Typen\/Eigenschaften in XAML ermöglichten. Es handelt sich dabei um die folgenden Dienste:  
