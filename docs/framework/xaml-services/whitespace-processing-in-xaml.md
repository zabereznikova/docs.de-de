...
## <a name="white-space-definition"></a>Leerraum Definition  
 In Übereinstimmung mit [!INCLUDE[TLA2#tla_xml](../../../includes/tla2sharptla-xml-md.md)] sind Leerraum Zeichen in [!INCLUDE[TLA2#tla_xaml](../../../includes/tla2sharptla-xaml-md.md)] Leerzeichen, Zeilenvorschub und Tabulator. Diese entsprechen den Unicode-Werten 0020, 000A bzw. 0009.  
...
## <a name="preserving-white-space"></a>Beibehalten von Leerraum  
 Es gibt mehrere Verfahren zum Beibehalten von Leerraum in der Quell [!INCLUDE[TLA2#tla_xaml](../../../includes/tla2sharptla-xaml-md.md)] für die letztliche Darstellung, die nicht von der Leerraum Normalisierung [!INCLUDE[TLA2#tla_xaml](../../../includes/tla2sharptla-xaml-md.md)]-Prozessors betroffen sind.  
