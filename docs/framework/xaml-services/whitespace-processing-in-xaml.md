...
## <a name="white-space-definition"></a>Leerraum Definition  
 In Übereinstimmung mit [!INCLUDE[TLA2#tla_xml](../../../includes/tla2sharptla-xml-md.md)]sind Leerzeichen in [!INCLUDE[TLA2#tla_xaml](../../../includes/tla2sharptla-xaml-md.md)] Leerzeichen, Zeilenvorschub und Tabulator. Diese entsprechen den Unicode-Werten 0020, 000A bzw. 0009.  
