...
### <a name="xbyte"></a>x:Byte  
 Für CLR-Unterstützung entspricht die `x:Byte` -Primitive <xref:System.Byte>. Ein <xref:System.Byte>  /  `x:Byte` wird behandelt, als Zahl ohne Vorzeichen.  
