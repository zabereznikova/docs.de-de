...
Dieser Abschnitt enthält Beispiele für die grundlegende Funktionalität für Windows Workflow Foundation (WF).  
...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Enthält Beispiele, die Windows Workflow Foundation (WF)-Ausdrücke veranschaulichen.  
  
 [Migration](../../../../docs/framework/windows-workflow-foundation/samples/migration.md)  
 Enthält Beispiele für die Migration von Workflows, die mit früheren Versionen von Windows Workflow Foundation (WF) erstellt.  
 ...
 Enthält Beispiele, die Überprüfung in Windows Workflow Foundation zu veranschaulichen.  
