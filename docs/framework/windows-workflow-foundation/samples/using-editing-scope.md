...
2. Klicken Sie auf **Editing Scope öffnen**.  
...
3. Drücken Sie **Den Bearbeitungsbereich schließen,** um den Bearbeitungsbereich zu übertragen. Drei Aktivitäten werden im Designer angezeigt.  
