---
title: "Permanenter Duplex | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  Die in diesem Beispiel verwendeten Warteschlangen sind nicht transaktionsgebunden.Ein Beispiel, das zeigt, wie [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]\-Nachrichtenaustausch mit Transaktionswarteschlangen eingerichtet wird, finden Sie im Beispiel [MSMQ\-Aktivierung](../../../../docs/framework/wcf/samples/msmq-activation.md).  
...
2.  Richten Sie die virtuelle Anwendung ein.  
    ...
    2.  Führen Sie [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)] mit Administratorberechtigungen aus, indem Sie mit der rechten Maustaste auf [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)] klicken und **Als Administrator ausführen** auswählen.  
...
3.  Richten Sie die Dienstwarteschlangen ein.  
    ...
    2.  Öffnen Sie die Konsole **Computerverwaltung**, indem Sie `Compmgmt.msc` an einer Eingabeaufforderung ausführen.  
  
    3.  Erweitern Sie **Dienste und Anwendungen**, **Message Queuing**.**Private Warteschlangen**.  
  
    4.  Klicken Sie mit der rechten Maustaste auf die Warteschlangen durableduplex\/service1.xamlx und durableduplex\/service2.xamlx, und wählen Sie **Eigenschaften** aus.  
  
    5.  Wählen Sie die Registerkarte **Sicherheit** aus, und gewähren Sie allen die Berechtigungen **Nachricht empfangen**, **Nachricht einsehen** und **Nachricht senden** für beide Warteschlangen.  
  
    6.  Öffnen Sie den IIS\-Manager \(Internet Information Services, Internetinformationsdienste\).  
  
    7.  Wechseln Sie zu **Server**, **Sites**, **Standardwebsite**, **Privat**, **Permanenter Duplex**, und wählen Sie **Erweiterte Optionen** aus.  
...
2.  Entfernen Sie die virtuelle Anwendung für die Dienste.  
    ...
    1.  Öffnen Sie den IIS\-Manager, indem Sie `Inetmgr.exe` an einer Eingabeaufforderung ausführen.  
  
    2.  Wechseln Sie zur Standardwebsite, und entfernen Sie das virtuelle Verzeichnis **private**.  
  
3.  Entfernen Sie die Warteschlangeneinrichtung für dieses Beispiel.  
  
    1.  Öffnen Sie die Konsole Computerverwaltung, indem Sie `Compmgmt.msc` an einer Eingabeaufforderung ausführen.  
