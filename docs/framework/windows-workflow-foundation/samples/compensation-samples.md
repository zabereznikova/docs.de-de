...
Dieser Abschnitt enthält Beispiele zur Kompensierung in Windows Workflow Foundation (WF).  
...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Veranschaulicht vier gängige Szenarios zur Verwendung von <xref:System.Activities.Statements.CompensableActivity> und Bestätigung.  
  
 [Abbruchhandler für kompensierbare Aktivität](../../../../docs/framework/windows-workflow-foundation/samples/cancellation-handler-on-compensable-activity.md)  
 Veranschaulicht die Verwendung eines Abbruchhandlers für eine <xref:System.Activities.Statements.CompensableActivity>.
