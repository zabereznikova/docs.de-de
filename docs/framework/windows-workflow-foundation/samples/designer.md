...
ms.locfileid: "48777038"
---
# <a name="designer"></a>Designer
Dieser Abschnitt enthält Beispiele, die veranschaulichen, wie [!INCLUDE[wfd1](../../../../includes/wfd1-md.md)] verwendet wird.  
  
## <a name="in-this-section"></a>In diesem Abschnitt  
 [Entfernen des vom Designer zu einer XAML-Datei hinzugefügten Ansichtzustands](../../../../docs/framework/windows-workflow-foundation/samples/removing-the-view-state-the-designer-adds-to-an-xaml-file.md)  
