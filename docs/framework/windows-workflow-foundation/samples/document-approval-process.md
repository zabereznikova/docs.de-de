...
## <a name="sample-details"></a>Beispieldetails  
 ...
 ![Ein Prozess Dokumentgenehmigungsworkflow](../../../../docs/framework/windows-workflow-foundation/samples/media/approvalprocess.jpg "ApprovalProcess")  
...
3.  Um die Projektmappe auszuführen, starten Sie die Genehmigungs-Manager-Anwendung mit einen Rechtsklick auf das ApprovalManager-Projekt in der **Projektmappen-Explorer** und auf **Debuggen**->**starten**  über das Kontextmenü neue Instanz.  
...
7.  Im `UserType2`-Client wird ein Dokument, das auf Genehmigung wartet, angezeigt. Wählen Sie diese, und drücken Sie **genehmigen** oder **ablehnen**. Die Ergebnisse werden im `UserType1`-Client angezeigt.  
...
7.  In den `UserType2`-Clients wird ein Dokument, das auf Genehmigung wartet, angezeigt. Wählen Sie diese, und drücken Sie **genehmigen** oder **ablehnen**. Die Ergebnisse werden im `UserType1`-Client angezeigt.  
...
7.  In den `UserType2`-Clients wird ein Dokument, das auf Genehmigung wartet, angezeigt. Wählen Sie diese, und drücken Sie **genehmigen**, das Dokument wird zum Übergeben der `UserType3` Client.  
