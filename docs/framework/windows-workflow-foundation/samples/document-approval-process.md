...
7. In den `UserType2`-Clients wird ein Dokument, das auf Genehmigung wartet, angezeigt. Wählen Sie diese Option aus, und drücken Sie **genehmigen**, das `UserType3` Dokument wird an den Client weitergegeben.
