...
> [!NOTE]
> Dieses Thema behandelt die Kompensation in Workflows. Weitere Informationen zu Transaktionen in Workflows finden Sie unter [Transaktionen](workflow-transactions.md) und <xref:System.Activities.Statements.TransactionScope>. Weitere Informationen zu Transaktionen finden <xref:System.Transactions?displayProperty=nameWithType> Sie unter und. <xref:System.Transactions.Transaction?displayProperty=nameWithType>  
 ...
 **ReserveFlight Ticket ist reserviert.**  
...
**CancelFlight Ticket wurde abgebrochen.**    
**Workflow wurde erfolgreich mit dem Status "" abgeschlossen: Hob.**    
 ...
 **ChargeCreditCard: Kreditkarte für den Flug Betrag.**  
**SimulatedErrorCondition Auslösen einer ApplicationException.**    
**Nicht behandelte Workflow Ausnahme:**    
**System.ApplicationException: Simulierte Fehlerbedingung im Workflow.**    
**Cancelcreditcard: Kündigen Sie Kreditkartengebühren an.**    
**Workflow wurde erfolgreich mit dem Status "" abgeschlossen: Hob.**  Weitere Informationen zu Abbruch finden Sie unter [Abbruch](modeling-cancellation-behavior-in-workflows.md).  
...
**ManagerApproval Die Genehmigung des Managers wurde empfangen.**    
**PurchaseFlight Ticket wird gekauft.**    
**TakeFlight Der Flug Vorgang ist abgeschlossen.**    
**ConfirmFlight Der Flug wurde durchgeführt, es ist keine Kompensation möglich.**    
**Workflow wurde erfolgreich mit dem Status "" abgeschlossen: Geschlossen.**   
