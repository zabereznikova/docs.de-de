...
> [!NOTE]
>  Dieses Thema behandelt die Kompensation in Workflows. Weitere Informationen zu Transaktionen in Workflows finden Sie unter [Transaktionen](../../../docs/framework/windows-workflow-foundation/workflow-transactions.md) und <xref:System.Activities.Statements.TransactionScope>. Weitere Informationen über Transaktionen finden Sie unter <xref:System.Transactions?displayProperty=nameWithType> und <xref:System.Transactions.Transaction?displayProperty=nameWithType>.  
...
**ManagerApproval: Genehmigung eines Managers empfangen.**   
**PurchaseFlight: Ticket wird gekauft.**   
**Workflow wurde erfolgreich mit dem Status abgeschlossen: geschlossen.**    
> [!NOTE]
...
> [!NOTE]
>  Wenn eine <xref:System.Activities.Statements.CompensableActivity> ist *bestätigt*, eine Kompensation für die Aktivität kann nicht mehr aufgerufen werden. Der Bestätigungsvorgang wird weiter unten in diesem Abschnitt beschrieben.  
...
**Workflow wurde erfolgreich mit dem Status abgeschlossen: abgebrochen.**    
...
**Workflow wurde erfolgreich mit dem Status abgeschlossen: abgebrochen.**  Weitere Informationen über Abbrüche finden Sie unter [Abbruch](../../../docs/framework/windows-workflow-foundation/modeling-cancellation-behavior-in-workflows.md).  
