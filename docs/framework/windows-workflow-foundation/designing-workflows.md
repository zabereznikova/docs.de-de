...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 [Verfahrensworkflows](../../../docs/framework/windows-workflow-foundation/procedural-workflows.md)  
 Zeigt, wie Workflows mithilfe eines grundlegenden sequenziellen Ausführungsparadigmas erstellt werden.  
  
 [Zustandsautomatworkflows](../../../docs/framework/windows-workflow-foundation/state-machine-workflows.md)  
