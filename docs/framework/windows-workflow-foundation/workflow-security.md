...
-   Bei der Verwendung von <xref:System.Activities.DurableInstancing.SqlWorkflowInstanceStore> muss der Instanzspeicher gesichert werden. [!INCLUDE[crdefault](../../../includes/crdefault-md.md)] [Bewährte Methoden für SQL Server](http://go.microsoft.com/fwlink/?LinkId=164972).  
...
-   In Workflows verwendete [!INCLUDE[indigo1](../../../includes/indigo1-md.md)]-Endpunkte sollten gesichert werden. [!INCLUDE[crdefault](../../../includes/crdefault-md.md)] [Übersicht über die WCF-Sicherheit](http://go.microsoft.com/fwlink/?LinkID=164975).  
