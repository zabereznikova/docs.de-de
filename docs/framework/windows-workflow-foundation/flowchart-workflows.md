...
## <a name="flowchart-workflow-structure"></a>Flussdiagramm-Workflowstruktur
...
## <a name="types-of-flow-nodes"></a>Arten von Durchflussknoten
...
### <a name="creating-a-basic-activity-sequence-with-a-flowstep-node"></a>Erstellen einer grundlegenden Aktivitätssequenz mit einem FlowStep-Knoten
...
### <a name="creating-a-conditional-flowchart-with-a-flowdecision-node"></a>Erstellen eines bedingten Flussdiagramms mit einem FlowDecision-Knoten
...
### <a name="creating-an-exclusive-switch-with-a-flowswitch-node"></a>Erstellen eines exklusiven Switches mit einem FlowSwitch-Knoten
