...
1.  Öffnen Sie die Projektmappe des vorherigen Themas [How to: Create an Activity](../../../docs/framework/windows-workflow-foundation/how-to-create-an-activity.md) mit [!INCLUDE[vs_current_long](../../../includes/vs-current-long-md.md)]durcharbeiten und abschließen.  
