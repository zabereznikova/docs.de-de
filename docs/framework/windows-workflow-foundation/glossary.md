---
title: "Windows Workflow Foundation-Glossar f&#252;r .NET Framework 4.5 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - "WF [WF], Glossar"
  - "Windows Workflow Foundation [WF], Glossar"
...
|Lesezeichen|Der Punkt, an dem eine Aktivität angehalten werden und warten kann, bis die Wiederaufnahme erfolgt.|  
|Kompensation|Eine Gruppe von Aktionen, die dazu vorgesehen sind, die Auswirkung der zuvor abgeschlossenen Arbeit rückgängig zu machen oder zu mildern.|  
...
|Persistenz|Das Speichern des Zustands eines Workflows oder Diensts auf einem permanenten Speichermedium, sodass der Zustand nach einem Systemfehler aus dem Speicher entladen oder wiederhergestellt werden kann.|  
