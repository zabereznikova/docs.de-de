...
**Korrigieren Sie die Workflowdefinition oder stellen Sie Eingabewerte zur Behebung dieser Fehler bereit:**   
**'Add': Wert für das erforderliche aktivitätsargument 'Operand2' wurde nicht bereitgestellt.**   
**'Add': Wert für das erforderliche aktivitätsargument "Operand1" wurde nicht bereitgestellt.**  Nachdem die richtigen Argumente übergeben wurden, wird der Workflow erfolgreich abgeschlossen, wie im folgenden Beispiel gezeigt.  
