---
title: "Aufrufen der Aktivit&#228;tsvalidierung | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
**Fehler: Für das erforderliche Aktivitätsargument 'Operand1' wurde kein Wert angegeben.**  Bei Aufruf dieses Workflows würde ein <xref:System.Activities.InvalidWorkflowException>\-Objekt ausgelöst werden, wie im folgenden Beispiel gezeigt.  
...
**Korrigieren Sie entweder die Workflowdefinition oder stellen Sie Eingabewerte bereit, um diese Fehler zu beheben:**   
**'Add': Für das erforderliche Aktivitätsargument 'Operand2' wurde kein Wert angegeben.**   
**'Add': Für das erforderliche Aktivitätsargument 'Operand1' wurde kein Wert angegeben.**  Nachdem die richtigen Argumente übergeben werden, wird der Workflow erfolgreich abgeschlossen, wie im folgenden Beispiel gezeigt.  
