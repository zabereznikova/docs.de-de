 ...
 **"Add": der Wert für das erforderliche Aktivitäts Argument "operand2" wurde nicht angegeben.** 
 **"Add": der Wert für das erforderliche Aktivitäts Argument "Operand1" wurde nicht angegeben.**  Nachdem die richtigen Argumente übergeben wurden, wird der Workflow erfolgreich abgeschlossen, wie im folgenden Beispiel gezeigt.  
