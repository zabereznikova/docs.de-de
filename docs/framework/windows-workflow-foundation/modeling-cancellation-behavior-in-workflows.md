...
> [!NOTE]
> Weitere Informationen zu Transaktionen und [Vergütungfinden](workflow-transactions.md) finden Sie unter Transaktionen und [Vergütung](compensation.md).  
