---
title: "Bereichsauswahl und Sichtbarkeit der Aktivit&#228;tsdefinition | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Definition und Verwendung  
 Workflows werden durch Erstellen neuer Aktivitäten über Vererbung von Basisaktivitätsklassen sowie durch Verwendung von Aktivitäten aus der [Integrierte Aktivitätsbibliothek](../../../docs/framework/windows-workflow-foundation//net-framework-4-5-built-in-activity-library.md) erstellt.Damit eine Aktivität verwendet werden kann, muss die Sichtbarkeit der Komponenten ihrer Definition vom Autor der Aktivität konfiguriert werden.  
...
|---------------|--------------------|---------------|-------------------------------------|  
|Argumente|Öffentlich\/Privat|Öffentlich|n\/v|  
|Variablen|Öffentlich\/Privat|Öffentlich|n\/v|  
|Untergeordnete Aktivitäten|Öffentlich\/Privat|Öffentlich, ein privates untergeordnetes Element in der Implementierung festgelegt.|n\/v|  
|ActivityDelegates|Öffentlich\/Privat|Öffentlich|n\/v|  
