...
## <a name="editingcontext-host-items-and-services"></a>EditingContext-Hostelemente und -Dienste  
 .NET Framework stellt eine Reihe integrierter Elemente und Dienste bereit, auf die über den Bearbeitungskontext zugegriffen wird.  
...
- <xref:System.Activities.Presentation.IWorkflowDesignerStorageService>: Stellt einen internen Dienst zum Speichern und Abrufen von Daten bereit. Dieser Dienst wird intern von .NET Framework verwendet und ist nicht für die externe Verwendung vorgesehen.  
