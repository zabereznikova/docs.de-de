...
> [!NOTE]
>  Eine Liste aller von der neuen Windows Workflow Foundation (WF)-Funktionen in .NET Framework 4.5, einschließlich derjenigen, die unabhängig von Designer betreffen, sind finden Sie unter [Neuigkeiten in Windows Workflow Foundation in .NET 4.5](whats-new-in-wf-in-dotnet.md).
...
### <a name="designer-search"></a>Designer-Suche
 Die [Schnellsuche](whats-new-in-wf-in-dotnet.md#BKMK_QuickFind) und [in Dateien suchen](whats-new-in-wf-in-dotnet.md#BKMK_FindInFiles) in .NET Framework 4.5 eingeführten Features werden im neu gehosteten Designer nicht unterstützt. Die `Toolbox`-Suche wird im neu gehosteten Designer unterstützt. Weitere Informationen zu diesen Funktionen finden Sie unter [Designer-Suche](whats-new-in-wf-in-dotnet.md#BKMK_DesignerSearch).
...
### <a name="delete-context-menu-item-in-variable-and-argument-designer"></a>Löschen von Kontextmenüelementen im Variablen- und Argument-Designer
 In [!INCLUDE[netfx40_short](../../../includes/netfx40-short-md.md)] konnten Variablen und Argumente nur im Designer und mithilfe der Tastatur gelöscht werden. Ab .NET Framework 4.5, können Variablen und Argumente gelöscht werden mithilfe des Kontextmenüs. Diese Funktion wird im neu gehosteten Designer unterstützt.
