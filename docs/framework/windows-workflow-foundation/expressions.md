---
title: "Ausdr&#252;cke [.NET Framework 4] | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 [!INCLUDE[crabout](../../../includes/crabout-md.md)] zur Verwendung von Ausdrücken im Code finden Sie unter [Erstellen von Workflows, Aktivitäten und Ausdrücken mit imperativem Code](../../../docs/framework/windows-workflow-foundation//authoring-workflows-activities-and-expressions-using-imperative-code.md).