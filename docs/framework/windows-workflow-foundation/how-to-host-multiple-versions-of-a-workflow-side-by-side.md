...
**1 ist zu niedrig.**   
**Bitte geben Sie eine Zahl zwischen 1 und 10**   
**2 ist richtig. Sie ahnen es bereits in 4 deaktiviert.**      Die aktualisierte `WriteLine`-Ausgabe ist in der Nachverfolgungsdatei enthalten, einschließlich der Ausgabe der `WriteLine`-Aktivität, die diesem Thema hinzugefügt wurde.  
