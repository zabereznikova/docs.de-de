...
2. Die neue Erweiterung wird dann dem Host hinzugefügt.
    ...
    ```
     ...
     Weitere Informationen zum Hinzufügen eines benutzerdefinierten persistenzteilnehmers finden Sie unter den [Persistenzteilnehmer](persistence-participants.md) Beispiel.
