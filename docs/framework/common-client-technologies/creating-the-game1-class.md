...
## <a name="creating-the-code"></a>Erstellen des Codes  
 ...
 Die [Update](https://docs.microsoft.com/previous-versions/windows/xna/bb199616%28v%3dxnagamestudio.41%29)-Methode wird beim Ausführen des Spiels wiederholt von XNA Framework aufgerufen. Die [Update](https://docs.microsoft.com/previous-versions/windows/xna/bb199616%28v%3dxnagamestudio.41%29)-Methode ruft die Methoden **ProcessInertia** und **UpdateFromMouse** in der Auflistung der Spielsteine auf. Diese Methoden sind unter [Creating the GamePieceCollection Class (Erstellen der GamePieceCollection-Klasse)](../../../docs/framework/common-client-technologies/creating-the-gamepiececollection-class.md) beschrieben.  
  
 [!code-csharp[ManipulationXNA#_Game1_UpdateGame](../../../samples/snippets/csharp/VS_Snippets_Misc/manipulationxna/cs/game1.cs#_game1_updategame)]  
  
 Die [Draw](https://docs.microsoft.com/previous-versions/windows/xna/bb196422%28v%3dxnagamestudio.41%29)-Methode wird beim Ausführen des Spiels ebenfalls wiederholt von XNA Framework aufgerufen. Die [Draw](https://docs.microsoft.com/previous-versions/windows/xna/bb196422%28v%3dxnagamestudio.41%29)-Methode rendert Spielsteine, indem sie die **Draw**-Methode des **GamePieceCollection**-Objekts aufruft. Diese Methode ist unter [Creating the GamePieceCollection Class (Erstellen der GamePieceCollection-Klasse)](../../../docs/framework/common-client-technologies/creating-the-gamepiececollection-class.md) beschrieben.  
