...
## <a name="gamepiece-class"></a>GamePiece-Klasse  
 Der folgende Code zeigt die vollständige **GamePiece**-Klasse.  
...
## <a name="gamepiececollection-class"></a>GamePieceCollection-Klasse  
 Der folgende Code zeigt die vollständige **GamePieceCollection**-Klasse.  
...
## <a name="game1-class"></a>Game1-Klasse  
 Der folgende Code zeigt die vollständige **Game1**-Klasse.  
