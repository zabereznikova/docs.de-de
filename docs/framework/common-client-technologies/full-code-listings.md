...
---
# Full Code Listings
Dieses Thema enthält die gesamte Codeauflistung für eine Anwendung, die Manipulations\- und Trägheitsprozessoren \([Manipulations and Inertia](../../../docs/framework/common-client-technologies/manipulations-and-inertia.md)\) verwendet.  
  
## GamePiece\-Klasse  
 Der folgende Code veranschaulicht die gesamte **GamePiece**\-Klasse.  
...
## GamePieceCollection\-Klasse  
 Der folgende Code veranschaulicht die gesamte **GamePieceCollection**\-Klasse.  
...
## Game1\-Klasse  
 Der folgende Code veranschaulicht die gesamte **Game1**\-Klasse.  
