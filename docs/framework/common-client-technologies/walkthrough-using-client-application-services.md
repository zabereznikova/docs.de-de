---
title: "Exemplarische Vorgehensweise: Verwenden von Clientanwendungsdiensten | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Anwendungsdiensthost [Clientanwendungdienste]"
  - "Clientanwendungsdienste, exemplarische Vorgehensweisen"
...
#### So erstellen Sie eine Clientanwendung und aktivieren Sie Clientanwendungsdienste:  
  
1.  Wählen Sie unter [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] die Menüoption **Datei &#124; Neu &#124; Project**.  
...
#### So konfigurieren Sie die Mitgliedschaft und Rollen:  
...
12. Klicken Sie auf **Benutzer erstellen**  
    ...
    > [!NOTE]
    >  Die Werte für **E\-Mail**, **Sicherheitsfrage**, und **Sicherheitsantwort** werden vom Formular benötigt, werden jedoch in diesem Beispiel nicht verwendet.  
...
#### So konfigurieren Sie ihre Anwendung auf die Verwendung eines Anmeldeinformationsanbieters:  
...
##### Erstellen Sie als Anmeldeinformationsanbieter ein Anmeldedialogfeld in Visual Basic  
...
5.  Geben Sie in das Fenster **Eigenschaften** einen **\(Name\)**\-Wert von `rememberMeCheckBox` und einen Wert **Text**\-Wert von `&Remember me` ein.  
...
##### So erstellen Sie als Anmeldeinformationsanbieter ein Anmeldedialogfeld in C\#:  
...
#### So ändern Sie die Benutzerrollen\-basierte Benutzeroberfläche:  
  
1.  Wählen Sie im **Projektmappen\-Explorer** im Projekt ClientAppServicesDemo die Option Form1 aus. Wählen Sie dann **Ansicht &#124; Designer** aus [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] im Hauptmenü.  
...
#### So verwenden Sie die Webeinstellungen auf  der Benutzeroberfläche:  
...
5.  Wählen Sie im **Projektmappen\-Explorer** im Projekt ClientAppServicesDemo die Option Form1 aus. Wählen Sie dann **Ansicht &#124; Designer** aus [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] im Hauptmenü.  
...
#### So implementieren Sie die Abmeldefunktion:  
  
1.  Fügen Sie im im Form1\-Designer dem Formular ein <xref:System.Windows.Forms.Button>\-Steuerelement aus der **Toolbox** hinzu.  
...
## Aktivieren des Offline\-Modus  
 ...
 Im Offline\-Modus werden bei allen Kundenanwendungsdienst\-Anforderungen Daten aus dem lokalen Cache abgerufen, statt zu versuchen, ob die Dienste zuzugreifen In der Standardkonfiguration enthalten die lokalen Daten das Benutzerkennwort in verschlüsselter Form. Dadurch kann sich der Benutzer anmelden, während sich die Anwendung im Offline\-Modus befindet. Weitere Informationen finden Sie unter [Gewusst wie: Konfigurieren von Clientanwendungsdiensten](../../../docs/framework/common-client-technologies/how-to-configure-client-application-services.md).  
  
#### So wird der Offline\-Modus in der Anwendung aktiviert:  
