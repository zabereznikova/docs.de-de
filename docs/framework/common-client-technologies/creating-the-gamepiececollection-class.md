---
title: Erstellen der GamePieceCollection-Klasse | Microsoft-Dokumentation
ms.custom: 
ms.date: 03/30/2017
...
## <a name="see-also"></a>Siehe auch  
 ...
 [Using Manipulations and Inertia in an XNA Application (Verwenden von Manipulationen und Trägheit in einer XNA-Anwendung)](../../../docs/framework/common-client-technologies/use-manipulations-and-inertia-in-an-xna-application.md)   
