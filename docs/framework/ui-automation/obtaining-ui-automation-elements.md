...
## Stammelement  
 ...
 Das Stammelement für den Desktop, aus dem alle Elemente abgeleitet werden, wird aus der statischen <xref:System.Windows.Automation.AutomationElement.RootElement%2A?displayProperty=fullName>\-Eigenschaft abgerufen.  
