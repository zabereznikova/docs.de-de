...
## Beispiel  
 Im folgenden Beispiel werden die Steuerelementmuster <xref:System.Windows.Automation.WindowPattern> und <xref:System.Windows.Automation.TransformPattern> dazu verwendet, um eine [!INCLUDE[TLA#tla_win32](../../../includes/tlasharptla-win32-md.md)]\-Zielanwendung programmgesteuert an einzelne Bildschirmpositionen zu verschieben und die <xref:System.Windows.Automation.AutomationElement.BoundingRectangleProperty> <xref:System.Windows.Automation.AutomationElement.AutomationPropertyChangedEvent> nachzuverfolgen.  
...
## Siehe auch  
 [WindowPattern Sample](http://msdn.microsoft.com/de-de/598b695c-8baf-406e-bbfb-2a1c7842a1de)