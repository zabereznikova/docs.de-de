...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsContentElementProperty>|Richtig|Das Steuerelement für eine unterteilte Schaltfläche enthält Informationen für den Endbenutzer.|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsControlElementProperty>|Richtig|Das Steuerelement für eine unterteilte Schaltfläche ist für den Endbenutzer sichtbar.|  
...
## <a name="splitbutton-control-example"></a>Beispiel für ein SplitButton-Steuerelement  
 ...
 ![Unterteilte Schaltfläche](./media/uiauto-splitbutton-detailed.gif "uiauto_splitbutton_detailed")  
