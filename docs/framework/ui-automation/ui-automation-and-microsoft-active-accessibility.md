...
>  Diese Dokumentation ist für .NET Framework-Entwickler vorgesehen, die die verwalteten [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]-Klassen verwenden möchten, die im <xref:System.Windows.Automation>-Namespace definiert sind. Die neuesten Informationen zu [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)], finden Sie unter [Windows-Automatisierungs-API: Benutzeroberflächenautomatisierung](https://go.microsoft.com/fwlink/?LinkID=156746).  
 ...
 [!INCLUDE[TLA#tla_aa](../../../includes/tlasharptla-aa-md.md)] war die vorherige Lösung zum Herstellen von Anwendungen zugegriffen werden kann. [!INCLUDE[TLA#tla_uiautomation](../../../includes/tlasharptla-uiautomation-md.md)] ist das neue Zugriffsmodell für [!INCLUDE[TLA#tla_win](../../../includes/tlasharptla-win-md.md)] und dient zum Erfüllen der Anforderungen von Hilfstechnologieprodukten und automatisierte TestTools. [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] bietet zahlreiche Verbesserungen gegenüber [!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)].  
...
## <a name="roles-and-control-types"></a>Rollen und Steuerelementtypen  
 ...
 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] unterstützt benutzerdefinierte Steuerelemente, die identifizierten der <xref:System.Windows.Automation.ControlType.Custom> Eigenschaft und kann dadurch beschrieben werden, die <xref:System.Windows.Automation.AutomationElement.LocalizedControlTypeProperty> Eigenschaft.  
...
## <a name="states-and-properties"></a>Zustände und Eigenschaften  
 ...
 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] definiert viele weitere Eigenschaften, von denen einige entsprechen, den Status im [!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)]. Manche beziehen sich auf alle Elemente, während andere nur für Steuerelementtypen und Steuerelementmuster gelten. Eigenschaften werden durch eindeutige Bezeichner unterschieden, und die meisten Eigenschaften können über eine einzelne Methode, <xref:System.Windows.Automation.AutomationElement.GetCurrentPropertyValue%2A> oder <xref:System.Windows.Automation.AutomationElement.GetCachedPropertyValue%2A>, abgerufen werden. Viele Eigenschaften können auch leicht über die <xref:System.Windows.Automation.AutomationElement.Current%2A> - und <xref:System.Windows.Automation.AutomationElement.Cached%2A> - Eigenschaftenaccessoren abgerufen werden.  
...
|[!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)] Eigenschaftenaccessor|[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] Eigenschafts-ID|Hinweise|  
|-----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|-------------|  
|`get_accKeyboardShortcut`|<xref:System.Windows.Automation.AutomationElement.AccessKeyProperty> oder <xref:System.Windows.Automation.AutomationElement.AcceleratorKeyProperty>|`AccessKeyProperty` hat Vorrang vor, wenn beide vorhanden sind.|  
...
|`get_accDescription`|In unterstützt nicht [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|`accDescription` eindeutige Spezifikation in MSAA keine was Anbieter unterschiedliche Arten von Informationen in dieser Eigenschaft ablegen geführt hat.|  
|`get_accHelpTopic`|In unterstützt nicht [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]||  
...
|[!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)] -Zustand|[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] property|Löst Zustandsänderung aus?|  
|-----------------------------------------------------------------------|------------------------------------------------------------------------------------|----------------------------|  
|STATE_SYSTEM_CHECKED|Für Kontrollkästchen <xref:System.Windows.Automation.TogglePattern.ToggleStateProperty><br /><br /> Für Optionsfeld <xref:System.Windows.Automation.SelectionItemPattern.IsSelectedProperty>|J|  
...
|STATE_SYSTEM_INVISIBLE|<xref:System.Windows.Automation.AutomationElement.IsOffscreenProperty> = True und <xref:System.Windows.Automation.AutomationElement.GetClickablePoint%2A> bewirkt, dass <xref:System.Windows.Automation.NoClickablePointException>|N|  
...
|WinEvent|[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] Ereignis-ID|  
|--------------|--------------------------------------------------------------------------------------------|  
...
|EVENT_OBJECT_CONTENTSCROLLED|<xref:System.Windows.Automation.ScrollPattern.VerticalScrollPercentProperty> oder <xref:System.Windows.Automation.ScrollPattern.HorizontalScrollPercentProperty> -Eigenschaftenänderung für die entsprechenden Bildlaufleisten|  
...
|Keine Entsprechung|<xref:System.Windows.Automation.AutomationElement.AsyncContentLoadedEvent> event|  
