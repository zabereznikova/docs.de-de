...
|Liste<br /><br /> -   DataItem \(beliebige Anzahl\)<br />-   ListItem \(beliebige Anzahl\)<br />-   Group \(beliebige Anzahl\)<br />-   ScrollBar \(0, 1 oder 2\)|Liste<br /><br /> -   DataItem \(beliebige Anzahl\)<br />-   ListItem \(beliebige Anzahl\)<br />-   Group \(beliebige Anzahl\)|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsContentElementProperty>|True|Das Listensteuerelement ist stets in der Inhaltsansicht der [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]\-Struktur enthalten.|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsControlElementProperty>|True|Das Listensteuerelement ist stets in der Steuerelementansicht der [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]\-Struktur enthalten.|  
