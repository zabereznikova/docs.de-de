...
|------------------|------------------|  
|ListItem<br /><br /> - Bild (0 oder mehr)<br />- Text (0 oder mehr)<br />- Bearbeiten (0 oder mehr)|ListItem|  
  
 Die untergeordneten Elemente eines Listenelement-Steuerelements innerhalb der Inhaltsansicht der [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] -Struktur müssen immer "0" sein. Wenn die Struktur des Steuerelements so ist, dass andere Elemente unter dem Listenelement enthalten sind, sollte es den Anforderungen für die [Benutzeroberflächenautomatisierungsunterstützung für den TreeItem-Steuerelementtyptyp](ui-automation-support-for-the-treeitem-control-type.md) entsprechen.  
  
<a name="Required_UI_Automation_Properties"></a>
## <a name="required-ui-automation-properties"></a>Erforderliche Benutzeroberflächenautomatisierungs-Eigenschaften  
 Die folgende Tabelle enthält die [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] -Eigenschaften, deren Werte oder Definitionen für Listenelement-Steuerelemente besonders relevant sind. Weitere Informationen [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] zu Eigenschaften finden Sie unter [UI Automation Properties for Clients](ui-automation-properties-for-clients.md).  
