...
|------------------|------------------|  
|ToolTip<br /><br /> -Text (0 oder mehr)<br />-Image (0 oder mehr)|ToolTip|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.ControlTypeProperty>|ToolTip|Dieser Wert ist für alle Benutzeroberflächen-Frameworks gleich.|  
