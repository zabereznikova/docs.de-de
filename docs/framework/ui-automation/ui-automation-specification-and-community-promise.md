...
## <a name="see-also"></a>Siehe auch  
 [Spezifikation für die Benutzeroberflächenautomatisierung](http://go.microsoft.com/fwlink/?LinkId=108541)  
 [UI-Automatisierung Zusicherung an die Community](http://go.microsoft.com/fwlink/?LinkId=108542)
