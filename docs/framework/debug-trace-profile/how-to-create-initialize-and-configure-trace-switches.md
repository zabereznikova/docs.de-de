...
2. Enthält Ihr Projekt keine Konfigurationsdatei („app.config“ oder „Web.config“), dann wählen Sie im Menü **Projekt** den Befehl **Neues Element hinzufügen** aus.  
    ...
    - **Visual C#:** Klicken Sie im Dialogfeld **Neues Element hinzufügen** auf **XML-Datei**. Benennen Sie diese Datei **app.config**. Fügen Sie im XML-Editor nach der XML-Deklaration den folgenden XML-Code hinzu:  
...
- [Schema der Ablauf Verfolgung und Debugeinstellungen](../configure-apps/file-schema/trace-debug/index.md)
