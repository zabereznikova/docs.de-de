...
> [!NOTE]
> Alle Beispiele sind in dem [Beispieldownload für .NET Framework SDK Version 2.0](https://www.microsoft.com/en-us/download/confirmation.aspx?id=22181) verfügbar, das für .NET Framework 2.0 veröffentlicht wurde, und sind möglicherweise veraltet.

## <a name="in-this-section"></a>In diesem Abschnitt  
 [Beispiel zur Technologie der Downloadstatusanzeige](https://msdn.microsoft.com/en-us/library/t8w6294a(v=vs.85).aspx)  
 Zeigt, wie der Fortschritt eines Dateidownloads angezeigt wird.  
  
 [Beispiel zur FTP-Clienttechnologie](https://msdn.microsoft.com/en-us/library/b7810t5c(v=vs.85).aspx)  
 ...
 [Beispiel zur Technologie des NetStat-Tools](https://msdn.microsoft.com/en-us/library/ks32hs88(v=vs.85).aspx)  
 Veranschaulicht das NCLNetStat-Netzwerk-Informationstool.  
  
 [Beispiel zur Netzwerk-Informationstechnologie](https://msdn.microsoft.com/en-us/library/2xatedhd(v=vs.85).aspx)  
 Zeigt, wie Netzwerkinformationen überwacht und angezeigt werden.  
  
 [Beispiel für die Technologie eines Ping-Clients](https://msdn.microsoft.com/en-us/library/5253acs7(v=vs.85).aspx)  
 Veranschaulicht eine Clientanwendung, die einen Remotehost Pingen kann.  
  
 [Beispiele für die Web-Clienttechnologie](https://msdn.microsoft.com/en-us/library/fxk992zc(v=vs.85).aspx)  
 Veranschaulicht, wie allgemeine Vorgänge, z.B. das Hoch- oder Herunterladen von Dateien oder Daten ausgeführt werden.  
  
 [Beispiel für sichere Streams](https://msdn.microsoft.com/en-us/library/ms180980(v=vs.85).aspx)  
 ...
 [Beispiel für Socket-IPv6](https://msdn.microsoft.com/en-us/library/ms180981(v=vs.85).aspx)  
 Veranschaulicht, wie Sockets verwendet werden, wenn IPv6 aktiviert ist.  
  
 [Beispiel zur FTP-Explorer-Technologie](https://msdn.microsoft.com/en-us/library/ms233623(v=vs.85).aspx)  
