...
|-------------------|---------------------|  
|`enabled`|Gibt an, ob Member der <xref:System.Net.Dns> Klasse Internet Protokollversion 6 (IPv6)-Adressen zurückgeben. Der Standardwert ist `false`sein.|  
