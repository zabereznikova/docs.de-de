...
|deadLetterQueue|Gibt den zu verwendenden Typ der Warteschlange für unzustellbare Nachrichten an.<br /><br /> Gültige Werte sind<br /><br /> -   Custom: Benutzerdefinierte Warteschlange für unzustellbare Nachrichten.<br />-   None: Es soll keine Warteschlange für unzustellbare Nachrichten verwendet werden.<br />-   System: Systemweite Warteschlange für unzustellbare Nachrichten verwenden.<br /><br /> Dieses Attribut ist vom Typ DeadLetterQueue.|  
...
|queueTransferProtocol|Gibt den von dieser Bindung verwendeten Kommunikationskanaltransport in der Warteschlange an.  Folgende Werte sind gültig:<br /><br /> -   Native: Verwendung des systemeigenen MSMQ\-Protokolls.<br />-   Srmp: Verwendung des Soap Reliable Messaging Protocol \(SRMP\).<br />-   SrmpSecure: Verwendung des Soap Reliable Messaging Protocol Secure \(SRMPS\)\-Transports.<br /><br /> Dieses Attribut ist vom Typ <xref:System.ServiceModel.QueueTransferProtocol>.<br /><br /> Da MSMQ die Active Directory\-Adressierung bei der Verwendung von SOAP Reliable Messaging Protocol verwendet, sollten Sie dieses Attribut nicht auf Srmp oder Srmps festlegen, wenn `u``seActiveDirectory` auf `true` festgelegt ist.|  
