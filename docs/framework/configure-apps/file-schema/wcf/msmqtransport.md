...
|deadLetterQueue|Gibt den zu verwendenden Typ der Warteschlange für unzustellbare Nachrichten an.<br /><br /> Gültige Werte sind<br /><br /> Zollunion Benutzerdefinierte Warteschlange für Warteschlangen.<br />Gar Es darf keine Warteschlange für unzustellbare Nachrichten verwendet werden.<br />Anlage Verwenden Sie die Warteschlange für System DeadLetter.<br /><br /> Dieses Attribut ist vom Typ DeadLetterQueue.|  
...
|queueTransferProtocol|Gibt den von dieser Bindung verwendeten Kommunikationskanaltransport in der Warteschlange an. Folgende Werte sind gültig:<br /><br /> Einheimischen  Verwenden Sie das systemeigene MSMQ-Protokoll.<br />SRMP  Verwenden Sie das Soap Reliable Messaging Protocol (SRMP).<br />-SrmpSecure: Verwenden Sie den Soap Reliable Messaging Protocol Secure (SRMPS)-Transport.<br /><br /> Dieses Attribut ist vom Typ <xref:System.ServiceModel.QueueTransferProtocol>.<br /><br /> Da MSMQ Active Directory Adressierung bei der Verwendung des SOAP-Protokolls für zuverlässiges Messaging nicht unterstützt, sollten Sie dieses Attribut nicht auf SRMP `useActiveDirectory` oder Srmps `true`festlegen, wenn auf festgelegt ist.|  
