...
|deadLetterQueue|Gibt den zu verwendenden Typ der Warteschlange für unzustellbare Nachrichten an.<br /><br /> Gültige Werte sind<br /><br /> -Custom: Benutzerdefinierte Warteschlange für unzustellbare Nachrichten Warteschlange.<br />-Keine: Keine Warteschlange für unzustellbare Nachrichten verwendet wird.<br />-System: Verwenden der Systemwarteschlange für unzustellbare Nachrichten.<br /><br /> Dieses Attribut ist vom Typ DeadLetterQueue.|  
...
|queueTransferProtocol|Gibt den von dieser Bindung verwendeten Kommunikationskanaltransport in der Warteschlange an. Folgende Werte sind gültig:<br /><br /> -Native: Verwendung des systemeigenen MSMQ-Protokolls.<br />-Srmp: Verwendung der Soap Reliable Messaging Protocol (SRMP).<br />-SrmpSecure: Verwendung des Soap Reliable Messaging Protocol Secure (SRMPS)-Transports.<br /><br /> Dieses Attribut ist vom Typ <xref:System.ServiceModel.QueueTransferProtocol>.<br /><br /> Da MSMQ die Active Directory-Adressierung wird bei Verwendung von SOAP Reliable Messaging Protocol unterstützt, sollte dieses Attribut nicht auf Srmp oder Srmps festlegen beim `u``seActiveDirectory` festgelegt ist, um `true`.|  
