...
|-------------|-----------------|  
|ChannelInitializationTimeout|Ruft einen <xref:System.TimeSpan> ab oder legt ihn fest, der die maximale Zeit bestimmt, die ein Kanal im Initialisierungs Status sein kann, bevor er getrennt wird.|  
...
|[\<connectionpoolsettings-> \<namedPipeTransport->](connectionpoolsettings.md)|Gibt zusätzliche Verbindungspooleinstellungen für eine Named Pipe-Bindung an.|  
