...
|-------------|-----------------|  
|[\<diagnostics>](diagnostics.md)|Definiert WCF-Einstellungen für die Laufzeitüberprüfung und Steuerungen für den Administrator.|  
...
- [End-to-End-Ablauf Verfolgung](../../../wcf/diagnostics/tracing/end-to-end-tracing.md)
