...
---
# <a name="message-of-ws2007httpbinding"></a>\<-Nachrichten > von \<WS2007HttpBinding >
Definiert die Einstellungen für die Sicherheit auf Nachrichten Ebene des [\<WS2007HttpBinding->](ws2007httpbinding.md) Elements.  
