---
title: "&lt;security&gt; von &lt;netHttpBinding | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|--------------|------------------|  
|Modus|Dies ist optional.  Gibt den verwendeten Sicherheitstyp an.  Die Standardeinstellung ist `None`.  Dieses Attribut ist vom Typ <xref:System.ServiceModel.NetHttpSecurityMode>.|  
...
|[\<message\>](../../../../../docs/framework/configure-apps/file-schema/wcf/message-of-nethttpbinding.md)|Definiert die Nachrichtensicherheitseinstellungen für einen Standard\-HTTP\-Dienst.  Dieses Element entspricht <xref:System.ServiceModel.NetHttpMessageSecurity>.|  
