...
|-------------|-----------------|  
|[\<Sicherheits >](security-of-wsdualhttpbinding.md)|Definiert die Sicherheitseinstellungen für die Bindung. Dieses Element ist vom Typ <xref:System.ServiceModel.Configuration.WSDualHttpSecurityElement>.|  
