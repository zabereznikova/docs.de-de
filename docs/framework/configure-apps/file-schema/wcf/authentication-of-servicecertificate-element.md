---
title: "&lt;authentication&gt; des &lt;serviceCertificate&gt;-Elements | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|Wert|Beschreibung|  
|----------|------------------|  
|Enumeration|Einer der folgenden Werte: NoCheck, Online, Offline.<br /><br /> Weitere Informationen finden Sie unter [Verwenden von Zertifikaten](../../../../../docs/framework/wcf/feature-details/working-with-certificates.md).|  
