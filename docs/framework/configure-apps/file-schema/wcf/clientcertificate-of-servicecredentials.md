...
---
# <a name="clientcertificate-of-servicecredentials"></a>\<clientCertificate> von \<serviceCredentials>
...
- [Vorgehensweise: Erstellen eines Duplexvertrags](../../../wcf/feature-details/how-to-create-a-duplex-contract.md)
