...
|---------------|-----------------|  
|Modus|Optionale. Gibt den angewendeten Sicherheitstyp an. Standardwert: `Message`. Dieses Attribut ist vom Typ <xref:System.ServiceModel.WSDualHttpSecurityMode>.|  
