...
## <a name="remarks"></a>Hinweise  
 ...
 Die `wsFederationHttpBinding` steuert die Details der Sicherheitseinstellungen für die Nachricht in [ \<Nachricht >](../../../../../docs/framework/configure-apps/file-schema/wcf/message-element-of-wsfederationhttpbinding.md). Beachten Sie, dass die [ \<Sicherheit >](../../../../../docs/framework/configure-apps/file-schema/wcf/security-of-wsfederationhttpbinding.md) Element Zugriff erhält nur verwendet werden, wie die von der Bindung verwendeten Sicherheitsmodus nicht geändert werden kann, nach dem Erstellen der Bindung bereit.  
