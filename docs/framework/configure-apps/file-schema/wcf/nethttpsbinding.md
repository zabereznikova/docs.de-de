...
|-------------|-----------------|  
|[\<Sicherheits >](security-of-nethttpbinding.md)|Definiert die Sicherheitseinstellungen für die Bindung. Dieses Element ist vom Typ <xref:System.ServiceModel.Configuration.BasicHttpsSecurityElement>. |  
...
## <a name="remarks"></a>Hinweise  
 ...
 Sicherheit ist standardmäßig deaktiviert, kann jedoch hinzugefügt werden, indem das Mode-Attribut des untergeordneten Elements [\<Security >](security-of-basichttpbinding.md) auf einen anderen Wert als `None`festgelegt wird. Standardmäßig wird "Text"-Nachrichtencodierung und UTF-8-Textcodierung verwendet.  
