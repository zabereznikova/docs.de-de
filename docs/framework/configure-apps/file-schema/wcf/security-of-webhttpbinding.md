...
---
# <a name="security-of-webhttpbinding"></a>\<Sicherheits > von \<WebHttpBinding >
Gibt die Sicherheitsanforderungen für einen Endpunkt an, der mit einem [ \<WebHttpBinding->](webhttpbinding.md)konfiguriert wurde.  
