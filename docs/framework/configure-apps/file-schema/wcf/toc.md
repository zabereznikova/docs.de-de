# [WCF Configuration Schema (Schema zur WCF-Konfiguration)](index.md)
...
######## [<add>der<defaultPorts>](add-of-defaultports.md)
...
####### [<connectionPoolSettings>der<namedPipeTransport>](connectionpoolsettings.md)
...
##### [<add>der<namespaceTable>](add-of-namespacetable.md)
