...
|---------------|-----------------|  
|address|Erforderliches `string`-Attribut.<br /><br /> Gibt die Adresse des Endpunkts an. Die Adresse muss ein absoluter URI sein. Der Standardwert ist eine leere Zeichenfolge.|  
