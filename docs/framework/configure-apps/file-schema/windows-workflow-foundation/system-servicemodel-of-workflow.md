...
|-------------|-----------------|  
|[\<behaviors>](behaviors-of-workflow.md)|In diesem Abschnitt wird **serviceBehaviors** die serviceverhaltenauflistung definiert.  Jedes Element der Auflistung definiert von Diensten verarbeitete Verhaltenselemente. Jedes Behavior-Element wird durch das eindeutige **Name** -Attribut identifiziert.|  
