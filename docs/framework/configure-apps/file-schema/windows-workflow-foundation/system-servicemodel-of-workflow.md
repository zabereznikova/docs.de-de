---
title: "&lt;system.serviceModel&gt; des Workflows | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|-------------|------------------|  
|[\<behaviors\>](../../../../../docs/framework/configure-apps/file-schema/windows-workflow-foundation/behaviors-of-workflow.md)|In diesem Abschnitt wird die **serviceBehaviors**\-Auflistung definiert.  Jedes Element der Auflistung definiert von Diensten verarbeitete Verhaltenselemente.  Jedes Verhaltenselement wird durch seinen eindeutigen **name** identifiziert.|  
