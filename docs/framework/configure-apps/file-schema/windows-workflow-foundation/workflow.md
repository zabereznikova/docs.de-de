...
## <a name="remarks"></a>Hinweise  
 ...
 Überwachungsprofile werden als deklarative Abonnements für Überwachungsdatensätze angeordnet, die es Ihnen ermöglichen, bestimmte Überwachungsdatensätze aus der Workflowlaufzeit abzufragen. Es gibt eine Handvoll Abfragetypen, die es, dass Sie andere Klassen ermöglichen von nachverfolgungsdatensätzen abonnieren. Eine vollständige Liste der Abfragen, finden Sie unter der untergeordneten Elementliste dieses Themas und [Nachverfolgungsprofile](../../../../../docs/framework/windows-workflow-foundation/tracking-profiles.md).  
