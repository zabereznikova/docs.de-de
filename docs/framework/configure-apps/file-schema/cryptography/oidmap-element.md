...
Enthält ASN.1-Objektbezeichnerzuordnungen (OID) zu Klassen.  
...
|-------------|-----------------|  
|[\<oidEntry>](oidentry-element.md)|Ordnet eine ASN.1-OID einem Anzeigenamen zu.|  
...
## <a name="example"></a>Beispiel  
 Das folgende Beispiel zeigt, wie Sie das ** \<oidMap->-Element** verwenden, um eine Zuordnung einer OID für den RIPEMD-160-Hashalgorithmus zu einer Implementierung dieses Hashalgorithmus zu enthalten.  
