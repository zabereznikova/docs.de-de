...
## <a name="remarks"></a>Hinweise  
 ...
 Wenn Sie eigene benutzerdefinierte Diensthostfactory statt der standardfactory verwenden möchten, geben Sie nur den Typnamen in der [ @ServiceHost ](../../../../../docs/framework/configure-apps/file-schema/wcf-directive/servicehost.md) Richtlinie wie folgt:  
...
```  
 ...
 Beispielsweise, um einen AJAX-aktivierten Endpunkt für aktivieren `MyService`, geben Sie die <xref:System.ServiceModel.Activation.WebScriptServiceHostFactory> für den Wert des der `Factory` -Attribut, anstelle des standardmäßigen <xref:System.ServiceModel.Activation.ServiceHostFactory>in der [ @ServiceHost ](../../../../../docs/framework/configure-apps/file-schema/wcf-directive/servicehost.md) als Richtlinie Im folgenden Beispiel gezeigt.  
