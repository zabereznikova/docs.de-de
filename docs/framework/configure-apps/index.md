...
-   Von ASP.NET gehostete App.  
     ...
     Weitere Informationen zu ASP.NET-Konfigurationsdateien finden Sie unter [ASP.NET-Einstellungsschema](http://msdn.microsoft.com/library/116608f3-c03d-4413-9fc7-978703e18b0f)  
