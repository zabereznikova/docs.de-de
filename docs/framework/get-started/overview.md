---
title: "&#220;bersicht &#252;ber .NET&#160;Framework | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Anwendungsentwicklung [.NET Framework]"
  - "Common Language Runtime"
  - "Common Language Runtime, Informationen über"
  - "Common Language Runtime, Übersicht"
...
> [!NOTE]
>  Eine allgemeine Einführung in .NET Framework für Benutzer und Entwickler erhalten Sie unter [Erste Schritte](../../../docs/framework/get-started/index.md).  Weitere Informationen zum Herunterladen von .NET Framework finden Sie unter [Installationshandbuch](../../../docs/framework/install/guide-for-developers.md).  
...
-   Windows\-Dienste  Siehe [Introduction to Windows Service Applications](../../../docs/framework/windows-services/introduction-to-windows-service-applications.md).  
  
-   Dienstorientierte Anwendungen mit Windows Communication Foundation \(WCF\)  Siehe [Dienstorientierte Anwendungen mit WCF](../../../docs/framework/wcf/developing-service-oriented-applications-with-wcf.md).  
  
-   Workflowfähige Anwendungen mit Windows Workflow Foundation \(WF\)  Siehe [Building Workflows in the .NET Framework](http://msdn.microsoft.com/de-de/cbf3880f-dc7b-466d-b808-1109b1223f4a).  
