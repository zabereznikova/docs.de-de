...
- GUI-Apps für Windows (Windows Forms) Siehe [Windows Forms](/dotnet/desktop/winforms/).

- Apps für Windows Presentation Foundation (WPF) Siehe [Windows Presentation Foundation](/dotnet/desktop/wpf/).
