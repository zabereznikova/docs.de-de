...
- .NET Framework wird in der Server Core-Rolle mit Windows Server 2008 R2 SP1 oder höher unterstützt, jedoch nicht unter Windows Server 2008 R2 für Itanium-basierte Systeme.
