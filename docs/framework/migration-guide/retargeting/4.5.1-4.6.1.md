...
Wenn Sie von .NET Framework 4.5.1 und 4.6.1 zu migrieren, lesen Sie die folgenden Themen zu Anwendungskompatibilitätsproblemen, die Ihre app betreffen können:
