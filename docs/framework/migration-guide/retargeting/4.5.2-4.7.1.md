...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-471"></a>Neuzuweisung von Änderungen für die Migration von .NET Framework 4.5.2 zu 4.7.1
