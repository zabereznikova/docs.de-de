...
---
# <a name="retargeting-changes-for-migration-from-net-framework-461-to-47"></a>Neuzuweisung von Änderungen für die Migration von .NET Framework 4.6.1, 4.7

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Wenn Sie von .NET Framework 4.6.1, 4.7 migrieren, lesen Sie die folgenden Themen zu Anwendungskompatibilitätsproblemen, die Ihre app betreffen können:
