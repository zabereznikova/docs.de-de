---
title: "Änderungen zur Laufzeit für die Migration von .NET Framework 4.5, 4.5.1"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="5bac9-102">Änderungen zur Laufzeit für die Migration von .NET Framework 4.5, 4.5.1</span><span class="sxs-lookup"><span data-stu-id="5bac9-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="5bac9-103">Wenn Sie von .NET Framework 4.5, 4.5.1 migrieren, lesen Sie die folgenden Themen zu Anwendungskompatibilitätsproblemen, die Ihre app betreffen können:</span><span class="sxs-lookup"><span data-stu-id="5bac9-103">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="5bac9-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="5bac9-104">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="5bac9-105">Kernspeicher</span><span class="sxs-lookup"><span data-stu-id="5bac9-105">Core</span></span>
...
## <a name="serialization"></a><span data-ttu-id="5bac9-106">Serialisierung</span><span class="sxs-lookup"><span data-stu-id="5bac9-106">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="5bac9-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="5bac9-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="5bac9-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="5bac9-108">Windows Presentation Foundation (WPF)</span></span>
