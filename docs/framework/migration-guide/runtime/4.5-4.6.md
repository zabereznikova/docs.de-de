...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a>Änderungen zur Laufzeit für die Migration von .NET Framework 4.5 auf 4.6

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Wenn Sie .NET Framework 4.5 zu 4.6 migrieren, lesen Sie die folgenden Themen zu Anwendungskompatibilitätsproblemen, die Ihre app betreffen können:
