---
title: Runtime-Änderungen für die Migration von .NET Framework 4.5 zu 4.6.1
description: In diesem Artikel finden Sie Informationen zu von Runtimeänderungen ausgehenden Problemen bei der Anwendungskompatibilität, die sich bei der Migration von .NET Framework 4.5 zu 4.6.1 negativ auf Ihre App auswirken können.
ms.date: 07/10/2019
...
ms.locfileid: "97009292"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-461"></a><span data-ttu-id="c73cf-103">Runtime-Änderungen für die Migration von .NET Framework 4.5 zu 4.6.1</span><span class="sxs-lookup"><span data-stu-id="c73cf-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="c73cf-104">Wenn Sie von .NET Framework 4.5 zu 4.6.1 migrieren, finden Sie in den folgenden Abschnitten weitere Informationen zu den Anwendungskompatibilitätsproblemen, die sich möglicherweise auf Ihre App auswirken können:</span><span class="sxs-lookup"><span data-stu-id="c73cf-104">If you are migrating from the .NET Framework 4.5 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="c73cf-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="c73cf-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="c73cf-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c73cf-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="c73cf-107">Kernspeicher</span><span class="sxs-lookup"><span data-stu-id="c73cf-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="c73cf-108">Daten</span><span class="sxs-lookup"><span data-stu-id="c73cf-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="c73cf-109">Debugger</span><span class="sxs-lookup"><span data-stu-id="c73cf-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="c73cf-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="c73cf-110">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="c73cf-111">Netzwerk</span><span class="sxs-lookup"><span data-stu-id="c73cf-111">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="c73cf-112">Serialisierung</span><span class="sxs-lookup"><span data-stu-id="c73cf-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="c73cf-113">Setup und Bereitstellung</span><span class="sxs-lookup"><span data-stu-id="c73cf-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="c73cf-114">Tools</span><span class="sxs-lookup"><span data-stu-id="c73cf-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c73cf-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="c73cf-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c73cf-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c73cf-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="c73cf-117">XML</span><span class="sxs-lookup"><span data-stu-id="c73cf-117">XML</span></span>
