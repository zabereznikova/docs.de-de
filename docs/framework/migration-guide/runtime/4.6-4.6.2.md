...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-462"></a><span data-ttu-id="77fe7-102">Runtime-Änderungen für die Migration von .NET Framework 4.6 zu 4.6.2</span><span class="sxs-lookup"><span data-stu-id="77fe7-102">Runtime Changes for Migration from .NET Framework 4.6 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="77fe7-103">Wenn Sie von .NET Framework 4.6 zu 4.6.2 migrieren, finden Sie in den folgenden Abschnitten weitere Informationen zu den Anwendungskompatibilitätsproblemen, die sich möglicherweise auf Ihre App auswirken können:</span><span class="sxs-lookup"><span data-stu-id="77fe7-103">If you are migrating from the .NET Framework 4.6 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="77fe7-104">Kernspeicher</span><span class="sxs-lookup"><span data-stu-id="77fe7-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="77fe7-105">Daten</span><span class="sxs-lookup"><span data-stu-id="77fe7-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="77fe7-106">Globalisierung</span><span class="sxs-lookup"><span data-stu-id="77fe7-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="77fe7-107">Sicherheit</span><span class="sxs-lookup"><span data-stu-id="77fe7-107">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="77fe7-108">Tools</span><span class="sxs-lookup"><span data-stu-id="77fe7-108">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="77fe7-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="77fe7-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="77fe7-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="77fe7-110">Windows Presentation Foundation (WPF)</span></span>
