---
title: "Änderungen zur Laufzeit für die Migration von .NET Framework 4.5.1 auf 4.6"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a><span data-ttu-id="196e6-102">Änderungen zur Laufzeit für die Migration von .NET Framework 4.5.1 auf 4.6</span><span class="sxs-lookup"><span data-stu-id="196e6-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="196e6-103">Wenn Sie von .NET Framework 4.5.1 zu 4.6 migrieren, lesen Sie die folgenden Themen zu Anwendungskompatibilitätsproblemen, die Ihre app betreffen können:</span><span class="sxs-lookup"><span data-stu-id="196e6-103">If you are migrating from the .NET Framework 4.5.1 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="196e6-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="196e6-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="196e6-105">Kernspeicher</span><span class="sxs-lookup"><span data-stu-id="196e6-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="196e6-106">Daten</span><span class="sxs-lookup"><span data-stu-id="196e6-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="196e6-107">Debugger</span><span class="sxs-lookup"><span data-stu-id="196e6-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="196e6-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="196e6-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="196e6-109">Netzwerk</span><span class="sxs-lookup"><span data-stu-id="196e6-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="196e6-110">Serialisierung</span><span class="sxs-lookup"><span data-stu-id="196e6-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="196e6-111">Setup und Bereitstellung</span><span class="sxs-lookup"><span data-stu-id="196e6-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="196e6-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="196e6-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="196e6-113">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="196e6-113">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="196e6-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="196e6-114">Windows Presentation Foundation (WPF)</span></span>
