---
title: Runtime-Änderungen für die Migration von .NET Framework 4.5.1 zu 4.6.2
description: In diesem Artikel finden Sie Informationen zu von Runtimeänderungen ausgehenden Problemen bei der Anwendungskompatibilität, die sich bei der Migration von .NET Framework 4.5.1 zu 4.6.2 negativ auf Ihre App auswirken können.
ms.date: 07/10/2019
...
ms.locfileid: "97009136"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-462"></a><span data-ttu-id="25356-103">Runtime-Änderungen für die Migration von .NET Framework 4.5.1 zu 4.6.2</span><span class="sxs-lookup"><span data-stu-id="25356-103">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="25356-104">Wenn Sie von .NET Framework 4.5.1 zu 4.6.2 migrieren, finden Sie in den folgenden Abschnitten weitere Informationen zu den Anwendungskompatibilitätsproblemen, die sich möglicherweise auf Ihre App auswirken können:</span><span class="sxs-lookup"><span data-stu-id="25356-104">If you are migrating from the .NET Framework 4.5.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="25356-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="25356-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="25356-106">Kernspeicher</span><span class="sxs-lookup"><span data-stu-id="25356-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="25356-107">Daten</span><span class="sxs-lookup"><span data-stu-id="25356-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="25356-108">Debugger</span><span class="sxs-lookup"><span data-stu-id="25356-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="25356-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="25356-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="25356-110">Globalisierung</span><span class="sxs-lookup"><span data-stu-id="25356-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="25356-111">Netzwerk</span><span class="sxs-lookup"><span data-stu-id="25356-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="25356-112">Sicherheit</span><span class="sxs-lookup"><span data-stu-id="25356-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="25356-113">Serialisierung</span><span class="sxs-lookup"><span data-stu-id="25356-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="25356-114">Setup und Bereitstellung</span><span class="sxs-lookup"><span data-stu-id="25356-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="25356-115">Tools</span><span class="sxs-lookup"><span data-stu-id="25356-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="25356-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="25356-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="25356-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="25356-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="25356-118">XML</span><span class="sxs-lookup"><span data-stu-id="25356-118">XML</span></span>
