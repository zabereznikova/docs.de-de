---
title: "Änderungen zur Laufzeit für die Migration von .NET Framework 4.7 zu 4.7.1 | Microsoft Docs"
ms.date: 10/09/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-47-to-471"></a><span data-ttu-id="6800c-102">Änderungen zur Laufzeit für die Migration von .NET Framework 4.7 zu 4.7.1</span><span class="sxs-lookup"><span data-stu-id="6800c-102">Runtime Changes for Migration from .NET Framework 4.7 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="6800c-103">Wenn Sie von der .NET Framework-4.7 zu 4.7.1 migrieren, lesen Sie die folgenden Themen zu Anwendungskompatibilitätsproblemen, die Ihre app betreffen können:</span><span class="sxs-lookup"><span data-stu-id="6800c-103">If you are migrating from the .NET Framework 4.7 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="jit"></a><span data-ttu-id="6800c-104">JIT</span><span class="sxs-lookup"><span data-stu-id="6800c-104">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="6800c-105">Sicherheit</span><span class="sxs-lookup"><span data-stu-id="6800c-105">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="6800c-106">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="6800c-106">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="6800c-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="6800c-107">Windows Presentation Foundation (WPF)</span></span>
