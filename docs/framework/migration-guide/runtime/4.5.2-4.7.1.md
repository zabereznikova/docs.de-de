...
ms.locfileid: "67858899"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-471"></a><span data-ttu-id="edd28-102">Runtime-Änderungen für die Migration von .NET Framework 4.5.2 zu 4.7.1</span><span class="sxs-lookup"><span data-stu-id="edd28-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="edd28-103">Wenn Sie von .NET Framework 4.5.2 zu 4.7.1 migrieren, finden Sie in den folgenden Abschnitten weitere Informationen zu den Anwendungskompatibilitätsproblemen, die sich möglicherweise auf Ihre App auswirken können:</span><span class="sxs-lookup"><span data-stu-id="edd28-103">If you are migrating from the .NET Framework 4.5.2 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="edd28-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="edd28-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="edd28-105">Kernspeicher</span><span class="sxs-lookup"><span data-stu-id="edd28-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="edd28-106">Daten</span><span class="sxs-lookup"><span data-stu-id="edd28-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="edd28-107">Debugger</span><span class="sxs-lookup"><span data-stu-id="edd28-107">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="edd28-108">Globalisierung</span><span class="sxs-lookup"><span data-stu-id="edd28-108">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="edd28-109">Netzwerk</span><span class="sxs-lookup"><span data-stu-id="edd28-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="edd28-110">Sicherheit</span><span class="sxs-lookup"><span data-stu-id="edd28-110">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="edd28-111">Serialisierung</span><span class="sxs-lookup"><span data-stu-id="edd28-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="edd28-112">Setup und Bereitstellung</span><span class="sxs-lookup"><span data-stu-id="edd28-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="edd28-113">Tools</span><span class="sxs-lookup"><span data-stu-id="edd28-113">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="edd28-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="edd28-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="edd28-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="edd28-115">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="edd28-116">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="edd28-116">Windows Workflow Foundation (WF)</span></span>
