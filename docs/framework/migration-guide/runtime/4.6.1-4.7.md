...
ms.locfileid: "37071249"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="dc397-102">Runtime-Änderungen für die Migration von .NET Framework 4.6.1 zu 4.7</span><span class="sxs-lookup"><span data-stu-id="dc397-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="dc397-103">Wenn Sie von .NET Framework 4.6.1 zu 4.7 migrieren, finden Sie in den folgenden Abschnitten weitere Informationen zu den Anwendungskompatibilitätsproblemen, die sich möglicherweise auf Ihre App auswirken können:</span><span class="sxs-lookup"><span data-stu-id="dc397-103">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="dc397-104">Daten</span><span class="sxs-lookup"><span data-stu-id="dc397-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="dc397-105">Globalisierung</span><span class="sxs-lookup"><span data-stu-id="dc397-105">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="dc397-106">JIT</span><span class="sxs-lookup"><span data-stu-id="dc397-106">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="dc397-107">Sicherheit</span><span class="sxs-lookup"><span data-stu-id="dc397-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="dc397-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="dc397-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="dc397-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="dc397-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="dc397-110">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="dc397-110">Windows Workflow Foundation (WF)</span></span>
