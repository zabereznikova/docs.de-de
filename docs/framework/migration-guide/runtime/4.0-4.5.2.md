---
title: Runtime-Änderungen für die Migration von .NET Framework 4.0 zu 4.5.2
description: In diesem Artikel finden Sie Informationen zu von Runtimeänderungen ausgehenden Problemen bei der Anwendungskompatibilität, die sich bei der Migration von .NET Framework 4.0 bis 4.5.2 negativ auf Ihre App auswirken können.
ms.date: 07/10/2019
...
ms.locfileid: "97009383"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-452"></a><span data-ttu-id="b2aae-103">Runtime-Änderungen für die Migration von .NET Framework 4.0 zu 4.5.2</span><span class="sxs-lookup"><span data-stu-id="b2aae-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="b2aae-104">Wenn Sie von .NET Framework 4.0 zu 4.5.2 migrieren, finden Sie in den folgenden Abschnitten weitere Informationen zu den Anwendungskompatibilitätsproblemen, die sich möglicherweise auf Ihre App auswirken können:</span><span class="sxs-lookup"><span data-stu-id="b2aae-104">If you are migrating from the .NET Framework 4.0 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="b2aae-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="b2aae-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="b2aae-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="b2aae-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b2aae-107">Kernspeicher</span><span class="sxs-lookup"><span data-stu-id="b2aae-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b2aae-108">Daten</span><span class="sxs-lookup"><span data-stu-id="b2aae-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="b2aae-109">Debugger</span><span class="sxs-lookup"><span data-stu-id="b2aae-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="b2aae-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="b2aae-110">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="b2aae-111">LINQ</span><span class="sxs-lookup"><span data-stu-id="b2aae-111">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="b2aae-112">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="b2aae-112">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="b2aae-113">Netzwerk</span><span class="sxs-lookup"><span data-stu-id="b2aae-113">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="b2aae-114">Drucken</span><span class="sxs-lookup"><span data-stu-id="b2aae-114">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="b2aae-115">Serialisierung</span><span class="sxs-lookup"><span data-stu-id="b2aae-115">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="b2aae-116">Webanwendungen</span><span class="sxs-lookup"><span data-stu-id="b2aae-116">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b2aae-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b2aae-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="b2aae-118">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="b2aae-118">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b2aae-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b2aae-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="b2aae-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="b2aae-120">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="b2aae-121">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="b2aae-121">XML, XSLT</span></span>
