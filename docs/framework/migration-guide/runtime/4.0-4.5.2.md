...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-452"></a>Runtime-Änderungen für die Migration von .NET Framework 4.0 zu 4.5.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Wenn Sie von .NET Framework 4.0 zu 4.5.2 migrieren, finden Sie in den folgenden Abschnitten weitere Informationen zu den Anwendungskompatibilitätsproblemen, die sich möglicherweise auf Ihre App auswirken können:
