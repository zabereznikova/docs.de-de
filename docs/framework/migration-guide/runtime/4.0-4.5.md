...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-45"></a>Änderungen zur Laufzeit für die Migration von .NET Framework 4.0, 4.5

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Wenn Sie .NET Framework 4.0, 4.5 migrieren, lesen Sie die folgenden Themen zu Anwendungskompatibilitätsproblemen, die Ihre app betreffen können:
