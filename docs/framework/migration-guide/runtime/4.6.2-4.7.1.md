...
---
# <a name="runtime-changes-for-migration-from-net-framework-462-to-471"></a>Änderungen zur Laufzeit für die Migration von .NET Framework 4.6.2, 4.7.1

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Wenn Sie von .NET Framework 4.6.2, 4.7.1 migrieren, lesen Sie die folgenden Themen zu Anwendungskompatibilitätsproblemen, die Ihre app betreffen können:
