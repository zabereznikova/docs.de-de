...
ms.locfileid: "68237912"
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-47"></a><span data-ttu-id="c45ed-102">Runtime-Änderungen für die Migration von .NET Framework 4.6 zu 4.7</span><span class="sxs-lookup"><span data-stu-id="c45ed-102">Runtime Changes for Migration from .NET Framework 4.6 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="c45ed-103">Wenn Sie von .NET Framework 4.6 zu 4.7 migrieren, finden Sie in den folgenden Abschnitten weitere Informationen zu den Anwendungskompatibilitätsproblemen, die sich möglicherweise auf Ihre App auswirken können:</span><span class="sxs-lookup"><span data-stu-id="c45ed-103">If you are migrating from the .NET Framework 4.6 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="c45ed-104">Daten</span><span class="sxs-lookup"><span data-stu-id="c45ed-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="c45ed-105">Globalisierung</span><span class="sxs-lookup"><span data-stu-id="c45ed-105">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="c45ed-106">JIT</span><span class="sxs-lookup"><span data-stu-id="c45ed-106">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="c45ed-107">Sicherheit</span><span class="sxs-lookup"><span data-stu-id="c45ed-107">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="c45ed-108">Tools</span><span class="sxs-lookup"><span data-stu-id="c45ed-108">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c45ed-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="c45ed-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c45ed-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c45ed-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="c45ed-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="c45ed-111">Windows Workflow Foundation (WF)</span></span>
