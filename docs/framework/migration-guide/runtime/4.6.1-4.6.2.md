---
title: "Änderungen zur Laufzeit für die Migration von .NET Framework 4.6.1, 4.6.2"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="52278-102">Änderungen zur Laufzeit für die Migration von .NET Framework 4.6.1, 4.6.2</span><span class="sxs-lookup"><span data-stu-id="52278-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="52278-103">Wenn Sie von .NET Framework 4.6.1, 4.6.2 migrieren, lesen Sie die folgenden Themen zu Anwendungskompatibilitätsproblemen, die Ihre app betreffen können:</span><span class="sxs-lookup"><span data-stu-id="52278-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="52278-104">Kernspeicher</span><span class="sxs-lookup"><span data-stu-id="52278-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="52278-105">Daten</span><span class="sxs-lookup"><span data-stu-id="52278-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="52278-106">Globalisierung</span><span class="sxs-lookup"><span data-stu-id="52278-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="52278-107">Sicherheit</span><span class="sxs-lookup"><span data-stu-id="52278-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="52278-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="52278-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="52278-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="52278-109">Windows Presentation Foundation (WPF)</span></span>
