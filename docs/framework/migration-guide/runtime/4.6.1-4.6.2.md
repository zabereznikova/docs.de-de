...
ms.locfileid: "33392056"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="bf960-102">Runtime-Änderungen für die Migration von .NET Framework 4.6.1 zu 4.6.2</span><span class="sxs-lookup"><span data-stu-id="bf960-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="bf960-103">Wenn Sie von .NET Framework 4.6.1 zu 4.6.2 migrieren, finden Sie in den folgenden Themen weitere Informationen zu den Anwendungskompatibilitätsproblemen, die sich möglicherweise auf Ihre App auswirken können:</span><span class="sxs-lookup"><span data-stu-id="bf960-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="bf960-104">Daten</span><span class="sxs-lookup"><span data-stu-id="bf960-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="bf960-105">Globalisierung</span><span class="sxs-lookup"><span data-stu-id="bf960-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="bf960-106">Sicherheit</span><span class="sxs-lookup"><span data-stu-id="bf960-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="bf960-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="bf960-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="bf960-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="bf960-108">Windows Presentation Foundation (WPF)</span></span>
