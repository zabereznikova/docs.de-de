---
title: "Migrieren von .NET&#160;Framework&#160;1.1 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - ".NET Framework 1.1, Migrieren auf .NET Framework 4.5"
  - ".NET Framework 4.5, Migrieren von 1.1"
...
## Veraltete Typen und Member  
 ...
 Nähere Informationen zur Bewertung der Auswirkungen von Typen und Membern, die seit der Veröffentlichung von [!INCLUDE[net_v20SP1_short](../../../includes/net-v20sp1-short-md.md)] veraltet sind, finden Sie unter [Veraltete Elemente in der Klassenbibliothek](../../../docs/framework/whats-new/whats-obsolete.md). Überprüfen Sie die Listen der veralteten Typen und Member für [!INCLUDE[net_v20SP1_short](../../../includes/net-v20sp1-short-md.md)], [!INCLUDE[net_v35_short](../../../includes/net-v35-short-md.md)] und [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)].