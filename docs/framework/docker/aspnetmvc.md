...
Dieser Inhalt wurde zusammengeführt und in das Thema [Migrieren von ASP.NET MVC-Anwendungen zu Windows-Containern](https://docs.microsoft.com/aspnet/mvc/overview/deployment/docker-aspnetmvc) verschoben.
