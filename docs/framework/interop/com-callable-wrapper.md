...
```  
 ...
 Der COM\-Client kann einen Zeiger auf die Klassenschnittstelle mit Namen `_Mammal` abrufen, die in der Typbibliothek beschrieben wird, die von Tool [Type Library Exporter \(Tlbexp.exe\)](../../../docs/framework/tools/tlbexp-exe-type-library-exporter.md) generiert wird.  Wenn die `Mammal`\-Klasse eine oder mehrere Schnittstellen implementiert hat, werden die Schnittstellen unter der Coklasse angezeigt.  
...
### Definieren Sie eine explizite Schnittstelle für COM\-Clients anstatt die Klassenschnittstelle zu generieren.  
...
### Vermeiden Sie das Zwischenspeichern von Dispatch\-IDs \(DispIds\).  
...
### Beschränken Sie die Nutzung der dualen Schnittstellenoption für die Klassenschnittstelle.  
...
## Siehe auch  
 ...
 [Simulating COM Interfaces](http://msdn.microsoft.com/de-de/ad2ab959-e2be-411b-aaff-275c3fba606c)   
