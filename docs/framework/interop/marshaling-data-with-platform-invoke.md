...
|**WCHAR**|**wchar_t**|<xref:System.Char?displayProperty=fullName>|Mit Unicode ergänzen.|  
...
|**LPWSTR**|**wchar_t\***|<xref:System.String?displayProperty=fullName> oder <xref:System.Text.StringBuilder?displayProperty=fullName>|Mit Unicode ergänzen.|  
|**LPCWSTR**|**Const wchar_t\***|<xref:System.String?displayProperty=fullName> oder <xref:System.Text.StringBuilder?displayProperty=fullName>|Mit Unicode ergänzen.|  
