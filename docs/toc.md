...
### [Einzelvorhersage mit PredictionFunction](machine-learning/how-to-guides/single-predict-model-ml-net.md)
...
### [Einsatz von verallgemeinerten additiven Modellen zur Modellerklärung](machine-learning/how-to-guides/use-gams-for-model-explainability.md)
### [Verwenden von Metriken zum Auswerten der Modellqualität](machine-learning/how-to-guides/verify-model-quality-ml-net.md)
## Referenz
