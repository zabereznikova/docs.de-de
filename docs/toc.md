...
<!-- Start of .NET Guide -->
# [Leitfaden für .NET](standard/index.md)
...
### [.NET Microservices: Architektur für .NET-Containeranwendungen](standard/microservices-architecture/)
...
## [Neuerungen in .NET Core](core/whats-new/index.md)
### [Neuerungen in .NET Core 3.0](core/whats-new/dotnet-core-3-0.md)
### [Neuerungen in .NET Core 2.2](core/whats-new/dotnet-core-2-2.md)
### [Neuerungen in .NET Core 2.1](core/whats-new/dotnet-core-2-1.md)
### [Neuerungen in .NET Core 2.0](core/whats-new/dotnet-core-2-0.md)
...
### [Verpacken einer Verteilung in .NET Core](core/build/distribution-packaging.md)
...
## [Neuerungen](framework/whats-new/)
...
## [Neuerungen in C#](csharp/whats-new/index.md)
...
#### [Der Wert vom Typ „<Typ1>“ kann nicht in „<Typ2>“ konvertiert werden](visual-basic/language-reference/error-messages/value-of-type-type1-cannot-be-converted-to-type2.md)
...
### [Vorhersage des Taxifahrtpreises (Regression)](machine-learning/tutorials/taxi-fare.md)
### [Iris-Dataset (Clustering)](machine-learning/tutorials/iris-clustering.md)
...
### [Maschinelles Lernen (Aufgaben)](machine-learning/resources/tasks.md)
