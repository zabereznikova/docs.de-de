...
## [Leitfaden für die Open Source-Bibliothek](standard/library-guidance/)
...
### [Vorgehensweise: Verwenden und Debuggen von Assemblyentladbarkeit in .NET Core](standard/assembly/unloadability-howto.md)
...
### Leitfaden zur Verwendung von [Memory<T> und <Span<T>](standard/memory-and-spans/memory-t-usage-guidelines.md)
## [Native Interoperabilität](standard/native-interop/index.md)
### [P/Invoke](standard/native-interop/pinvoke.md)
### [Marshallen von Typen](standard/native-interop/type-marshalling.md)
### [Anpassen des Marshalling für Strukturen](standard/native-interop/customize-struct-marshalling.md)
### [Anpassen des Marshalling für Parameter](standard/native-interop/customize-parameter-marshalling.md)
### [Leitfaden zur Interoperabilität](standard/native-interop/best-practices.md)
### [Zeichensätze und Marshalling](standard/native-interop/charset.md)
...
### [Debuggen einer „Hallo Welt“-Anwendung (.NET Core) in C# oder Visual Basic mit Visual Studio 2017](core/tutorials/debugging-with-visual-studio.md)
### [Veröffentlichen Ihrer „Hallo Welt“-Anwendung mit Visual Studio 2017](core/tutorials/publishing-with-visual-studio.md)
### [Erstellen einer .NET Standard-Bibliothek mit C# und .NET Core in Visual Studio 2017](core/tutorials/library-with-visual-studio.md)
### [Erstellen einer .NET Standard-Bibliothek mit Visual Basic und .NET Core in Visual Studio 2017](core/tutorials/vb-library-with-visual-studio.md)
### [Testen einer .NET Standard-Bibliothek mit .NET Core in Visual Studio 2017](core/tutorials/testing-library-with-visual-studio.md)
...
### [Neuerungen in .NET Core 3.0](core/whats-new/dotnet-core-3-0.md)
### [Neuerungen in .NET Core 2.2](core/whats-new/dotnet-core-2-2.md)
...
### [Migration über „project.json“](core/migration/index.md)
...
### [Containerisieren einer .NET Core-App](core/docker/docker-basics-dotnet-core.md)
### [Arbeiten mit Docker-basierten Images](core/docker/building-net-docker-images.md)
...
### [Aktivieren der Vervollständigung mit der TAB-TASTE](core/tools/enable-tab-autocomplete.md)
...
### [dotnet-install-Skripts](core/tools/dotnet-install-script.md)
...
### [.NET Framework-Technologien, die auf .NET Core nicht verfügbar sind](core/porting/net-framework-tech-unavailable.md)
...
### [Tools zur Unterstützung beim Portieren zu .NET Core](core/porting/tools.md)
### [Verwenden von Windows Compatibility Pack](core/porting/windows-compat-pack.md)
### [Portieren von Windows Forms-Projekten](core/porting/winforms.md)
...
### [Einführung in C#](csharp/tutorials/intro-to-csharp/index.md)
#### [Hello World](csharp/tutorials/intro-to-csharp/hello-world.yml)
#### [Zahlen in C#](csharp/tutorials/intro-to-csharp/numbers-in-csharp.yml)
#### [Verzweigungen und Schleifen](csharp/tutorials/intro-to-csharp/branches-and-loops.yml)
#### [Zeichenfolgeninterpolation](csharp/tutorials/intro-to-csharp/interpolated-strings.yml)
#### [Listensammlungen](csharp/tutorials/intro-to-csharp/list-collection.yml)
#### [Arbeiten in Ihrer lokalen Umgebung](csharp/tutorials/intro-to-csharp/local-environment.md)
##### [Zahlen in C#](csharp/tutorials/intro-to-csharp/numbers-in-csharp-local.md)
##### [Verzweigungen und Schleifen](csharp/tutorials/intro-to-csharp/branches-and-loops-local.md)
##### [Zeichenfolgeninterpolation](csharp/tutorials/intro-to-csharp/interpolated-strings-local.md)
##### [Listensammlungen](csharp/tutorials/intro-to-csharp/arrays-and-collections.md)
...
### [Upgrade einer App auf Verweistypen, die NULL-Werte zulassen](csharp/tutorials/upgrade-to-nullable-references.md)
### [Generieren und Nutzen asynchroner Streams](csharp/tutorials/generate-consume-asynchronous-stream.md)
### [Erweitern von Datenfunktionen mithilfe des Musterabgleichs](csharp/tutorials/pattern-matching.md)
...
### [Zeichenfolgeninterpolation](csharp/tutorials/string-interpolation.md)
### [Verwenden von Attributen](csharp/tutorials/attributes.md)
...
### [Nullwerte zulassende Verweistypen](csharp/nullable-references.md)
...
### [Erste Schritte mit F# in Visual Studio](fsharp/get-started/get-started-visual-studio.md)
### [Erste Schritte mit F# in Visual Studio für Mac](fsharp/get-started/get-started-with-visual-studio-for-mac.md)
### [Erste Schritte mit F# in Visual Studio Code und Ionide](fsharp/get-started/get-started-vscode.md)
### [Erste Schritte mit F# mit der .NET Core-CLI](fsharp/get-started/get-started-command-line.md)
...
#### [Funktionen erster Klasse](fsharp/introduction-to-functional-programming/first-class-functions.md)
...
### [Slices](fsharp/language-reference/slices.md)
...
### [Nicht strikte Ausdrücke](fsharp/language-reference/lazy-expressions.md)
...
##### [Vorgehensweise: Asynchrones Aufrufen eines Webdiensts](visual-basic/developing-apps/programming/how-to-call-a-web-service-asynchronously.md)
...
##### [Vorgehensweise: Konvertieren eines Objekts in einen anderen Typ](visual-basic/programming-guide/language-features/data-types/how-to-convert-an-object-to-another-type.md)
...
#### [Tupel](visual-basic/programming-guide/language-features/data-types/tuples.md)
...
### [Vorgehensweise: Verweisen auf COM-Objekte](visual-basic/programming-guide/com-interop/how-to-reference-com-objects.md)
...
#### Liste der Visual Basic-Operatoren
...
#### [Der angeforderte Vorgang ist nicht verfügbar (BC35000)](visual-basic/language-reference/error-messages/bc35000.md)
...
## [Verweis](visual-basic/reference/index.md)
...
### [Sprachspezifikation](visual-basic/reference/language-specification/)
...
## Übersicht
### [Was ist ML.NET?](machine-learning/what-is-mldotnet.md)
### [Konzepte für das Modelltraining](machine-learning/basic-concepts-model-training-in-mldotnet.md)
...
### [Filmempfehlung (Empfehlung)](machine-learning/tutorials/movie-recommmendation.md)
## [Anleitungen](machine-learning/how-to-guides/index.md)
### Vorbereiten von Daten
#### [Featureentwicklung für Kategoriedaten](machine-learning/how-to-guides/train-model-categorical-ml-net.md)
#### [Featureentwicklung für Textdaten](machine-learning/how-to-guides/train-model-textual-ml-net.md)
#### [Laden von Daten mit vielen Spalten](machine-learning/how-to-guides/load-data-from-mult-column-csv-ml-net.md)
#### [Laden von Daten aus mehreren Dateien](machine-learning/how-to-guides/load-data-from-multiple-files-ml-net.md)
...
## Referenz
### [API-Referenz](https://docs.microsoft.com/dotnet/api/?view=ml-dotnet)
## [Ressourcen](machine-learning/resources/index.md)
### [Maschinelles Lernen (Glossar)](machine-learning/resources/glossary.md)
### [Maschinelles Lernen (Tasks)](machine-learning/resources/tasks.md)
### [Datentransformationen](machine-learning/resources/transforms.md)
