...
> **Hinweis:** Wenn Ihnen die allgemeine `csproj`-Syntax noch unbekannt ist, können Sie sich mithilfe der [Dokumentation zu MSBuild-Projektverweisen]() damit vertraut machen.  
