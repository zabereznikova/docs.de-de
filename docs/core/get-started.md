---
title: Erste Schritte mit .NET Core | Microsoft-Dokumentation
...
* [Erstellen einer Klassenbibliothek mit C# und .NET Core in Visual Studio 2017](../csharp/getting-started/library-with-visual-studio.md): Erfahren Sie, wie Sie eine in C# geschriebene Klassenbibliothek mithilfe von Visual Studio 2017 erstellen.
