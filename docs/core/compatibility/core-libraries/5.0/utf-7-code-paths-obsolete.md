...
- Wenn Sie `Encoding.GetEncoding("utf-7", ...)` unterstützen müssen, gehen Sie wie folgt vor:
  ...
  Sie können die Unterstützung über einen Kompatibilitätsschalter wieder aktivieren. Dieser Kompatibilitätsschalter kann in der *CSPROJ*-Datei der Anwendung oder in einer [Runtimekonfigurationsdatei](../../../run-time-config/index.md) angegeben werden, wie in den folgenden Beispielen gezeigt.
