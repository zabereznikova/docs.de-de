---
title: .NET Core-Wartung | Microsoft-Dokumentation
description: .NET Core-Wartung
...
# <a name="-net-core-servicing"></a>🔧 .NET Core-Wartung

> **Hinweis**
> 
> Zu diesem Thema wurde noch nichts geschrieben. 
>
> Wir freuen uns auf Ihre Ideen zur Gestaltung des Umfangs und der Herangehensweise. Sie können den Status nachverfolgen und Informationen zu diesem [Problem](https://github.com/dotnet/docs/issues/469) auf GitHub bereitstellen.
> 
