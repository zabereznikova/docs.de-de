...
### Formular der Versionskontrolle
...
- Beschreibt die Pakete, die für die moderne App-Entwicklung als erforderlich gelten und dass .NET-Plattformen implementiert werden müssen, um als [.NET Standard](../../standard/net-standard.md)-Plattform zu gelten.
