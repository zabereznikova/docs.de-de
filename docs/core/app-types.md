---
title: .NET Core-App-Typen
description: .NET Core-App-Typen
...
# <a name="net-core-app-types"></a>.NET Core-App-Typen

## <a name="content-moved"></a>Inhalt verschoben.
Dieser Inhalt wurde zusammengeführt und in das Thema [.NET Core-Anwendungsbereitstellung](deploying/index.md) verschoben. 
