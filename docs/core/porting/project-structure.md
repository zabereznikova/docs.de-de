...
* <a name="support-vs"></a><span data-ttu-id="a21fe-119">[**Trennen vorhandener und neuer .NET Core-Projekte**][option-csproj-folder]</span><span class="sxs-lookup"><span data-stu-id="a21fe-119">[**Keep existing projects and new .NET Core projects separate**][option-csproj-folder]</span></span>
