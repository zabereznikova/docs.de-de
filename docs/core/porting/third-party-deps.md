...
# <a name="porting-to-net-core-analyzing-your-thirdparty-party-dependencies"></a>Portieren auf .NET Core – Analysieren der Abhängigkeiten von Drittanbietern
