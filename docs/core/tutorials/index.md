...
- [Erste Schritte mit .NET Core unter Windows](using-on-windows.md)
- [Erste Schritte mit .NET Core unter macOS](using-on-macos.md)
- [Erste Schritte mit .NET Core unter Windows/Linux/macOS unter Verwendung der Befehlszeile](using-with-xplat-cli.md)
...
- [Verwenden von MSBuild für die Erstellung von .NET Core-Projekten](target-dotnetcore-with-msbuild.md)
