...
2. Erstellen Sie eine Visual Studio-Projektmappendatei, um das Erstellen des Projekts zu vereinfachen. Führen Sie im selben Ordner den folgenden Befehl aus:
