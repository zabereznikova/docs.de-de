...
<span data-ttu-id="519ad-181">Druckt eine kurze Hilfe für den Befehl.</span><span class="sxs-lookup"><span data-stu-id="519ad-181">Prints out a short help for the command.</span></span>
