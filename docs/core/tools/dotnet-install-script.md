...
- **`-ProxyBypassList <LIST_OF_URLS>`**
  ...
  Wenn diese Einstellung mit `ProxyAddress`festgelegt ist, wird eine Liste mit durch Trennzeichen getrennten URLs bereitstellt, die den Proxy umgehen. (Nur gültig für Windows)
