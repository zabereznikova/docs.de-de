---
title: .NET Core Runtime-ID (RID)-Katalog
description: .NET Core Runtime-ID (RID)-Katalog
...
# <a name="net-core-runtime-identifier-rid-catalog"></a>.NET Core Runtime-ID (RID)-Katalog

## <a name="what-are-rids"></a>Was sind RIDs?
