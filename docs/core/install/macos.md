...
- <span data-ttu-id="f97f4-144">2.0 ([Versionshinweise][release-notes-20])</span><span class="sxs-lookup"><span data-stu-id="f97f4-144">2.0 ([Release notes][release-notes-20])</span></span>
