...
- <span data-ttu-id="41bea-144">2.0 ([Versionshinweise][release-notes-20])</span><span class="sxs-lookup"><span data-stu-id="41bea-144">2.0 ([Release notes][release-notes-20])</span></span>
