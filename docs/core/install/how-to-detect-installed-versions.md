...
Sie können sehen, welche Versionen des .NET Core SDK aktuell mit einem Terminal installiert sind. Öffnen Sie ein Terminal und führen Sie den `dotnet --list-sdks`-Befehl aus.
...
Sie können sehen, welche Versionen der .NET Core-Runtime derzeit mit dem `dotnet --list-runtimes`-Befehl installiert sind.
