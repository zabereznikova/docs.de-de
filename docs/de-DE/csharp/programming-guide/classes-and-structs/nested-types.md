...
- Geschachtelte Typen einer **Klasse** können öffentlich ([public](../../../csharp/language-reference/keywords/public.md)), geschützt ([protected](../../../csharp/language-reference/keywords/protected.md)), intern ([internal](../../../csharp/language-reference/keywords/internal.md)), geschützt intern ([protected internal](../../../csharp/language-reference/keywords/protected-internal.md)), privat ([private](../../../csharp/language-reference/keywords/private.md)) oder geschützt privat ([private protected](../../../csharp/language-reference/keywords/private-protected.md)) sein. 

   Definieren Sie jedoch eine geschachtelte Klasse der Typen `protected`, `protected internal` or `private protected` innerhalb einer [versiegelten Klasse](../../language-reference/keywords/sealed.md), dann wird die Compilerwarnung [CS0628](../../misc/cs0628.md) („New Protected Member Declared in Sealed Class“, „Neuer Protected-Member in versiegelter Klasse deklariert“) generiert.
