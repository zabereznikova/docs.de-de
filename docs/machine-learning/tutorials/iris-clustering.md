...
---
# <a name="tutorial-categorize-iris-flowers-using-a-clustering-model-with-mlnet"></a>Tutorial: Kategorisieren von Schwertlilien mit einem Clusteringmodell mit ML.NET
