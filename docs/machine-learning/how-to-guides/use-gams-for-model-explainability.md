...
Ein Beispiel für das Trainieren eines GAM-Modells und die Überprüfung und Interpretation der Ergebnisse finden Sie im [Binary Classification Trainer-Beispiel auf GitHub](https://github.com/dotnet/machinelearning/blob/master/docs/samples/Microsoft.ML.Samples/Dynamic/Trainers/BinaryClassification/Gam.cs).
