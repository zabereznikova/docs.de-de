...
## <a name="remarks"></a>Hinweise  
 ...
 Benutzerdefinierte Typen können die unären `-`- und binären `-`-Operatoren überladen. Weitere Informationen finden Sie unter [Operator (C#-Referenz)](../../../csharp/language-reference/keywords/operator.md).  
