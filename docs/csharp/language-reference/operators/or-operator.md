...
## <a name="remarks"></a>Hinweise  
 Im Gegensatz zum [bedingten OR-Operator] (conditional-or-operator.md) `||` wertet der binäre `|`-Operator beide Operatoren unabhängig vom Wert des ersten Operators aus.
