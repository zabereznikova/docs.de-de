...
Die Standardsprachversion ist vom Zielframework für Ihre Anwendung und der installierten Version des SDK oder von Visual Studio abhängig. Diese Regeln sind im Artikel zum [Konfigurieren der Sprachversion definiert](../configure-language-version.md#defaults).
