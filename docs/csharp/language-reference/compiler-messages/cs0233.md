...
„identifier“ hat keine vordefinierte Größe, weshalb „sizeof“ nur in einem unsicheren Kontext verwendet werden kann.
 ...
 Ohne [unsicheren](../keywords/unsafe.md) Kontext kann der [sizeof](../../../csharp/language-reference/operators/sizeof.md)-Operator nur für Typen verwendet werden, deren Größe eine Kompilierzeitkonstante ist. Wenn Sie einen unsicheren Kontext verwenden, wird dieser Fehler angezeigt.
