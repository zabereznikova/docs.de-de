...
Der Typ „Typname1“ ist sowohl in „Typname2“ als auch in „Typname3“ vorhanden.  
 ...
 Verwenden Sie zum Lösen dieses Problems das Aliasfeature der Compileroption [/reference (C# Compiler Options) (/reference (C#-Compileroptionen))](../compiler-options/reference-compiler-option.md), oder verweisen Sie auf keine der Assemblys.  
