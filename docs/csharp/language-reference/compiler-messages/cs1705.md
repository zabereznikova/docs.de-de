...
- Ein Client, der nur auf Version 1.0 der identischen DLLs, verweist, jedoch auf eine Klasse von Version 2.0 zugreift.  
 ...
 Der folgende Code erstellt die erste der identischen DLLs. Weitere Informationen über das Generieren einer Schlüsseldatei finden Sie unter [/keyfile (C#-Compileroptionen)](../compiler-options/keyfile-compiler-option.md).  
