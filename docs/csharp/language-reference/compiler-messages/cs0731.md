...
Die Typweiterleitung für den Typ "Typweiterleitung" in der Assembly "Assembly" verursacht eine Schleife  
  
 Dieser Fehler tritt nur bei importierten Metadaten auf, die nicht ordnungsgemäß formatiert sind.  Bei reinem C\#\-Quellcode kann dieser Fehler nicht auftreten.  
  
## Beispiel  
 Im folgenden Beispiel wird CS0731 generiert.  Das Beispiel besteht aus drei Dateien:  
 ...
 Kompilieren Sie zuerst die IL\-Dateien als Bibliotheken, und kompilieren Sie dann den CS\-Code, der auf die beiden Dateien verweist.  
