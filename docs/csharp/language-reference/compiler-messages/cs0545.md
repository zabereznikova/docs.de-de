...
- Blenden Sie die Basisklasseneigenschaft aus, indem Sie das Schlüsselwort [new](../../../csharp/language-reference/keywords/new-modifier.md) einer Eigenschaft in einer abgeleiteten Klasse hinzufügen.  
