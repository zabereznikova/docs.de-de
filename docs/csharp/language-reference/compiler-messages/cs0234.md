...
- Auf eine Assembly, die eine Typdefinition enthält, wurde in der Kompilierung nicht verwiesen. Verwenden Sie [-reference (Import Metadata)](../../../csharp/language-reference/compiler-options/reference-compiler-option.md), um die Assembly anzugeben.  
  
- Sie haben einen Namen einer Variable dem [typeof](../../../csharp/language-reference/operators/type-testing-and-conversion-operators.md#typeof-operator)-Operator übergeben.  
