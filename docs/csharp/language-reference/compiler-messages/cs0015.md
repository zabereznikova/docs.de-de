...
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="02ebc-102">Compilerfehler CS0015</span><span class="sxs-lookup"><span data-stu-id="02ebc-102">Compiler Error CS0015</span></span>
<span data-ttu-id="02ebc-103">Der Name des Typs „type“ ist zu lang.</span><span class="sxs-lookup"><span data-stu-id="02ebc-103">The name of type 'type' is too long</span></span>  
  
 <span data-ttu-id="02ebc-104">Der vollqualifizierte Name eines benutzerdefinierten Typs muss weniger als 1024 Zeichen haben, einschließlich der Punkte.</span><span class="sxs-lookup"><span data-stu-id="02ebc-104">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>  
  
 <span data-ttu-id="02ebc-105">Im folgenden Beispiel wird CS0015 generiert:</span><span class="sxs-lookup"><span data-stu-id="02ebc-105">The following sample generates CS0015:</span></span>  
