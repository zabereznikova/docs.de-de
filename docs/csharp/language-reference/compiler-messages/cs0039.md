...
Eine Konvertierung mithilfe des [as](../../language-reference/operators/type-testing-and-conversion-operators.md#as-operator)-Operators ist nach Vererbung, Verweiskonvertierung und Boxing-Konvertierung zulässig.
