...
## <a name="remarks"></a>Bemerkungen  
 [#endif](./preprocessor-endif.md) muss die nächste Präprozessoranweisung nach `#else` sein. Unter [#if](./preprocessor-if.md) finden Sie ein Beispiel zur Verwendung von `#else`.  
