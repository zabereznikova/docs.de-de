...
Generiert Prüfsummen für Quelldateien, um das Debuggen von [!INCLUDE[vstecasp](~/includes/vstecasp-md.md)]\-Seiten zu unterstützen.  
...
## Hinweise  
 ...
 Diese Lösung funktioniert nicht bei [!INCLUDE[vstecasp](~/includes/vstecasp-md.md)]\-Projekten, da sich die berechnete Prüfsumme auf die generierte Quelldatei und nicht auf die ASPX\-Datei bezieht.  Zur Lösung dieses Problems stellt `#pragma checksum` Prüfsummenunterstützung für [!INCLUDE[vstecasp](~/includes/vstecasp-md.md)]\-Seiten bereit.  
  
 Wenn in [!INCLUDE[csprcs](~/includes/csprcs-md.md)] ein [!INCLUDE[vstecasp](~/includes/vstecasp-md.md)]\-Projekt erstellt wird, enthält die generierte Quelldatei eine Prüfsumme für die ASPX\-Datei, die die Quelldatei generiert hat.  Der Compiler schreibt dann diese Informationen in die PDB\-Datei.  
