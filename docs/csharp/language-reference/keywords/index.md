...
|[var](../../../csharp/language-reference/keywords/var.md)|[when (Filterbedingung)](when.md)|[where (Einschränkung eines generischen Typs)](../../../csharp/language-reference/keywords/where-generic-type-constraint.md)|[where (Abfrageklausel)](../../../csharp/language-reference/keywords/where-clause.md)|  
