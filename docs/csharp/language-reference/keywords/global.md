...
## <a name="example"></a><span data-ttu-id="c6cc5-105">Beispiel</span><span class="sxs-lookup"><span data-stu-id="c6cc5-105">Example</span></span>  
 <span data-ttu-id="c6cc5-106">Im folgenden Beispiel wird veranschaulicht, wie mit dem Kontextschlüsselwort `global` angegeben wird, dass die Klasse `TestApp` im globalen Namespace definiert ist:</span><span class="sxs-lookup"><span data-stu-id="c6cc5-106">The following example shows how to use the `global` contextual keyword to specify that the class `TestApp` is defined in the global namespace:</span></span>  
  
 [!code-csharp[csrefKeywordsContextual#13](../../../csharp/language-reference/keywords/codesnippet/CSharp/global_1.cs)]  
  
## <a name="see-also"></a><span data-ttu-id="c6cc5-107">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="c6cc5-107">See Also</span></span>  
 [<span data-ttu-id="c6cc5-108">Namespaces</span><span class="sxs-lookup"><span data-stu-id="c6cc5-108">Namespaces</span></span>](../../../csharp/programming-guide/namespaces/index.md)
