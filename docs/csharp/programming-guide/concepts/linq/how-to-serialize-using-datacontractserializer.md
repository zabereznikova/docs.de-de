---
title: 'Vorgehensweise: Serialisieren mit DataContractSerializer (C#) | Microsoft-Dokumentation'
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
In diesem Thema finden Sie ein Beispiel für das Serialisieren und Deserialisieren mit <xref:System.Runtime.Serialization.DataContractSerializer>.  
