...
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="dc9f4-102">Beispiel-XML-Datei: Kunden und Bestellungen in einem Namespace</span><span class="sxs-lookup"><span data-stu-id="dc9f4-102">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="dc9f4-103">Die folgende XML-Datei wird in verschiedenen Beispielen in der [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)]-Dokumentation verwendet.</span><span class="sxs-lookup"><span data-stu-id="dc9f4-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="dc9f4-104">Sie enthält Kunden (<legacyBold>Customers</legacyBold>) und Aufträge (<legacyBold>Orders</legacyBold>).</span><span class="sxs-lookup"><span data-stu-id="dc9f4-104">This file contains customers and orders.</span></span> <span data-ttu-id="dc9f4-105">Der XML-Code befindet sich in einem Namespace.</span><span class="sxs-lookup"><span data-stu-id="dc9f4-105">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="dc9f4-106">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="dc9f4-106">CustomersOrdersInNamespace.xml</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="dc9f4-107">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="dc9f4-107">See Also</span></span>  
 [<span data-ttu-id="dc9f4-108">XML-Beispieldokumente (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="dc9f4-108">Sample XML Documents (LINQ to XML)</span></span>](../../../../csharp/programming-guide/concepts/linq/sample-xml-documents-linq-to-xml.md)
