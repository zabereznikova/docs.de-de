---
title: 'Vorgehensweise: Filtern nach einem Attribut (XPath-LINQ to XML) (C#) | Microsoft-Dokumentation'
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
---
# <a name="how-to-filter-on-an-attribute-xpath-linq-to-xml-c"></a>Vorgehensweise: Filtern nach einem Attribut (XPath-LINQ to XML) (C#)
