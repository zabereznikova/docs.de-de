...
## Übergeben von Werttypen als Wert  
 ...
 [!code-cs[csProgGuideParameters#3](../../../csharp/programming-guide/classes-and-structs/codesnippet/CSharp/passing-value-type-paramete_1.cs)]  
...
## Übergeben von Werttypen als Verweis  
 ...
 [!code-cs[csProgGuideParameters#4](../../../csharp/programming-guide/classes-and-structs/codesnippet/CSharp/passing-value-type-paramete_2.cs)]  
...
## Vertauschen von Werttypen  
 ...
 [!code-cs[csProgGuideParameters#5](../../../csharp/programming-guide/classes-and-structs/codesnippet/CSharp/passing-value-type-paramete_3.cs)]  
  
 Wenn Sie die `SwapByRef`\-Methode aufrufen, verwenden Sie das Schlüsselwort im Aufruf `ref` , wie im folgenden Beispiel gezeigt.  
  
 [!code-cs[csProgGuideParameters#6](../../../csharp/programming-guide/classes-and-structs/codesnippet/CSharp/passing-value-type-paramete_4.cs)]  
