...
Sie müssen [IronPython](http://ironpython.net/) für .NET zum Durchführen dieser exemplarischen Vorgehensweise. Wechseln Sie zu ihrer [Downloadseite](http://ironpython.net/download/) auf die neueste Version zu erhalten.
