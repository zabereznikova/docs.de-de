...
```
 Eingabeparametertypen müssen alle entweder explizit oder implizit sein. Andernfalls generiert C# den Compilerfehler [CS0748](../../misc/cs0748.md).
