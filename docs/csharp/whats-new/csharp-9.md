...
Datensätze unterstützen auch _*_with-Ausdrücke_*_. Ein _*_with-Ausdruck_*_ weist den Compiler an, eine Kopie eines Datensatzes mit (engl.: „with“) bestimmten geänderten Eigenschaften zu erstellen:
