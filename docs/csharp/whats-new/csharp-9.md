...
Datensätze unterstützen auch [`with`-Ausdrücke](../language-reference/operators/with-expression.md). Ein _*_ `with`-Ausdruck_ *_ weist den Compiler an, eine Kopie eines Datensatzes _mit* bestimmten geänderten Eigenschaften zu erstellen:
