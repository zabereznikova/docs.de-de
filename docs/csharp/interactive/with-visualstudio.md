...
# <a name="-using-c-interactive-with-visual-studio"></a>🔧 Verwenden von C# Interactive mit Visual Studio

> **Hinweis**
> 
> Zu diesem Thema wurde noch nichts geschrieben. 
>
> Wir freuen uns auf Ihre Ideen zur Gestaltung des Umfangs und der Herangehensweise. Sie können den Status nachverfolgen und Informationen zu diesem [Problem](https://github.com/dotnet/docs/issues/969) auf GitHub bereitstellen.
> 
