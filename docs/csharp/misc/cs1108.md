...
Ein Parameter kann nicht alle angegebenen Modifizierer aufweisen. Für den Parameter wurden zu viele Modifizierer angegeben.  
 ...
 Bestimmte Kombinationen von Parametermodifizierern, z. B. `in`, `ref`, und `out`, sind nicht zulässig, da sie sich gegenseitig ausschließende Bedeutungen für den Compiler haben.  
