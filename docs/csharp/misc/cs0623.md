...
## <a name="example"></a>Beispiel  
 Im folgenden Beispiel wird CS0623 erzeugt, da der Compiler {4} den als eingebetteten Arrayinitialisierer innerhalb des äußeren Arrayinitialisierers interpretiert:  
