...
Der Typ "Typ" ist in einer nicht referenzierten Assembly definiert. Fügen Sie einen Verweis auf die Assembly "Assembly" hinzu.  
 ...
 Die Definition für einen referenzierten Typ wurde nicht gefunden. Dies kann passieren, wenn eine erforderliche DLL-Datei nicht in der Kompilierung enthalten ist. Weitere Informationen finden Sie unter [Add Reference Dialog Box](/visualstudio/ide/how-to-add-or-remove-references-by-using-the-reference-manager) und [/reference (C# Compiler Options)](../../csharp/language-reference/compiler-options/reference-compiler-option.md).  
