...
Der erste Operand des "is"- oder "as"-Operators darf kein Lambda-Ausdruck und keine anonyme Methode sein.  
 ...
 Lambda-Ausdrücke und anonyme Methoden dürfen nicht auf der linken Seite von [is](../../csharp/language-reference/operators/type-testing-and-conversion-operators.md#is-operator) oder [as](../../csharp/language-reference/operators/type-testing-and-conversion-operators.md#as-operator)verwendet werden.
