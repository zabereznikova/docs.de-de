...
Fehlende Dateispezifikation für die Option "Option".  
 ...
 Beispielsweise wird bei Verwendung [/recurse](../../csharp/language-reference/compiler-options/recurse-compiler-option.md), müssen Sie die zu durchsuchende Datei angeben: **/recurse:***Filename***cs**.  
