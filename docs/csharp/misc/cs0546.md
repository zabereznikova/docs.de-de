...
- Die Basisklasseneigenschaft deklariert den [get](../../csharp/language-reference/keywords/get.md) - oder [set](../../csharp/language-reference/keywords/set.md) -Accessor nicht, den Sie überschreiben möchten.  
 ...
 Wenn Sie die Basisklasseneigenschaft nicht überschreiben möchten, können Sie vor der Eigenschaft in einer abgeleiteten Klasse das [new](../../csharp/language-reference/keywords/new-modifier.md) -Schlüsselwort verwenden.  
