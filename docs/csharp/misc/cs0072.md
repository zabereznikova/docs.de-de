...
'ereignis': Überschreiben nicht möglich; 'methode' ist kein Ereignis  
 ...
 Ein [Ereignis](../../csharp/language-reference/keywords/event.md) kann nur ein anderes Ereignis überschreiben. Weitere Informationen finden Sie unter [Ereignisse](../../csharp/programming-guide/events/index.md)definiert sind.  
