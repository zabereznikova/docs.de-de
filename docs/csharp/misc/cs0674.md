...
Verwenden Sie nicht "System.ParamArrayAttribute". Verwenden Sie stattdessen das Schlüsselwort "params".  
 ...
 Der C#-Compiler lässt die Verwendung von <xref:System.ParamArrayAttribute?displayProperty=nameWithType>nicht zu; verwenden Sie stattdessen [params](../../csharp/language-reference/keywords/params.md) .  
