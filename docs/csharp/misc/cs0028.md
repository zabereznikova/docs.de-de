...
Die "Funktionsdeklaration" weist als Einstiegspunkt die falsche Signatur auf.  
 ...
 Die Methodendeklaration für `Main` war ungültig: Die Deklaration erfolgte mit einer ungültigen Signatur. `Main`muss als statisch und es entweder zurückgeben müssen deklariert werden [Int](../../csharp/language-reference/keywords/int.md) oder [void](../../csharp/language-reference/keywords/void.md). Weitere Informationen finden Sie unter [Main() und Befehlszeilenargumente](../../csharp/programming-guide/main-and-command-args/index.md).  
