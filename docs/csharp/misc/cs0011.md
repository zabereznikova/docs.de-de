...
Die Basisklasse oder Schnittstelle "Klasse" in der Assembly "Assembly", auf die vom Typ "Typ" verwiesen wird, konnte nicht aufgelöst werden.  
 ...
 Weitere Informationen finden Sie unter [hinzufügen Dialogfelds "Verweis"](http://msdn.microsoft.com/library/2feb0fe2-0805-4cc9-8cba-b0315849dfb7) und [/Reference (C#-Compileroptionen)](../../csharp/language-reference/compiler-options/reference-compiler-option.md).  
...
## <a name="see-also"></a>Siehe auch  
 [Hinzufügen des Dialogfelds "Verweis"](http://msdn.microsoft.com/library/2feb0fe2-0805-4cc9-8cba-b0315849dfb7)  
