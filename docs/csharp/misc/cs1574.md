...
XML-Kommentar zu „construct“ weist ein syntaktisch falsches cref-Attribut „name“ auf.  
 ...
 Eine Zeichenfolge übergeben, um ein Cref-Tag, z. B. innerhalb einer \<Ausnahme > Tag, verwies auf ein Element, das an der aktuellen Buildumgebung nicht verfügbar ist. Die Zeichenfolge, die Sie an ein cref-Tag übergeben, muss der syntaktisch korrekte Name eines Members oder Felds sein.  
