...
Der as-Operator muss mit einem Referenztyp oder einem Typ, der NULL-Werte zulässt, verwendet werden. ("int" ist ein Werttyp, der keine NULL-Werte zulässt.)  
 ...
 An den [as](../language-reference/operators/type-testing-and-cast.md#as-operator) -Operator wurde ein [Werttyp](../language-reference/keywords/value-types.md)übergeben. Da `as` [null](../language-reference/keywords/null.md)zurückgeben kann, dürfen nur [Verweistypen](../language-reference/keywords/reference-types.md) oder ein Typ, der NULL-Werte zulässt, an ihn übergeben werden. Weitere Informationen zu Typen, die NULL-Werte zulassen, finden Sie unter [Werte zulässt-Typen](../programming-guide/nullable-types/index.md).  
