...
Methode, Operator oder Accessor 'Methode' ist extern markiert und weist keine Attribute auf. Erwägen Sie eine DllImport-Attribut, um die externe Implementierung anzugeben.
