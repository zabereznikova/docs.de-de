...
Im Schnellstart [Hallo Welt](hello-world.yml) erstellen Sie das einfachste C#-Programm. Sie untersuchen den `string`-Typ und lernen, mit Text zu arbeiten.
...
In diesem Schnellstart wird vorausgesetzt, dass Sie die Onlineschnellstarts abgeschlossen und das [.NET Core SDK](http://dot.net/core) und [Visual Studio Code](https://code.visualstudio.com/) installiert haben.